 ...
 * @version 1.11.0
 */
class CreateAutomaticTokensForwardingE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `CreateAutomaticTokensForwardingE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan, TokensForwardingAutomationsLimitReached. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/CreateAutomaticTokensForwardingE403} An instance of CreateAutomaticTokensForwardingE403.
     */
...
export default CreateAutomaticTokensForwardingE403;
