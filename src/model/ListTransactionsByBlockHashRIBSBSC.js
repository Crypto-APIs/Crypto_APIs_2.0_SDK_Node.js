...
class ListTransactionsByBlockHashRIBSBSC {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHashRIBSBSC.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['gasPrice']) { // data not null
          ListTransactionsByBlockHashRIBSBSCGasPrice.validateJSON(data['gasPrice']);
        }
        // ensure the json data is a string
...
export default ListTransactionsByBlockHashRIBSBSC;
