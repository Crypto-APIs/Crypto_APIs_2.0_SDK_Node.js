...
class ListUnconfirmedTransactionsByAddressRIBSBVinInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListUnconfirmedTransactionsByAddressRIBSBVinInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptSig']) { // data not null
          ListUnconfirmedTransactionsByAddressRIBSBVinInnerScriptSig.validateJSON(data['scriptSig']);
        }
