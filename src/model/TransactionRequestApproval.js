...
import TransactionRequestApprovalData from './TransactionRequestApprovalData';
...
class TransactionRequestApproval {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = TransactionRequestApprovalData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of TransactionRequestApproval.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          TransactionRequestApprovalData.validateJSON(data['data']);
        }
...
export default TransactionRequestApproval;
