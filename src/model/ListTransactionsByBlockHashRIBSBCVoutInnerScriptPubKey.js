 ...
 * @version 1.11.0
 */
class ListTransactionsByBlockHashRIBSBCVoutInnerScriptPubKey {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHashRIBSBCVoutInnerScriptPubKey.RequiredProperties) {
            if (!data[property]) {
...
export default ListTransactionsByBlockHashRIBSBCVoutInnerScriptPubKey;
