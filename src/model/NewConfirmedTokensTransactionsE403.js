 ...
 * @version 1.11.0
 */
class NewConfirmedTokensTransactionsE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewConfirmedTokensTransactionsE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/NewConfirmedTokensTransactionsE403} An instance of NewConfirmedTokensTransactionsE403.
     */
...
export default NewConfirmedTokensTransactionsE403;
