...
import BlockchainDataInternalTransactionNotFoundError from './BlockchainDataInternalTransactionNotFoundError';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = BlockchainDataInternalTransactionNotFoundError.constructFromObject(data['error']);
            }
        }
        return obj;
    }
