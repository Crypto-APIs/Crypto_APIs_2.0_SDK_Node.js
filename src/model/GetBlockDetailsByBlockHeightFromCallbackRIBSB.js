 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHeightFromCallbackRIBSB {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetBlockDetailsByBlockHeightFromCallbackRIBSB.RequiredProperties) {
            if (!data[property]) {
...
export default GetBlockDetailsByBlockHeightFromCallbackRIBSB;
