 ...
 * @version 1.11.0
 */
class GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey.RequiredProperties) {
            if (!data[property]) {
...
export default GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey;
