...
class GetTransactionRequestDetailsE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetTransactionRequestDetailsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetTransactionRequestDetailsE400} An instance of GetTransactionRequestDetailsE400.
     */
...
export default GetTransactionRequestDetailsE400;
