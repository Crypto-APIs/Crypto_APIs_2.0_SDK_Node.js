...
import GetAddressDetailsE400 from './GetAddressDetailsE400';
...
class GetAddressDetails400Response {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = GetAddressDetailsE400.constructFromObject(data['error']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetAddressDetails400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAddressDetails400Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetAddressDetails400Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          GetAddressDetailsE400.validateJSON(data['error']);
        }
...
GetAddressDetails400Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default GetAddressDetails400Response;
