...
import ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey from './ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey';
 ...
 * @version 1.11.0
 */
class ListTransactionsByBlockHashRIBSD2VoutInner {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHashRIBSD2VoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
...
export default ListTransactionsByBlockHashRIBSD2VoutInner;
