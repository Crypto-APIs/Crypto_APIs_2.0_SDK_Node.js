...
class ListConfirmedTransactionsByAddressRIBSZ {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListConfirmedTransactionsByAddressRIBSZ.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vJoinSplit']) { // data not null
            ...
            for (const item of data['vJoinSplit']) {
                ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner.validateJsonObject(item);
            };
        }
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                ListConfirmedTransactionsByAddressRIBSZVinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                GetTransactionDetailsByTransactionIDRIBSZVoutInner.validateJsonObject(item);
            };
        }
...
export default ListConfirmedTransactionsByAddressRIBSZ;
