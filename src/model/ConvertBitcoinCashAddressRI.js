 ...
 * @version 1.11.0
 */
class ConvertBitcoinCashAddressRI {
    /**
     ...
     */
    static initialize(obj, convertedAddress) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('convertedAddress')) {
                obj['convertedAddress'] = ApiClient.convertToType(data['convertedAddress'], 'String');
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ConvertBitcoinCashAddressRI.RequiredProperties) {
            if (!data[property]) {
...
export default ConvertBitcoinCashAddressRI;
