 ...
 * @version 1.11.0
 */
class SyncHDWalletXPubYPubZPubE401 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `SyncHDWalletXPubYPubZPubE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/SyncHDWalletXPubYPubZPubE401} An instance of SyncHDWalletXPubYPubZPubE401.
     */
...
export default SyncHDWalletXPubYPubZPubE401;
