...
import GetFeeAddressDetailsRI from './GetFeeAddressDetailsRI';
 ...
 * @version 1.11.0
 */
class GetFeeAddressDetailsRData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = GetFeeAddressDetailsRI.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of GetFeeAddressDetailsRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          GetFeeAddressDetailsRI.validateJSON(data['item']);
        }
...
export default GetFeeAddressDetailsRData;
