...
class ListTokensTransfersByTransactionHashE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListTokensTransfersByTransactionHashE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListTokensTransfersByTransactionHashE403} An instance of ListTokensTransfersByTransactionHashE403.
     */
...
export default ListTokensTransfersByTransactionHashE403;
