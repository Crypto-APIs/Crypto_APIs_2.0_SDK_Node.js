...
class CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE401.validateJSON(data['error']);
        }
