 ...
 * @version 1.11.0
 */
class ListTransactionsByBlockHashRIBSBC {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHashRIBSBC.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                ListTransactionsByBlockHashRIBSBCVinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                ListTransactionsByBlockHashRIBSBCVoutInner.validateJsonObject(item);
            };
        }
...
export default ListTransactionsByBlockHashRIBSBC;
