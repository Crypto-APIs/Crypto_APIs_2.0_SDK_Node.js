...
class GetWalletTransactionDetailsByTransactionIDRIBSDVinInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetWalletTransactionDetailsByTransactionIDRIBSDVinInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptSig']) { // data not null
          GetWalletTransactionDetailsByTransactionIDRIBSDVinInnerScriptSig.validateJSON(data['scriptSig']);
        }
        // ensure the json data is a string
