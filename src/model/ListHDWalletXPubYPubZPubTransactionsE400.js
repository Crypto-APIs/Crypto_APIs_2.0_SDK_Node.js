 ...
 * @version 1.11.0
 */
class ListHDWalletXPubYPubZPubTransactionsE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListHDWalletXPubYPubZPubTransactionsE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListHDWalletXPubYPubZPubTransactionsE400} An instance of ListHDWalletXPubYPubZPubTransactionsE400.
     */
...
export default ListHDWalletXPubYPubZPubTransactionsE400;
