...
import WalletAsAServiceWalletBalanceNotEnoughError from './WalletAsAServiceWalletBalanceNotEnoughError';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = WalletAsAServiceWalletBalanceNotEnoughError.constructFromObject(data['error']);
            }
        }
        return obj;
    }
...
export default WalletAsAServiceWalletBalanceNotEnough;
