...
import TransactionMinedData from './TransactionMinedData';
...
class TransactionMined {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = TransactionMinedData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of TransactionMined.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          TransactionMinedData.validateJSON(data['data']);
        }
...
export default TransactionMined;
