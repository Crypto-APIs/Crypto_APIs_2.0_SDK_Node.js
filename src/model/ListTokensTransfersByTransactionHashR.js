...
import ListTokensTransfersByTransactionHashRData from './ListTokensTransfersByTransactionHashRData';
...
class ListTokensTransfersByTransactionHashR {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ListTokensTransfersByTransactionHashRData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListTokensTransfersByTransactionHashR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTokensTransfersByTransactionHashR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListTokensTransfersByTransactionHashR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          ListTokensTransfersByTransactionHashRData.validateJSON(data['data']);
        }
...
ListTokensTransfersByTransactionHashR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
export default ListTokensTransfersByTransactionHashR;
