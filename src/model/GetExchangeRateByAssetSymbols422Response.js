...
class GetExchangeRateByAssetSymbols422Response {
    ...
    /**
     * Validates the JSON data with respect to <code>GetExchangeRateByAssetSymbols422Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetExchangeRateByAssetSymbols422Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetExchangeRateByAssetSymbols422Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          GetExchangeRateByAssetSymbolsE422.validateJSON(data['error']);
        }
...
GetExchangeRateByAssetSymbols422Response.RequiredProperties = ["apiVersion", "requestId", "error"];
