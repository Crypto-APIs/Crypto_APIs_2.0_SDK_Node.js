...
import ListOmniTransactionsByAddressRI from './ListOmniTransactionsByAddressRI';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListOmniTransactionsByAddressRI]);
            }
        }
        return obj;
    }
...
export default ListOmniTransactionsByAddressRData;
