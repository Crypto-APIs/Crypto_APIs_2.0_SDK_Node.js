...
class NewUnconfirmedTokensTransactionsE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewUnconfirmedTokensTransactionsE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/NewUnconfirmedTokensTransactionsE403} An instance of NewUnconfirmedTokensTransactionsE403.
     */
...
export default NewUnconfirmedTokensTransactionsE403;
