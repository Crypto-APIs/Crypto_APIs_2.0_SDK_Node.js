...
class GetTransactionDetailsByTransactionIDE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetTransactionDetailsByTransactionIDE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetTransactionDetailsByTransactionIDE403} An instance of GetTransactionDetailsByTransactionIDE403.
     */
...
export default GetTransactionDetailsByTransactionIDE403;
