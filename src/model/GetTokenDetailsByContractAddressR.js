...
import GetTokenDetailsByContractAddressRData from './GetTokenDetailsByContractAddressRData';
 ...
 * @version 1.11.0
 */
class GetTokenDetailsByContractAddressR {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = GetTokenDetailsByContractAddressRData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetTokenDetailsByContractAddressR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTokenDetailsByContractAddressR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetTokenDetailsByContractAddressR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          GetTokenDetailsByContractAddressRData.validateJSON(data['data']);
        }
...
GetTokenDetailsByContractAddressR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
export default GetTokenDetailsByContractAddressR;
