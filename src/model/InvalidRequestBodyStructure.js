...
import InvalidRequestBodyStructureError from './InvalidRequestBodyStructureError';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = InvalidRequestBodyStructureError.constructFromObject(data['error']);
            }
        }
        return obj;
    }
