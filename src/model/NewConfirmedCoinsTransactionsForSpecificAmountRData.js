...
import NewConfirmedCoinsTransactionsForSpecificAmountRI from './NewConfirmedCoinsTransactionsForSpecificAmountRI';
 ...
 * @version 1.11.0
 */
class NewConfirmedCoinsTransactionsForSpecificAmountRData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = NewConfirmedCoinsTransactionsForSpecificAmountRI.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedCoinsTransactionsForSpecificAmountRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          NewConfirmedCoinsTransactionsForSpecificAmountRI.validateJSON(data['item']);
        }
...
export default NewConfirmedCoinsTransactionsForSpecificAmountRData;
