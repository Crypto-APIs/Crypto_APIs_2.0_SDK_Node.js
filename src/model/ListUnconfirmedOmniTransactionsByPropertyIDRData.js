...
import ListUnconfirmedOmniTransactionsByPropertyIDRI from './ListUnconfirmedOmniTransactionsByPropertyIDRI';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListUnconfirmedOmniTransactionsByPropertyIDRI]);
            }
        }
        return obj;
    }
...
export default ListUnconfirmedOmniTransactionsByPropertyIDRData;
