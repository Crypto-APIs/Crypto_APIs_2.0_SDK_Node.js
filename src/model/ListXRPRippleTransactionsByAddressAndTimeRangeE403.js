...
class ListXRPRippleTransactionsByAddressAndTimeRangeE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListXRPRippleTransactionsByAddressAndTimeRangeE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListXRPRippleTransactionsByAddressAndTimeRangeE403} An instance of ListXRPRippleTransactionsByAddressAndTimeRangeE403.
     */
...
export default ListXRPRippleTransactionsByAddressAndTimeRangeE403;
