...
class GetBlockDetailsByBlockHeightFromCallback403Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetBlockDetailsByBlockHeightFromCallback403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          GetBlockDetailsByBlockHeightFromCallbackE403.validateJSON(data['error']);
        }
