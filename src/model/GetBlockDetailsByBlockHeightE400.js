...
class GetBlockDetailsByBlockHeightE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetBlockDetailsByBlockHeightE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetBlockDetailsByBlockHeightE400} An instance of GetBlockDetailsByBlockHeightE400.
     */
...
export default GetBlockDetailsByBlockHeightE400;
