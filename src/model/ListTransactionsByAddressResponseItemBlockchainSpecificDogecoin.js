...
import ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin from './ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin';
 ...
 * @version 2.0.0
 */
class ListTransactionsByAddressResponseItemBlockchainSpecificDogecoin {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('vin')) {
                obj['vin'] = ApiClient.convertToType(data['vin'], [ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin]);
            }
...
export default ListTransactionsByAddressResponseItemBlockchainSpecificDogecoin;
