 ...
 * @version 1.11.0
 */
class ListInternalTransactionDetailsByTransactionHashE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListInternalTransactionDetailsByTransactionHashE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListInternalTransactionDetailsByTransactionHashE403} An instance of ListInternalTransactionDetailsByTransactionHashE403.
     */
...
export default ListInternalTransactionDetailsByTransactionHashE403;
