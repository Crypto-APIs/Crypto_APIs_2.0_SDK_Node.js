...
class ListTransactionsByBlockHashRIBSZ {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHashRIBSZ.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vJoinSplit']) { // data not null
            ...
            for (const item of data['vJoinSplit']) {
                ListTransactionsByBlockHashRIBSZVJoinSplitInner.validateJsonObject(item);
            };
        }
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                ListTransactionsByBlockHashRIBSZVinInner.validateJsonObject(item);
            };
        }
...
export default ListTransactionsByBlockHashRIBSZ;
