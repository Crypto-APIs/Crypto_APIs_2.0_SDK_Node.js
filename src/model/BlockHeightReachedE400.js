...
class BlockHeightReachedE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `BlockHeightReachedE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/BlockHeightReachedE400} An instance of BlockHeightReachedE400.
     */
...
export default BlockHeightReachedE400;
