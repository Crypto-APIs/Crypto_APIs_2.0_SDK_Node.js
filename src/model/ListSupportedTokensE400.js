...
class ListSupportedTokensE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListSupportedTokensE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListSupportedTokensE400} An instance of ListSupportedTokensE400.
     */
...
export default ListSupportedTokensE400;
