...
class ListUnconfirmedTokensTransfersByAddressE401 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListUnconfirmedTokensTransfersByAddressE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListUnconfirmedTokensTransfersByAddressE401} An instance of ListUnconfirmedTokensTransfersByAddressE401.
     */
...
export default ListUnconfirmedTokensTransfersByAddressE401;
