...
import WalletAsAServiceAddressBalanceNotEnoughError from './WalletAsAServiceAddressBalanceNotEnoughError';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = WalletAsAServiceAddressBalanceNotEnoughError.constructFromObject(data['error']);
            }
        }
        return obj;
    }
