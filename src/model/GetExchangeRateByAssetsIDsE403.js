 ...
 * @version 1.11.0
 */
class GetExchangeRateByAssetsIDsE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetExchangeRateByAssetsIDsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetExchangeRateByAssetsIDsE403} An instance of GetExchangeRateByAssetsIDsE403.
     */
...
export default GetExchangeRateByAssetsIDsE403;
