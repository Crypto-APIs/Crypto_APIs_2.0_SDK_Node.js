 ...
 * @version 1.11.0
 */
class UnfreezeTronEnergyOrBandwidthE409 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `UnfreezeTronEnergyOrBandwidthE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceTokenNotSupported, WalletAsAServiceWalletBalanceNotEnough. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Create an instance of UnfreezeTronEnergyOrBandwidthE409 from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/UnfreezeTronEnergyOrBandwidthE409} An instance of UnfreezeTronEnergyOrBandwidthE409.
     */
...
export default UnfreezeTronEnergyOrBandwidthE409;
