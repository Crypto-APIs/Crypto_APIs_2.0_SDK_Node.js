...
class ListUnconfirmedTransactionsByAddressRIBSB {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListUnconfirmedTransactionsByAddressRIBSB.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                ListUnconfirmedTransactionsByAddressRIBSBVinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                ListUnconfirmedTransactionsByAddressRIBSBVoutInner.validateJsonObject(item);
            };
        }
