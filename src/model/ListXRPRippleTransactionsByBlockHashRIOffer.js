 ...
 * @version 1.11.0
 */
class ListXRPRippleTransactionsByBlockHashRIOffer {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of ListXRPRippleTransactionsByBlockHashRIOffer.RequiredProperties) {
            if (!data[property]) {
...
export default ListXRPRippleTransactionsByBlockHashRIOffer;
