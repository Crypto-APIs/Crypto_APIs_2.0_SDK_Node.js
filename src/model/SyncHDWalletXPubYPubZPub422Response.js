 ...
 * @version 1.11.0
 */
class SyncHDWalletXPubYPubZPub422Response {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = SyncHDWalletXPubYPubZPubE422.constructFromObject(data['error']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SyncHDWalletXPubYPubZPub422Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SyncHDWalletXPubYPubZPub422Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of SyncHDWalletXPubYPubZPub422Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          SyncHDWalletXPubYPubZPubE422.validateJSON(data['error']);
        }
...
SyncHDWalletXPubYPubZPub422Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default SyncHDWalletXPubYPubZPub422Response;
