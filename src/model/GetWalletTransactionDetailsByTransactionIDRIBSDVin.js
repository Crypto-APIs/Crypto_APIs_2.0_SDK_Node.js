...
import GetWalletTransactionDetailsByTransactionIDRIBSDScriptSig from './GetWalletTransactionDetailsByTransactionIDRIBSDScriptSig';
 ...
 * @version 1.4.0
 */
class GetWalletTransactionDetailsByTransactionIDRIBSDVin {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptSig')) {
                obj['scriptSig'] = GetWalletTransactionDetailsByTransactionIDRIBSDScriptSig.constructFromObject(data['scriptSig']);
            }
...
export default GetWalletTransactionDetailsByTransactionIDRIBSDVin;
