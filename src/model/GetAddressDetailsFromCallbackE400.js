 ...
 * @version 1.11.0
 */
class GetAddressDetailsFromCallbackE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetAddressDetailsFromCallbackE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetAddressDetailsFromCallbackE400} An instance of GetAddressDetailsFromCallbackE400.
     */
...
export default GetAddressDetailsFromCallbackE400;
