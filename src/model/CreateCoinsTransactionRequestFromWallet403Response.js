...
class CreateCoinsTransactionRequestFromWallet403Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateCoinsTransactionRequestFromWallet403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          CreateCoinsTransactionRequestFromWalletE403.validateJSON(data['error']);
        }
