 ...
 * @version 1.11.0
 */
class ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey.RequiredProperties) {
            if (!data[property]) {
...
export default ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey;
