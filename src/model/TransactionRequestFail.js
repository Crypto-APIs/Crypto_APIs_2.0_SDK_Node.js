...
class TransactionRequestFail {
    ...
    /**
     * Validates the JSON data with respect to <code>TransactionRequestFail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransactionRequestFail</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransactionRequestFail.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          TransactionRequestFailData.validateJSON(data['data']);
        }
...
TransactionRequestFail.RequiredProperties = ["apiVersion", "referenceId", "idempotencyKey", "data"];
