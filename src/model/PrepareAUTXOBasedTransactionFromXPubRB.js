...
import PrepareAUTXOBasedTransactionFromXPubRBData from './PrepareAUTXOBasedTransactionFromXPubRBData';
 ...
 * @version 1.7.1
 */
class PrepareAUTXOBasedTransactionFromXPubRB {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = PrepareAUTXOBasedTransactionFromXPubRBData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
...
export default PrepareAUTXOBasedTransactionFromXPubRB;
