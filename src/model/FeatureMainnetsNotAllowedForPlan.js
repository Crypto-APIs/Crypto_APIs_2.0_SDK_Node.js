...
import FeatureMainnetsNotAllowedForPlanError from './FeatureMainnetsNotAllowedForPlanError';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = FeatureMainnetsNotAllowedForPlanError.constructFromObject(data['error']);
            }
        }
        return obj;
    }
