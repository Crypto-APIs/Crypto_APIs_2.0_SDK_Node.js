...
import GetOmniTransactionDetailsByTransactionIDTxidRISendersInner from './GetOmniTransactionDetailsByTransactionIDTxidRISendersInner';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('senders')) {
                obj['senders'] = ApiClient.convertToType(data['senders'], [GetOmniTransactionDetailsByTransactionIDTxidRISendersInner]);
            }
