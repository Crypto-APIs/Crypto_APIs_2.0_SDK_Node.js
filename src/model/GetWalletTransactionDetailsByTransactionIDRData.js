...
import GetWalletTransactionDetailsByTransactionIDRI from './GetWalletTransactionDetailsByTransactionIDRI';
 ...
 * @version 1.11.0
 */
class GetWalletTransactionDetailsByTransactionIDRData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = GetWalletTransactionDetailsByTransactionIDRI.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of GetWalletTransactionDetailsByTransactionIDRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          GetWalletTransactionDetailsByTransactionIDRI.validateJSON(data['item']);
        }
...
export default GetWalletTransactionDetailsByTransactionIDRData;
