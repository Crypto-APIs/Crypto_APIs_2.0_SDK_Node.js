...
class ListLatestMinedBlocksE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListLatestMinedBlocksE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListLatestMinedBlocksE403} An instance of ListLatestMinedBlocksE403.
     */
...
export default ListLatestMinedBlocksE403;
