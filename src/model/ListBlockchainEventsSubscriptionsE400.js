...
class ListBlockchainEventsSubscriptionsE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListBlockchainEventsSubscriptionsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListBlockchainEventsSubscriptionsE400} An instance of ListBlockchainEventsSubscriptionsE400.
     */
...
export default ListBlockchainEventsSubscriptionsE400;
