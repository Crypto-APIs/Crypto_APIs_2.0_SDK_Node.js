...
import ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey from './ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey';
 ...
 * @version 1.11.0
 */
class ListTransactionsByBlockHashRIBSBVoutInner {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHashRIBSBVoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
...
export default ListTransactionsByBlockHashRIBSBVoutInner;
