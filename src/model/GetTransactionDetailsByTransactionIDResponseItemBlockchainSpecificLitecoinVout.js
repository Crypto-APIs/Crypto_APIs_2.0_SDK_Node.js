...
import GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificLitecoinScriptPubKey from './GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificLitecoinScriptPubKey';
 ...
 * @version 2.0.0
 */
class GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificLitecoinVout {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificLitecoinScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
...
export default GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificLitecoinVout;
