...
class GetZilliqaBlockDetailsByBlockHashE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetZilliqaBlockDetailsByBlockHashE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetZilliqaBlockDetailsByBlockHashE400} An instance of GetZilliqaBlockDetailsByBlockHashE400.
     */
...
export default GetZilliqaBlockDetailsByBlockHashE400;
