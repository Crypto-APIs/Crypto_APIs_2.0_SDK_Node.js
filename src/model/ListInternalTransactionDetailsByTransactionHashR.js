...
import ListInternalTransactionDetailsByTransactionHashRData from './ListInternalTransactionDetailsByTransactionHashRData';
...
class ListInternalTransactionDetailsByTransactionHashR {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ListInternalTransactionDetailsByTransactionHashRData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListInternalTransactionDetailsByTransactionHashR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListInternalTransactionDetailsByTransactionHashR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListInternalTransactionDetailsByTransactionHashR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          ListInternalTransactionDetailsByTransactionHashRData.validateJSON(data['data']);
        }
...
ListInternalTransactionDetailsByTransactionHashR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
export default ListInternalTransactionDetailsByTransactionHashR;
