...
class AddressCoinsTransactionConfirmedEachConfirmationDataItem {
    ...
    static validateJSON(data) {
        ...
        for (const property of AddressCoinsTransactionConfirmedEachConfirmationDataItem.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['minedInBlock']) { // data not null
          AddressCoinsTransactionConfirmedEachConfirmationDataItemMinedInBlock.validateJSON(data['minedInBlock']);
        }
        // ensure the json data is a string
