 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHeightFromCallbackE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetBlockDetailsByBlockHeightFromCallbackE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetBlockDetailsByBlockHeightFromCallbackE403} An instance of GetBlockDetailsByBlockHeightFromCallbackE403.
     */
...
export default GetBlockDetailsByBlockHeightFromCallbackE403;
