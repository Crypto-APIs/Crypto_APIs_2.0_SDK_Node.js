...
import CreateAutomaticTokensForwardingRequestBodyTokenData from './CreateAutomaticTokensForwardingRequestBodyTokenData';
 ...
 * @version 2.0.0
 */
class CreateAutomaticTokensForwardingRequestBodyDataItem {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tokenData')) {
                obj['tokenData'] = CreateAutomaticTokensForwardingRequestBodyTokenData.constructFromObject(data['tokenData']);
            }
        }
        return obj;
    }
...
export default CreateAutomaticTokensForwardingRequestBodyDataItem;
