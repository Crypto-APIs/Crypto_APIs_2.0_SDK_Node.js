...
class NewConfirmedCoinsTransactionsForSpecificAmount403Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedCoinsTransactionsForSpecificAmount403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          NewConfirmedCoinsTransactionsForSpecificAmountE403.validateJSON(data['error']);
        }
