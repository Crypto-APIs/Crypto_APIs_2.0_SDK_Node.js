...
import ListTokensForwardingAutomationsRITS from './ListTokensForwardingAutomationsRITS';
...
class ListTokensForwardingAutomationsRI {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('tokenData')) {
                obj['tokenData'] = ListTokensForwardingAutomationsRITS.constructFromObject(data['tokenData']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTokensForwardingAutomationsRI.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['tokenData']) { // data not null
          ListTokensForwardingAutomationsRITS.validateJSON(data['tokenData']);
        }
...
export default ListTokensForwardingAutomationsRI;
