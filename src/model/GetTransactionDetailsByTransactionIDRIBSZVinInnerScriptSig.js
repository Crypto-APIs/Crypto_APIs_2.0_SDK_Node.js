 ...
 * @version 1.11.0
 */
class GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig.RequiredProperties) {
            if (!data[property]) {
...
export default GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig;
