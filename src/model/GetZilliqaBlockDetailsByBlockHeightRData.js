...
import GetZilliqaBlockDetailsByBlockHeightRI from './GetZilliqaBlockDetailsByBlockHeightRI';
...
class GetZilliqaBlockDetailsByBlockHeightRData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = GetZilliqaBlockDetailsByBlockHeightRI.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of GetZilliqaBlockDetailsByBlockHeightRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          GetZilliqaBlockDetailsByBlockHeightRI.validateJSON(data['item']);
        }
...
export default GetZilliqaBlockDetailsByBlockHeightRData;
