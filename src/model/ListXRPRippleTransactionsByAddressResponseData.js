...
import ListXRPRippleTransactionsByAddressResponseItem from './ListXRPRippleTransactionsByAddressResponseItem';
 ...
 * @version 2.0.0
 */
class ListXRPRippleTransactionsByAddressResponseData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListXRPRippleTransactionsByAddressResponseItem]);
            }
        }
        return obj;
    }
...
export default ListXRPRippleTransactionsByAddressResponseData;
