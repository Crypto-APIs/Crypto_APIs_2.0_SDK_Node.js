 ...
 * @version 1.11.0
 */
class ListXRPRippleTransactionsByBlockHeightRIFee {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of ListXRPRippleTransactionsByBlockHeightRIFee.RequiredProperties) {
            if (!data[property]) {
...
export default ListXRPRippleTransactionsByBlockHeightRIFee;
