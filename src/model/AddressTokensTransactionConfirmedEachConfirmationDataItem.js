...
class AddressTokensTransactionConfirmedEachConfirmationDataItem {
    ...
    static validateJSON(data) {
        ...
        for (const property of AddressTokensTransactionConfirmedEachConfirmationDataItem.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['token']) { // data not null
          AddressTokensTransactionConfirmedEachConfirmationToken.validateJSON(data['token']);
        }
        // ensure the json data is a string
