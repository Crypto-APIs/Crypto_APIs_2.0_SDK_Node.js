...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSL {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDFromCallbackRIBSL.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                GetTransactionDetailsByTransactionIDRIBSLVinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInner.validateJsonObject(item);
            };
        }
