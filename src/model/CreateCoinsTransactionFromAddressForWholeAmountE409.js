 ...
 * @version 1.11.0
 */
class CreateCoinsTransactionFromAddressForWholeAmountE409 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `CreateCoinsTransactionFromAddressForWholeAmountE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceWalletBalanceNotEnough. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/CreateCoinsTransactionFromAddressForWholeAmountE409} An instance of CreateCoinsTransactionFromAddressForWholeAmountE409.
     */
...
export default CreateCoinsTransactionFromAddressForWholeAmountE409;
