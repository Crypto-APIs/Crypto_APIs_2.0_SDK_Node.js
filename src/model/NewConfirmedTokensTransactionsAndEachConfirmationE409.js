 ...
 * @version 1.11.0
 */
class NewConfirmedTokensTransactionsAndEachConfirmationE409 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewConfirmedTokensTransactionsAndEachConfirmationE409` with oneOf schemas AlreadyExists, InvalidData. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/NewConfirmedTokensTransactionsAndEachConfirmationE409} An instance of NewConfirmedTokensTransactionsAndEachConfirmationE409.
     */
...
export default NewConfirmedTokensTransactionsAndEachConfirmationE409;
