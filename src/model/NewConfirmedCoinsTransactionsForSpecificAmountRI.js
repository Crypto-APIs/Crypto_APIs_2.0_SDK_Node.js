 ...
 * @version 1.11.0
 */
class NewConfirmedCoinsTransactionsForSpecificAmountRI {
    /**
     ...
     */
    constructor(amountHigherThan, callbackUrl, createdTimestamp, eventType, isActive, referenceId) { 
     ...
     */
    static initialize(obj, amountHigherThan, callbackUrl, createdTimestamp, eventType, isActive, referenceId) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedCoinsTransactionsForSpecificAmountRI.RequiredProperties) {
            if (!data[property]) {
...
export default NewConfirmedCoinsTransactionsForSpecificAmountRI;
