...
class BroadcastLocallySignedTransactionE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `BroadcastLocallySignedTransactionE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/BroadcastLocallySignedTransactionE403} An instance of BroadcastLocallySignedTransactionE403.
     */
...
export default BroadcastLocallySignedTransactionE403;
