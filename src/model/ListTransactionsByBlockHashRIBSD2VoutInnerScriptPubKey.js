...
class ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey.RequiredProperties) {
            if (!data[property]) {
...
export default ListTransactionsByBlockHashRIBSD2VoutInnerScriptPubKey;
