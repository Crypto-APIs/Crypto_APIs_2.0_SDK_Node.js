...
import TransactionRequestMinedData from './TransactionRequestMinedData';
...
class TransactionRequestMined {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = TransactionRequestMinedData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TransactionRequestMined</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransactionRequestMined</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of TransactionRequestMined.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          TransactionRequestMinedData.validateJSON(data['data']);
        }
...
TransactionRequestMined.RequiredProperties = ["apiVersion", "referenceId", "idempotencyKey", "data"];
...
export default TransactionRequestMined;
