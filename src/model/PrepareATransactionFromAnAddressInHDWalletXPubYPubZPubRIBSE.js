...
class PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSE {
    ...
    static validateJSON(data) {
        ...
        for (const property of PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSE.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['fee']) { // data not null
          PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee.validateJSON(data['fee']);
        }
        // ensure the json data is a string
