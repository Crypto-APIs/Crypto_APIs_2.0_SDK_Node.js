 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHeightRIBSL {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetBlockDetailsByBlockHeightRIBSL.RequiredProperties) {
            if (!data[property]) {
...
export default GetBlockDetailsByBlockHeightRIBSL;
