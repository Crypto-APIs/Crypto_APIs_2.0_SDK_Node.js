...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
