...
class GetNextAvailableNonceE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetNextAvailableNonceE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetNextAvailableNonceE400} An instance of GetNextAvailableNonceE400.
     */
...
export default GetNextAvailableNonceE400;
