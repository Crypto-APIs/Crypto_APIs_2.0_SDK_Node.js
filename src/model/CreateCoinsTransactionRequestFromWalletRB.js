...
class CreateCoinsTransactionRequestFromWalletRB {
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateCoinsTransactionRequestFromWalletRB.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          CreateCoinsTransactionRequestFromWalletRBData.validateJSON(data['data']);
        }
