...
class GetFeeRecommendationsE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetFeeRecommendationsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetFeeRecommendationsE400} An instance of GetFeeRecommendationsE400.
     */
...
export default GetFeeRecommendationsE400;
