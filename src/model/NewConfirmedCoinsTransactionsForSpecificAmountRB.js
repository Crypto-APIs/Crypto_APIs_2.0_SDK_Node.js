...
import NewConfirmedCoinsTransactionsForSpecificAmountRBData from './NewConfirmedCoinsTransactionsForSpecificAmountRBData';
 ...
 * @version 1.11.0
 */
class NewConfirmedCoinsTransactionsForSpecificAmountRB {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = NewConfirmedCoinsTransactionsForSpecificAmountRBData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedCoinsTransactionsForSpecificAmountRB.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          NewConfirmedCoinsTransactionsForSpecificAmountRBData.validateJSON(data['data']);
        }
...
export default NewConfirmedCoinsTransactionsForSpecificAmountRB;
