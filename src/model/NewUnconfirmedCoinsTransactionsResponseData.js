...
import NewUnconfirmedCoinsTransactionsResponseItem from './NewUnconfirmedCoinsTransactionsResponseItem';
 ...
 * @version 2.0.0
 */
class NewUnconfirmedCoinsTransactionsResponseData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = NewUnconfirmedCoinsTransactionsResponseItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
...
export default NewUnconfirmedCoinsTransactionsResponseData;
