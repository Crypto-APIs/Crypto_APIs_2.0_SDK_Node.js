...
class GetWalletTransactionDetailsByTransactionIDRIBSEC {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetWalletTransactionDetailsByTransactionIDRIBSEC.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['gasPrice']) { // data not null
          GetTransactionDetailsByTransactionIDRIBSECGasPrice.validateJSON(data['gasPrice']);
        }
        // ensure the json data is a string
...
export default GetWalletTransactionDetailsByTransactionIDRIBSEC;
