...
import GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin from './GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin';
 ...
 * @version 2.0.0
 */
class GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCash {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('vin')) {
                obj['vin'] = ApiClient.convertToType(data['vin'], [GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCashVin]);
            }
...
export default GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinCash;
