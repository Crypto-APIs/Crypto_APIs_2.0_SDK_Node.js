...
class ListTransactionsByBlockHashRIBSD2VinInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHashRIBSD2VinInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptSig']) { // data not null
          ListTransactionsByBlockHashRIBSD2VinInnerScriptSig.validateJSON(data['scriptSig']);
        }
        // ensure the json data is a string
