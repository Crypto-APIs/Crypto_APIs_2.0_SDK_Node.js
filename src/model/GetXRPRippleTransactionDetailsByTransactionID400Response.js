...
class GetXRPRippleTransactionDetailsByTransactionID400Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetXRPRippleTransactionDetailsByTransactionID400Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          GetXRPRippleTransactionDetailsByTransactionIDE400.validateJSON(data['error']);
        }
