...
class ListZilliqaTransactionsByBlockHeightE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListZilliqaTransactionsByBlockHeightE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListZilliqaTransactionsByBlockHeightE400} An instance of ListZilliqaTransactionsByBlockHeightE400.
     */
...
export default ListZilliqaTransactionsByBlockHeightE400;
