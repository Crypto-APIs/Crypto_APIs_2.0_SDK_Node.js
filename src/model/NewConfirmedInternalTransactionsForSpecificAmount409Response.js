...
class NewConfirmedInternalTransactionsForSpecificAmount409Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedInternalTransactionsForSpecificAmount409Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          NewConfirmedInternalTransactionsForSpecificAmountE409.validateJSON(data['error']);
        }
