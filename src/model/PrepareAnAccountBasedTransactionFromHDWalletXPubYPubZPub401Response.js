...
import PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401 from './PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401';
 ...
 * @version 1.10.0
 */
class PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPub401Response {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE401.constructFromObject(data['error']);
            }
        }
        return obj;
    }
...
export default PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPub401Response;
