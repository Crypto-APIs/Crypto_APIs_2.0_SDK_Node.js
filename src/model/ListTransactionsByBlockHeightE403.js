 ...
 * @version 1.11.0
 */
class ListTransactionsByBlockHeightE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListTransactionsByBlockHeightE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListTransactionsByBlockHeightE403} An instance of ListTransactionsByBlockHeightE403.
     */
...
export default ListTransactionsByBlockHeightE403;
