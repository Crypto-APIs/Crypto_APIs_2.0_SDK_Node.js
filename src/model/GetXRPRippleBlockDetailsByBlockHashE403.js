 ...
 * @version 1.11.0
 */
class GetXRPRippleBlockDetailsByBlockHashE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetXRPRippleBlockDetailsByBlockHashE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetXRPRippleBlockDetailsByBlockHashE403} An instance of GetXRPRippleBlockDetailsByBlockHashE403.
     */
...
export default GetXRPRippleBlockDetailsByBlockHashE403;
