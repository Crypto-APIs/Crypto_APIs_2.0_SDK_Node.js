...
import NewBlockRequestBodyData from './NewBlockRequestBodyData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = NewBlockRequestBodyData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
...
export default NewBlockRequestBody;
