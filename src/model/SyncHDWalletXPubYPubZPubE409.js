...
class SyncHDWalletXPubYPubZPubE409 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `SyncHDWalletXPubYPubZPubE409` with oneOf schemas AlreadyExists, InvalidData. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/SyncHDWalletXPubYPubZPubE409} An instance of SyncHDWalletXPubYPubZPubE409.
     */
...
export default SyncHDWalletXPubYPubZPubE409;
