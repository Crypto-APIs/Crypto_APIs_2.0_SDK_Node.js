...
import PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSECFee from './PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSECFee';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fee')) {
                obj['fee'] = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSECFee.constructFromObject(data['fee']);
            }
...
export default PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEC;
