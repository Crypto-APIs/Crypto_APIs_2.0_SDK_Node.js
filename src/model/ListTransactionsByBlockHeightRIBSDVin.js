...
import ListTransactionsByBlockHeightRIBSDScriptSig from './ListTransactionsByBlockHeightRIBSDScriptSig';
 ...
 * @version 1.2.1
 */
class ListTransactionsByBlockHeightRIBSDVin {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptSig')) {
                obj['scriptSig'] = ListTransactionsByBlockHeightRIBSDScriptSig.constructFromObject(data['scriptSig']);
            }
...
export default ListTransactionsByBlockHeightRIBSDVin;
