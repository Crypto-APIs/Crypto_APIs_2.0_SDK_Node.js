...
import ListTransactionsByBlockHashRIBSBScriptPubKey from './ListTransactionsByBlockHashRIBSBScriptPubKey';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = ListTransactionsByBlockHashRIBSBScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
...
export default ListTransactionsByBlockHashRIBSBVout;
