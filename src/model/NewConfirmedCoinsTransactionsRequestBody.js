...
import NewConfirmedCoinsTransactionsRequestBodyData from './NewConfirmedCoinsTransactionsRequestBodyData';
 ...
 * @version 2.0.0
 */
class NewConfirmedCoinsTransactionsRequestBody {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = NewConfirmedCoinsTransactionsRequestBodyData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
...
export default NewConfirmedCoinsTransactionsRequestBody;
