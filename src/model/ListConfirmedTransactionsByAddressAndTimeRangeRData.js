...
class ListConfirmedTransactionsByAddressAndTimeRangeRData {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListConfirmedTransactionsByAddressAndTimeRangeRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ListConfirmedTransactionsByAddressAndTimeRangeRI.validateJsonObject(item);
            };
        }
