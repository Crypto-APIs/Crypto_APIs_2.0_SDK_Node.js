...
class GetInternalTransactionByTransactionHashAndOperationId400Response {
    ...
    /**
     * Validates the JSON data with respect to <code>GetInternalTransactionByTransactionHashAndOperationId400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetInternalTransactionByTransactionHashAndOperationId400Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetInternalTransactionByTransactionHashAndOperationId400Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          GetInternalTransactionByTransactionHashAndOperationIdE400.validateJSON(data['error']);
        }
...
GetInternalTransactionByTransactionHashAndOperationId400Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default GetInternalTransactionByTransactionHashAndOperationId400Response;
