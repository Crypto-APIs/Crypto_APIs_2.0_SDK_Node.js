 ...
 * @version 1.11.0
 */
class ListZilliqaTransactionsByBlockHeight401Response {
    /**
    ...
    /**
     * Validates the JSON data with respect to <code>ListZilliqaTransactionsByBlockHeight401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListZilliqaTransactionsByBlockHeight401Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListZilliqaTransactionsByBlockHeight401Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          ListZilliqaTransactionsByBlockHeightE401.validateJSON(data['error']);
        }
...
ListZilliqaTransactionsByBlockHeight401Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default ListZilliqaTransactionsByBlockHeight401Response;
