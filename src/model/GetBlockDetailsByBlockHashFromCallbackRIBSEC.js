 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHashFromCallbackRIBSEC {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetBlockDetailsByBlockHashFromCallbackRIBSEC.RequiredProperties) {
            if (!data[property]) {
...
export default GetBlockDetailsByBlockHashFromCallbackRIBSEC;
