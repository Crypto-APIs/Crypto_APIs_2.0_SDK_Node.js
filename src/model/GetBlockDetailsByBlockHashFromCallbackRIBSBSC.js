 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHashFromCallbackRIBSBSC {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetBlockDetailsByBlockHashFromCallbackRIBSBSC.RequiredProperties) {
            if (!data[property]) {
...
export default GetBlockDetailsByBlockHashFromCallbackRIBSBSC;
