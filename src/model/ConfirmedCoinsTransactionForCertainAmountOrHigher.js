...
class ConfirmedCoinsTransactionForCertainAmountOrHigher {
    ...
    static validateJSON(data) {
        ...
        for (const property of ConfirmedCoinsTransactionForCertainAmountOrHigher.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          ConfirmedCoinsTransactionForCertainAmountOrHigherData.validateJSON(data['data']);
        }
