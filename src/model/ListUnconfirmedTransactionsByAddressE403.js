 ...
 * @version 1.11.0
 */
class ListUnconfirmedTransactionsByAddressE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListUnconfirmedTransactionsByAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListUnconfirmedTransactionsByAddressE403} An instance of ListUnconfirmedTransactionsByAddressE403.
     */
...
export default ListUnconfirmedTransactionsByAddressE403;
