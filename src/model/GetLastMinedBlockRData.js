...
import GetLastMinedBlockRI from './GetLastMinedBlockRI';
...
class GetLastMinedBlockRData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = GetLastMinedBlockRI.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of GetLastMinedBlockRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          GetLastMinedBlockRI.validateJSON(data['item']);
        }
...
export default GetLastMinedBlockRData;
