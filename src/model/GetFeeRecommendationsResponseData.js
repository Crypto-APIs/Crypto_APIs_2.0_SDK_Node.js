...
import GetFeeRecommendationsResponseItem from './GetFeeRecommendationsResponseItem';
 ...
 * @version 2.0.0
 */
class GetFeeRecommendationsResponseData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = GetFeeRecommendationsResponseItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
...
export default GetFeeRecommendationsResponseData;
