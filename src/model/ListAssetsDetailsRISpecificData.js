...
import ListAssetsDetailsRISpecificDataCryptoTypeData from './ListAssetsDetailsRISpecificDataCryptoTypeData';
 ...
 * @version 1.1.0
 */
class ListAssetsDetailsRISpecificData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ListAssetsDetailsRISpecificDataCryptoTypeData.constructFromObject(data, obj);
 ...
 */
ListAssetsDetailsRISpecificData.prototype['maxSupply'] = undefined;


// Implement ListAssetsDetailsRISpecificDataCryptoTypeData interface:
/**
 * Represents the percentage of the asset's current price against the its price from 1 hour ago.
 * @member {String} 1HourPriceChangeInPercentage
 */
...
export default ListAssetsDetailsRISpecificData;
