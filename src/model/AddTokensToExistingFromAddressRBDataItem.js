...
class AddTokensToExistingFromAddressRBDataItem {
    ...
    static validateJSON(data) {
        ...
        for (const property of AddTokensToExistingFromAddressRBDataItem.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['tokenData']) { // data not null
          AddTokensToExistingFromAddressRBTokenData.validateJSON(data['tokenData']);
        }
