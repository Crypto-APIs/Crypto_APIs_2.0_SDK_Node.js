...
import GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinScriptPubKey from './GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinScriptPubKey';
 ...
 * @version 2.0.0
 */
class GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
...
export default GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout;
