...
class GetAssetDetailsByAssetIDE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetAssetDetailsByAssetIDE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetAssetDetailsByAssetIDE403} An instance of GetAssetDetailsByAssetIDE403.
     */
...
export default GetAssetDetailsByAssetIDE403;
