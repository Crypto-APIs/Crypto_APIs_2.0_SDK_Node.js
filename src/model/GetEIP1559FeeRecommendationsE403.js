 ...
 * @version 1.11.0
 */
class GetEIP1559FeeRecommendationsE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetEIP1559FeeRecommendationsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetEIP1559FeeRecommendationsE403} An instance of GetEIP1559FeeRecommendationsE403.
     */
...
export default GetEIP1559FeeRecommendationsE403;
