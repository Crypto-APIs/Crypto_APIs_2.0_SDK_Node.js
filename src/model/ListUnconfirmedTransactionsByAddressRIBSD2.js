...
class ListUnconfirmedTransactionsByAddressRIBSD2 {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListUnconfirmedTransactionsByAddressRIBSD2.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                ListUnconfirmedTransactionsByAddressRIBSD2VinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                ListUnconfirmedTransactionsByAddressRIBSD2VoutInner.validateJsonObject(item);
            };
        }
