...
import XpubSyncInProgressError from './XpubSyncInProgressError';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = XpubSyncInProgressError.constructFromObject(data['error']);
            }
        }
        return obj;
    }
...
export default XpubSyncInProgress;
