...
class GetLastMinedBlockRIBS {
     ...
     */
    constructor(bits, chainwork, merkleRoot, nonce, size, strippedSize, version, versionHex, weight, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles, dsBlock, dsDifficulty, dsLeader, microBlocks) { 
        GetLastMinedBlockRIBSB.initialize(this, bits, chainwork, merkleRoot, nonce, size, strippedSize, version, versionHex, weight);GetLastMinedBlockRIBSE.initialize(this, extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty, uncles);GetLastMinedBlockRIBSEC.initialize(this, extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty, uncles);GetLastMinedBlockRIBSBC.initialize(this, bits, chainwork, merkleRoot, nonce, size, version, versionHex);GetLastMinedBlockRIBSL.initialize(this, bits, chainwork, merkleRoot, nonce, size, strippedSize, version, versionHex, weight);GetLastMinedBlockRIBSD.initialize(this, bits, chainwork, merkleRoot, nonce, size, strippedSize, version, weight);GetLastMinedBlockRIBSD2.initialize(this, bits, chainwork, merkleRoot, nonce, size, version, versionHex);GetLastMinedBlockRIBSBSC.initialize(this, extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty, uncles);GetLastMinedBlockRIBSZ.initialize(this, bits, chainwork, merkleRoot, nonce, size, version);GetLastMinedBlockRIBSZ2.initialize(this, dsBlock, dsDifficulty, dsLeader, gasLimit, gasUsed, microBlocks);GetLastMinedBlockRIBST.initialize(this, size);
     ...
     */
    static initialize(obj, bits, chainwork, merkleRoot, nonce, size, strippedSize, version, versionHex, weight, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles, dsBlock, dsDifficulty, dsLeader, microBlocks) { 
        obj['bits'] = bits;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            GetLastMinedBlockRIBST.constructFromObject(data, obj);
