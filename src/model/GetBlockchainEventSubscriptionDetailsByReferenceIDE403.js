...
class GetBlockchainEventSubscriptionDetailsByReferenceIDE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetBlockchainEventSubscriptionDetailsByReferenceIDE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetBlockchainEventSubscriptionDetailsByReferenceIDE403} An instance of GetBlockchainEventSubscriptionDetailsByReferenceIDE403.
     */
...
export default GetBlockchainEventSubscriptionDetailsByReferenceIDE403;
