...
class NewConfirmedInternalTransactionsForSpecificAmountRBData {
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedInternalTransactionsForSpecificAmountRBData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          NewConfirmedInternalTransactionsForSpecificAmountRBDataItem.validateJSON(data['item']);
        }
