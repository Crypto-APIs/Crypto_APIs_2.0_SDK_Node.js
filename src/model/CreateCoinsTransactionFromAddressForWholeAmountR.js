...
class CreateCoinsTransactionFromAddressForWholeAmountR {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCoinsTransactionFromAddressForWholeAmountR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCoinsTransactionFromAddressForWholeAmountR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCoinsTransactionFromAddressForWholeAmountR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          CreateCoinsTransactionFromAddressForWholeAmountRData.validateJSON(data['data']);
        }
...
CreateCoinsTransactionFromAddressForWholeAmountR.RequiredProperties = ["apiVersion", "requestId", "data"];
