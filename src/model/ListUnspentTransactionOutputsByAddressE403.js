 ...
 * @version 1.11.0
 */
class ListUnspentTransactionOutputsByAddressE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListUnspentTransactionOutputsByAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListUnspentTransactionOutputsByAddressE403} An instance of ListUnspentTransactionOutputsByAddressE403.
     */
...
export default ListUnspentTransactionOutputsByAddressE403;
