 ...
 * @version 1.11.0
 */
class DecodeRawTransactionHexRISD2VoutInnerScriptPubKey {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of DecodeRawTransactionHexRISD2VoutInnerScriptPubKey.RequiredProperties) {
            if (!data[property]) {
...
export default DecodeRawTransactionHexRISD2VoutInnerScriptPubKey;
