...
class GetZilliqaTransactionDetailsByTransactionIDRData {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetZilliqaTransactionDetailsByTransactionIDRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          GetZilliqaTransactionDetailsByTransactionIDRI.validateJSON(data['item']);
        }
