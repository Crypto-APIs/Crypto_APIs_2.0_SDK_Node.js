...
class NewRevertedBlockE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewRevertedBlockE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/NewRevertedBlockE400} An instance of NewRevertedBlockE400.
     */
...
export default NewRevertedBlockE400;
