...
class GetExchangeRateByAssetSymbolsE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetExchangeRateByAssetSymbolsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetExchangeRateByAssetSymbolsE403} An instance of GetExchangeRateByAssetSymbolsE403.
     */
...
export default GetExchangeRateByAssetSymbolsE403;
