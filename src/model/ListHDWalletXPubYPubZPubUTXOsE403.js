 ...
 * @version 1.11.0
 */
class ListHDWalletXPubYPubZPubUTXOsE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListHDWalletXPubYPubZPubUTXOsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListHDWalletXPubYPubZPubUTXOsE403} An instance of ListHDWalletXPubYPubZPubUTXOsE403.
     */
...
export default ListHDWalletXPubYPubZPubUTXOsE403;
