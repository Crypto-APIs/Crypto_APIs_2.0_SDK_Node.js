 ...
 * @version 1.11.0
 */
class AddressCoinsTransactionConfirmedEachConfirmation {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = AddressCoinsTransactionConfirmedEachConfirmationData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of AddressCoinsTransactionConfirmedEachConfirmation.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          AddressCoinsTransactionConfirmedEachConfirmationData.validateJSON(data['data']);
        }
...
export default AddressCoinsTransactionConfirmedEachConfirmation;
