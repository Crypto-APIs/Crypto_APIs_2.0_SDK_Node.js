...
import TransactionRequestRejectData from './TransactionRequestRejectData';
 ...
 * @version 1.1.0
 */
class TransactionRequestReject {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = TransactionRequestRejectData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
...
export default TransactionRequestReject;
