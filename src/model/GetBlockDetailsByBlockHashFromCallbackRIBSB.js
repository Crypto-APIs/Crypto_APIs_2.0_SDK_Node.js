 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHashFromCallbackRIBSB {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetBlockDetailsByBlockHashFromCallbackRIBSB.RequiredProperties) {
            if (!data[property]) {
...
export default GetBlockDetailsByBlockHashFromCallbackRIBSB;
