 ...
 * @version 1.11.0
 */
class FreezeTronForEnergyOrBandwidthE409 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `FreezeTronForEnergyOrBandwidthE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceTokenNotSupported, WalletAsAServiceWalletBalanceNotEnough. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Create an instance of FreezeTronForEnergyOrBandwidthE409 from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/FreezeTronForEnergyOrBandwidthE409} An instance of FreezeTronForEnergyOrBandwidthE409.
     */
...
export default FreezeTronForEnergyOrBandwidthE409;
