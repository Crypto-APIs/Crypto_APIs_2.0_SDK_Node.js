 ...
 * @version 1.10.0
 */
class PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIBlockchainSpecificFee {
    /**
...
export default PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIBlockchainSpecificFee;
