...
import GetExchangeRateByAssetSymbolsResponseItem from './GetExchangeRateByAssetSymbolsResponseItem';
 ...
 * @version 2.0.0
 */
class GetExchangeRateByAssetSymbolsResponseData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = GetExchangeRateByAssetSymbolsResponseItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
...
export default GetExchangeRateByAssetSymbolsResponseData;
