...
class NewConfirmedInternalTransactionsForSpecificAmountRData {
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedInternalTransactionsForSpecificAmountRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          NewConfirmedInternalTransactionsForSpecificAmountRI.validateJSON(data['item']);
        }
