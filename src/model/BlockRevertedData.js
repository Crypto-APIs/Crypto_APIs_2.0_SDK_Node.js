...
import BlockRevertedDataItem from './BlockRevertedDataItem';
...
class BlockRevertedData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = BlockRevertedDataItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of BlockRevertedData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          BlockRevertedDataItem.validateJSON(data['item']);
        }
...
export default BlockRevertedData;
