...
import TransactionRequestBroadcastedData from './TransactionRequestBroadcastedData';
 ...
 * @version 1.11.0
 */
class TransactionRequestBroadcasted {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = TransactionRequestBroadcastedData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of TransactionRequestBroadcasted.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          TransactionRequestBroadcastedData.validateJSON(data['data']);
        }
...
export default TransactionRequestBroadcasted;
