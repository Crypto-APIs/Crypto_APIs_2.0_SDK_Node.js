...
class GetTokenDetailsByContractAddress403Response {
    ...
    /**
     * Validates the JSON data with respect to <code>GetTokenDetailsByContractAddress403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTokenDetailsByContractAddress403Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetTokenDetailsByContractAddress403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          GetTokenDetailsByContractAddressE403.validateJSON(data['error']);
        }
...
GetTokenDetailsByContractAddress403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default GetTokenDetailsByContractAddress403Response;
