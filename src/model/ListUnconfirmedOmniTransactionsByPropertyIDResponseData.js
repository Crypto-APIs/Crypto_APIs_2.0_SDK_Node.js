...
import ListUnconfirmedOmniTransactionsByPropertyIDResponseItem from './ListUnconfirmedOmniTransactionsByPropertyIDResponseItem';
 ...
 * @version 2.0.0
 */
class ListUnconfirmedOmniTransactionsByPropertyIDResponseData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListUnconfirmedOmniTransactionsByPropertyIDResponseItem]);
            }
        }
        return obj;
    }
...
export default ListUnconfirmedOmniTransactionsByPropertyIDResponseData;
