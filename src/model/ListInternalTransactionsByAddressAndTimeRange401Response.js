...
class ListInternalTransactionsByAddressAndTimeRange401Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListInternalTransactionsByAddressAndTimeRange401Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          ListInternalTransactionsByAddressAndTimeRangeE401.validateJSON(data['error']);
        }
