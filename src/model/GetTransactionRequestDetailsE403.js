 ...
 * @version 1.11.0
 */
class GetTransactionRequestDetailsE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetTransactionRequestDetailsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetTransactionRequestDetailsE403} An instance of GetTransactionRequestDetailsE403.
     */
...
export default GetTransactionRequestDetailsE403;
