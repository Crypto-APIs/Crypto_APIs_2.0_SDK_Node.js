...
import GetOmniTransactionDetailsByTransactionIDTxidResponseItem from './GetOmniTransactionDetailsByTransactionIDTxidResponseItem';
 ...
 * @version 2.0.0
 */
class GetOmniTransactionDetailsByTransactionIDTxidResponseData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = GetOmniTransactionDetailsByTransactionIDTxidResponseItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
...
export default GetOmniTransactionDetailsByTransactionIDTxidResponseData;
