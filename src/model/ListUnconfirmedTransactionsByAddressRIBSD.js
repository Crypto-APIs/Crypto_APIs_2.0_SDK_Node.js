...
class ListUnconfirmedTransactionsByAddressRIBSD {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListUnconfirmedTransactionsByAddressRIBSD.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                ListUnconfirmedTransactionsByAddressRIBSDVinInner.validateJsonObject(item);
            };
        }
