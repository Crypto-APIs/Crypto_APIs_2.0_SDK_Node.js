 ...
 * @version 1.11.0
 */
class NewConfirmedCoinsTransactionsAndEachConfirmationE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewConfirmedCoinsTransactionsAndEachConfirmationE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/NewConfirmedCoinsTransactionsAndEachConfirmationE403} An instance of NewConfirmedCoinsTransactionsAndEachConfirmationE403.
     */
...
export default NewConfirmedCoinsTransactionsAndEachConfirmationE403;
