...
import ListTokensByAddressRI from './ListTokensByAddressRI';
...
class ListTokensByAddressRData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListTokensByAddressRI]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTokensByAddressRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ListTokensByAddressRI.validateJsonObject(item);
            };
        }
...
export default ListTokensByAddressRData;
