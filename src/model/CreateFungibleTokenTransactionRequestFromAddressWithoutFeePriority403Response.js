...
class CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403.validateJSON(data['error']);
        }
