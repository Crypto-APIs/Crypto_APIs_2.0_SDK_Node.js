 ...
 * @version 1.11.0
 */
class ListBlockchainEventsSubscriptionsE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListBlockchainEventsSubscriptionsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListBlockchainEventsSubscriptionsE403} An instance of ListBlockchainEventsSubscriptionsE403.
     */
...
export default ListBlockchainEventsSubscriptionsE403;
