...
import EstimateTransactionSmartFeeRData from './EstimateTransactionSmartFeeRData';
 ...
 * @version 1.11.0
 */
class EstimateTransactionSmartFeeR {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = EstimateTransactionSmartFeeRData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EstimateTransactionSmartFeeR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EstimateTransactionSmartFeeR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EstimateTransactionSmartFeeR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          EstimateTransactionSmartFeeRData.validateJSON(data['data']);
        }
...
EstimateTransactionSmartFeeR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
export default EstimateTransactionSmartFeeR;
