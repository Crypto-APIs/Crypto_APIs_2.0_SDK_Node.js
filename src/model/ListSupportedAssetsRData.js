...
class ListSupportedAssetsRData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListSupportedAssetsRI]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListSupportedAssetsRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ListSupportedAssetsRI.validateJsonObject(item);
            };
        }
...
export default ListSupportedAssetsRData;
