 ...
 * @version 1.11.0
 */
class GenerateDepositAddressE401 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GenerateDepositAddressE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GenerateDepositAddressE401} An instance of GenerateDepositAddressE401.
     */
...
export default GenerateDepositAddressE401;
