...
class GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner.RequiredProperties) {
            if (!data[property]) {
...
export default GetTransactionDetailsByTransactionIDRIBSZVJoinSplitInner;
