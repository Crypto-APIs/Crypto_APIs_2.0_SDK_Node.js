 ...
 * @version 1.11.0
 */
class AddressTokensTransactionConfirmedErc20 {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of AddressTokensTransactionConfirmedErc20.RequiredProperties) {
            if (!data[property]) {
...
export default AddressTokensTransactionConfirmedErc20;
