 ...
 * @version 1.11.0
 */
class NewUnconfirmedCoinsTransactionsRI {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of NewUnconfirmedCoinsTransactionsRI.RequiredProperties) {
            if (!data[property]) {
...
export default NewUnconfirmedCoinsTransactionsRI;
