...
import BlockHeightReachedRI from './BlockHeightReachedRI';
...
class BlockHeightReachedRData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = BlockHeightReachedRI.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of BlockHeightReachedRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          BlockHeightReachedRI.validateJSON(data['item']);
        }
...
export default BlockHeightReachedRData;
