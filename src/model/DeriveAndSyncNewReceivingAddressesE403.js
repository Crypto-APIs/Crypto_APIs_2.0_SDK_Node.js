...
class DeriveAndSyncNewReceivingAddressesE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `DeriveAndSyncNewReceivingAddressesE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/DeriveAndSyncNewReceivingAddressesE403} An instance of DeriveAndSyncNewReceivingAddressesE403.
     */
...
export default DeriveAndSyncNewReceivingAddressesE403;
