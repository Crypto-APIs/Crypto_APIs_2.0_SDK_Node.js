...
class ListAllAssetsFromAllWalletsE401 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListAllAssetsFromAllWalletsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListAllAssetsFromAllWalletsE401} An instance of ListAllAssetsFromAllWalletsE401.
     */
...
export default ListAllAssetsFromAllWalletsE401;
