...
class ListConfirmedTokensTransfersByAddressAndTimeRangeE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListConfirmedTokensTransfersByAddressAndTimeRangeE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListConfirmedTokensTransfersByAddressAndTimeRangeE403} An instance of ListConfirmedTokensTransfersByAddressAndTimeRangeE403.
     */
...
export default ListConfirmedTokensTransfersByAddressAndTimeRangeE403;
