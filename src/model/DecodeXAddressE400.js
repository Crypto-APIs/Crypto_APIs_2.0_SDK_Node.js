...
class DecodeXAddressE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `DecodeXAddressE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/DecodeXAddressE400} An instance of DecodeXAddressE400.
     */
...
export default DecodeXAddressE400;
