 ...
 * @version 2.0.0
 */
class CreateAutomaticTokensForwardingRequestBodyTokenDataBitcoinOmniToken {
    /**
...
export default CreateAutomaticTokensForwardingRequestBodyTokenDataBitcoinOmniToken;
