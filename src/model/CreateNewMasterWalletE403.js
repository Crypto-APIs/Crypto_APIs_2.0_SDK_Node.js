...
class CreateNewMasterWalletE403 {
    ...
    constructor(code, message) { 
        BannedIpAddress.initialize(this, code, message);EndpointNotAllowedForPlan.initialize(this, code, message);EndpointNotAllowedForApiKey.initialize(this, code, message);FeatureMainnetsNotAllowedForPlan.initialize(this, code, message);WalletAsAServiceWalletsLimitReached.initialize(this, code, message);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            WalletAsAServiceWalletsLimitReached.constructFromObject(data, obj);
