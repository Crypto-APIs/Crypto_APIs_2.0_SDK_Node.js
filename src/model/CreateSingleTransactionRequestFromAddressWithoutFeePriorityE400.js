...
class CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400} An instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400.
     */
...
export default CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400;
