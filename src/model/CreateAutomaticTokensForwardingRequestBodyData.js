...
import CreateAutomaticTokensForwardingRequestBodyDataItem from './CreateAutomaticTokensForwardingRequestBodyDataItem';
 ...
 * @version 2.0.0
 */
class CreateAutomaticTokensForwardingRequestBodyData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = CreateAutomaticTokensForwardingRequestBodyDataItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
...
export default CreateAutomaticTokensForwardingRequestBodyData;
