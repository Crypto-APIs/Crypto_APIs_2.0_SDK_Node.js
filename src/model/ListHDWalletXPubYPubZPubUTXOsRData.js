 ...
 * @version 1.11.0
 */
class ListHDWalletXPubYPubZPubUTXOsRData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListHDWalletXPubYPubZPubUTXOsRI]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListHDWalletXPubYPubZPubUTXOsRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ListHDWalletXPubYPubZPubUTXOsRI.validateJsonObject(item);
            };
        }
...
export default ListHDWalletXPubYPubZPubUTXOsRData;
