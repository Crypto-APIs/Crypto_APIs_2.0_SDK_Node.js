...
import CreateTokensTransactionRequestFromAddressRI from './CreateTokensTransactionRequestFromAddressRI';
 ...
 * @version 1.3.0
 */
class CreateTokensTransactionRequestFromAddressRData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = CreateTokensTransactionRequestFromAddressRI.constructFromObject(data['item']);
            }
        }
        return obj;
    }
...
export default CreateTokensTransactionRequestFromAddressRData;
