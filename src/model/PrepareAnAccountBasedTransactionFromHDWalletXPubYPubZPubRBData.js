...
import PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBDataItem from './PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBDataItem';
 ...
 * @version 1.8.0
 */
class PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBDataItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
...
export default PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBData;
