...
class GetAddressDetailsE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetAddressDetailsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Create an instance of GetAddressDetailsE400 from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/GetAddressDetailsE400} An instance of GetAddressDetailsE400.
     */
...
export default GetAddressDetailsE400;
