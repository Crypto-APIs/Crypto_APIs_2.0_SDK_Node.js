...
class NewConfirmedInternalTransactionsAndEachConfirmationE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewConfirmedInternalTransactionsAndEachConfirmationE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/NewConfirmedInternalTransactionsAndEachConfirmationE403} An instance of NewConfirmedInternalTransactionsAndEachConfirmationE403.
     */
...
export default NewConfirmedInternalTransactionsAndEachConfirmationE403;
