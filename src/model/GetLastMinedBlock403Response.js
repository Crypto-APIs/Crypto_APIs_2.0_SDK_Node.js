...
class GetLastMinedBlock403Response {
    ...
    /**
     * Validates the JSON data with respect to <code>GetLastMinedBlock403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLastMinedBlock403Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetLastMinedBlock403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          GetLastMinedBlockE403.validateJSON(data['error']);
        }
...
GetLastMinedBlock403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default GetLastMinedBlock403Response;
