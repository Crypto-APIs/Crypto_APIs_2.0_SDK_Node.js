...
import ListTransactionsByBlockHashRI from './ListTransactionsByBlockHashRI';
 ...
 * @version 1.11.0
 */
class ListTransactionsByBlockHashRData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListTransactionsByBlockHashRI]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHashRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ListTransactionsByBlockHashRI.validateJsonObject(item);
            };
        }
...
export default ListTransactionsByBlockHashRData;
