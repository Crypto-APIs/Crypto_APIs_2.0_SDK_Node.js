...
import ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinScriptSig from './ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinScriptSig';
 ...
 * @version 2.0.0
 */
class ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptSig')) {
                obj['scriptSig'] = ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinScriptSig.constructFromObject(data['scriptSig']);
            }
...
export default ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin;
