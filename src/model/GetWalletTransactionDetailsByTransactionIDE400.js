 ...
 * @version 1.11.0
 */
class GetWalletTransactionDetailsByTransactionIDE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetWalletTransactionDetailsByTransactionIDE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetWalletTransactionDetailsByTransactionIDE400} An instance of GetWalletTransactionDetailsByTransactionIDE400.
     */
...
export default GetWalletTransactionDetailsByTransactionIDE400;
