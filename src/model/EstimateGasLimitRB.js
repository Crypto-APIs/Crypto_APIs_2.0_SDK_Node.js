...
import EstimateGasLimitRBData from './EstimateGasLimitRBData';
...
class EstimateGasLimitRB {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = EstimateGasLimitRBData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of EstimateGasLimitRB.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          EstimateGasLimitRBData.validateJSON(data['data']);
        }
...
export default EstimateGasLimitRB;
