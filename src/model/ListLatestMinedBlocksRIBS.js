...
class ListLatestMinedBlocksRIBS {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ListLatestMinedBlocksRIBST.constructFromObject(data, obj);
