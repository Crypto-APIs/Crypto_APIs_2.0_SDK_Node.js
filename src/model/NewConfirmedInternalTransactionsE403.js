 ...
 * @version 1.11.0
 */
class NewConfirmedInternalTransactionsE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewConfirmedInternalTransactionsE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/NewConfirmedInternalTransactionsE403} An instance of NewConfirmedInternalTransactionsE403.
     */
...
export default NewConfirmedInternalTransactionsE403;
