...
import ListTransactionsByBlockHashResponseItem from './ListTransactionsByBlockHashResponseItem';
 ...
 * @version 2.0.0
 */
class ListTransactionsByBlockHashResponseData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListTransactionsByBlockHashResponseItem]);
            }
        }
        return obj;
    }
...
export default ListTransactionsByBlockHashResponseData;
