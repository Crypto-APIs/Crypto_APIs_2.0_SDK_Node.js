...
class ListWalletTransactionsE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListWalletTransactionsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListWalletTransactionsE400} An instance of ListWalletTransactionsE400.
     */
...
export default ListWalletTransactionsE400;
