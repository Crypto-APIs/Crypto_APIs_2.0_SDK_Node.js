 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHashFromCallbackE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetBlockDetailsByBlockHashFromCallbackE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetBlockDetailsByBlockHashFromCallbackE403} An instance of GetBlockDetailsByBlockHashFromCallbackE403.
     */
...
export default GetBlockDetailsByBlockHashFromCallbackE403;
