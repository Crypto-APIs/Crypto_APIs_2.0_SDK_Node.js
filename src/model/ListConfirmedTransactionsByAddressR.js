...
import ListConfirmedTransactionsByAddressRData from './ListConfirmedTransactionsByAddressRData';
...
class ListConfirmedTransactionsByAddressR {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ListConfirmedTransactionsByAddressRData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListConfirmedTransactionsByAddressR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListConfirmedTransactionsByAddressR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListConfirmedTransactionsByAddressR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          ListConfirmedTransactionsByAddressRData.validateJSON(data['data']);
        }
...
ListConfirmedTransactionsByAddressR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
export default ListConfirmedTransactionsByAddressR;
