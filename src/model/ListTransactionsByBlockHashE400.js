...
class ListTransactionsByBlockHashE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListTransactionsByBlockHashE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListTransactionsByBlockHashE400} An instance of ListTransactionsByBlockHashE400.
     */
...
export default ListTransactionsByBlockHashE400;
