...
class DecodeRawTransactionHexRISL {
    ...
    static validateJSON(data) {
        ...
        for (const property of DecodeRawTransactionHexRISL.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                DecodeRawTransactionHexRISLVinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                DecodeRawTransactionHexRISLVoutInner.validateJsonObject(item);
            };
        }
