 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHeightRIBSB {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetBlockDetailsByBlockHeightRIBSB.RequiredProperties) {
            if (!data[property]) {
...
export default GetBlockDetailsByBlockHeightRIBSB;
