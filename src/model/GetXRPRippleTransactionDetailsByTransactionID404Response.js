...
class GetXRPRippleTransactionDetailsByTransactionID404Response {
    ...
    /**
     * Validates the JSON data with respect to <code>GetXRPRippleTransactionDetailsByTransactionID404Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetXRPRippleTransactionDetailsByTransactionID404Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetXRPRippleTransactionDetailsByTransactionID404Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          ResourceNotFound.validateJSON(data['error']);
        }
...
GetXRPRippleTransactionDetailsByTransactionID404Response.RequiredProperties = ["apiVersion", "requestId", "error"];
