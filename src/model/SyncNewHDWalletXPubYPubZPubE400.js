 ...
 * @version 1.11.0
 */
class SyncNewHDWalletXPubYPubZPubE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `SyncNewHDWalletXPubYPubZPubE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/SyncNewHDWalletXPubYPubZPubE400} An instance of SyncNewHDWalletXPubYPubZPubE400.
     */
...
export default SyncNewHDWalletXPubYPubZPubE400;
