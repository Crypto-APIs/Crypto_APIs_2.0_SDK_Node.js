...
class ListZilliqaTransactionsByBlockHeightE401 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListZilliqaTransactionsByBlockHeightE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListZilliqaTransactionsByBlockHeightE401} An instance of ListZilliqaTransactionsByBlockHeightE401.
     */
...
export default ListZilliqaTransactionsByBlockHeightE401;
