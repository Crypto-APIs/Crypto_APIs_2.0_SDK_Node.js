 ...
 * @version 1.11.0
 */
class ListLatestMinedBlocksE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListLatestMinedBlocksE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListLatestMinedBlocksE400} An instance of ListLatestMinedBlocksE400.
     */
...
export default ListLatestMinedBlocksE400;
