...
import ListTransactionsByAddressRIBSD2ScriptPubKey from './ListTransactionsByAddressRIBSD2ScriptPubKey';
 ...
 * @version 1.2.1
 */
class ListTransactionsByAddressRIBSD2Vout {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = ListTransactionsByAddressRIBSD2ScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
...
export default ListTransactionsByAddressRIBSD2Vout;
