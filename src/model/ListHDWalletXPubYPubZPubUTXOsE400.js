...
class ListHDWalletXPubYPubZPubUTXOsE400 {
    ...
    constructor(code, message) { 
        UriNotFound.initialize(this, code, message);LimitGreaterThanAllowed.initialize(this, code, message);InvalidPagination.initialize(this, code, message);XpubNotSynced.initialize(this, code, message);InvalidXpub.initialize(this, code, message);
