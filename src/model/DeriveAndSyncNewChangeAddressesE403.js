 ...
 * @version 1.11.0
 */
class DeriveAndSyncNewChangeAddressesE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `DeriveAndSyncNewChangeAddressesE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/DeriveAndSyncNewChangeAddressesE403} An instance of DeriveAndSyncNewChangeAddressesE403.
     */
...
export default DeriveAndSyncNewChangeAddressesE403;
