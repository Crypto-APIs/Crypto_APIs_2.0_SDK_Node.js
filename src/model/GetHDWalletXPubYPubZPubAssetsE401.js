 ...
 * @version 1.11.0
 */
class GetHDWalletXPubYPubZPubAssetsE401 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetHDWalletXPubYPubZPubAssetsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetHDWalletXPubYPubZPubAssetsE401} An instance of GetHDWalletXPubYPubZPubAssetsE401.
     */
...
export default GetHDWalletXPubYPubZPubAssetsE401;
