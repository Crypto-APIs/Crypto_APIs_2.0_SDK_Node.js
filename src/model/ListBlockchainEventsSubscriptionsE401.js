...
class ListBlockchainEventsSubscriptionsE401 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListBlockchainEventsSubscriptionsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListBlockchainEventsSubscriptionsE401} An instance of ListBlockchainEventsSubscriptionsE401.
     */
...
export default ListBlockchainEventsSubscriptionsE401;
