...
class DeleteAutomaticTokensForwardingR {
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAutomaticTokensForwardingR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAutomaticTokensForwardingR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeleteAutomaticTokensForwardingR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          DeleteAutomaticTokensForwardingRData.validateJSON(data['data']);
        }
...
DeleteAutomaticTokensForwardingR.RequiredProperties = ["apiVersion", "requestId", "data"];
