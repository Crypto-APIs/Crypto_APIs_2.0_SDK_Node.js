 ...
 * @version 1.11.0
 */
class GetLatestMinedZilliqaBlockE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetLatestMinedZilliqaBlockE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetLatestMinedZilliqaBlockE403} An instance of GetLatestMinedZilliqaBlockE403.
     */
...
export default GetLatestMinedZilliqaBlockE403;
