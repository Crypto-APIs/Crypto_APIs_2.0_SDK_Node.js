...
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSD {
    ...
    static validateJSON(data) {
        ...
        for (const property of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSD.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSDVinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSDVoutInner.validateJsonObject(item);
            };
        }
