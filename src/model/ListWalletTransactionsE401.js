 ...
 * @version 1.11.0
 */
class ListWalletTransactionsE401 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListWalletTransactionsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListWalletTransactionsE401} An instance of ListWalletTransactionsE401.
     */
...
export default ListWalletTransactionsE401;
