...
class ListTransactionsByBlockHashRIBSL {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHashRIBSL.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                ListTransactionsByBlockHashRIBSLVinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                ListTransactionsByBlockHashRIBSLVoutInner.validateJsonObject(item);
            };
        }
