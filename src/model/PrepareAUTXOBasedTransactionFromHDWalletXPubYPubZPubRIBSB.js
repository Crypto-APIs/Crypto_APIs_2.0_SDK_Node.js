...
import PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVinInner from './PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVinInner';
import PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVoutInner from './PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVoutInner';
 ...
 * @version 1.11.0
 */
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSB {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('vin')) {
                obj['vin'] = ApiClient.convertToType(data['vin'], [PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVinInner]);
            }
            if (data.hasOwnProperty('vout')) {
                obj['vout'] = ApiClient.convertToType(data['vout'], [PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVoutInner]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSB.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBVoutInner.validateJsonObject(item);
            };
        }
...
export default PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSB;
