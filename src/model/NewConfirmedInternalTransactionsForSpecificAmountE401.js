...
class NewConfirmedInternalTransactionsForSpecificAmountE401 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewConfirmedInternalTransactionsForSpecificAmountE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Create an instance of NewConfirmedInternalTransactionsForSpecificAmountE401 from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/NewConfirmedInternalTransactionsForSpecificAmountE401} An instance of NewConfirmedInternalTransactionsForSpecificAmountE401.
     */
