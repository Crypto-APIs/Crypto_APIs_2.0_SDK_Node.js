...
class ListUnconfirmedTransactionsByAddressRIBSDVinInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListUnconfirmedTransactionsByAddressRIBSDVinInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptSig']) { // data not null
          ListConfirmedTransactionsByAddressRIBSDVinInnerScriptSig.validateJSON(data['scriptSig']);
        }
