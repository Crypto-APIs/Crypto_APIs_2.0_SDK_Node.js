...
class NewConfirmedInternalTransactionsForSpecificAmountE409 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewConfirmedInternalTransactionsForSpecificAmountE409` with oneOf schemas AlreadyExists, InvalidData. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Create an instance of NewConfirmedInternalTransactionsForSpecificAmountE409 from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/NewConfirmedInternalTransactionsForSpecificAmountE409} An instance of NewConfirmedInternalTransactionsForSpecificAmountE409.
     */
