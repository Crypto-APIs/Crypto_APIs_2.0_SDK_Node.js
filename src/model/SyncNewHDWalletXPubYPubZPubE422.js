...
class SyncNewHDWalletXPubYPubZPubE422 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `SyncNewHDWalletXPubYPubZPubE422` with oneOf schemas InvalidRequestBodyStructure, XpubSyncInProgress. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/SyncNewHDWalletXPubYPubZPubE422} An instance of SyncNewHDWalletXPubYPubZPubE422.
     */
...
export default SyncNewHDWalletXPubYPubZPubE422;
