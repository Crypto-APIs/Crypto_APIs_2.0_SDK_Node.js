 ...
 * @version 1.11.0
 */
class GetXRPRippleBlockDetailsByBlockHeightE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetXRPRippleBlockDetailsByBlockHeightE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetXRPRippleBlockDetailsByBlockHeightE403} An instance of GetXRPRippleBlockDetailsByBlockHeightE403.
     */
...
export default GetXRPRippleBlockDetailsByBlockHeightE403;
