 ...
 * @version 1.11.0
 */
class SyncHDWalletXPubYPubZPubE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `SyncHDWalletXPubYPubZPubE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/SyncHDWalletXPubYPubZPubE400} An instance of SyncHDWalletXPubYPubZPubE400.
     */
...
export default SyncHDWalletXPubYPubZPubE400;
