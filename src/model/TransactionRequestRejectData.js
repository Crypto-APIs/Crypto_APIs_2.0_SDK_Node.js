...
import TransactionRequestRejectDataItem from './TransactionRequestRejectDataItem';
 ...
 * @version 1.1.0
 */
class TransactionRequestRejectData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = TransactionRequestRejectDataItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
...
export default TransactionRequestRejectData;
