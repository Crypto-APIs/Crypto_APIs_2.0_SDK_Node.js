...
import CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400 from './CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400';
...
class CreateSingleTransactionRequestFromAddressWithoutFeePriority400Response {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400.constructFromObject(data['error']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateSingleTransactionRequestFromAddressWithoutFeePriority400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateSingleTransactionRequestFromAddressWithoutFeePriority400Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateSingleTransactionRequestFromAddressWithoutFeePriority400Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          CreateSingleTransactionRequestFromAddressWithoutFeePriorityE400.validateJSON(data['error']);
        }
...
CreateSingleTransactionRequestFromAddressWithoutFeePriority400Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default CreateSingleTransactionRequestFromAddressWithoutFeePriority400Response;
