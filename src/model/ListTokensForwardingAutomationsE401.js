 ...
 * @version 1.11.0
 */
class ListTokensForwardingAutomationsE401 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListTokensForwardingAutomationsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListTokensForwardingAutomationsE401} An instance of ListTokensForwardingAutomationsE401.
     */
...
export default ListTokensForwardingAutomationsE401;
