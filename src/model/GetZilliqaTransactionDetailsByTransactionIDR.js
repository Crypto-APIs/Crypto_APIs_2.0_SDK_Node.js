...
import GetZilliqaTransactionDetailsByTransactionIDRData from './GetZilliqaTransactionDetailsByTransactionIDRData';
 ...
 * @version 1.11.0
 */
class GetZilliqaTransactionDetailsByTransactionIDR {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = GetZilliqaTransactionDetailsByTransactionIDRData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetZilliqaTransactionDetailsByTransactionIDR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetZilliqaTransactionDetailsByTransactionIDR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetZilliqaTransactionDetailsByTransactionIDR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          GetZilliqaTransactionDetailsByTransactionIDRData.validateJSON(data['data']);
        }
...
GetZilliqaTransactionDetailsByTransactionIDR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
export default GetZilliqaTransactionDetailsByTransactionIDR;
