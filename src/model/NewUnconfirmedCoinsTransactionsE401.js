...
class NewUnconfirmedCoinsTransactionsE401 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewUnconfirmedCoinsTransactionsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/NewUnconfirmedCoinsTransactionsE401} An instance of NewUnconfirmedCoinsTransactionsE401.
     */
...
export default NewUnconfirmedCoinsTransactionsE401;
