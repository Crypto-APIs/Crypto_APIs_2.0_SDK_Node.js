...
import CouldNotCalculateRateForPairError from './CouldNotCalculateRateForPairError';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = CouldNotCalculateRateForPairError.constructFromObject(data['error']);
            }
        }
        return obj;
    }
...
export default CouldNotCalculateRateForPair;
