...
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403} An instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403.
     */
...
export default PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403;
