 ...
 * @version 1.11.0
 */
class GetLatestMinedZilliqaBlockE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetLatestMinedZilliqaBlockE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetLatestMinedZilliqaBlockE400} An instance of GetLatestMinedZilliqaBlockE400.
     */
...
export default GetLatestMinedZilliqaBlockE400;
