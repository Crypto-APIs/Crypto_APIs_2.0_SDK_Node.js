...
class ListZilliqaTransactionsByBlockHeight400Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListZilliqaTransactionsByBlockHeight400Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          ListZilliqaTransactionsByBlockHeightE400.validateJSON(data['error']);
        }
