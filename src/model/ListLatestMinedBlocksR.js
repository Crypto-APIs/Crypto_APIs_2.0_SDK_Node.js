...
import ListLatestMinedBlocksRData from './ListLatestMinedBlocksRData';
...
class ListLatestMinedBlocksR {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ListLatestMinedBlocksRData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListLatestMinedBlocksR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLatestMinedBlocksR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListLatestMinedBlocksR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          ListLatestMinedBlocksRData.validateJSON(data['data']);
        }
...
ListLatestMinedBlocksR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
export default ListLatestMinedBlocksR;
