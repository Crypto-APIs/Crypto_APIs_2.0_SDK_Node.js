...
class GetWalletTransactionDetailsByTransactionIDRIBSBVinInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetWalletTransactionDetailsByTransactionIDRIBSBVinInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptSig']) { // data not null
          GetWalletTransactionDetailsByTransactionIDRIBSBVinInnerScriptSig.validateJSON(data['scriptSig']);
        }
        // ensure the json data is a string
