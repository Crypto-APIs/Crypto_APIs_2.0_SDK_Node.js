...
class NewConfirmedInternalTransactionsForSpecificAmount401Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedInternalTransactionsForSpecificAmount401Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          NewConfirmedInternalTransactionsForSpecificAmountE401.validateJSON(data['error']);
        }
