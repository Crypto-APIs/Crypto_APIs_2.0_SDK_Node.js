...
class GetEIP1559FeeRecommendationsE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetEIP1559FeeRecommendationsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetEIP1559FeeRecommendationsE400} An instance of GetEIP1559FeeRecommendationsE400.
     */
...
export default GetEIP1559FeeRecommendationsE400;
