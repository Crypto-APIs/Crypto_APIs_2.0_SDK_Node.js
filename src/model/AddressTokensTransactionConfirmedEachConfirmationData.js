...
class AddressTokensTransactionConfirmedEachConfirmationData {
    ...
    static validateJSON(data) {
        ...
        for (const property of AddressTokensTransactionConfirmedEachConfirmationData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          AddressTokensTransactionConfirmedEachConfirmationDataItem.validateJSON(data['item']);
        }
