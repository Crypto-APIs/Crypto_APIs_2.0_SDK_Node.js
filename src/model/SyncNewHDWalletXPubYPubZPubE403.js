 ...
 * @version 1.11.0
 */
class SyncNewHDWalletXPubYPubZPubE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `SyncNewHDWalletXPubYPubZPubE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/SyncNewHDWalletXPubYPubZPubE403} An instance of SyncNewHDWalletXPubYPubZPubE403.
     */
...
export default SyncNewHDWalletXPubYPubZPubE403;
