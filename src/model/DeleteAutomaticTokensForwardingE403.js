...
class DeleteAutomaticTokensForwardingE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `DeleteAutomaticTokensForwardingE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/DeleteAutomaticTokensForwardingE403} An instance of DeleteAutomaticTokensForwardingE403.
     */
...
export default DeleteAutomaticTokensForwardingE403;
