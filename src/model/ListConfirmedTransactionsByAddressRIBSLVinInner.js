...
class ListConfirmedTransactionsByAddressRIBSLVinInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListConfirmedTransactionsByAddressRIBSLVinInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptSig']) { // data not null
          ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig.validateJSON(data['scriptSig']);
        }
        // ensure the json data is a string
