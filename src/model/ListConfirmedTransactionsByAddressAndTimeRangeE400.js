...
class ListConfirmedTransactionsByAddressAndTimeRangeE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListConfirmedTransactionsByAddressAndTimeRangeE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListConfirmedTransactionsByAddressAndTimeRangeE400} An instance of ListConfirmedTransactionsByAddressAndTimeRangeE400.
     */
...
export default ListConfirmedTransactionsByAddressAndTimeRangeE400;
