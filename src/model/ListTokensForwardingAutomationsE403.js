 ...
 * @version 1.11.0
 */
class ListTokensForwardingAutomationsE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListTokensForwardingAutomationsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListTokensForwardingAutomationsE403} An instance of ListTokensForwardingAutomationsE403.
     */
...
export default ListTokensForwardingAutomationsE403;
