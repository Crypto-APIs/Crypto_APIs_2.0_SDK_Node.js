...
class ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig.RequiredProperties) {
            if (!data[property]) {
...
export default ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig;
