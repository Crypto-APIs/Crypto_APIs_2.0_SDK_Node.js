...
class CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400.validateJSON(data['error']);
        }
