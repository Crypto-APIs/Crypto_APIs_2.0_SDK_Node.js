 ...
 * @version 1.11.0
 */
class GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInnerScriptPubKey {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInnerScriptPubKey.RequiredProperties) {
            if (!data[property]) {
...
export default GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInnerScriptPubKey;
