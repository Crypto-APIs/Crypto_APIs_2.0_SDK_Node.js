...
import GetXRPRippleTransactionDetailsByTransactionIDE403 from './GetXRPRippleTransactionDetailsByTransactionIDE403';
...
class GetXRPRippleTransactionDetailsByTransactionID403Response {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = GetXRPRippleTransactionDetailsByTransactionIDE403.constructFromObject(data['error']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetXRPRippleTransactionDetailsByTransactionID403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetXRPRippleTransactionDetailsByTransactionID403Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetXRPRippleTransactionDetailsByTransactionID403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          GetXRPRippleTransactionDetailsByTransactionIDE403.validateJSON(data['error']);
        }
...
GetXRPRippleTransactionDetailsByTransactionID403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default GetXRPRippleTransactionDetailsByTransactionID403Response;
