...
class CreateCoinsTransactionRequestFromAddressRBData {
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateCoinsTransactionRequestFromAddressRBData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          CreateCoinsTransactionRequestFromAddressRBDataItem.validateJSON(data['item']);
        }
