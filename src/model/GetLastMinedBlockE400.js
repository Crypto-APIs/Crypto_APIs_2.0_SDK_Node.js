...
class GetLastMinedBlockE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetLastMinedBlockE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetLastMinedBlockE400} An instance of GetLastMinedBlockE400.
     */
...
export default GetLastMinedBlockE400;
