...
class GetTransactionDetailsByTransactionIDFromCallbackE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetTransactionDetailsByTransactionIDFromCallbackE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetTransactionDetailsByTransactionIDFromCallbackE403} An instance of GetTransactionDetailsByTransactionIDFromCallbackE403.
     */
...
export default GetTransactionDetailsByTransactionIDFromCallbackE403;
