...
class ListTransactionsByBlockHeight401Response {
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeight401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeight401Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListTransactionsByBlockHeight401Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          ListTransactionsByBlockHeightE401.validateJSON(data['error']);
        }
...
ListTransactionsByBlockHeight401Response.RequiredProperties = ["apiVersion", "requestId", "error"];
