    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = NewConfirmedInternalTransactionsAndEachConfirmationRBDataItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
...
export default NewConfirmedInternalTransactionsAndEachConfirmationRBData;
