...
import ListTransactionsByAddressRIBSLScriptSig from './ListTransactionsByAddressRIBSLScriptSig';
 ...
 * @version 1.2.1
 */
class ListTransactionsByAddressRIBSLVin {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptSig')) {
                obj['scriptSig'] = ListTransactionsByAddressRIBSLScriptSig.constructFromObject(data['scriptSig']);
            }
...
export default ListTransactionsByAddressRIBSLVin;
