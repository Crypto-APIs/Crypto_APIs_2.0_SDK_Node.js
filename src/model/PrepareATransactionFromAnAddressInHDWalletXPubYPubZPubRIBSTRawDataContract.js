...
class PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSTRawDataContract {
    ...
    static validateJSON(data) {
        ...
        for (const property of PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSTRawDataContract.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['parameter']) { // data not null
          PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSTRawDataContractParameter.validateJSON(data['parameter']);
        }
