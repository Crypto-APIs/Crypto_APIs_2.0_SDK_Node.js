...
class GetTransactionDetailsByTransactionIDRIBSBVoutInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDRIBSBVoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
