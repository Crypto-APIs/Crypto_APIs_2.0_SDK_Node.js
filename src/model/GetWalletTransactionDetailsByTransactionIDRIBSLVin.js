...
import GetWalletTransactionDetailsByTransactionIDRIBSLScriptSig from './GetWalletTransactionDetailsByTransactionIDRIBSLScriptSig';
 ...
 * @version 1.5.0
 */
class GetWalletTransactionDetailsByTransactionIDRIBSLVin {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptSig')) {
                obj['scriptSig'] = GetWalletTransactionDetailsByTransactionIDRIBSLScriptSig.constructFromObject(data['scriptSig']);
            }
...
export default GetWalletTransactionDetailsByTransactionIDRIBSLVin;
