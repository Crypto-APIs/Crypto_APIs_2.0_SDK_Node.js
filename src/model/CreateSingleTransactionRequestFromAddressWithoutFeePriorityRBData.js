...
import CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem from './CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem';
...
class CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBDataItem.validateJSON(data['item']);
        }
...
export default CreateSingleTransactionRequestFromAddressWithoutFeePriorityRBData;
