 ...
 * @version 1.11.0
 */
class AddTokensToExistingFromAddressE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `AddTokensToExistingFromAddressE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/AddTokensToExistingFromAddressE400} An instance of AddTokensToExistingFromAddressE400.
     */
...
export default AddTokensToExistingFromAddressE400;
