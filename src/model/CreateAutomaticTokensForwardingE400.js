 ...
 * @version 1.11.0
 */
class CreateAutomaticTokensForwardingE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `CreateAutomaticTokensForwardingE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/CreateAutomaticTokensForwardingE400} An instance of CreateAutomaticTokensForwardingE400.
     */
...
export default CreateAutomaticTokensForwardingE400;
