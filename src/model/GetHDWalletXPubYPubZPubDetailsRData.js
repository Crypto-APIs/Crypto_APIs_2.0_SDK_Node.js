...
import GetHDWalletXPubYPubZPubDetailsRI from './GetHDWalletXPubYPubZPubDetailsRI';
 ...
 * @version 1.11.0
 */
class GetHDWalletXPubYPubZPubDetailsRData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = GetHDWalletXPubYPubZPubDetailsRI.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of GetHDWalletXPubYPubZPubDetailsRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          GetHDWalletXPubYPubZPubDetailsRI.validateJSON(data['item']);
        }
...
export default GetHDWalletXPubYPubZPubDetailsRData;
