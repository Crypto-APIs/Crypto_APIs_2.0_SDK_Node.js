...
class GetExchangeRateByAssetSymbolsE422 {
    ...
    constructor(instance = null) {
        ...
        try {
            if (typeof instance === "CouldNotCalculateRateForPair") {
                ...
                // plain JS object
                // validate the object
                CouldNotCalculateRateForPair.validateJSON(instance); // throw an exception if no match
                // create CouldNotCalculateRateForPair from JS object
                this.actualInstance = CouldNotCalculateRateForPair.constructFromObject(instance);
            }
            match++;
        } catch(err) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetExchangeRateByAssetSymbolsE422` with oneOf schemas CouldNotCalculateRateForPair, InvalidRequestBodyStructure. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetExchangeRateByAssetSymbolsE422} An instance of GetExchangeRateByAssetSymbolsE422.
     */
