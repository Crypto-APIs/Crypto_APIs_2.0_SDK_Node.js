...
import DeriveAndSyncNewChangeAddressesRData from './DeriveAndSyncNewChangeAddressesRData';
 ...
 * @version 1.11.0
 */
class DeriveAndSyncNewChangeAddressesR {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = DeriveAndSyncNewChangeAddressesRData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>DeriveAndSyncNewChangeAddressesR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeriveAndSyncNewChangeAddressesR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of DeriveAndSyncNewChangeAddressesR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          DeriveAndSyncNewChangeAddressesRData.validateJSON(data['data']);
        }
...
DeriveAndSyncNewChangeAddressesR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
export default DeriveAndSyncNewChangeAddressesR;
