 ...
 * @version 1.11.0
 */
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub401Response {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401.constructFromObject(data['error']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub401Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub401Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401.validateJSON(data['error']);
        }
...
PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub401Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub401Response;
