 ...
 * @version 1.11.0
 */
class ListConfirmedTransactionsByAddressRIBSB {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of ListConfirmedTransactionsByAddressRIBSB.RequiredProperties) {
            if (!data[property]) {
...
export default ListConfirmedTransactionsByAddressRIBSB;
