...
class ConfirmedTokensTransactionForCertainAmountOrHigherErc20 {
    ...
    static validateJSON(data) {
        ...
        for (const property of ConfirmedTokensTransactionForCertainAmountOrHigherErc20.RequiredProperties) {
            if (!data[property]) {
...
export default ConfirmedTokensTransactionForCertainAmountOrHigherErc20;
