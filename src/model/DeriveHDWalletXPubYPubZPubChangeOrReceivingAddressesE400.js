...
class DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400} An instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400.
     */
...
export default DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400;
