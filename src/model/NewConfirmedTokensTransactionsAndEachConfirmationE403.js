 ...
 * @version 1.11.0
 */
class NewConfirmedTokensTransactionsAndEachConfirmationE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewConfirmedTokensTransactionsAndEachConfirmationE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/NewConfirmedTokensTransactionsAndEachConfirmationE403} An instance of NewConfirmedTokensTransactionsAndEachConfirmationE403.
     */
...
export default NewConfirmedTokensTransactionsAndEachConfirmationE403;
