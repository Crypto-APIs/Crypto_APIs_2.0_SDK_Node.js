...
class ListHDWalletXPubYPubZPubTransactionsE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListHDWalletXPubYPubZPubTransactionsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListHDWalletXPubYPubZPubTransactionsE403} An instance of ListHDWalletXPubYPubZPubTransactionsE403.
     */
...
export default ListHDWalletXPubYPubZPubTransactionsE403;
