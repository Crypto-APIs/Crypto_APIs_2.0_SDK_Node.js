...
class PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBData {
    ...
    static validateJSON(data) {
        ...
        for (const property of PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBDataItem.validateJSON(data['item']);
        }
