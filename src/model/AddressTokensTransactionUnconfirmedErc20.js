 ...
 * @version 1.11.0
 */
class AddressTokensTransactionUnconfirmedErc20 {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of AddressTokensTransactionUnconfirmedErc20.RequiredProperties) {
            if (!data[property]) {
...
export default AddressTokensTransactionUnconfirmedErc20;
