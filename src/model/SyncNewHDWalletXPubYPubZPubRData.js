...
import SyncNewHDWalletXPubYPubZPubRI from './SyncNewHDWalletXPubYPubZPubRI';
 ...
 * @version 1.11.0
 */
class SyncNewHDWalletXPubYPubZPubRData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = SyncNewHDWalletXPubYPubZPubRI.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of SyncNewHDWalletXPubYPubZPubRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          SyncNewHDWalletXPubYPubZPubRI.validateJSON(data['item']);
        }
...
export default SyncNewHDWalletXPubYPubZPubRData;
