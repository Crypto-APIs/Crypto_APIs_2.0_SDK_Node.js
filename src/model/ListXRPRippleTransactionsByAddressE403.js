 ...
 * @version 1.11.0
 */
class ListXRPRippleTransactionsByAddressE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListXRPRippleTransactionsByAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListXRPRippleTransactionsByAddressE403} An instance of ListXRPRippleTransactionsByAddressE403.
     */
...
export default ListXRPRippleTransactionsByAddressE403;
