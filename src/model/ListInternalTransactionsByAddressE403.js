 ...
 * @version 1.11.0
 */
class ListInternalTransactionsByAddressE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListInternalTransactionsByAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListInternalTransactionsByAddressE403} An instance of ListInternalTransactionsByAddressE403.
     */
...
export default ListInternalTransactionsByAddressE403;
