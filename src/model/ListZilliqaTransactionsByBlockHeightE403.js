...
class ListZilliqaTransactionsByBlockHeightE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListZilliqaTransactionsByBlockHeightE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListZilliqaTransactionsByBlockHeightE403} An instance of ListZilliqaTransactionsByBlockHeightE403.
     */
...
export default ListZilliqaTransactionsByBlockHeightE403;
