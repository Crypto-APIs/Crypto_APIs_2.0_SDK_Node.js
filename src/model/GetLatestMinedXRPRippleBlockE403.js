...
class GetLatestMinedXRPRippleBlockE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetLatestMinedXRPRippleBlockE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetLatestMinedXRPRippleBlockE403} An instance of GetLatestMinedXRPRippleBlockE403.
     */
...
export default GetLatestMinedXRPRippleBlockE403;
