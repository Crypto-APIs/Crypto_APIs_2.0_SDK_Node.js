...
class ListTransactionsByBlockHashRI {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHashRI.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['recipients']) { // data not null
            ...
            for (const item of data['recipients']) {
                ListTransactionsByBlockHashRIRecipientsInner.validateJsonObject(item);
            };
        }
        if (data['senders']) { // data not null
            ...
            for (const item of data['senders']) {
                ListTransactionsByBlockHashRISendersInner.validateJsonObject(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['fee']) { // data not null
          ListTransactionsByBlockHashRIFee.validateJSON(data['fee']);
        }
        // validate the optional field `blockchainSpecific`
        if (data['blockchainSpecific']) { // data not null
          ListTransactionsByBlockHashRIBS.validateJSON(data['blockchainSpecific']);
        }
