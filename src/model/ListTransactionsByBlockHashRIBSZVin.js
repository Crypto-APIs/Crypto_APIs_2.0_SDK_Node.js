...
import ListTransactionsByBlockHashRIBSZScriptSig from './ListTransactionsByBlockHashRIBSZScriptSig';
 ...
 * @version 1.4.0
 */
class ListTransactionsByBlockHashRIBSZVin {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptSig')) {
                obj['scriptSig'] = ListTransactionsByBlockHashRIBSZScriptSig.constructFromObject(data['scriptSig']);
            }
...
export default ListTransactionsByBlockHashRIBSZVin;
