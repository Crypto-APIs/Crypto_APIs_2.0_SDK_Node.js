 ...
 * @version 1.11.0
 */
class ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey.RequiredProperties) {
            if (!data[property]) {
...
export default ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey;
