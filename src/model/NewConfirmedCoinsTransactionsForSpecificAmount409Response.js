...
class NewConfirmedCoinsTransactionsForSpecificAmount409Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedCoinsTransactionsForSpecificAmount409Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          NewConfirmedCoinsTransactionsForSpecificAmountE409.validateJSON(data['error']);
        }
