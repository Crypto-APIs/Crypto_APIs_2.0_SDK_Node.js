...
class CreateFungibleTokensTransactionRequestFromAddressRB {
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateFungibleTokensTransactionRequestFromAddressRB.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          CreateFungibleTokensTransactionRequestFromAddressRBData.validateJSON(data['data']);
        }
