...
class AddressInternalTransactionConfirmedEachConfirmation {
    ...
    static validateJSON(data) {
        ...
        for (const property of AddressInternalTransactionConfirmedEachConfirmation.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          AddressInternalTransactionConfirmedEachConfirmationData.validateJSON(data['data']);
        }
