...
import ListTransactionsByBlockHashRIBSDVoutInnerScriptPubKey from './ListTransactionsByBlockHashRIBSDVoutInnerScriptPubKey';
 ...
 * @version 1.11.0
 */
class ListTransactionsByBlockHashRIBSDVoutInner {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = ListTransactionsByBlockHashRIBSDVoutInnerScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHashRIBSDVoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          ListTransactionsByBlockHashRIBSDVoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
...
export default ListTransactionsByBlockHashRIBSDVoutInner;
