...
import ListTransactionsByBlockHeightRIBSLScriptPubKey from './ListTransactionsByBlockHeightRIBSLScriptPubKey';
 ...
 * @version 1.2.0
 */
class ListTransactionsByBlockHeightRIBSLVout {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = ListTransactionsByBlockHeightRIBSLScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
...
export default ListTransactionsByBlockHeightRIBSLVout;
