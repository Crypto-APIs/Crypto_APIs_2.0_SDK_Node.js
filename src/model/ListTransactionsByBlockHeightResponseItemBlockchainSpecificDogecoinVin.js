 ...
 * @version 2.0.0
 */
class ListTransactionsByBlockHeightResponseItemBlockchainSpecificDogecoinVin {
    /**
...
export default ListTransactionsByBlockHeightResponseItemBlockchainSpecificDogecoinVin;
