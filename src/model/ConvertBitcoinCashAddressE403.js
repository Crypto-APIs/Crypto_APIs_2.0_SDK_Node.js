...
class ConvertBitcoinCashAddressE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ConvertBitcoinCashAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ConvertBitcoinCashAddressE403} An instance of ConvertBitcoinCashAddressE403.
     */
...
export default ConvertBitcoinCashAddressE403;
