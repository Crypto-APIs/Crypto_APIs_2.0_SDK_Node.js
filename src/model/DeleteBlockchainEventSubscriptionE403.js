...
class DeleteBlockchainEventSubscriptionE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `DeleteBlockchainEventSubscriptionE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/DeleteBlockchainEventSubscriptionE403} An instance of DeleteBlockchainEventSubscriptionE403.
     */
...
export default DeleteBlockchainEventSubscriptionE403;
