...
class GetWalletTransactionDetailsByTransactionIDRIBSD2 {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetWalletTransactionDetailsByTransactionIDRIBSD2.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner.validateJsonObject(item);
            };
        }
