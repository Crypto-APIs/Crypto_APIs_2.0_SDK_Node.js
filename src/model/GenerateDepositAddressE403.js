...
class GenerateDepositAddressE403 {
    ...
    constructor(code, message) { 
        BannedIpAddress.initialize(this, code, message);EndpointNotAllowedForPlan.initialize(this, code, message);EndpointNotAllowedForApiKey.initialize(this, code, message);FeatureMainnetsNotAllowedForPlan.initialize(this, code, message);WalletAsAServiceDepositAddressesLimitReached.initialize(this, code, message);WalletAsAServiceProvidedNetworkIsNotSuitableForThisWalletType.initialize(this, code, message);
