 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHashE401 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetBlockDetailsByBlockHashE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetBlockDetailsByBlockHashE401} An instance of GetBlockDetailsByBlockHashE401.
     */
...
export default GetBlockDetailsByBlockHashE401;
