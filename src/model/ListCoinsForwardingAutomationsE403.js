...
class ListCoinsForwardingAutomationsE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListCoinsForwardingAutomationsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListCoinsForwardingAutomationsE403} An instance of ListCoinsForwardingAutomationsE403.
     */
...
export default ListCoinsForwardingAutomationsE403;
