...
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR {
    ...
    static validateJSON(data) {
        ...
        for (const property of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRData.validateJSON(data['data']);
        }
