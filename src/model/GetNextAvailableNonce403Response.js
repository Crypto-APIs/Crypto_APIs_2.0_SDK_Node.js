...
class GetNextAvailableNonce403Response {
    ...
    /**
     * Validates the JSON data with respect to <code>GetNextAvailableNonce403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetNextAvailableNonce403Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetNextAvailableNonce403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          GetNextAvailableNonceE403.validateJSON(data['error']);
        }
...
GetNextAvailableNonce403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default GetNextAvailableNonce403Response;
