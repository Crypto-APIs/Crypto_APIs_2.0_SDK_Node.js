...
class ActivateBlockchainEventSubscriptionE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ActivateBlockchainEventSubscriptionE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ActivateBlockchainEventSubscriptionE400} An instance of ActivateBlockchainEventSubscriptionE400.
     */
...
export default ActivateBlockchainEventSubscriptionE400;
