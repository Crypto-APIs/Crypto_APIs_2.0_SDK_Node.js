...
class GetXRPRippleTransactionDetailsByTransactionIDE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetXRPRippleTransactionDetailsByTransactionIDE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetXRPRippleTransactionDetailsByTransactionIDE400} An instance of GetXRPRippleTransactionDetailsByTransactionIDE400.
     */
...
export default GetXRPRippleTransactionDetailsByTransactionIDE400;
