 ...
 * @version 1.11.0
 */
class ListBlockchainEventsSubscriptionsR {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ListBlockchainEventsSubscriptionsRData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListBlockchainEventsSubscriptionsR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListBlockchainEventsSubscriptionsR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListBlockchainEventsSubscriptionsR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          ListBlockchainEventsSubscriptionsRData.validateJSON(data['data']);
        }
...
ListBlockchainEventsSubscriptionsR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
export default ListBlockchainEventsSubscriptionsR;
