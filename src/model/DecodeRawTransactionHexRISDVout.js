...
import DecodeRawTransactionHexRISDScriptPubKey from './DecodeRawTransactionHexRISDScriptPubKey';
 ...
 * @version 1.5.0
 */
class DecodeRawTransactionHexRISDVout {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = DecodeRawTransactionHexRISDScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
...
export default DecodeRawTransactionHexRISDVout;
