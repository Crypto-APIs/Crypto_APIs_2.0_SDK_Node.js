 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHashE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetBlockDetailsByBlockHashE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetBlockDetailsByBlockHashE400} An instance of GetBlockDetailsByBlockHashE400.
     */
...
export default GetBlockDetailsByBlockHashE400;
