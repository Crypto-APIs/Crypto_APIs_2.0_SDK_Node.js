 ...
 * @version 1.11.0
 */
class ListAllAssetsByWalletIDE401 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListAllAssetsByWalletIDE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListAllAssetsByWalletIDE401} An instance of ListAllAssetsByWalletIDE401.
     */
...
export default ListAllAssetsByWalletIDE401;
