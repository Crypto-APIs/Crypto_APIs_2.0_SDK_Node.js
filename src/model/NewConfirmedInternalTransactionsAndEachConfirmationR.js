...
class NewConfirmedInternalTransactionsAndEachConfirmationR {
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedInternalTransactionsAndEachConfirmationR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          NewConfirmedInternalTransactionsAndEachConfirmationRData.validateJSON(data['data']);
        }
