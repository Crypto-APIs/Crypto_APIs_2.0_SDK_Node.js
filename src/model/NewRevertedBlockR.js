...
import NewRevertedBlockRData from './NewRevertedBlockRData';
...
class NewRevertedBlockR {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = NewRevertedBlockRData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NewRevertedBlockR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewRevertedBlockR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of NewRevertedBlockR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          NewRevertedBlockRData.validateJSON(data['data']);
        }
...
NewRevertedBlockR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
export default NewRevertedBlockR;
