...
class GetBlockDetailsByBlockHashFromCallbackE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetBlockDetailsByBlockHashFromCallbackE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetBlockDetailsByBlockHashFromCallbackE400} An instance of GetBlockDetailsByBlockHashFromCallbackE400.
     */
...
export default GetBlockDetailsByBlockHashFromCallbackE400;
