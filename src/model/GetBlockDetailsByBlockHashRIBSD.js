 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHashRIBSD {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetBlockDetailsByBlockHashRIBSD.RequiredProperties) {
            if (!data[property]) {
...
export default GetBlockDetailsByBlockHashRIBSD;
