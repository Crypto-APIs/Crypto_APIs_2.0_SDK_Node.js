...
import GenerateAddressRBData from './GenerateAddressRBData';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = GenerateAddressRBData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
...
export default GenerateAddressRB;
