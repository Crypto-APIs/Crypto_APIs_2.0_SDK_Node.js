 ...
 * @version 1.11.0
 */
class CreateCoinsTransactionFromAddressForWholeAmount403Response {
    /**
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCoinsTransactionFromAddressForWholeAmount403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCoinsTransactionFromAddressForWholeAmount403Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCoinsTransactionFromAddressForWholeAmount403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          CreateCoinsTransactionFromAddressForWholeAmountE403.validateJSON(data['error']);
        }
...
CreateCoinsTransactionFromAddressForWholeAmount403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default CreateCoinsTransactionFromAddressForWholeAmount403Response;
