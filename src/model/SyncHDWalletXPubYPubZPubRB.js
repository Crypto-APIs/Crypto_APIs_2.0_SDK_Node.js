 ...
 * @version 1.11.0
 */
class SyncHDWalletXPubYPubZPubRB {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of SyncHDWalletXPubYPubZPubRB.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          SyncHDWalletXPubYPubZPubRBData.validateJSON(data['data']);
        }
...
export default SyncHDWalletXPubYPubZPubRB;
