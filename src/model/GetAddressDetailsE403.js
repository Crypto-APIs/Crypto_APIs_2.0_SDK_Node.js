...
class GetAddressDetailsE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetAddressDetailsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Create an instance of GetAddressDetailsE403 from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/GetAddressDetailsE403} An instance of GetAddressDetailsE403.
     */
...
export default GetAddressDetailsE403;
