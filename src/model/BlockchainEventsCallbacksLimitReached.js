...
import BlockchainEventsCallbacksLimitReachedError from './BlockchainEventsCallbacksLimitReachedError';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = BlockchainEventsCallbacksLimitReachedError.constructFromObject(data['error']);
            }
        }
        return obj;
    }
...
export default BlockchainEventsCallbacksLimitReached;
