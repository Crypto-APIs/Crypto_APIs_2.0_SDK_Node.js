...
class DecodeRawTransactionHexRISD {
    ...
    static validateJSON(data) {
        ...
        for (const property of DecodeRawTransactionHexRISD.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                DecodeRawTransactionHexRISDVinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                DecodeRawTransactionHexRISDVoutInner.validateJsonObject(item);
            };
        }
