...
class EstimateTokenGasLimitE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `EstimateTokenGasLimitE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/EstimateTokenGasLimitE400} An instance of EstimateTokenGasLimitE400.
     */
...
export default EstimateTokenGasLimitE400;
