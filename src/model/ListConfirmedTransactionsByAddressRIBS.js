...
class ListConfirmedTransactionsByAddressRIBS {
     ...
     */
    constructor(locktime, size, vSize, version, vin, vout, contract, gasLimit, gasPrice, gasUsed, inputData, internalTransactionsCount, nonce, tokenTransfersCount, transactionStatus, bindingSig, expiryHeight, joinSplitPubKey, joinSplitSig, overwintered, vJoinSplit, vShieldedOutput, vShieldedSpend, valueBalance, versionGroupId, bandwidthUsed, energyUsed, hasInternalTransactions, hasTokenTransfers) { 
        ListConfirmedTransactionsByAddressRIBSB.initialize(this, locktime, size, vSize, version, vin, vout);ListConfirmedTransactionsByAddressRIBSBC.initialize(this, locktime, size, version, vin);ListConfirmedTransactionsByAddressRIBSL.initialize(this, locktime, size, vSize, version, vin, vout);ListConfirmedTransactionsByAddressRIBSD.initialize(this, locktime, size, version, vin, vout);ListConfirmedTransactionsByAddressRIBSD2.initialize(this, locktime, size, version, vin, vout);ListConfirmedTransactionsByAddressRIBSEC.initialize(this, gasLimit, gasPrice, gasUsed, internalTransactionsCount, nonce, tokenTransfersCount, transactionStatus);ListConfirmedTransactionsByAddressRIBSE.initialize(this, gasLimit, gasPrice, gasUsed, internalTransactionsCount, nonce, tokenTransfersCount, transactionStatus);ListConfirmedTransactionsByAddressRIBSBSC.initialize(this, gasLimit, gasPrice, gasUsed, internalTransactionsCount, nonce, tokenTransfersCount, transactionStatus);ListConfirmedTransactionsByAddressRIBSZ.initialize(this, bindingSig, expiryHeight, joinSplitPubKey, joinSplitSig, locktime, overwintered, size, vJoinSplit, vShieldedOutput, vShieldedSpend, valueBalance, version, versionGroupId, vin, vout);ListConfirmedTransactionsByAddressRIBST.initialize(this, bandwidthUsed, contract, energyUsed, hasInternalTransactions, hasTokenTransfers, inputData, internalTransactionsCount, tokenTransfersCount, transactionStatus);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            ListConfirmedTransactionsByAddressRIBST.constructFromObject(data, obj);
