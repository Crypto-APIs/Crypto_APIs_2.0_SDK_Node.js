...
import ListTransactionsByAddressRIBS from './ListTransactionsByAddressRIBS';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('blockchainSpecific')) {
                obj['blockchainSpecific'] = ListTransactionsByAddressRIBS.constructFromObject(data['blockchainSpecific']);
            }
        }
        return obj;
    }
...
export default ListTransactionsByAddressRI;
