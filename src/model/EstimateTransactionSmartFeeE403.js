...
class EstimateTransactionSmartFeeE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `EstimateTransactionSmartFeeE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/EstimateTransactionSmartFeeE403} An instance of EstimateTransactionSmartFeeE403.
     */
...
export default EstimateTransactionSmartFeeE403;
