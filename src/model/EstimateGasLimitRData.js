...
import EstimateGasLimitRI from './EstimateGasLimitRI';
...
class EstimateGasLimitRData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = EstimateGasLimitRI.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of EstimateGasLimitRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          EstimateGasLimitRI.validateJSON(data['item']);
        }
...
export default EstimateGasLimitRData;
