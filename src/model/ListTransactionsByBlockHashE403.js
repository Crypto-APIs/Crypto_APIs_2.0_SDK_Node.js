...
class ListTransactionsByBlockHashE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListTransactionsByBlockHashE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListTransactionsByBlockHashE403} An instance of ListTransactionsByBlockHashE403.
     */
...
export default ListTransactionsByBlockHashE403;
