...
import GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInnerScriptPubKey from './GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInnerScriptPubKey';
...
class GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInner {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInnerScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
...
export default GetWalletTransactionDetailsByTransactionIDRIBSBCVoutInner;
