...
class EstimateTransactionSmartFeeE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `EstimateTransactionSmartFeeE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/EstimateTransactionSmartFeeE400} An instance of EstimateTransactionSmartFeeE400.
     */
...
export default EstimateTransactionSmartFeeE400;
