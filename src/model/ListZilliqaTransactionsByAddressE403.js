 ...
 * @version 1.11.0
 */
class ListZilliqaTransactionsByAddressE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListZilliqaTransactionsByAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListZilliqaTransactionsByAddressE403} An instance of ListZilliqaTransactionsByAddressE403.
     */
...
export default ListZilliqaTransactionsByAddressE403;
