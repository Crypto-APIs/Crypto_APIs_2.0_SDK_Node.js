...
import ListHDWalletxPubYPubZPubTransactionsResponseItemFee from './ListHDWalletxPubYPubZPubTransactionsResponseItemFee';
import ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients from './ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients';
import ListHDWalletxPubYPubZPubTransactionsResponseItemSenders from './ListHDWalletxPubYPubZPubTransactionsResponseItemSenders';
 ...
 * @version 2.0.0
 */
class ListHDWalletxPubYPubZPubTransactionsResponseItem {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('recipients')) {
                obj['recipients'] = ApiClient.convertToType(data['recipients'], [ListHDWalletxPubYPubZPubTransactionsResponseItemRecipients]);
            }
            if (data.hasOwnProperty('senders')) {
                obj['senders'] = ApiClient.convertToType(data['senders'], [ListHDWalletxPubYPubZPubTransactionsResponseItemSenders]);
            }
            ...
            if (data.hasOwnProperty('fee')) {
                obj['fee'] = ListHDWalletxPubYPubZPubTransactionsResponseItemFee.constructFromObject(data['fee']);
            }
        }
        return obj;
    }
...
export default ListHDWalletxPubYPubZPubTransactionsResponseItem;
