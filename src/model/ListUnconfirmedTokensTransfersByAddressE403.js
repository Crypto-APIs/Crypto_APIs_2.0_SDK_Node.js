...
class ListUnconfirmedTokensTransfersByAddressE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListUnconfirmedTokensTransfersByAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListUnconfirmedTokensTransfersByAddressE403} An instance of ListUnconfirmedTokensTransfersByAddressE403.
     */
...
export default ListUnconfirmedTokensTransfersByAddressE403;
