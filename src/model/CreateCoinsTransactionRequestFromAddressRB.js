...
class CreateCoinsTransactionRequestFromAddressRB {
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateCoinsTransactionRequestFromAddressRB.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          CreateCoinsTransactionRequestFromAddressRBData.validateJSON(data['data']);
        }
