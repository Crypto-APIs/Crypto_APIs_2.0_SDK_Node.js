 ...
 * @version 1.11.0
 */
class ListAllAssetsByWalletIDE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListAllAssetsByWalletIDE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListAllAssetsByWalletIDE400} An instance of ListAllAssetsByWalletIDE400.
     */
...
export default ListAllAssetsByWalletIDE400;
