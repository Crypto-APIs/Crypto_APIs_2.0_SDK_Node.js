 ...
 * @version 1.11.0
 */
class GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey.RequiredProperties) {
            if (!data[property]) {
...
export default GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey;
