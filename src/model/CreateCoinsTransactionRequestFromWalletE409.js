...
class CreateCoinsTransactionRequestFromWalletE409 {
    ...
    constructor(instance = null) {
        ...
        try {
            if (typeof instance === "WalletAsAServiceNoDepositAddressesFound") {
                ...
                // plain JS object
                // validate the object
                WalletAsAServiceNoDepositAddressesFound.validateJSON(instance); // throw an exception if no match
                // create WalletAsAServiceNoDepositAddressesFound from JS object
                this.actualInstance = WalletAsAServiceNoDepositAddressesFound.constructFromObject(instance);
            }
            match++;
        } catch(err) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `CreateCoinsTransactionRequestFromWalletE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceNoDepositAddressesFound, WalletAsAServiceWalletBalanceNotEnough. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/CreateCoinsTransactionRequestFromWalletE409} An instance of CreateCoinsTransactionRequestFromWalletE409.
     */
