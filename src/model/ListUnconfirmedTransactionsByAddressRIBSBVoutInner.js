...
class ListUnconfirmedTransactionsByAddressRIBSBVoutInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListUnconfirmedTransactionsByAddressRIBSBVoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          ListUnconfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
