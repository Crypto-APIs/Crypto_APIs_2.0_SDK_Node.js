 ...
 * @version 1.11.0
 */
class NewConfirmedInternalTransactionsForSpecificAmountE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        try {
            if (typeof instance === "BlockchainEventsCallbacksLimitReached") {
                ...
                // plain JS object
                // validate the object
                BlockchainEventsCallbacksLimitReached.validateJSON(instance); // throw an exception if no match
                // create BlockchainEventsCallbacksLimitReached from JS object
                this.actualInstance = BlockchainEventsCallbacksLimitReached.constructFromObject(instance);
            }
            match++;
        } catch(err) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewConfirmedInternalTransactionsForSpecificAmountE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Create an instance of NewConfirmedInternalTransactionsForSpecificAmountE403 from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/NewConfirmedInternalTransactionsForSpecificAmountE403} An instance of NewConfirmedInternalTransactionsForSpecificAmountE403.
     */
...
export default NewConfirmedInternalTransactionsForSpecificAmountE403;
