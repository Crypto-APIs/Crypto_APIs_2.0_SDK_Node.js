...
import ListUnconfirmedOmniTransactionsByAddressResponseItemSenders from './ListUnconfirmedOmniTransactionsByAddressResponseItemSenders';
 ...
 * @version 2.0.0
 */
class ListUnconfirmedOmniTransactionsByAddressResponseItem {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('senders')) {
                obj['senders'] = ApiClient.convertToType(data['senders'], [ListUnconfirmedOmniTransactionsByAddressResponseItemSenders]);
            }
...
export default ListUnconfirmedOmniTransactionsByAddressResponseItem;
