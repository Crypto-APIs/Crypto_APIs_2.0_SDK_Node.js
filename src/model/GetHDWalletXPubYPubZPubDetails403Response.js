...
class GetHDWalletXPubYPubZPubDetails403Response {
    ...
    /**
     * Validates the JSON data with respect to <code>GetHDWalletXPubYPubZPubDetails403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetHDWalletXPubYPubZPubDetails403Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetHDWalletXPubYPubZPubDetails403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          GetHDWalletXPubYPubZPubDetailsE403.validateJSON(data['error']);
        }
...
GetHDWalletXPubYPubZPubDetails403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default GetHDWalletXPubYPubZPubDetails403Response;
