...
import GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinVin from './GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinVin';
 ...
 * @version 2.0.0
 */
class GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoin {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('vin')) {
                obj['vin'] = ApiClient.convertToType(data['vin'], [GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinVin]);
            }
...
export default GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoin;
