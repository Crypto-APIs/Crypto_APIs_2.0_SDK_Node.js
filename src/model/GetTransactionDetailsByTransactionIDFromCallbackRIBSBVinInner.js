...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptSig']) { // data not null
          GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInnerScriptSig.validateJSON(data['scriptSig']);
        }
        // ensure the json data is a string
