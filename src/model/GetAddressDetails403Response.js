...
import GetAddressDetailsE403 from './GetAddressDetailsE403';
...
class GetAddressDetails403Response {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = GetAddressDetailsE403.constructFromObject(data['error']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetAddressDetails403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAddressDetails403Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetAddressDetails403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          GetAddressDetailsE403.validateJSON(data['error']);
        }
...
GetAddressDetails403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default GetAddressDetails403Response;
