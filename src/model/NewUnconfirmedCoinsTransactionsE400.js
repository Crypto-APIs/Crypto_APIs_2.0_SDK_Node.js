...
class NewUnconfirmedCoinsTransactionsE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewUnconfirmedCoinsTransactionsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/NewUnconfirmedCoinsTransactionsE400} An instance of NewUnconfirmedCoinsTransactionsE400.
     */
...
export default NewUnconfirmedCoinsTransactionsE400;
