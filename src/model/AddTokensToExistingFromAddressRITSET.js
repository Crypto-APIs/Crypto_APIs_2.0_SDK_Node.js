 ...
 * @version 1.11.0
 */
class AddTokensToExistingFromAddressRITSET {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of AddTokensToExistingFromAddressRITSET.RequiredProperties) {
            if (!data[property]) {
...
export default AddTokensToExistingFromAddressRITSET;
