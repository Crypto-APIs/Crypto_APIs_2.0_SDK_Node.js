...
class NewConfirmedCoinsTransactionsAndEachConfirmationRB {
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedCoinsTransactionsAndEachConfirmationRB.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          NewConfirmedCoinsTransactionsAndEachConfirmationRBData.validateJSON(data['data']);
        }
