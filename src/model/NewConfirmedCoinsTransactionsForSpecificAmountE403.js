 ...
 * @version 1.11.0
 */
class NewConfirmedCoinsTransactionsForSpecificAmountE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewConfirmedCoinsTransactionsForSpecificAmountE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Create an instance of NewConfirmedCoinsTransactionsForSpecificAmountE403 from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/NewConfirmedCoinsTransactionsForSpecificAmountE403} An instance of NewConfirmedCoinsTransactionsForSpecificAmountE403.
     */
...
export default NewConfirmedCoinsTransactionsForSpecificAmountE403;
