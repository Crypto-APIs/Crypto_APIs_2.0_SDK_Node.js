...
class GetAddressBalanceE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetAddressBalanceE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetAddressBalanceE400} An instance of GetAddressBalanceE400.
     */
...
export default GetAddressBalanceE400;
