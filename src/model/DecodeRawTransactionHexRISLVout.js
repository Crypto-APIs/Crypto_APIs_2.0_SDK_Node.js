...
import DecodeRawTransactionHexRISLScriptPubKey from './DecodeRawTransactionHexRISLScriptPubKey';
 ...
 * @version 1.5.0
 */
class DecodeRawTransactionHexRISLVout {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = DecodeRawTransactionHexRISLScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
...
export default DecodeRawTransactionHexRISLVout;
