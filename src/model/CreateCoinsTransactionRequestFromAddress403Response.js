...
class CreateCoinsTransactionRequestFromAddress403Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateCoinsTransactionRequestFromAddress403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          CreateCoinsTransactionRequestFromAddressE403.validateJSON(data['error']);
        }
