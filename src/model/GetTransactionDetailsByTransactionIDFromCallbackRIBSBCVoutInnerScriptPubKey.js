 ...
 * @version 1.11.0
 */
class GetTransactionDetailsByTransactionIDFromCallbackRIBSBCVoutInnerScriptPubKey {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDFromCallbackRIBSBCVoutInnerScriptPubKey.RequiredProperties) {
            if (!data[property]) {
...
export default GetTransactionDetailsByTransactionIDFromCallbackRIBSBCVoutInnerScriptPubKey;
