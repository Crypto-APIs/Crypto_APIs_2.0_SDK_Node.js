...
class NewConfirmedCoinsTransactionsAndEachConfirmationRData {
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedCoinsTransactionsAndEachConfirmationRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          NewConfirmedCoinsTransactionsAndEachConfirmationRI.validateJSON(data['item']);
        }
