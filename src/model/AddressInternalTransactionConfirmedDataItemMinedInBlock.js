 ...
 * @version 1.11.0
 */
class AddressInternalTransactionConfirmedDataItemMinedInBlock {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of AddressInternalTransactionConfirmedDataItemMinedInBlock.RequiredProperties) {
            if (!data[property]) {
...
export default AddressInternalTransactionConfirmedDataItemMinedInBlock;
