...
import ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey from './ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey';
...
class ListUnconfirmedTransactionsByAddressRIBSBCVoutInner {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListUnconfirmedTransactionsByAddressRIBSBCVoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
...
export default ListUnconfirmedTransactionsByAddressRIBSBCVoutInner;
