 ...
 * @version 1.11.0
 */
class GetZilliqaBlockDetailsByBlockHeightE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetZilliqaBlockDetailsByBlockHeightE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetZilliqaBlockDetailsByBlockHeightE403} An instance of GetZilliqaBlockDetailsByBlockHeightE403.
     */
...
export default GetZilliqaBlockDetailsByBlockHeightE403;
