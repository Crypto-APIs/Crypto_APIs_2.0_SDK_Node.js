...
class ListConfirmedTransactionsByAddressE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListConfirmedTransactionsByAddressE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListConfirmedTransactionsByAddressE400} An instance of ListConfirmedTransactionsByAddressE400.
     */
...
export default ListConfirmedTransactionsByAddressE400;
