 ...
 * @version 1.11.0
 */
class ActivateBlockchainEventSubscriptionE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ActivateBlockchainEventSubscriptionE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ActivateBlockchainEventSubscriptionE403} An instance of ActivateBlockchainEventSubscriptionE403.
     */
...
export default ActivateBlockchainEventSubscriptionE403;
