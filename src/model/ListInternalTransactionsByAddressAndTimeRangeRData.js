...
class ListInternalTransactionsByAddressAndTimeRangeRData {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListInternalTransactionsByAddressAndTimeRangeRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ListInternalTransactionsByAddressAndTimeRangeRI.validateJsonObject(item);
            };
        }
