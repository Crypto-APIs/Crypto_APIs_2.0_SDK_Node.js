...
class DecodeRawTransactionHexE400 {
    ...
    constructor(code, message) { 
        UriNotFound.initialize(this, code, message);LimitGreaterThanAllowed.initialize(this, code, message);InvalidPagination.initialize(this, code, message);InvalidBlockchain.initialize(this, code, message);InvalidNetwork.initialize(this, code, message);InvalidTransactionHex.initialize(this, code, message);
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            InvalidTransactionHex.constructFromObject(data, obj);
