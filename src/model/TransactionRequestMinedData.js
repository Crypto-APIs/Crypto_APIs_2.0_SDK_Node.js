 ...
 * @version 1.11.0
 */
class TransactionRequestMinedData {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of TransactionRequestMinedData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          TransactionRequestBroadcastedDataItem.validateJSON(data['item']);
        }
...
export default TransactionRequestMinedData;
