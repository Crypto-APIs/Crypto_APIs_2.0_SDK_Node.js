...
class GetAssetDetailsByAssetSymbolE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetAssetDetailsByAssetSymbolE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetAssetDetailsByAssetSymbolE400} An instance of GetAssetDetailsByAssetSymbolE400.
     */
...
export default GetAssetDetailsByAssetSymbolE400;
