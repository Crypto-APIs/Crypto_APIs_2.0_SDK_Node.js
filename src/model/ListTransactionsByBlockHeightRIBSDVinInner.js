...
class ListTransactionsByBlockHeightRIBSDVinInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHeightRIBSDVinInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptSig']) { // data not null
          ListTransactionsByBlockHeightRIBSDVinInnerScriptSig.validateJSON(data['scriptSig']);
        }
        // ensure the json data is a string
