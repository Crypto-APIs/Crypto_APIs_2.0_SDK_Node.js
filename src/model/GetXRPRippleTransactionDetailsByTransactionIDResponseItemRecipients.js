 ...
 * @version 2.0.0
 */
class GetXRPRippleTransactionDetailsByTransactionIDResponseItemRecipients {
    /**
...
export default GetXRPRippleTransactionDetailsByTransactionIDResponseItemRecipients;
