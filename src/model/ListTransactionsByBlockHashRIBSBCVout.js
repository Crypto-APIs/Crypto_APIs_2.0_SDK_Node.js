...
import ListTransactionsByBlockHashRIBSBCScriptPubKey from './ListTransactionsByBlockHashRIBSBCScriptPubKey';
 ...
 * @version 1.2.1
 */
class ListTransactionsByBlockHashRIBSBCVout {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = ListTransactionsByBlockHashRIBSBCScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
...
export default ListTransactionsByBlockHashRIBSBCVout;
