 ...
 * @version 1.6.0
 */
class GetUnconfirmedOmniTransactionByTransactionIDTxidRIRecipientsInner {
    /**
...
export default GetUnconfirmedOmniTransactionByTransactionIDTxidRIRecipientsInner;
