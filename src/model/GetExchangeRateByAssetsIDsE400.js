...
class GetExchangeRateByAssetsIDsE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetExchangeRateByAssetsIDsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetExchangeRateByAssetsIDsE400} An instance of GetExchangeRateByAssetsIDsE400.
     */
...
export default GetExchangeRateByAssetsIDsE400;
