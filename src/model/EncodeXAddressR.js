...
class EncodeXAddressR {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = EncodeXAddressRData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EncodeXAddressR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EncodeXAddressR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EncodeXAddressR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          EncodeXAddressRData.validateJSON(data['data']);
        }
...
EncodeXAddressR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
export default EncodeXAddressR;
