 ...
 * @version 1.11.0
 */
class GetTransactionDetailsByTransactionIDFromCallbackE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetTransactionDetailsByTransactionIDFromCallbackE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetTransactionDetailsByTransactionIDFromCallbackE400} An instance of GetTransactionDetailsByTransactionIDFromCallbackE400.
     */
...
export default GetTransactionDetailsByTransactionIDFromCallbackE400;
