...
class ListXRPRippleTransactionsByAddressAndTimeRangeRI {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListXRPRippleTransactionsByAddressAndTimeRangeRI.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['recipients']) { // data not null
            ...
            for (const item of data['recipients']) {
                GetXRPRippleTransactionDetailsByTransactionIDRIRecipientsInner.validateJsonObject(item);
            };
        }
        if (data['senders']) { // data not null
            ...
            for (const item of data['senders']) {
                GetXRPRippleTransactionDetailsByTransactionIDRISendersInner.validateJsonObject(item);
            };
        }
        // ensure the json data is a string
        ...
        if (data['fee']) { // data not null
          ListXRPRippleTransactionsByAddressRIFee.validateJSON(data['fee']);
        }
        // validate the optional field `offer`
        if (data['offer']) { // data not null
          ListXRPRippleTransactionsByAddressRIOffer.validateJSON(data['offer']);
        }
        // validate the optional field `receive`
        if (data['receive']) { // data not null
          ListXRPRippleTransactionsByAddressRIReceive.validateJSON(data['receive']);
        }
        // validate the optional field `value`
        if (data['value']) { // data not null
          ListXRPRippleTransactionsByAddressRIValue.validateJSON(data['value']);
        }
...
export default ListXRPRippleTransactionsByAddressAndTimeRangeRI;
