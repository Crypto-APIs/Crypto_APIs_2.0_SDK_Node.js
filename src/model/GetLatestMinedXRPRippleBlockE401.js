...
class GetLatestMinedXRPRippleBlockE401 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetLatestMinedXRPRippleBlockE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetLatestMinedXRPRippleBlockE401} An instance of GetLatestMinedXRPRippleBlockE401.
     */
...
export default GetLatestMinedXRPRippleBlockE401;
