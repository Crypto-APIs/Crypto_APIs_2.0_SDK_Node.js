 ...
 * @version 2.0.0
 */
class GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemSenders {
    /**
...
export default GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemSenders;
