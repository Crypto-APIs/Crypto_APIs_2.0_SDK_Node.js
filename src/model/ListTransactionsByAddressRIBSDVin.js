...
import ListTransactionsByAddressRIBSDScriptSig from './ListTransactionsByAddressRIBSDScriptSig';
 ...
 * @version 1.2.1
 */
class ListTransactionsByAddressRIBSDVin {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptSig')) {
                obj['scriptSig'] = ListTransactionsByAddressRIBSDScriptSig.constructFromObject(data['scriptSig']);
            }
...
export default ListTransactionsByAddressRIBSDVin;
