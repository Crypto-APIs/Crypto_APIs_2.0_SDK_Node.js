...
import ListZilliqaTransactionsByBlockHashRI from './ListZilliqaTransactionsByBlockHashRI';
 ...
 * @version 1.11.0
 */
class ListZilliqaTransactionsByBlockHashRData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListZilliqaTransactionsByBlockHashRI]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListZilliqaTransactionsByBlockHashRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ListZilliqaTransactionsByBlockHashRI.validateJsonObject(item);
            };
        }
...
export default ListZilliqaTransactionsByBlockHashRData;
