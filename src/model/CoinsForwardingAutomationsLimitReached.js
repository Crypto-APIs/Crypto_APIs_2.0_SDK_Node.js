...
import CoinsForwardingAutomationsLimitReachedError from './CoinsForwardingAutomationsLimitReachedError';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('error')) {
                obj['error'] = CoinsForwardingAutomationsLimitReachedError.constructFromObject(data['error']);
            }
        }
        return obj;
    }
...
export default CoinsForwardingAutomationsLimitReached;
