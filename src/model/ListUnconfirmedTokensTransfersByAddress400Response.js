...
class ListUnconfirmedTokensTransfersByAddress400Response {
    ...
    /**
     * Validates the JSON data with respect to <code>ListUnconfirmedTokensTransfersByAddress400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUnconfirmedTokensTransfersByAddress400Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ListUnconfirmedTokensTransfersByAddress400Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          ListUnconfirmedTokensTransfersByAddressE400.validateJSON(data['error']);
        }
...
ListUnconfirmedTokensTransfersByAddress400Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default ListUnconfirmedTokensTransfersByAddress400Response;
