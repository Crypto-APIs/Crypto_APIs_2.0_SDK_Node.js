 ...
 * @version 1.11.0
 */
class ListTokensTransfersByTransactionHashE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListTokensTransfersByTransactionHashE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListTokensTransfersByTransactionHashE400} An instance of ListTokensTransfersByTransactionHashE400.
     */
...
export default ListTokensTransfersByTransactionHashE400;
