...
class GetXRPRippleBlockDetailsByBlockHeight403Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetXRPRippleBlockDetailsByBlockHeight403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          GetXRPRippleBlockDetailsByBlockHeightE403.validateJSON(data['error']);
        }
