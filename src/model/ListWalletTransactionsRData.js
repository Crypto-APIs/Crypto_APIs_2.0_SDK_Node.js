...
import ListWalletTransactionsRI from './ListWalletTransactionsRI';
...
class ListWalletTransactionsRData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListWalletTransactionsRI]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListWalletTransactionsRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ListWalletTransactionsRI.validateJsonObject(item);
            };
        }
...
export default ListWalletTransactionsRData;
