 ...
 * @version 1.11.0
 */
class PrepareTransactionFromAddressE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `PrepareTransactionFromAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/PrepareTransactionFromAddressE403} An instance of PrepareTransactionFromAddressE403.
     */
...
export default PrepareTransactionFromAddressE403;
