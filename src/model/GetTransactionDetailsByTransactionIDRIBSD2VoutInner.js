...
class GetTransactionDetailsByTransactionIDRIBSD2VoutInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDRIBSD2VoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          GetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
