 ...
 * @version 1.11.0
 */
class ListAllAssetsFromAllWalletsE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListAllAssetsFromAllWalletsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListAllAssetsFromAllWalletsE400} An instance of ListAllAssetsFromAllWalletsE400.
     */
...
export default ListAllAssetsFromAllWalletsE400;
