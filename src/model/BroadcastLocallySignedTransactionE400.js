...
class BroadcastLocallySignedTransactionE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `BroadcastLocallySignedTransactionE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/BroadcastLocallySignedTransactionE400} An instance of BroadcastLocallySignedTransactionE400.
     */
...
export default BroadcastLocallySignedTransactionE400;
