...
import ListXRPRippleTransactionsByBlockHashRI from './ListXRPRippleTransactionsByBlockHashRI';
 ...
 * @version 1.11.0
 */
class ListXRPRippleTransactionsByBlockHashRData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListXRPRippleTransactionsByBlockHashRI]);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ListXRPRippleTransactionsByBlockHashRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ListXRPRippleTransactionsByBlockHashRI.validateJsonObject(item);
            };
        }
...
export default ListXRPRippleTransactionsByBlockHashRData;
