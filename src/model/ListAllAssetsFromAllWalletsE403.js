 ...
 * @version 1.11.0
 */
class ListAllAssetsFromAllWalletsE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListAllAssetsFromAllWalletsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListAllAssetsFromAllWalletsE403} An instance of ListAllAssetsFromAllWalletsE403.
     */
...
export default ListAllAssetsFromAllWalletsE403;
