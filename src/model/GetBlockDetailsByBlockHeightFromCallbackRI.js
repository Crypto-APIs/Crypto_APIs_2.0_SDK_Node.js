...
import GetBlockDetailsByBlockHeightFromCallbackRIBS from './GetBlockDetailsByBlockHeightFromCallbackRIBS';
 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHeightFromCallbackRI {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('blockchainSpecific')) {
                obj['blockchainSpecific'] = GetBlockDetailsByBlockHeightFromCallbackRIBS.constructFromObject(data['blockchainSpecific']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of GetBlockDetailsByBlockHeightFromCallbackRI.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['blockchainSpecific']) { // data not null
          GetBlockDetailsByBlockHeightFromCallbackRIBS.validateJSON(data['blockchainSpecific']);
        }
...
export default GetBlockDetailsByBlockHeightFromCallbackRI;
