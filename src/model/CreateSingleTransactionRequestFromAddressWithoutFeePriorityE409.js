...
class CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceWalletBalanceNotEnough. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409} An instance of CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409.
     */
...
export default CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409;
