 ...
 * @version 1.11.0
 */
class ListHDWalletXPubYPubZPubUTXOsE401 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListHDWalletXPubYPubZPubUTXOsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListHDWalletXPubYPubZPubUTXOsE401} An instance of ListHDWalletXPubYPubZPubUTXOsE401.
     */
...
export default ListHDWalletXPubYPubZPubUTXOsE401;
