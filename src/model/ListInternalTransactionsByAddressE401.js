...
class ListInternalTransactionsByAddressE401 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListInternalTransactionsByAddressE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListInternalTransactionsByAddressE401} An instance of ListInternalTransactionsByAddressE401.
     */
...
export default ListInternalTransactionsByAddressE401;
