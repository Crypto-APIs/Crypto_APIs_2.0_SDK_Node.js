 ...
 * @version 2.0.0
 */
class GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic {
    /**
     ...
     */
    constructor(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles) { 
     ...
     */
    static initialize(obj, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles) { 
...
export default GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic;
