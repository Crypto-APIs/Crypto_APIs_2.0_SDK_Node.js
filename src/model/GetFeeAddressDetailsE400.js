 ...
 * @version 1.11.0
 */
class GetFeeAddressDetailsE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetFeeAddressDetailsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetFeeAddressDetailsE400} An instance of GetFeeAddressDetailsE400.
     */
...
export default GetFeeAddressDetailsE400;
