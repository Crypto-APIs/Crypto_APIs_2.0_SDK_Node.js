...
import ListTransactionsByBlockHashRIBSLScriptPubKey from './ListTransactionsByBlockHashRIBSLScriptPubKey';
 ...
 * @version 1.1.0
 */
class ListTransactionsByBlockHashRIBSLVout {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = ListTransactionsByBlockHashRIBSLScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
...
export default ListTransactionsByBlockHashRIBSLVout;
