 ...
 * @version 1.11.0
 */
class ListXRPRippleTransactionsByBlockHashRISendersInner {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of ListXRPRippleTransactionsByBlockHashRISendersInner.RequiredProperties) {
            if (!data[property]) {
...
export default ListXRPRippleTransactionsByBlockHashRISendersInner;
