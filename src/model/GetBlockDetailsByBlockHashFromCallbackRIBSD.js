 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHashFromCallbackRIBSD {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetBlockDetailsByBlockHashFromCallbackRIBSD.RequiredProperties) {
            if (!data[property]) {
...
export default GetBlockDetailsByBlockHashFromCallbackRIBSD;
