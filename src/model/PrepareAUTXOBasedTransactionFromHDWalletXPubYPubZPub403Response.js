...
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE403.validateJSON(data['error']);
        }
