...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSZ {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDFromCallbackRIBSZ.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                GetTransactionDetailsByTransactionIDRIBSZVinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                GetTransactionDetailsByTransactionIDFromCallbackRIBSZVoutInner.validateJsonObject(item);
            };
        }
