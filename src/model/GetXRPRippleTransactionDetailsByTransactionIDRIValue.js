 ...
 * @version 1.11.0
 */
class GetXRPRippleTransactionDetailsByTransactionIDRIValue {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetXRPRippleTransactionDetailsByTransactionIDRIValue.RequiredProperties) {
            if (!data[property]) {
...
export default GetXRPRippleTransactionDetailsByTransactionIDRIValue;
