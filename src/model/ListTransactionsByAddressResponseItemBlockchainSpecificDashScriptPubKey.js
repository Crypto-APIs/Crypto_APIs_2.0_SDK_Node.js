 ...
 * @version 2.0.0
 */
class ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey {
    /**
...
export default ListTransactionsByAddressResponseItemBlockchainSpecificDashScriptPubKey;
