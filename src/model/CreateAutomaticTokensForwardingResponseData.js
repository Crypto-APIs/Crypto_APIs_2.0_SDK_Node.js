...
import CreateAutomaticTokensForwardingResponseItem from './CreateAutomaticTokensForwardingResponseItem';
 ...
 * @version 2.0.0
 */
class CreateAutomaticTokensForwardingResponseData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = CreateAutomaticTokensForwardingResponseItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
...
export default CreateAutomaticTokensForwardingResponseData;
