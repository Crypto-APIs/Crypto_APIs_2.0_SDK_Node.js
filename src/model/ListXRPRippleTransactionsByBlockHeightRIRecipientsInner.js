 ...
 * @version 1.11.0
 */
class ListXRPRippleTransactionsByBlockHeightRIRecipientsInner {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of ListXRPRippleTransactionsByBlockHeightRIRecipientsInner.RequiredProperties) {
            if (!data[property]) {
...
export default ListXRPRippleTransactionsByBlockHeightRIRecipientsInner;
