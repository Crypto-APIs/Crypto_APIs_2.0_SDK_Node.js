...
class GetXRPRippleBlockDetailsByBlockHashE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetXRPRippleBlockDetailsByBlockHashE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetXRPRippleBlockDetailsByBlockHashE400} An instance of GetXRPRippleBlockDetailsByBlockHashE400.
     */
...
export default GetXRPRippleBlockDetailsByBlockHashE400;
