...
class NewConfirmedTokenTransactionsForSpecificAmountE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewConfirmedTokenTransactionsForSpecificAmountE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
    ...
    /**
     * Create an instance of NewConfirmedTokenTransactionsForSpecificAmountE400 from a JSON string.
     * @param {string} json_string JSON string.
     * @return {module:model/NewConfirmedTokenTransactionsForSpecificAmountE400} An instance of NewConfirmedTokenTransactionsForSpecificAmountE400.
     */
...
export default NewConfirmedTokenTransactionsForSpecificAmountE400;
