...
class NewConfirmedInternalTransactionsAndEachConfirmationRData {
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedInternalTransactionsAndEachConfirmationRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          NewConfirmedInternalTransactionsAndEachConfirmationRI.validateJSON(data['item']);
        }
