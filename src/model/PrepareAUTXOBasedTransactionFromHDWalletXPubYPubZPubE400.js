...
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400} An instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400.
     */
...
export default PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE400;
