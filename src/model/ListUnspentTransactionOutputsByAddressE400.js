...
class ListUnspentTransactionOutputsByAddressE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListUnspentTransactionOutputsByAddressE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListUnspentTransactionOutputsByAddressE400} An instance of ListUnspentTransactionOutputsByAddressE400.
     */
...
export default ListUnspentTransactionOutputsByAddressE400;
