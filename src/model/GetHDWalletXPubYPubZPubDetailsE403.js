...
class GetHDWalletXPubYPubZPubDetailsE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetHDWalletXPubYPubZPubDetailsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetHDWalletXPubYPubZPubDetailsE403} An instance of GetHDWalletXPubYPubZPubDetailsE403.
     */
...
export default GetHDWalletXPubYPubZPubDetailsE403;
