...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSZVoutInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDFromCallbackRIBSZVoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          GetTransactionDetailsByTransactionIDFromCallbackRIBSZVoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
