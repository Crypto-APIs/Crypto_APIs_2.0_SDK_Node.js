...
import ListAssetsDetailsRI from './ListAssetsDetailsRI';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListAssetsDetailsRI]);
            }
        }
        return obj;
    }
...
export default ListAssetsDetailsRData;
