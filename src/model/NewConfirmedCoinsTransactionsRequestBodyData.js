...
import NewConfirmedCoinsTransactionsRequestBodyDataItem from './NewConfirmedCoinsTransactionsRequestBodyDataItem';
 ...
 * @version 2.0.0
 */
class NewConfirmedCoinsTransactionsRequestBodyData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = NewConfirmedCoinsTransactionsRequestBodyDataItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
...
export default NewConfirmedCoinsTransactionsRequestBodyData;
