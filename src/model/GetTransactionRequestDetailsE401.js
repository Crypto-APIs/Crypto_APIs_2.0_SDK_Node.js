 ...
 * @version 1.11.0
 */
class GetTransactionRequestDetailsE401 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetTransactionRequestDetailsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetTransactionRequestDetailsE401} An instance of GetTransactionRequestDetailsE401.
     */
...
export default GetTransactionRequestDetailsE401;
