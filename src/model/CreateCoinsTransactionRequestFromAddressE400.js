...
class CreateCoinsTransactionRequestFromAddressE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `CreateCoinsTransactionRequestFromAddressE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/CreateCoinsTransactionRequestFromAddressE400} An instance of CreateCoinsTransactionRequestFromAddressE400.
     */
...
export default CreateCoinsTransactionRequestFromAddressE400;
