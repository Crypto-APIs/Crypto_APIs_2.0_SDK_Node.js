...
class CreateFungibleTokensTransactionRequestFromAddressE409 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `CreateFungibleTokensTransactionRequestFromAddressE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceTokenNotSupported, WalletAsAServiceWalletBalanceNotEnough. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/CreateFungibleTokensTransactionRequestFromAddressE409} An instance of CreateFungibleTokensTransactionRequestFromAddressE409.
     */
