 ...
 * @version 2.0.0
 */
class GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin {
    /**
...
export default GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDogecoin;
