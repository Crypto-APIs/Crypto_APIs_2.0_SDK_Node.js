 ...
 * @version 2.0.0
 */
class DeleteAutomaticTokensForwardingResponseItemTokenDataBitcoinOmniToken {
    /**
...
export default DeleteAutomaticTokensForwardingResponseItemTokenDataBitcoinOmniToken;
