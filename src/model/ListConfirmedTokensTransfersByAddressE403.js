 ...
 * @version 1.11.0
 */
class ListConfirmedTokensTransfersByAddressE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListConfirmedTokensTransfersByAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListConfirmedTokensTransfersByAddressE403} An instance of ListConfirmedTokensTransfersByAddressE403.
     */
...
export default ListConfirmedTokensTransfersByAddressE403;
