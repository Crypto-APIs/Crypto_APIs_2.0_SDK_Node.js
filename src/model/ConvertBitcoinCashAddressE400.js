...
class ConvertBitcoinCashAddressE400 {
    ...
    constructor(code, message) { 
        UriNotFound.initialize(this, code, message);LimitGreaterThanAllowed.initialize(this, code, message);InvalidPagination.initialize(this, code, message);InvalidBlockchain.initialize(this, code, message);
