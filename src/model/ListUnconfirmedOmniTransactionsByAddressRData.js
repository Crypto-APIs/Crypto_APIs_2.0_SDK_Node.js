...
import ListUnconfirmedOmniTransactionsByAddressRI from './ListUnconfirmedOmniTransactionsByAddressRI';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('items')) {
                obj['items'] = ApiClient.convertToType(data['items'], [ListUnconfirmedOmniTransactionsByAddressRI]);
            }
        }
        return obj;
    }
...
export default ListUnconfirmedOmniTransactionsByAddressRData;
