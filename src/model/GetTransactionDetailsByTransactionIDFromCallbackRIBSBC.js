...
class GetTransactionDetailsByTransactionIDFromCallbackRIBSBC {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDFromCallbackRIBSBC.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                GetTransactionDetailsByTransactionIDFromCallbackRIBSBCVoutInner.validateJsonObject(item);
            };
        }
