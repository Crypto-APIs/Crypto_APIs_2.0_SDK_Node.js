 ...
 * @version 1.11.0
 */
class GetZilliqaBlockDetailsByBlockHashE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetZilliqaBlockDetailsByBlockHashE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetZilliqaBlockDetailsByBlockHashE403} An instance of GetZilliqaBlockDetailsByBlockHashE403.
     */
...
export default GetZilliqaBlockDetailsByBlockHashE403;
