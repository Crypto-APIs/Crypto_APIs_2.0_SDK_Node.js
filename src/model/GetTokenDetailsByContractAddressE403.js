 ...
 * @version 1.11.0
 */
class GetTokenDetailsByContractAddressE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetTokenDetailsByContractAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetTokenDetailsByContractAddressE403} An instance of GetTokenDetailsByContractAddressE403.
     */
...
export default GetTokenDetailsByContractAddressE403;
