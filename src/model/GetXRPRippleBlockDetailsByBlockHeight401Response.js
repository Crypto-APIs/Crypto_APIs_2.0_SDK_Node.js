...
class GetXRPRippleBlockDetailsByBlockHeight401Response {
    ...
    /**
     * Validates the JSON data with respect to <code>GetXRPRippleBlockDetailsByBlockHeight401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetXRPRippleBlockDetailsByBlockHeight401Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of GetXRPRippleBlockDetailsByBlockHeight401Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          GetXRPRippleBlockDetailsByBlockHeightE401.validateJSON(data['error']);
        }
...
GetXRPRippleBlockDetailsByBlockHeight401Response.RequiredProperties = ["apiVersion", "requestId", "error"];
