...
import ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig from './ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig';
 ...
 * @version 2.0.0
 */
class ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptSig')) {
                obj['scriptSig'] = ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinScriptSig.constructFromObject(data['scriptSig']);
            }
...
export default ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin;
