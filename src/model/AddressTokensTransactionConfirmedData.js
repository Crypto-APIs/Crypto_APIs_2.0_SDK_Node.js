...
class AddressTokensTransactionConfirmedData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = AddressTokensTransactionConfirmedDataItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of AddressTokensTransactionConfirmedData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          AddressTokensTransactionConfirmedDataItem.validateJSON(data['item']);
        }
...
export default AddressTokensTransactionConfirmedData;
