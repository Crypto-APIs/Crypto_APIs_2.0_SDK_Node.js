...
import GetXRPRippleAddressDetailsResponseItem from './GetXRPRippleAddressDetailsResponseItem';
 ...
 * @version 2.0.0
 */
class GetXRPRippleAddressDetailsResponseData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = GetXRPRippleAddressDetailsResponseItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
...
export default GetXRPRippleAddressDetailsResponseData;
