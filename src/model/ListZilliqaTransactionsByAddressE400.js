 ...
 * @version 1.11.0
 */
class ListZilliqaTransactionsByAddressE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListZilliqaTransactionsByAddressE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListZilliqaTransactionsByAddressE400} An instance of ListZilliqaTransactionsByAddressE400.
     */
...
export default ListZilliqaTransactionsByAddressE400;
