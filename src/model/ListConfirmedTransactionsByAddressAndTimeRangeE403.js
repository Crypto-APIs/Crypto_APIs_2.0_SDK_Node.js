 ...
 * @version 1.11.0
 */
class ListConfirmedTransactionsByAddressAndTimeRangeE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListConfirmedTransactionsByAddressAndTimeRangeE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListConfirmedTransactionsByAddressAndTimeRangeE403} An instance of ListConfirmedTransactionsByAddressAndTimeRangeE403.
     */
...
export default ListConfirmedTransactionsByAddressAndTimeRangeE403;
