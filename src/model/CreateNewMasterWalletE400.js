 ...
 * @version 1.11.0
 */
class CreateNewMasterWalletE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `CreateNewMasterWalletE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/CreateNewMasterWalletE400} An instance of CreateNewMasterWalletE400.
     */
...
export default CreateNewMasterWalletE400;
