...
class ListTransactionsByBlockHeightRIBSLVoutInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHeightRIBSLVoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
