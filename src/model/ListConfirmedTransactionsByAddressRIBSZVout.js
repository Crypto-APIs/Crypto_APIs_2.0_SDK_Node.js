...
import ListConfirmedTransactionsByAddressRIBSZScriptPubKey from './ListConfirmedTransactionsByAddressRIBSZScriptPubKey';
 ...
 * @version 1.3.0
 */
class ListConfirmedTransactionsByAddressRIBSZVout {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = ListConfirmedTransactionsByAddressRIBSZScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
...
export default ListConfirmedTransactionsByAddressRIBSZVout;
