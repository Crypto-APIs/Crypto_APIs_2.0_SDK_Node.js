...
class GetWalletTransactionDetailsByTransactionIDRIBSBVoutInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetWalletTransactionDetailsByTransactionIDRIBSBVoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
