...
class ListTransactionsByBlockHashRIBSBCVoutInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHashRIBSBCVoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          ListTransactionsByBlockHashRIBSBCVoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
