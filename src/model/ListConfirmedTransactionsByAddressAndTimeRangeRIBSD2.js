...
class ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2 {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListConfirmedTransactionsByAddressAndTimeRangeRIBSD2.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                ListConfirmedTransactionsByAddressRIBSD2VinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                ListConfirmedTransactionsByAddressRIBSD2VoutInner.validateJsonObject(item);
            };
        }
