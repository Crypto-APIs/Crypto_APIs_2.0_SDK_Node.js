...
import ConfirmedInternalTransactionForCertainAmountOrHigherData from './ConfirmedInternalTransactionForCertainAmountOrHigherData';
 ...
 * @version 1.11.0
 */
class ConfirmedInternalTransactionForCertainAmountOrHigher {
    /**
     ...
     * @param data {module:model/ConfirmedInternalTransactionForCertainAmountOrHigherData} 
     */
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ConfirmedInternalTransactionForCertainAmountOrHigherData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmedInternalTransactionForCertainAmountOrHigher</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmedInternalTransactionForCertainAmountOrHigher</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConfirmedInternalTransactionForCertainAmountOrHigher.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          ConfirmedInternalTransactionForCertainAmountOrHigherData.validateJSON(data['data']);
        }
...
ConfirmedInternalTransactionForCertainAmountOrHigher.RequiredProperties = ["apiVersion", "referenceId", "idempotencyKey", "data"];
...
export default ConfirmedInternalTransactionForCertainAmountOrHigher;
