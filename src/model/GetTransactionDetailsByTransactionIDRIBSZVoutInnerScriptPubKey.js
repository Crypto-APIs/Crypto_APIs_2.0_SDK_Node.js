 ...
 * @version 1.11.0
 */
class GetTransactionDetailsByTransactionIDRIBSZVoutInnerScriptPubKey {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDRIBSZVoutInnerScriptPubKey.RequiredProperties) {
            if (!data[property]) {
...
export default GetTransactionDetailsByTransactionIDRIBSZVoutInnerScriptPubKey;
