 ...
 * @version 1.11.0
 */
class GetFeeAddressDetailsE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetFeeAddressDetailsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetFeeAddressDetailsE403} An instance of GetFeeAddressDetailsE403.
     */
...
export default GetFeeAddressDetailsE403;
