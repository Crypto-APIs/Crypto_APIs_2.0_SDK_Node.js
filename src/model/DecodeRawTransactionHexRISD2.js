...
class DecodeRawTransactionHexRISD2 {
    ...
    static validateJSON(data) {
        ...
        for (const property of DecodeRawTransactionHexRISD2.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                DecodeRawTransactionHexRISD2VinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                DecodeRawTransactionHexRISD2VoutInner.validateJsonObject(item);
            };
        }
