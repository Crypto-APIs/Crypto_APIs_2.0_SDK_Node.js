...
import DecodeRawTransactionHexRISD2Vin from './DecodeRawTransactionHexRISD2Vin';
import DecodeRawTransactionHexRISD2Vout from './DecodeRawTransactionHexRISD2Vout';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('vin')) {
                obj['vin'] = ApiClient.convertToType(data['vin'], [DecodeRawTransactionHexRISD2Vin]);
            }
            if (data.hasOwnProperty('vout')) {
                obj['vout'] = ApiClient.convertToType(data['vout'], [DecodeRawTransactionHexRISD2Vout]);
            }
