...
class CreateCoinsTransactionFromAddressForWholeAmountRB {
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateCoinsTransactionFromAddressForWholeAmountRB.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          CreateCoinsTransactionFromAddressForWholeAmountRBData.validateJSON(data['data']);
        }
