 ...
 * @version 1.11.0
 */
class GetXRPRippleBlockDetailsByBlockHeightRITotalFees {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetXRPRippleBlockDetailsByBlockHeightRITotalFees.RequiredProperties) {
            if (!data[property]) {
...
export default GetXRPRippleBlockDetailsByBlockHeightRITotalFees;
