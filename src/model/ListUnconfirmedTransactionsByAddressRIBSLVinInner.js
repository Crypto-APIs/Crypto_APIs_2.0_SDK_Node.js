...
class ListUnconfirmedTransactionsByAddressRIBSLVinInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListUnconfirmedTransactionsByAddressRIBSLVinInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptSig']) { // data not null
          ListUnconfirmedTransactionsByAddressRIBSLVinInnerScriptSig.validateJSON(data['scriptSig']);
        }
