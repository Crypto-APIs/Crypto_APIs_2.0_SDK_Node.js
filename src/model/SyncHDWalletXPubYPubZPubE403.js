 ...
 * @version 1.11.0
 */
class SyncHDWalletXPubYPubZPubE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `SyncHDWalletXPubYPubZPubE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/SyncHDWalletXPubYPubZPubE403} An instance of SyncHDWalletXPubYPubZPubE403.
     */
...
export default SyncHDWalletXPubYPubZPubE403;
