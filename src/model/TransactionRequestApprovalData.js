...
import TransactionRequestApprovalDataItem from './TransactionRequestApprovalDataItem';
 ...
 * @version 1.11.0
 */
class TransactionRequestApprovalData {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = TransactionRequestApprovalDataItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of TransactionRequestApprovalData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          TransactionRequestApprovalDataItem.validateJSON(data['item']);
        }
...
export default TransactionRequestApprovalData;
