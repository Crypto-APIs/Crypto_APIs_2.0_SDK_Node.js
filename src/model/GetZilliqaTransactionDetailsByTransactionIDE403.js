 ...
 * @version 1.11.0
 */
class GetZilliqaTransactionDetailsByTransactionIDE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetZilliqaTransactionDetailsByTransactionIDE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetZilliqaTransactionDetailsByTransactionIDE403} An instance of GetZilliqaTransactionDetailsByTransactionIDE403.
     */
...
export default GetZilliqaTransactionDetailsByTransactionIDE403;
