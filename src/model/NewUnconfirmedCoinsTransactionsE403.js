 ...
 * @version 1.11.0
 */
class NewUnconfirmedCoinsTransactionsE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `NewUnconfirmedCoinsTransactionsE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/NewUnconfirmedCoinsTransactionsE403} An instance of NewUnconfirmedCoinsTransactionsE403.
     */
...
export default NewUnconfirmedCoinsTransactionsE403;
