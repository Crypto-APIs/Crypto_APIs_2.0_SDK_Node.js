 ...
 * @version 1.11.0
 */
class GetRawTransactionDataE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetRawTransactionDataE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetRawTransactionDataE400} An instance of GetRawTransactionDataE400.
     */
...
export default GetRawTransactionDataE400;
