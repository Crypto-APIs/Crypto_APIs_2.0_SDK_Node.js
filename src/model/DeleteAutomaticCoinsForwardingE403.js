...
class DeleteAutomaticCoinsForwardingE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `DeleteAutomaticCoinsForwardingE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/DeleteAutomaticCoinsForwardingE403} An instance of DeleteAutomaticCoinsForwardingE403.
     */
...
export default DeleteAutomaticCoinsForwardingE403;
