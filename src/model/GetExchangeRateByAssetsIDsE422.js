...
class GetExchangeRateByAssetsIDsE422 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetExchangeRateByAssetsIDsE422` with oneOf schemas CouldNotCalculateRateForPair, InvalidRequestBodyStructure. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetExchangeRateByAssetsIDsE422} An instance of GetExchangeRateByAssetsIDsE422.
     */
