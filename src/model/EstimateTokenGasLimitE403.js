...
class EstimateTokenGasLimitE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `EstimateTokenGasLimitE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/EstimateTokenGasLimitE403} An instance of EstimateTokenGasLimitE403.
     */
...
export default EstimateTokenGasLimitE403;
