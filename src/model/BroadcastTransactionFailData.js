...
class BroadcastTransactionFailData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = BroadcastTransactionFailDataItem.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of BroadcastTransactionFailData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          BroadcastTransactionFailDataItem.validateJSON(data['item']);
        }
...
export default BroadcastTransactionFailData;
