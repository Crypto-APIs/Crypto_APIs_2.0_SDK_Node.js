 ...
 * @version 1.11.0
 */
class ListCoinsForwardingAutomationsE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListCoinsForwardingAutomationsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListCoinsForwardingAutomationsE400} An instance of ListCoinsForwardingAutomationsE400.
     */
...
export default ListCoinsForwardingAutomationsE400;
