...
class GetWalletAssetDetailsE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetWalletAssetDetailsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetWalletAssetDetailsE400} An instance of GetWalletAssetDetailsE400.
     */
...
export default GetWalletAssetDetailsE400;
