 ...
 * @version 1.11.0
 */
class ConfirmedTokensTransactionForCertainAmountOrHigherBep20 {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of ConfirmedTokensTransactionForCertainAmountOrHigherBep20.RequiredProperties) {
            if (!data[property]) {
...
export default ConfirmedTokensTransactionForCertainAmountOrHigherBep20;
