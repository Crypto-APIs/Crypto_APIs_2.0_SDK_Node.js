...
class BroadcastLocallySignedTransactionR {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = BroadcastLocallySignedTransactionRData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BroadcastLocallySignedTransactionR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BroadcastLocallySignedTransactionR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of BroadcastLocallySignedTransactionR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          BroadcastLocallySignedTransactionRData.validateJSON(data['data']);
        }
...
BroadcastLocallySignedTransactionR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
export default BroadcastLocallySignedTransactionR;
