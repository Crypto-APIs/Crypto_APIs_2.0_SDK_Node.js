...
class GetZilliqaAddressDetailsE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetZilliqaAddressDetailsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetZilliqaAddressDetailsE403} An instance of GetZilliqaAddressDetailsE403.
     */
...
export default GetZilliqaAddressDetailsE403;
