 ...
 * @version 1.11.0
 */
class GenerateDepositAddressE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GenerateDepositAddressE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GenerateDepositAddressE400} An instance of GenerateDepositAddressE400.
     */
...
export default GenerateDepositAddressE400;
