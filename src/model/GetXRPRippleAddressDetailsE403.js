 ...
 * @version 1.11.0
 */
class GetXRPRippleAddressDetailsE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetXRPRippleAddressDetailsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetXRPRippleAddressDetailsE403} An instance of GetXRPRippleAddressDetailsE403.
     */
...
export default GetXRPRippleAddressDetailsE403;
