...
import PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIBSBSCFee from './PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIBSBSCFee';
 ...
 * @version 1.9.0
 */
class PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIBSBSC {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fee')) {
                obj['fee'] = PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIBSBSCFee.constructFromObject(data['fee']);
            }
...
export default PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIBSBSC;
