...
import GetLatestMinedBlockResponseItemBlockchainSpecific from './GetLatestMinedBlockResponseItemBlockchainSpecific';
 ...
 * @version 2.0.0
 */
class GetLatestMinedBlockResponseItem {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('blockchainSpecific')) {
                obj['blockchainSpecific'] = GetLatestMinedBlockResponseItemBlockchainSpecific.constructFromObject(data['blockchainSpecific']);
            }
        }
        return obj;
    }
...
export default GetLatestMinedBlockResponseItem;
