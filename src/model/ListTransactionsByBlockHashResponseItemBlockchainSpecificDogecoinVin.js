 ...
 * @version 2.0.0
 */
class ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin {
    /**
...
export default ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin;
