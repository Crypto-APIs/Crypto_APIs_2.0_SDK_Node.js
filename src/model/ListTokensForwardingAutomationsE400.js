...
class ListTokensForwardingAutomationsE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListTokensForwardingAutomationsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListTokensForwardingAutomationsE400} An instance of ListTokensForwardingAutomationsE400.
     */
...
export default ListTokensForwardingAutomationsE400;
