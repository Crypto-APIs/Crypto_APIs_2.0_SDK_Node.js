...
import GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVin from './GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVin';
import GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout from './GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout';
 ...
 * @version 2.0.0
 */
class GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoin {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('vin')) {
                obj['vin'] = ApiClient.convertToType(data['vin'], [GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVin]);
            }
            if (data.hasOwnProperty('vout')) {
                obj['vout'] = ApiClient.convertToType(data['vout'], [GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoinVout]);
            }
        }
        return obj;
    }
...
export default GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDogecoin;
