...
class DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403} An instance of DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403.
     */
...
export default DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE403;
