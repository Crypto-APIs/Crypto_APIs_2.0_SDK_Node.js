 ...
 * @version 1.11.0
 */
class DecodeRawTransactionHexE401 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `DecodeRawTransactionHexE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/DecodeRawTransactionHexE401} An instance of DecodeRawTransactionHexE401.
     */
...
export default DecodeRawTransactionHexE401;
