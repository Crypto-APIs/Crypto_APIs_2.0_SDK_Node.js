 ...
 * @version 1.11.0
 */
class ListConfirmedTransactionsByAddressRIBSD2VinInner {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of ListConfirmedTransactionsByAddressRIBSD2VinInner.RequiredProperties) {
            if (!data[property]) {
...
export default ListConfirmedTransactionsByAddressRIBSD2VinInner;
