...
class EstimateGasLimitR {
    ...
    /**
     * Validates the JSON data with respect to <code>EstimateGasLimitR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EstimateGasLimitR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of EstimateGasLimitR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          EstimateGasLimitRData.validateJSON(data['data']);
        }
...
EstimateGasLimitR.RequiredProperties = ["apiVersion", "requestId", "data"];
