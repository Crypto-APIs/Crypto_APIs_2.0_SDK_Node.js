 ...
 * @version 1.11.0
 */
class GetTransactionDetailsByTransactionIDRIBSBSCGasPrice {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDRIBSBSCGasPrice.RequiredProperties) {
            if (!data[property]) {
...
export default GetTransactionDetailsByTransactionIDRIBSBSCGasPrice;
