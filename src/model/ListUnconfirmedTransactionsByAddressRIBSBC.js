...
class ListUnconfirmedTransactionsByAddressRIBSBC {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListUnconfirmedTransactionsByAddressRIBSBC.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                ListUnconfirmedTransactionsByAddressRIBSBCVinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                ListUnconfirmedTransactionsByAddressRIBSBCVoutInner.validateJsonObject(item);
            };
        }
