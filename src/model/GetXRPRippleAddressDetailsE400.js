...
class GetXRPRippleAddressDetailsE400 {
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetXRPRippleAddressDetailsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetXRPRippleAddressDetailsE400} An instance of GetXRPRippleAddressDetailsE400.
     */
...
export default GetXRPRippleAddressDetailsE400;
