 ...
 * @version 1.11.0
 */
class ListXRPRippleTransactionsByBlockHeightE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListXRPRippleTransactionsByBlockHeightE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListXRPRippleTransactionsByBlockHeightE403} An instance of ListXRPRippleTransactionsByBlockHeightE403.
     */
...
export default ListXRPRippleTransactionsByBlockHeightE403;
