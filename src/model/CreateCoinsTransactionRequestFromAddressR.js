...
class CreateCoinsTransactionRequestFromAddressR {
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCoinsTransactionRequestFromAddressR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCoinsTransactionRequestFromAddressR</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of CreateCoinsTransactionRequestFromAddressR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          CreateCoinsTransactionRequestFromAddressRData.validateJSON(data['data']);
        }
...
CreateCoinsTransactionRequestFromAddressR.RequiredProperties = ["apiVersion", "requestId", "data"];
