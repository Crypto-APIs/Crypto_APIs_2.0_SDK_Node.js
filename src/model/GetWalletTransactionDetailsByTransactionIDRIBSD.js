...
class GetWalletTransactionDetailsByTransactionIDRIBSD {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetWalletTransactionDetailsByTransactionIDRIBSD.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                GetWalletTransactionDetailsByTransactionIDRIBSDVinInner.validateJsonObject(item);
            };
        }
