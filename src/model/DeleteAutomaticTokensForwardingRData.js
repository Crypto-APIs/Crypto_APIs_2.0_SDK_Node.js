...
import DeleteAutomaticTokensForwardingRI from './DeleteAutomaticTokensForwardingRI';
...
class DeleteAutomaticTokensForwardingRData {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('item')) {
                obj['item'] = DeleteAutomaticTokensForwardingRI.constructFromObject(data['item']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of DeleteAutomaticTokensForwardingRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['item']) { // data not null
          DeleteAutomaticTokensForwardingRI.validateJSON(data['item']);
        }
...
export default DeleteAutomaticTokensForwardingRData;
