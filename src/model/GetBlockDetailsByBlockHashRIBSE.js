 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHashRIBSE {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetBlockDetailsByBlockHashRIBSE.RequiredProperties) {
            if (!data[property]) {
...
export default GetBlockDetailsByBlockHashRIBSE;
