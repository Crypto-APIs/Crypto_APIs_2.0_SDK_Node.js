...
class GetXRPRippleTransactionDetailsByTransactionIDR {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetXRPRippleTransactionDetailsByTransactionIDR.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          GetXRPRippleTransactionDetailsByTransactionIDRData.validateJSON(data['data']);
        }
