...
class ConvertBitcoinCashAddress422Response {
    ...
    /**
     * Validates the JSON data with respect to <code>ConvertBitcoinCashAddress422Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConvertBitcoinCashAddress422Response</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ConvertBitcoinCashAddress422Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          InvalidRequestBodyStructure.validateJSON(data['error']);
        }
...
ConvertBitcoinCashAddress422Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
export default ConvertBitcoinCashAddress422Response;
