 ...
 * @version 1.11.0
 */
class ListTransactionsByBlockHashE401 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `ListTransactionsByBlockHashE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/ListTransactionsByBlockHashE401} An instance of ListTransactionsByBlockHashE401.
     */
...
export default ListTransactionsByBlockHashE401;
