 ...
 * @version 2.0.0
 */
class ListTokensForwardingAutomationsResponseItemTokenDataEthereumToken {
    /**
...
export default ListTokensForwardingAutomationsResponseItemTokenDataEthereumToken;
