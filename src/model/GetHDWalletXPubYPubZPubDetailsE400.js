 ...
 * @version 1.11.0
 */
class GetHDWalletXPubYPubZPubDetailsE400 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetHDWalletXPubYPubZPubDetailsE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetHDWalletXPubYPubZPubDetailsE400} An instance of GetHDWalletXPubYPubZPubDetailsE400.
     */
...
export default GetHDWalletXPubYPubZPubDetailsE400;
