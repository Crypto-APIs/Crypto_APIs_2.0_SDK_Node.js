 ...
 * @version 1.11.0
 */
class ListTransactionsByBlockHeightRIBSECGasPrice {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of ListTransactionsByBlockHeightRIBSECGasPrice.RequiredProperties) {
            if (!data[property]) {
...
export default ListTransactionsByBlockHeightRIBSECGasPrice;
