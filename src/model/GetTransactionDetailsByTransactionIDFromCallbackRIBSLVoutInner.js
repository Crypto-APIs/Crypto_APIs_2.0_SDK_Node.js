...
import GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInnerScriptPubKey from './GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInnerScriptPubKey';
 ...
 * @version 1.11.0
 */
class GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInner {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInnerScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
...
export default GetTransactionDetailsByTransactionIDFromCallbackRIBSLVoutInner;
