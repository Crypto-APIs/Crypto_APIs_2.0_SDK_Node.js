...
class PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSD2 {
    ...
    static validateJSON(data) {
        ...
        for (const property of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSD2.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['vin']) { // data not null
            ...
            for (const item of data['vin']) {
                PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSD2VinInner.validateJsonObject(item);
            };
        }
        if (data['vout']) { // data not null
            ...
            for (const item of data['vout']) {
                PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSD2VoutInner.validateJsonObject(item);
            };
        }
