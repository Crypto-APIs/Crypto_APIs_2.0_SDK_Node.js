...
class GetTransactionDetailsByTransactionIDRIBSLVoutInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetTransactionDetailsByTransactionIDRIBSLVoutInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptPubKey']) { // data not null
          GetTransactionDetailsByTransactionIDRIBSLVoutInnerScriptPubKey.validateJSON(data['scriptPubKey']);
        }
...
export default GetTransactionDetailsByTransactionIDRIBSLVoutInner;
