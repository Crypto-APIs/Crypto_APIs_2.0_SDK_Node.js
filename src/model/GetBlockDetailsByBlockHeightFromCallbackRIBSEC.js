 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHeightFromCallbackRIBSEC {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetBlockDetailsByBlockHeightFromCallbackRIBSEC.RequiredProperties) {
            if (!data[property]) {
...
export default GetBlockDetailsByBlockHeightFromCallbackRIBSEC;
