 ...
 * @version 1.11.0
 */
class GetBlockDetailsByBlockHashFromCallbackRIBSL {
    /**
    ...
    static validateJSON(data) {
        ...
        for (const property of GetBlockDetailsByBlockHashFromCallbackRIBSL.RequiredProperties) {
            if (!data[property]) {
...
export default GetBlockDetailsByBlockHashFromCallbackRIBSL;
