...
class ListUnconfirmedTokensTransfersByAddressRData {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListUnconfirmedTokensTransfersByAddressRData.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['items']) { // data not null
            ...
            for (const item of data['items']) {
                ListUnconfirmedTokensTransfersByAddressRI.validateJsonObject(item);
            };
        }
