...
class ListXRPRippleTransactionsByBlockHeight400Response {
    ...
    static validateJSON(data) {
        ...
        for (const property of ListXRPRippleTransactionsByBlockHeight400Response.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['error']) { // data not null
          ListXRPRippleTransactionsByBlockHeightE400.validateJSON(data['error']);
        }
