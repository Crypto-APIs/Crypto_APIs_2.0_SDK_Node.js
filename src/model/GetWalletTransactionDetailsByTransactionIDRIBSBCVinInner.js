...
class GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner {
    ...
    static validateJSON(data) {
        ...
        for (const property of GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['scriptSig']) { // data not null
          GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig.validateJSON(data['scriptSig']);
        }
        // ensure the json data is a string
