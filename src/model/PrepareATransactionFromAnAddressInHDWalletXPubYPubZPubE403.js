 ...
 * @version 1.11.0
 */
class PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE403} An instance of PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE403.
     */
...
export default PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubE403;
