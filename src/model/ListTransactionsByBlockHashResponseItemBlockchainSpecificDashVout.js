...
import ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey from './ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey';
 ...
 * @version 2.0.0
 */
class ListTransactionsByBlockHashResponseItemBlockchainSpecificDashVout {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scriptPubKey')) {
                obj['scriptPubKey'] = ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptPubKey.constructFromObject(data['scriptPubKey']);
            }
...
export default ListTransactionsByBlockHashResponseItemBlockchainSpecificDashVout;
