...
import ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin from './ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin';
import ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVout from './ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVout';
 ...
 * @version 2.0.0
 */
class ListTransactionsByBlockHeightResponseItemBlockchainSpecificDash {
    /**
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('vin')) {
                obj['vin'] = ApiClient.convertToType(data['vin'], [ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin]);
            }
            if (data.hasOwnProperty('vout')) {
                obj['vout'] = ApiClient.convertToType(data['vout'], [ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVout]);
            }
        }
        return obj;
    }
...
export default ListTransactionsByBlockHeightResponseItemBlockchainSpecificDash;
