...
class NewConfirmedTokensTransactionsAndEachConfirmationRB {
    ...
    static validateJSON(data) {
        ...
        for (const property of NewConfirmedTokensTransactionsAndEachConfirmationRB.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['data']) { // data not null
          NewConfirmedTokensTransactionsAndEachConfirmationRBData.validateJSON(data['data']);
        }
