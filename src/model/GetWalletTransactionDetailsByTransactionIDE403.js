 ...
 * @version 1.11.0
 */
class GetWalletTransactionDetailsByTransactionIDE403 {
    /**
    ...
    constructor(instance = null) {
        ...
        if (match > 1) {
            ...
            throw new Error("No match found constructing `GetWalletTransactionDetailsByTransactionIDE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " +
                            errorMessages.join(", "));
        } else { // only 1 match
            // the input is valid
        }
     ...
     * @return {module:model/GetWalletTransactionDetailsByTransactionIDE403} An instance of GetWalletTransactionDetailsByTransactionIDE403.
     */
...
export default GetWalletTransactionDetailsByTransactionIDE403;
