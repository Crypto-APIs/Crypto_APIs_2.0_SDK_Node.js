...
export default class TransactionsApi {
    ...
    */
     ...
     */
    freezeTronEnergyOrBandwidthWithHttpInfo(blockchain, network, sender, walletId, opts) {
      opts = opts || {};
      let postBody = opts['freezeTronEnergyOrBandwidthRB'];
      // verify the required parameter 'blockchain' is set
      if (blockchain === undefined || blockchain === null) {
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = FreezeTronEnergyOrBandwidthR;
      return this.apiClient.callApi(
     ...
     */
    freezeTronEnergyOrBandwidth(blockchain, network, sender, walletId, opts) {
      return this.freezeTronEnergyOrBandwidthWithHttpInfo(blockchain, network, sender, walletId, opts)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
