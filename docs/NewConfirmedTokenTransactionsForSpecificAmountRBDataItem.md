# Cryptoapis.NewConfirmedTokenTransactionsForSpecificAmountRBDataItem
...
**amountHigherThan** | **Number** | Represents a specific amount of tokens after which the system have to send a callback to customers&#39; callbackUrl. | 
