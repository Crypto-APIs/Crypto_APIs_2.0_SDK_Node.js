...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListLatestMinedBlocksRIBSL();
  });
  ...
  describe('ListLatestMinedBlocksRIBSL', function() {
    it('should create an instance of ListLatestMinedBlocksRIBSL', function() {
      // uncomment below and update the code to test ListLatestMinedBlocksRIBSL
      //var instance = new Cryptoapis.ListLatestMinedBlocksRIBSL();
      //expect(instance).to.be.a(Cryptoapis.ListLatestMinedBlocksRIBSL);
    });
