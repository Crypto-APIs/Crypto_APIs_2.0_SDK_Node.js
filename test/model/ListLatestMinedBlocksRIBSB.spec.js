...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListLatestMinedBlocksRIBSB();
  });
  ...
  describe('ListLatestMinedBlocksRIBSB', function() {
    it('should create an instance of ListLatestMinedBlocksRIBSB', function() {
      // uncomment below and update the code to test ListLatestMinedBlocksRIBSB
      //var instance = new Cryptoapis.ListLatestMinedBlocksRIBSB();
      //expect(instance).to.be.a(Cryptoapis.ListLatestMinedBlocksRIBSB);
    });
