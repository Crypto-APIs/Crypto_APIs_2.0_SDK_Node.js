...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSB();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSB', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSB', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSB
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSB();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSB);
    });
