...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLastMinedBlockRIBSBSC();
  });
  ...
  describe('GetLastMinedBlockRIBSBSC', function() {
    it('should create an instance of GetLastMinedBlockRIBSBSC', function() {
      // uncomment below and update the code to test GetLastMinedBlockRIBSBSC
      //var instance = new Cryptoapis.GetLastMinedBlockRIBSBSC();
      //expect(instance).to.be.a(Cryptoapis.GetLastMinedBlockRIBSBSC);
    });
