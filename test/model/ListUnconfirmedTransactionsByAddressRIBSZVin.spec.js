...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSZVin();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSZVin', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSZVin', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSZVin
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSZVin();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSZVin);
    });
