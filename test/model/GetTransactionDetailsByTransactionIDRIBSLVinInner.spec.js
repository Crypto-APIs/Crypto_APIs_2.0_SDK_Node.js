...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSLVinInner();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDRIBSLVinInner', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDRIBSLVinInner', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDRIBSLVinInner
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSLVinInner();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDRIBSLVinInner);
    });
