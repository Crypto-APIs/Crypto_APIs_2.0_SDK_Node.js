...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLatestMinedBlockRI();
  });
  ...
  describe('GetLatestMinedBlockRI', function() {
    it('should create an instance of GetLatestMinedBlockRI', function() {
      // uncomment below and update the code to test GetLatestMinedBlockRI
      //var instane = new Cryptoapis.GetLatestMinedBlockRI();
      //expect(instance).to.be.a(Cryptoapis.GetLatestMinedBlockRI);
    });

    it('should have the property hash (base name: "hash")', function() {
      // uncomment below and update the code to test the property hash
      //var instance = new Cryptoapis.GetLatestMinedBlockRI();
