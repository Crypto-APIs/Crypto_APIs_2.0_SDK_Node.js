...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLastMinedBlockRIBSZ();
  });
  ...
  describe('GetLastMinedBlockRIBSZ', function() {
    it('should create an instance of GetLastMinedBlockRIBSZ', function() {
      // uncomment below and update the code to test GetLastMinedBlockRIBSZ
      //var instance = new Cryptoapis.GetLastMinedBlockRIBSZ();
      //expect(instance).to.be.a(Cryptoapis.GetLastMinedBlockRIBSZ);
    });
