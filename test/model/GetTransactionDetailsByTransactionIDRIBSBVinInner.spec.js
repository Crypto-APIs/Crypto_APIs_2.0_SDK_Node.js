...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSBVinInner();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDRIBSBVinInner', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDRIBSBVinInner', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDRIBSBVinInner
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSBVinInner();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDRIBSBVinInner);
    });
