...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISE2();
  });
  ...
  describe('DecodeRawTransactionHexRISE2', function() {
    it('should create an instance of DecodeRawTransactionHexRISE2', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISE2
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISE2();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISE2);
    });
