...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISDVinInner();
  });
  ...
  describe('DecodeRawTransactionHexRISDVinInner', function() {
    it('should create an instance of DecodeRawTransactionHexRISDVinInner', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISDVinInner
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISDVinInner();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISDVinInner);
    });
