...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum();
  });
  ...
  describe('GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum', function() {
    it('should create an instance of GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum
      //var instane = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum();
      //expect(instance).to.be.a(CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum();
