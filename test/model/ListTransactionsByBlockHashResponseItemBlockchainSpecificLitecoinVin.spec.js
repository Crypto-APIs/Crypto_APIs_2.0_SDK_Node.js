...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinVin();
  });
  ...
  describe('ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinVin', function() {
    it('should create an instance of ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinVin', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinVin
      //var instane = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinVin();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificLitecoinVin();
