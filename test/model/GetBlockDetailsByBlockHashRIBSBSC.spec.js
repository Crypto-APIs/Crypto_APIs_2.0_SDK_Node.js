...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashRIBSBSC();
  });
  ...
  describe('GetBlockDetailsByBlockHashRIBSBSC', function() {
    it('should create an instance of GetBlockDetailsByBlockHashRIBSBSC', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashRIBSBSC
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashRIBSBSC();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashRIBSBSC);
    });
