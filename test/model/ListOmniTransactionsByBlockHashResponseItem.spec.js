...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListOmniTransactionsByBlockHashResponseItem();
  });
  ...
  describe('ListOmniTransactionsByBlockHashResponseItem', function() {
    it('should create an instance of ListOmniTransactionsByBlockHashResponseItem', function() {
      // uncomment below and update the code to test ListOmniTransactionsByBlockHashResponseItem
      //var instane = new CryptoApis.ListOmniTransactionsByBlockHashResponseItem();
      //expect(instance).to.be.a(CryptoApis.ListOmniTransactionsByBlockHashResponseItem);
    });

    it('should have the property amount (base name: "amount")', function() {
      // uncomment below and update the code to test the property amount
      //var instance = new CryptoApis.ListOmniTransactionsByBlockHashResponseItem();
