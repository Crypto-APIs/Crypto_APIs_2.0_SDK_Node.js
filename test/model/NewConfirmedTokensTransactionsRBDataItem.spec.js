...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.NewConfirmedTokensTransactionsRBDataItem();
  });
  ...
  describe('NewConfirmedTokensTransactionsRBDataItem', function() {
    it('should create an instance of NewConfirmedTokensTransactionsRBDataItem', function() {
      // uncomment below and update the code to test NewConfirmedTokensTransactionsRBDataItem
      //var instance = new Cryptoapis.NewConfirmedTokensTransactionsRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.NewConfirmedTokensTransactionsRBDataItem);
    });
