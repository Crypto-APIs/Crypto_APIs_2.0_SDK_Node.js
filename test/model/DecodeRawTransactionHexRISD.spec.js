...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISD();
  });
  ...
  describe('DecodeRawTransactionHexRISD', function() {
    it('should create an instance of DecodeRawTransactionHexRISD', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISD
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISD();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISD);
    });
