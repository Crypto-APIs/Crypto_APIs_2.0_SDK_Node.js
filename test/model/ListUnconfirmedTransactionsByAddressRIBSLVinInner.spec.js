...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSLVinInner();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSLVinInner', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSLVinInner', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSLVinInner
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSLVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSLVinInner);
    });
