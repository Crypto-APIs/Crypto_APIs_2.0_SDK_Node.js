...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSDVinInner();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSDVinInner', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSDVinInner', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSDVinInner
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSDVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSDVinInner);
    });
