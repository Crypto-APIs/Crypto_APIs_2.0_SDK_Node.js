...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem();
  });
  ...
  describe('GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem', function() {
    it('should create an instance of GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem', function() {
      // uncomment below and update the code to test GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem
      //var instane = new CryptoApis.GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem();
      //expect(instance).to.be.a(CryptoApis.GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem);
    });

    it('should have the property amount (base name: "amount")', function() {
      // uncomment below and update the code to test the property amount
      //var instance = new CryptoApis.GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItem();
