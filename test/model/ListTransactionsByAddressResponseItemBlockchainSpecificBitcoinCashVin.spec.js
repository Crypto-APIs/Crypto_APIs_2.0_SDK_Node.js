...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin();
  });
  ...
  describe('ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin', function() {
    it('should create an instance of ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin', function() {
      // uncomment below and update the code to test ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin
      //var instane = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinCashVin();
