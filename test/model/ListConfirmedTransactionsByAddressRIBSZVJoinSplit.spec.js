...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSZVJoinSplit();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSZVJoinSplit', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSZVJoinSplit', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSZVJoinSplit
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSZVJoinSplit();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSZVJoinSplit);
    });
