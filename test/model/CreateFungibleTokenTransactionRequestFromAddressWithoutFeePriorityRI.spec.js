...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRI();
  });
  ...
  describe('CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRI', function() {
    it('should create an instance of CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRI', function() {
      // uncomment below and update the code to test CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRI
      //var instance = new Cryptoapis.CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRI();
      //expect(instance).to.be.a(Cryptoapis.CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRI);
    });
