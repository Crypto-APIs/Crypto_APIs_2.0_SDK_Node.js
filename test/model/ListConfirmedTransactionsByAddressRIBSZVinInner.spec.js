...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSZVinInner();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSZVinInner', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSZVinInner', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSZVinInner
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSZVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSZVinInner);
    });
