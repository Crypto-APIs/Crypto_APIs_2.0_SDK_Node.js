...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.CreateAutomaticCoinsForwardingResponseItem();
  });
  ...
  describe('CreateAutomaticCoinsForwardingResponseItem', function() {
    it('should create an instance of CreateAutomaticCoinsForwardingResponseItem', function() {
      // uncomment below and update the code to test CreateAutomaticCoinsForwardingResponseItem
      //var instane = new CryptoApis.CreateAutomaticCoinsForwardingResponseItem();
      //expect(instance).to.be.a(CryptoApis.CreateAutomaticCoinsForwardingResponseItem);
    });
    ...
    it('should have the property callbackUrl (base name: "callbackUrl")', function() {
      ...
      //var instance = new CryptoApis.CreateAutomaticCoinsForwardingResponseItem();
