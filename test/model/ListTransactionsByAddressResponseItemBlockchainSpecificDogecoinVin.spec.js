...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin();
  });
  ...
  describe('ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin', function() {
    it('should create an instance of ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin', function() {
      // uncomment below and update the code to test ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin
      //var instane = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificDogecoinVin();
