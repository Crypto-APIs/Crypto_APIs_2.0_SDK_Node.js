...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereum();
  });
  ...
  describe('ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereum', function() {
    it('should create an instance of ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereum', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereum
      //var instane = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereum();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereum);
    });
    ...
    it('should have the property contract (base name: "contract")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereum();
