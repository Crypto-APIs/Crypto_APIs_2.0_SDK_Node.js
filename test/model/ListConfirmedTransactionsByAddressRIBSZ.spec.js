...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSZ();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSZ', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSZ', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSZ
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSZ();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSZ);
    });
