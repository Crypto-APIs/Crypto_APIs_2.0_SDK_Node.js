...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSZ();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSZ', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSZ', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSZ
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSZ();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSZ);
    });
