...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSD2();
  });
  ...
  describe('GetBlockDetailsByBlockHashFromCallbackRIBSD2', function() {
    it('should create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSD2', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashFromCallbackRIBSD2
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSD2();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSD2);
    });
