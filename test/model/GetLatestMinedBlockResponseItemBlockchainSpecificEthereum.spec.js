...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificEthereum();
  });
  ...
  describe('GetLatestMinedBlockResponseItemBlockchainSpecificEthereum', function() {
    it('should create an instance of GetLatestMinedBlockResponseItemBlockchainSpecificEthereum', function() {
      // uncomment below and update the code to test GetLatestMinedBlockResponseItemBlockchainSpecificEthereum
      //var instane = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificEthereum();
      //expect(instance).to.be.a(CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificEthereum);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificEthereum();
