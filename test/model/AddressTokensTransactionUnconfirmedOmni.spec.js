...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.AddressTokensTransactionUnconfirmedOmni();
  });
  ...
  describe('AddressTokensTransactionUnconfirmedOmni', function() {
    it('should create an instance of AddressTokensTransactionUnconfirmedOmni', function() {
      // uncomment below and update the code to test AddressTokensTransactionUnconfirmedOmni
      //var instance = new Cryptoapis.AddressTokensTransactionUnconfirmedOmni();
      //expect(instance).to.be.a(Cryptoapis.AddressTokensTransactionUnconfirmedOmni);
    });
