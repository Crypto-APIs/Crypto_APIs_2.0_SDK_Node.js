...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockchainEventSubscriptionDetailsByReferenceIDRI();
  });
  ...
  describe('GetBlockchainEventSubscriptionDetailsByReferenceIDRI', function() {
    it('should create an instance of GetBlockchainEventSubscriptionDetailsByReferenceIDRI', function() {
      // uncomment below and update the code to test GetBlockchainEventSubscriptionDetailsByReferenceIDRI
      //var instance = new Cryptoapis.GetBlockchainEventSubscriptionDetailsByReferenceIDRI();
      //expect(instance).to.be.a(Cryptoapis.GetBlockchainEventSubscriptionDetailsByReferenceIDRI);
    });
