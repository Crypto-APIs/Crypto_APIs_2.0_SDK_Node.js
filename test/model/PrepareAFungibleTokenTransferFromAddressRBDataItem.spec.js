...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareAFungibleTokenTransferFromAddressRBDataItem();
  });
  ...
  describe('PrepareAFungibleTokenTransferFromAddressRBDataItem', function() {
    it('should create an instance of PrepareAFungibleTokenTransferFromAddressRBDataItem', function() {
      // uncomment below and update the code to test PrepareAFungibleTokenTransferFromAddressRBDataItem
      //var instance = new Cryptoapis.PrepareAFungibleTokenTransferFromAddressRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.PrepareAFungibleTokenTransferFromAddressRBDataItem);
    });
