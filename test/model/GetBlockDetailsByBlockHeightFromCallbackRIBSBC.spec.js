...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSBC();
  });
  ...
  describe('GetBlockDetailsByBlockHeightFromCallbackRIBSBC', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSBC', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightFromCallbackRIBSBC
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSBC();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSBC);
    });
