...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSLVinInner();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSLVinInner', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSLVinInner', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSLVinInner
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSLVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSLVinInner);
    });
