...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC();
  });
  ...
  describe('ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC);
    });
