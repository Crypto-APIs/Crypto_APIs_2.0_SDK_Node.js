...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSZVin();
  });
  ...
  describe('ListTransactionsByBlockHeightRIBSZVin', function() {
    it('should create an instance of ListTransactionsByBlockHeightRIBSZVin', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightRIBSZVin
      //var instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSZVin();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHeightRIBSZVin);
    });
