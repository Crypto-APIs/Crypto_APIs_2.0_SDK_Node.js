...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRIBSBSC();
  });
  ...
  describe('PrepareANonFungibleTokenTransferFromAddressRIBSBSC', function() {
    it('should create an instance of PrepareANonFungibleTokenTransferFromAddressRIBSBSC', function() {
      // uncomment below and update the code to test PrepareANonFungibleTokenTransferFromAddressRIBSBSC
      //var instance = new Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRIBSBSC();
      //expect(instance).to.be.a(Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRIBSBSC);
    });
