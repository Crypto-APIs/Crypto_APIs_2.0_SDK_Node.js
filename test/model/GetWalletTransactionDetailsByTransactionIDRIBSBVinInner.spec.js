...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSBVinInner();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSBVinInner', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSBVinInner', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSBVinInner
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSBVinInner();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSBVinInner);
    });
