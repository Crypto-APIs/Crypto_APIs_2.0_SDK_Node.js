...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareAnAccountBasedTransactionFromXPubRBDataItem();
  });
  ...
  describe('PrepareAnAccountBasedTransactionFromXPubRBDataItem', function() {
    it('should create an instance of PrepareAnAccountBasedTransactionFromXPubRBDataItem', function() {
      // uncomment below and update the code to test PrepareAnAccountBasedTransactionFromXPubRBDataItem
      //var instance = new Cryptoapis.PrepareAnAccountBasedTransactionFromXPubRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.PrepareAnAccountBasedTransactionFromXPubRBDataItem);
    });
