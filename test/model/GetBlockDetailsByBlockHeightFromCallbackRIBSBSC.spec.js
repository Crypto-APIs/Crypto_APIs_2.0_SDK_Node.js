...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSBSC();
  });
  ...
  describe('GetBlockDetailsByBlockHeightFromCallbackRIBSBSC', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSBSC', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightFromCallbackRIBSBSC
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSBSC();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSBSC);
    });
