...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.AddressTokensTransactionConfirmedOmni();
  });
  ...
  describe('AddressTokensTransactionConfirmedOmni', function() {
    it('should create an instance of AddressTokensTransactionConfirmedOmni', function() {
      // uncomment below and update the code to test AddressTokensTransactionConfirmedOmni
      //var instance = new Cryptoapis.AddressTokensTransactionConfirmedOmni();
      //expect(instance).to.be.a(Cryptoapis.AddressTokensTransactionConfirmedOmni);
    });
