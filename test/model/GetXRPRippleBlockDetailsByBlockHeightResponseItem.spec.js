...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetXRPRippleBlockDetailsByBlockHeightResponseItem();
  });
  ...
  describe('GetXRPRippleBlockDetailsByBlockHeightResponseItem', function() {
    it('should create an instance of GetXRPRippleBlockDetailsByBlockHeightResponseItem', function() {
      // uncomment below and update the code to test GetXRPRippleBlockDetailsByBlockHeightResponseItem
      //var instane = new CryptoApis.GetXRPRippleBlockDetailsByBlockHeightResponseItem();
      //expect(instance).to.be.a(CryptoApis.GetXRPRippleBlockDetailsByBlockHeightResponseItem);
    });
    ...
    it('should have the property blockHash (base name: "blockHash")', function() {
      ...
      //var instance = new CryptoApis.GetXRPRippleBlockDetailsByBlockHeightResponseItem();
