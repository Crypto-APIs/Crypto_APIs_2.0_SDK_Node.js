...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.CreateCoinsTransactionFromAddressForWholeAmountRI();
  });
  ...
  describe('CreateCoinsTransactionFromAddressForWholeAmountRI', function() {
    it('should create an instance of CreateCoinsTransactionFromAddressForWholeAmountRI', function() {
      // uncomment below and update the code to test CreateCoinsTransactionFromAddressForWholeAmountRI
      //var instance = new Cryptoapis.CreateCoinsTransactionFromAddressForWholeAmountRI();
      //expect(instance).to.be.a(Cryptoapis.CreateCoinsTransactionFromAddressForWholeAmountRI);
    });
