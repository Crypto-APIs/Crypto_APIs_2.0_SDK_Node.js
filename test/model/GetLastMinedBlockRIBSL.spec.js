...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLastMinedBlockRIBSL();
  });
  ...
  describe('GetLastMinedBlockRIBSL', function() {
    it('should create an instance of GetLastMinedBlockRIBSL', function() {
      // uncomment below and update the code to test GetLastMinedBlockRIBSL
      //var instance = new Cryptoapis.GetLastMinedBlockRIBSL();
      //expect(instance).to.be.a(Cryptoapis.GetLastMinedBlockRIBSL);
    });
