...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSBSC();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSBSC', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSBSC', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSBSC
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSBSC();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSBSC);
    });
