...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSDVin();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSDVin', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSDVin', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSDVin
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSDVin();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSDVin);
    });
