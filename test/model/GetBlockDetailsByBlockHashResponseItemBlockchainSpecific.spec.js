...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecific();
  });
  ...
  describe('GetBlockDetailsByBlockHashResponseItemBlockchainSpecific', function() {
    it('should create an instance of GetBlockDetailsByBlockHashResponseItemBlockchainSpecific', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashResponseItemBlockchainSpecific
      //var instane = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecific();
      //expect(instance).to.be.a(CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecific);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecific();
