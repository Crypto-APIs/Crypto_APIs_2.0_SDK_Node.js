...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLatestMinedBlockRIBSD2();
  });
  ...
  describe('GetLatestMinedBlockRIBSD2', function() {
    it('should create an instance of GetLatestMinedBlockRIBSD2', function() {
      // uncomment below and update the code to test GetLatestMinedBlockRIBSD2
      //var instane = new Cryptoapis.GetLatestMinedBlockRIBSD2();
      //expect(instance).to.be.a(Cryptoapis.GetLatestMinedBlockRIBSD2);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new Cryptoapis.GetLatestMinedBlockRIBSD2();
