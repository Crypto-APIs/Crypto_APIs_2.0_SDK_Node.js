...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHashRIBSDVinInner();
  });
  ...
  describe('ListTransactionsByBlockHashRIBSDVinInner', function() {
    it('should create an instance of ListTransactionsByBlockHashRIBSDVinInner', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashRIBSDVinInner
      //var instance = new Cryptoapis.ListTransactionsByBlockHashRIBSDVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHashRIBSDVinInner);
    });
