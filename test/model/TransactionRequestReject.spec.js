...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.TransactionRequestReject();
  });
  ...
  describe('TransactionRequestReject', function() {
    it('should create an instance of TransactionRequestReject', function() {
      // uncomment below and update the code to test TransactionRequestReject
      //var instane = new Cryptoapis.TransactionRequestReject();
      //expect(instance).to.be.a(Cryptoapis.TransactionRequestReject);
    });
    ...
    it('should have the property apiVersion (base name: "apiVersion")', function() {
      ...
      //var instance = new Cryptoapis.TransactionRequestReject();
