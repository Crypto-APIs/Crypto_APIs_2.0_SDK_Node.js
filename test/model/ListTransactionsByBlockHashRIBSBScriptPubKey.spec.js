...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHashRIBSBScriptPubKey();
  });
  ...
  describe('ListTransactionsByBlockHashRIBSBScriptPubKey', function() {
    it('should create an instance of ListTransactionsByBlockHashRIBSBScriptPubKey', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashRIBSBScriptPubKey
      //var instance = new Cryptoapis.ListTransactionsByBlockHashRIBSBScriptPubKey();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHashRIBSBScriptPubKey);
    });
