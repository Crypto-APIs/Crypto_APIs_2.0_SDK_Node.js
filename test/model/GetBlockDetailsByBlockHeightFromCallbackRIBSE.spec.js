...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSE();
  });
  ...
  describe('GetBlockDetailsByBlockHeightFromCallbackRIBSE', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSE', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightFromCallbackRIBSE
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSE();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSE);
    });
