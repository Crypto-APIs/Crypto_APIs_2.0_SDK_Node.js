...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRI();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRI', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRI', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRI
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRI();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRI);
    });
