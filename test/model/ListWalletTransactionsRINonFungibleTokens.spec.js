...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListWalletTransactionsRINonFungibleTokens();
  });
  ...
  describe('ListWalletTransactionsRINonFungibleTokens', function() {
    it('should create an instance of ListWalletTransactionsRINonFungibleTokens', function() {
      // uncomment below and update the code to test ListWalletTransactionsRINonFungibleTokens
      //var instance = new Cryptoapis.ListWalletTransactionsRINonFungibleTokens();
      //expect(instance).to.be.a(Cryptoapis.ListWalletTransactionsRINonFungibleTokens);
    });
