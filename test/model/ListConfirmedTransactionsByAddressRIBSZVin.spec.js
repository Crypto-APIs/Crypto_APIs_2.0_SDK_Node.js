...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSZVin();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSZVin', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSZVin', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSZVin
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSZVin();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSZVin);
    });
