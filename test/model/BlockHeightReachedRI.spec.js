...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.BlockHeightReachedRI();
  });
  ...
  describe('BlockHeightReachedRI', function() {
    it('should create an instance of BlockHeightReachedRI', function() {
      // uncomment below and update the code to test BlockHeightReachedRI
      //var instance = new Cryptoapis.BlockHeightReachedRI();
      //expect(instance).to.be.a(Cryptoapis.BlockHeightReachedRI);
    });
