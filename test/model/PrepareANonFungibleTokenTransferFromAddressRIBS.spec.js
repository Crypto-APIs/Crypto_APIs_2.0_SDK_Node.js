...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRIBS();
  });
  ...
  describe('PrepareANonFungibleTokenTransferFromAddressRIBS', function() {
    it('should create an instance of PrepareANonFungibleTokenTransferFromAddressRIBS', function() {
      // uncomment below and update the code to test PrepareANonFungibleTokenTransferFromAddressRIBS
      //var instance = new Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRIBS();
      //expect(instance).to.be.a(Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRIBS);
    });
