...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin();
  });
  ...
  describe('GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin', function() {
    it('should create an instance of GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin
      //var instane = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin();
      //expect(instance).to.be.a(CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin();
