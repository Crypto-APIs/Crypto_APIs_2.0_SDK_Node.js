...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSBSC();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDRIBSBSC', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDRIBSBSC', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDRIBSBSC
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSBSC();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDRIBSBSC);
    });
