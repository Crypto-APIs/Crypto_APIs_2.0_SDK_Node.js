...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightRIBSBSC();
  });
  ...
  describe('GetBlockDetailsByBlockHeightRIBSBSC', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightRIBSBSC', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightRIBSBSC
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightRIBSBSC();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightRIBSBSC);
    });
