...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListWalletTransactionsRIValue();
  });
  ...
  describe('ListWalletTransactionsRIValue', function() {
    it('should create an instance of ListWalletTransactionsRIValue', function() {
      // uncomment below and update the code to test ListWalletTransactionsRIValue
      //var instance = new Cryptoapis.ListWalletTransactionsRIValue();
      //expect(instance).to.be.a(Cryptoapis.ListWalletTransactionsRIValue);
    });
