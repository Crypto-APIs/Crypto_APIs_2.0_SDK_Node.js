...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByAddressRIBSBCVin();
  });
  ...
  describe('ListTransactionsByAddressRIBSBCVin', function() {
    it('should create an instance of ListTransactionsByAddressRIBSBCVin', function() {
      // uncomment below and update the code to test ListTransactionsByAddressRIBSBCVin
      //var instane = new Cryptoapis.ListTransactionsByAddressRIBSBCVin();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByAddressRIBSBCVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new Cryptoapis.ListTransactionsByAddressRIBSBCVin();
