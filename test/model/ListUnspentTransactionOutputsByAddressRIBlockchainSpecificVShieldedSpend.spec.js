...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend();
  });
  ...
  describe('ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend', function() {
    it('should create an instance of ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend', function() {
      // uncomment below and update the code to test ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend
      //var instance = new Cryptoapis.ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend();
      //expect(instance).to.be.a(Cryptoapis.ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVShieldedSpend);
    });
