...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.DeleteAutomaticCoinsForwardingResponseItem();
  });
  ...
  describe('DeleteAutomaticCoinsForwardingResponseItem', function() {
    it('should create an instance of DeleteAutomaticCoinsForwardingResponseItem', function() {
      // uncomment below and update the code to test DeleteAutomaticCoinsForwardingResponseItem
      //var instane = new CryptoApis.DeleteAutomaticCoinsForwardingResponseItem();
      //expect(instance).to.be.a(CryptoApis.DeleteAutomaticCoinsForwardingResponseItem);
    });
    ...
    it('should have the property callbackUrl (base name: "callbackUrl")', function() {
      ...
      //var instance = new CryptoApis.DeleteAutomaticCoinsForwardingResponseItem();
