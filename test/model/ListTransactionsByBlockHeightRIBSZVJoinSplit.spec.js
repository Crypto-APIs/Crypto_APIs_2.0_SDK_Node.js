...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSZVJoinSplit();
  });
  ...
  describe('ListTransactionsByBlockHeightRIBSZVJoinSplit', function() {
    it('should create an instance of ListTransactionsByBlockHeightRIBSZVJoinSplit', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightRIBSZVJoinSplit
      //var instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSZVJoinSplit();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHeightRIBSZVJoinSplit);
    });
