...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetAssetDetailsByAssetSymbolRISC();
  });
  ...
  describe('GetAssetDetailsByAssetSymbolRISC', function() {
    it('should create an instance of GetAssetDetailsByAssetSymbolRISC', function() {
      // uncomment below and update the code to test GetAssetDetailsByAssetSymbolRISC
      //var instance = new Cryptoapis.GetAssetDetailsByAssetSymbolRISC();
      //expect(instance).to.be.a(Cryptoapis.GetAssetDetailsByAssetSymbolRISC);
    });
