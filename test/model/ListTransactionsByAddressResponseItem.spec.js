...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByAddressResponseItem();
  });
  ...
  describe('ListTransactionsByAddressResponseItem', function() {
    it('should create an instance of ListTransactionsByAddressResponseItem', function() {
      // uncomment below and update the code to test ListTransactionsByAddressResponseItem
      //var instane = new CryptoApis.ListTransactionsByAddressResponseItem();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByAddressResponseItem);
    });

    it('should have the property index (base name: "index")', function() {
      // uncomment below and update the code to test the property index
      //var instance = new CryptoApis.ListTransactionsByAddressResponseItem();
