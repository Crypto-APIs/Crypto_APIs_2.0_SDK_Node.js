...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.NewConfirmedInternalTransactionsForSpecificAmountRBDataItem();
  });
  ...
  describe('NewConfirmedInternalTransactionsForSpecificAmountRBDataItem', function() {
    it('should create an instance of NewConfirmedInternalTransactionsForSpecificAmountRBDataItem', function() {
      // uncomment below and update the code to test NewConfirmedInternalTransactionsForSpecificAmountRBDataItem
      //var instance = new Cryptoapis.NewConfirmedInternalTransactionsForSpecificAmountRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.NewConfirmedInternalTransactionsForSpecificAmountRBDataItem);
    });
