...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSDVinInner();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSDVinInner', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSDVinInner', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSDVinInner
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSDVinInner();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSDVinInner);
    });
