...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit();
  });
  ...
  describe('ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit', function() {
    it('should create an instance of ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit', function() {
      // uncomment below and update the code to test ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit
      //var instance = new Cryptoapis.ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit();
      //expect(instance).to.be.a(Cryptoapis.ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit);
    });
