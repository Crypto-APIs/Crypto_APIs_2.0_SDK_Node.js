...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTokensTransfersByAddressRI();
  });
  ...
  describe('ListTokensTransfersByAddressRI', function() {
    it('should create an instance of ListTokensTransfersByAddressRI', function() {
      // uncomment below and update the code to test ListTokensTransfersByAddressRI
      //var instane = new Cryptoapis.ListTokensTransfersByAddressRI();
      //expect(instance).to.be.a(Cryptoapis.ListTokensTransfersByAddressRI);
    });
    ...
    it('should have the property contractAddress (base name: "contractAddress")', function() {
      ...
      //var instance = new Cryptoapis.ListTokensTransfersByAddressRI();
