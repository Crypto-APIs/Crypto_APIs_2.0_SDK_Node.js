...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetLatestMinedXRPRippleBlockResponseItem();
  });
  ...
  describe('GetLatestMinedXRPRippleBlockResponseItem', function() {
    it('should create an instance of GetLatestMinedXRPRippleBlockResponseItem', function() {
      // uncomment below and update the code to test GetLatestMinedXRPRippleBlockResponseItem
      //var instane = new CryptoApis.GetLatestMinedXRPRippleBlockResponseItem();
      //expect(instance).to.be.a(CryptoApis.GetLatestMinedXRPRippleBlockResponseItem);
    });
    ...
    it('should have the property blockHash (base name: "blockHash")', function() {
      ...
      //var instance = new CryptoApis.GetLatestMinedXRPRippleBlockResponseItem();
