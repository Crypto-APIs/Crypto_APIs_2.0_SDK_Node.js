...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.AddressInternalTransactionConfirmed();
  });
  ...
  describe('AddressInternalTransactionConfirmed', function() {
    it('should create an instance of AddressInternalTransactionConfirmed', function() {
      // uncomment below and update the code to test AddressInternalTransactionConfirmed
      //var instance = new Cryptoapis.AddressInternalTransactionConfirmed();
      //expect(instance).to.be.a(Cryptoapis.AddressInternalTransactionConfirmed);
    });
