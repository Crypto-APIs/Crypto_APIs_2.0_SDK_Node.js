...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSZVJoinSplitInner();
  });
  ...
  describe('ListTransactionsByBlockHeightRIBSZVJoinSplitInner', function() {
    it('should create an instance of ListTransactionsByBlockHeightRIBSZVJoinSplitInner', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightRIBSZVJoinSplitInner
      //var instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSZVJoinSplitInner();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHeightRIBSZVJoinSplitInner);
    });
