...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSBVinInner);
    });
