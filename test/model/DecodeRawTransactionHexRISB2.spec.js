...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISB2();
  });
  ...
  describe('DecodeRawTransactionHexRISB2', function() {
    it('should create an instance of DecodeRawTransactionHexRISB2', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISB2
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISB2();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISB2);
    });
