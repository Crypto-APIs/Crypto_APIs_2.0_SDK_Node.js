...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSEC();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSEC', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSEC', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSEC
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSEC();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSEC);
    });
