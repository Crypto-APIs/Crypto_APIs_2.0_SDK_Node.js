...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListAssetsDetailsResponseItem();
  });
  ...
  describe('ListAssetsDetailsResponseItem', function() {
    it('should create an instance of ListAssetsDetailsResponseItem', function() {
      // uncomment below and update the code to test ListAssetsDetailsResponseItem
      //var instane = new CryptoApis.ListAssetsDetailsResponseItem();
      //expect(instance).to.be.a(CryptoApis.ListAssetsDetailsResponseItem);
    });
    ...
    it('should have the property assetId (base name: "assetId")', function() {
      ...
      //var instance = new CryptoApis.ListAssetsDetailsResponseItem();
