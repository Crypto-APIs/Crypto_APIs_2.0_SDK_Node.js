...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListLatestMinedBlocksRIBSD2();
  });
  ...
  describe('ListLatestMinedBlocksRIBSD2', function() {
    it('should create an instance of ListLatestMinedBlocksRIBSD2', function() {
      // uncomment below and update the code to test ListLatestMinedBlocksRIBSD2
      //var instance = new Cryptoapis.ListLatestMinedBlocksRIBSD2();
      //expect(instance).to.be.a(Cryptoapis.ListLatestMinedBlocksRIBSD2);
    });
