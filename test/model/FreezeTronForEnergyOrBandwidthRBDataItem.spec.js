...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.FreezeTronForEnergyOrBandwidthRBDataItem();
  });
  ...
  describe('FreezeTronForEnergyOrBandwidthRBDataItem', function() {
    it('should create an instance of FreezeTronForEnergyOrBandwidthRBDataItem', function() {
      // uncomment below and update the code to test FreezeTronForEnergyOrBandwidthRBDataItem
      //var instance = new Cryptoapis.FreezeTronForEnergyOrBandwidthRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.FreezeTronForEnergyOrBandwidthRBDataItem);
    });
