...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSL();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSL', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSL', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSL
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSL();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSL);
    });
