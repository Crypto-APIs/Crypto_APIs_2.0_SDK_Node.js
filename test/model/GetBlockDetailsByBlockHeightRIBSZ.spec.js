...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightRIBSZ();
  });
  ...
  describe('GetBlockDetailsByBlockHeightRIBSZ', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightRIBSZ', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightRIBSZ
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightRIBSZ();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightRIBSZ);
    });
