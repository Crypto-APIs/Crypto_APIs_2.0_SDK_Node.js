...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetBlockDetailsByBlockHeightResponseItem();
  });
  ...
  describe('GetBlockDetailsByBlockHeightResponseItem', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightResponseItem', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightResponseItem
      //var instane = new CryptoApis.GetBlockDetailsByBlockHeightResponseItem();
      //expect(instance).to.be.a(CryptoApis.GetBlockDetailsByBlockHeightResponseItem);
    });

    it('should have the property hash (base name: "hash")', function() {
      // uncomment below and update the code to test the property hash
      //var instance = new CryptoApis.GetBlockDetailsByBlockHeightResponseItem();
