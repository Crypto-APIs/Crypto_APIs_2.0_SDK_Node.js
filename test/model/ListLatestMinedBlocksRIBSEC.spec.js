...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListLatestMinedBlocksRIBSEC();
  });
  ...
  describe('ListLatestMinedBlocksRIBSEC', function() {
    it('should create an instance of ListLatestMinedBlocksRIBSEC', function() {
      // uncomment below and update the code to test ListLatestMinedBlocksRIBSEC
      //var instance = new Cryptoapis.ListLatestMinedBlocksRIBSEC();
      //expect(instance).to.be.a(Cryptoapis.ListLatestMinedBlocksRIBSEC);
    });
