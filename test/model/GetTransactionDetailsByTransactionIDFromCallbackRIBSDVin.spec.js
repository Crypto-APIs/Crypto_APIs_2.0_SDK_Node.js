...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSDVin();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDFromCallbackRIBSDVin', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSDVin', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDFromCallbackRIBSDVin
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSDVin();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSDVin);
    });
