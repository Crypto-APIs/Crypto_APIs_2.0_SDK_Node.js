...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAssetsDetailsRISpecificDataCryptoTypeData();
  });
  ...
  describe('ListAssetsDetailsRISpecificDataCryptoTypeData', function() {
    it('should create an instance of ListAssetsDetailsRISpecificDataCryptoTypeData', function() {
      // uncomment below and update the code to test ListAssetsDetailsRISpecificDataCryptoTypeData
      //var instane = new Cryptoapis.ListAssetsDetailsRISpecificDataCryptoTypeData();
      //expect(instance).to.be.a(Cryptoapis.ListAssetsDetailsRISpecificDataCryptoTypeData);
    });
    ...
    it('should have the property _1hourPriceChangeInPercentage (base name: "1HourPriceChangeInPercentage")', function() {
      ...
      //var instance = new Cryptoapis.ListAssetsDetailsRISpecificDataCryptoTypeData();
