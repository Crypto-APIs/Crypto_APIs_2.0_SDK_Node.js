...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBS();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBS', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBS', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBS
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBS();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBS);
    });
