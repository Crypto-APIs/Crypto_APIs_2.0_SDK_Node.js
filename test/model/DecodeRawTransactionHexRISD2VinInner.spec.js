...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISD2VinInner();
  });
  ...
  describe('DecodeRawTransactionHexRISD2VinInner', function() {
    it('should create an instance of DecodeRawTransactionHexRISD2VinInner', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISD2VinInner
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISD2VinInner();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISD2VinInner);
    });
