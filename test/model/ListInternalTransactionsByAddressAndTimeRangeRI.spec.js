...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListInternalTransactionsByAddressAndTimeRangeRI();
  });
  ...
  describe('ListInternalTransactionsByAddressAndTimeRangeRI', function() {
    it('should create an instance of ListInternalTransactionsByAddressAndTimeRangeRI', function() {
      // uncomment below and update the code to test ListInternalTransactionsByAddressAndTimeRangeRI
      //var instance = new Cryptoapis.ListInternalTransactionsByAddressAndTimeRangeRI();
      //expect(instance).to.be.a(Cryptoapis.ListInternalTransactionsByAddressAndTimeRangeRI);
    });
