...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.AddressInternalTransactionConfirmedEachConfirmationDataItem();
  });
  ...
  describe('AddressInternalTransactionConfirmedEachConfirmationDataItem', function() {
    it('should create an instance of AddressInternalTransactionConfirmedEachConfirmationDataItem', function() {
      // uncomment below and update the code to test AddressInternalTransactionConfirmedEachConfirmationDataItem
      //var instance = new Cryptoapis.AddressInternalTransactionConfirmedEachConfirmationDataItem();
      //expect(instance).to.be.a(Cryptoapis.AddressInternalTransactionConfirmedEachConfirmationDataItem);
    });
