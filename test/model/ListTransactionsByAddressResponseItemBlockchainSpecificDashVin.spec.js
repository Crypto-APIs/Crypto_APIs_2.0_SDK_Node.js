...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificDashVin();
  });
  ...
  describe('ListTransactionsByAddressResponseItemBlockchainSpecificDashVin', function() {
    it('should create an instance of ListTransactionsByAddressResponseItemBlockchainSpecificDashVin', function() {
      // uncomment below and update the code to test ListTransactionsByAddressResponseItemBlockchainSpecificDashVin
      //var instane = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificDashVin();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificDashVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificDashVin();
