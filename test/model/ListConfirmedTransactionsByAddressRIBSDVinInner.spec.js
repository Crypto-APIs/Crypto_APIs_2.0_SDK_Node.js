...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSDVinInner();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSDVinInner', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSDVinInner', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSDVinInner
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSDVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSDVinInner);
    });
