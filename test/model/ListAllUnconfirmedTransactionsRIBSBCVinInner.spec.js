...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSBCVinInner();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSBCVinInner', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSBCVinInner', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSBCVinInner
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSBCVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSBCVinInner);
    });
