...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereumClassic();
  });
  ...
  describe('ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereumClassic', function() {
    it('should create an instance of ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereumClassic', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereumClassic
      //var instane = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereumClassic();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereumClassic);
    });
    ...
    it('should have the property contract (base name: "contract")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificEthereumClassic();
