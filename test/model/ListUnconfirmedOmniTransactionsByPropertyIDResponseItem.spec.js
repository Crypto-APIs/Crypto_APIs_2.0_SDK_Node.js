...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListUnconfirmedOmniTransactionsByPropertyIDResponseItem();
  });
  ...
  describe('ListUnconfirmedOmniTransactionsByPropertyIDResponseItem', function() {
    it('should create an instance of ListUnconfirmedOmniTransactionsByPropertyIDResponseItem', function() {
      // uncomment below and update the code to test ListUnconfirmedOmniTransactionsByPropertyIDResponseItem
      //var instane = new CryptoApis.ListUnconfirmedOmniTransactionsByPropertyIDResponseItem();
      //expect(instance).to.be.a(CryptoApis.ListUnconfirmedOmniTransactionsByPropertyIDResponseItem);
    });

    it('should have the property amount (base name: "amount")', function() {
      // uncomment below and update the code to test the property amount
      //var instance = new CryptoApis.ListUnconfirmedOmniTransactionsByPropertyIDResponseItem();
    ...
    it('should have the property typeIint (base name: "typeIint")', function() {
      // uncomment below and update the code to test the property typeIint
      //var instance = new CryptoApis.ListUnconfirmedOmniTransactionsByPropertyIDResponseItem();
      //expect(instance).to.be();
    });
