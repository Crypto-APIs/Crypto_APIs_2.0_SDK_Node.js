...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSE();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSE', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSE', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSE
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSE();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSE);
    });
