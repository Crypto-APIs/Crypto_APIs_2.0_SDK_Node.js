...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHashRIBSZVinInner();
  });
  ...
  describe('ListTransactionsByBlockHashRIBSZVinInner', function() {
    it('should create an instance of ListTransactionsByBlockHashRIBSZVinInner', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashRIBSZVinInner
      //var instance = new Cryptoapis.ListTransactionsByBlockHashRIBSZVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHashRIBSZVinInner);
    });
