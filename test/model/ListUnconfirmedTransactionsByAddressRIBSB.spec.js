...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSB();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSB', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSB', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSB
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSB();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSB);
    });
