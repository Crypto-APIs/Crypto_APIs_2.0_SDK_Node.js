...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetBlockDetailsByBlockHashResponseItem();
  });
  ...
  describe('GetBlockDetailsByBlockHashResponseItem', function() {
    it('should create an instance of GetBlockDetailsByBlockHashResponseItem', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashResponseItem
      //var instane = new CryptoApis.GetBlockDetailsByBlockHashResponseItem();
      //expect(instance).to.be.a(CryptoApis.GetBlockDetailsByBlockHashResponseItem);
    });

    it('should have the property hash (base name: "hash")', function() {
      // uncomment below and update the code to test the property hash
      //var instance = new CryptoApis.GetBlockDetailsByBlockHashResponseItem();
