...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTokensTransfersByAddressAndTimeRangeRI();
  });
  ...
  describe('ListConfirmedTokensTransfersByAddressAndTimeRangeRI', function() {
    it('should create an instance of ListConfirmedTokensTransfersByAddressAndTimeRangeRI', function() {
      // uncomment below and update the code to test ListConfirmedTokensTransfersByAddressAndTimeRangeRI
      //var instance = new Cryptoapis.ListConfirmedTokensTransfersByAddressAndTimeRangeRI();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTokensTransfersByAddressAndTimeRangeRI);
    });
