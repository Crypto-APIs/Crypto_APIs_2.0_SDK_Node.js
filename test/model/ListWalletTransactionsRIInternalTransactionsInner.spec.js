...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListWalletTransactionsRIInternalTransactionsInner();
  });
  ...
  describe('ListWalletTransactionsRIInternalTransactionsInner', function() {
    it('should create an instance of ListWalletTransactionsRIInternalTransactionsInner', function() {
      // uncomment below and update the code to test ListWalletTransactionsRIInternalTransactionsInner
      //var instance = new Cryptoapis.ListWalletTransactionsRIInternalTransactionsInner();
      //expect(instance).to.be.a(Cryptoapis.ListWalletTransactionsRIInternalTransactionsInner);
    });
