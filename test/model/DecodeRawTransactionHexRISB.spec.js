...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISB();
  });
  ...
  describe('DecodeRawTransactionHexRISB', function() {
    it('should create an instance of DecodeRawTransactionHexRISB', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISB
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISB();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISB);
    });
