...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSD2Vin();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSD2Vin', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSD2Vin', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSD2Vin
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSD2Vin();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSD2Vin);
    });
