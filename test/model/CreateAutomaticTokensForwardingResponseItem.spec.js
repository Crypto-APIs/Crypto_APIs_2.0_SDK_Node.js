...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.CreateAutomaticTokensForwardingResponseItem();
  });
  ...
  describe('CreateAutomaticTokensForwardingResponseItem', function() {
    it('should create an instance of CreateAutomaticTokensForwardingResponseItem', function() {
      // uncomment below and update the code to test CreateAutomaticTokensForwardingResponseItem
      //var instane = new CryptoApis.CreateAutomaticTokensForwardingResponseItem();
      //expect(instance).to.be.a(CryptoApis.CreateAutomaticTokensForwardingResponseItem);
    });
    ...
    it('should have the property callbackUrl (base name: "callbackUrl")', function() {
      ...
      //var instance = new CryptoApis.CreateAutomaticTokensForwardingResponseItem();
