...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISZVin();
  });
  ...
  describe('DecodeRawTransactionHexRISZVin', function() {
    it('should create an instance of DecodeRawTransactionHexRISZVin', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISZVin
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISZVin();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISZVin);
    });
