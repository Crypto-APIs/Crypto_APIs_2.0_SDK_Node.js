...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSBCVin();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSBCVin', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSBCVin', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSBCVin
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSBCVin();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSBCVin);
    });
