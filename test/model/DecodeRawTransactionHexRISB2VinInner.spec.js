...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISB2VinInner();
  });
  ...
  describe('DecodeRawTransactionHexRISB2VinInner', function() {
    it('should create an instance of DecodeRawTransactionHexRISB2VinInner', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISB2VinInner
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISB2VinInner();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISB2VinInner);
    });
