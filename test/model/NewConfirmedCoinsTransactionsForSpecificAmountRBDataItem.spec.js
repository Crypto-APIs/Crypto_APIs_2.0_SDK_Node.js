...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem();
  });
  ...
  describe('NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem', function() {
    it('should create an instance of NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem', function() {
      // uncomment below and update the code to test NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem
      //var instance = new Cryptoapis.NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem);
    });
