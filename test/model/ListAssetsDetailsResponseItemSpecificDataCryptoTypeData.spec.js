...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListAssetsDetailsResponseItemSpecificDataCryptoTypeData();
  });
  ...
  describe('ListAssetsDetailsResponseItemSpecificDataCryptoTypeData', function() {
    it('should create an instance of ListAssetsDetailsResponseItemSpecificDataCryptoTypeData', function() {
      // uncomment below and update the code to test ListAssetsDetailsResponseItemSpecificDataCryptoTypeData
      //var instane = new CryptoApis.ListAssetsDetailsResponseItemSpecificDataCryptoTypeData();
      //expect(instance).to.be.a(CryptoApis.ListAssetsDetailsResponseItemSpecificDataCryptoTypeData);
    });
    ...
    it('should have the property _1hourPriceChangeInPercentage (base name: "1HourPriceChangeInPercentage")', function() {
      ...
      //var instance = new CryptoApis.ListAssetsDetailsResponseItemSpecificDataCryptoTypeData();
