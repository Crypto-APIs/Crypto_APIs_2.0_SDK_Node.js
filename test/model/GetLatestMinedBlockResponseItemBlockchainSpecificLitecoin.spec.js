...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin();
  });
  ...
  describe('GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin', function() {
    it('should create an instance of GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin', function() {
      // uncomment below and update the code to test GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin
      //var instane = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin();
      //expect(instance).to.be.a(CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin();
