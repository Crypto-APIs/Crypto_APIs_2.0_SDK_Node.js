...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllAssetsFromAllWalletsRICoinsInner();
  });
  ...
  describe('ListAllAssetsFromAllWalletsRICoinsInner', function() {
    it('should create an instance of ListAllAssetsFromAllWalletsRICoinsInner', function() {
      // uncomment below and update the code to test ListAllAssetsFromAllWalletsRICoinsInner
      //var instance = new Cryptoapis.ListAllAssetsFromAllWalletsRICoinsInner();
      //expect(instance).to.be.a(Cryptoapis.ListAllAssetsFromAllWalletsRICoinsInner);
    });
