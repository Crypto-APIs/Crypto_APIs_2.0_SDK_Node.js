...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLastMinedBlockRIBSE();
  });
  ...
  describe('GetLastMinedBlockRIBSE', function() {
    it('should create an instance of GetLastMinedBlockRIBSE', function() {
      // uncomment below and update the code to test GetLastMinedBlockRIBSE
      //var instance = new Cryptoapis.GetLastMinedBlockRIBSE();
      //expect(instance).to.be.a(Cryptoapis.GetLastMinedBlockRIBSE);
    });
