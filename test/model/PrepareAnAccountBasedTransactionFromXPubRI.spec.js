...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareAnAccountBasedTransactionFromXPubRI();
  });
  ...
  describe('PrepareAnAccountBasedTransactionFromXPubRI', function() {
    it('should create an instance of PrepareAnAccountBasedTransactionFromXPubRI', function() {
      // uncomment below and update the code to test PrepareAnAccountBasedTransactionFromXPubRI
      //var instance = new Cryptoapis.PrepareAnAccountBasedTransactionFromXPubRI();
      //expect(instance).to.be.a(Cryptoapis.PrepareAnAccountBasedTransactionFromXPubRI);
    });
