...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListLatestMinedBlocksRIBSBSC();
  });
  ...
  describe('ListLatestMinedBlocksRIBSBSC', function() {
    it('should create an instance of ListLatestMinedBlocksRIBSBSC', function() {
      // uncomment below and update the code to test ListLatestMinedBlocksRIBSBSC
