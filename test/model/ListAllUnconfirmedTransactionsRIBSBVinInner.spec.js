...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSBVinInner();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSBVinInner', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSBVinInner', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSBVinInner
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSBVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSBVinInner);
    });
