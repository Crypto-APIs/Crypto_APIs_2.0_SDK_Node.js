...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTokensTransfersByTransactionHashResponseItem();
  });
  ...
  describe('ListTokensTransfersByTransactionHashResponseItem', function() {
    it('should create an instance of ListTokensTransfersByTransactionHashResponseItem', function() {
      // uncomment below and update the code to test ListTokensTransfersByTransactionHashResponseItem
      //var instane = new CryptoApis.ListTokensTransfersByTransactionHashResponseItem();
      //expect(instance).to.be.a(CryptoApis.ListTokensTransfersByTransactionHashResponseItem);
    });
    ...
    it('should have the property contractAddress (base name: "contractAddress")', function() {
      ...
      //var instance = new CryptoApis.ListTokensTransfersByTransactionHashResponseItem();
