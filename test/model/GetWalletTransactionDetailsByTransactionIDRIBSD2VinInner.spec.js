...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner);
    });
