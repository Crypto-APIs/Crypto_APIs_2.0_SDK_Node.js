...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSZ();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSZ', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSZ', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSZ
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSZ();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSZ);
    });
