...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBST();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDFromCallbackRIBST', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBST', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDFromCallbackRIBST
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBST();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBST);
    });
