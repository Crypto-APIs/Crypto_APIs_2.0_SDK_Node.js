...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic();
  });
  ...
  describe('GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic', function() {
    it('should create an instance of GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic', function() {
      // uncomment below and update the code to test GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic
      //var instane = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic();
      //expect(instance).to.be.a(CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic();
