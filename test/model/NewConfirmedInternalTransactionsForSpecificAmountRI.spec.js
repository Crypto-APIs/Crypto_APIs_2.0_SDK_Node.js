...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.NewConfirmedInternalTransactionsForSpecificAmountRI();
  });
  ...
  describe('NewConfirmedInternalTransactionsForSpecificAmountRI', function() {
    it('should create an instance of NewConfirmedInternalTransactionsForSpecificAmountRI', function() {
      // uncomment below and update the code to test NewConfirmedInternalTransactionsForSpecificAmountRI
      //var instance = new Cryptoapis.NewConfirmedInternalTransactionsForSpecificAmountRI();
      //expect(instance).to.be.a(Cryptoapis.NewConfirmedInternalTransactionsForSpecificAmountRI);
    });
