...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.BlockHeightReached();
  });
  ...
  describe('BlockHeightReached', function() {
    it('should create an instance of BlockHeightReached', function() {
      // uncomment below and update the code to test BlockHeightReached
      //var instance = new Cryptoapis.BlockHeightReached();
      //expect(instance).to.be.a(Cryptoapis.BlockHeightReached);
    });
