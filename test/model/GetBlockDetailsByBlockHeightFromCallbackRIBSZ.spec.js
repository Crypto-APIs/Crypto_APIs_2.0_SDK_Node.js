...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSZ();
  });
  ...
  describe('GetBlockDetailsByBlockHeightFromCallbackRIBSZ', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSZ', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightFromCallbackRIBSZ
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSZ();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSZ);
    });
