...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin();
  });
  ...
  describe('ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin', function() {
    it('should create an instance of ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin
      //var instane = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificLitecoinVin();
