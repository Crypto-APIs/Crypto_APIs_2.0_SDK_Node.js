...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSBVinInner();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSBVinInner', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSBVinInner', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSBVinInner
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSBVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSBVinInner);
    });
