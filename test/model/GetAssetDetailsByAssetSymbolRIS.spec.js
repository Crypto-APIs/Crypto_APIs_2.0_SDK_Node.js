...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetAssetDetailsByAssetSymbolRIS();
  });
  ...
  describe('GetAssetDetailsByAssetSymbolRIS', function() {
    it('should create an instance of GetAssetDetailsByAssetSymbolRIS', function() {
      // uncomment below and update the code to test GetAssetDetailsByAssetSymbolRIS
      //var instance = new Cryptoapis.GetAssetDetailsByAssetSymbolRIS();
      //expect(instance).to.be.a(Cryptoapis.GetAssetDetailsByAssetSymbolRIS);
    });
