...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin();
  });
  ...
  describe('ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin', function() {
    it('should create an instance of ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin
      //var instane = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecificDashVin();
