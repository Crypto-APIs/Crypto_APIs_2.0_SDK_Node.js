...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSDVin();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSDVin', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSDVin', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSDVin
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSDVin();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSDVin);
    });
