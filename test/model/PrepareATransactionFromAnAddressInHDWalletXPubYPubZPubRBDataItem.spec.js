...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBDataItem();
  });
  ...
  describe('PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBDataItem', function() {
    it('should create an instance of PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBDataItem', function() {
      // uncomment below and update the code to test PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBDataItem
      //var instance = new Cryptoapis.PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRBDataItem);
    });
