...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLatestMinedBlockRIBSEC();
  });
  ...
  describe('GetLatestMinedBlockRIBSEC', function() {
    it('should create an instance of GetLatestMinedBlockRIBSEC', function() {
      // uncomment below and update the code to test GetLatestMinedBlockRIBSEC
      //var instane = new Cryptoapis.GetLatestMinedBlockRIBSEC();
      //expect(instance).to.be.a(Cryptoapis.GetLatestMinedBlockRIBSEC);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new Cryptoapis.GetLatestMinedBlockRIBSEC();
