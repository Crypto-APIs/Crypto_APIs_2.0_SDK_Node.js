...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSZVJoinSplit();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDRIBSZVJoinSplit', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDRIBSZVJoinSplit', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDRIBSZVJoinSplit
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSZVJoinSplit();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDRIBSZVJoinSplit);
    });
