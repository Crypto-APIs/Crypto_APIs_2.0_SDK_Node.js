...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinVin();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinVin', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinVin', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinVin
      //var instane = new CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinVin();
      //expect(instance).to.be.a(CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificBitcoinVin();
