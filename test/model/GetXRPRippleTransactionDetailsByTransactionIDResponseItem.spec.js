...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetXRPRippleTransactionDetailsByTransactionIDResponseItem();
  });
  ...
  describe('GetXRPRippleTransactionDetailsByTransactionIDResponseItem', function() {
    it('should create an instance of GetXRPRippleTransactionDetailsByTransactionIDResponseItem', function() {
      // uncomment below and update the code to test GetXRPRippleTransactionDetailsByTransactionIDResponseItem
      //var instane = new CryptoApis.GetXRPRippleTransactionDetailsByTransactionIDResponseItem();
      //expect(instance).to.be.a(CryptoApis.GetXRPRippleTransactionDetailsByTransactionIDResponseItem);
    });
    ...
    it('should have the property additionalData (base name: "additionalData")', function() {
      ...
      //var instance = new CryptoApis.GetXRPRippleTransactionDetailsByTransactionIDResponseItem();
