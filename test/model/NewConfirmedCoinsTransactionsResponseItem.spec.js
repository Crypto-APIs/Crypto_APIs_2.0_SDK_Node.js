...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.NewConfirmedCoinsTransactionsResponseItem();
  });
  ...
  describe('NewConfirmedCoinsTransactionsResponseItem', function() {
    it('should create an instance of NewConfirmedCoinsTransactionsResponseItem', function() {
      // uncomment below and update the code to test NewConfirmedCoinsTransactionsResponseItem
      //var instane = new CryptoApis.NewConfirmedCoinsTransactionsResponseItem();
      //expect(instance).to.be.a(CryptoApis.NewConfirmedCoinsTransactionsResponseItem);
    });

    it('should have the property address (base name: "address")', function() {
      // uncomment below and update the code to test the property address
      //var instance = new CryptoApis.NewConfirmedCoinsTransactionsResponseItem();
