...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSBVin();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSBVin', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSBVin', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSBVin
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSBVin();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSBVin);
    });
