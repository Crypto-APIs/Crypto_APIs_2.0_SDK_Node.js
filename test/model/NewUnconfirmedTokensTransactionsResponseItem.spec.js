...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.NewUnconfirmedTokensTransactionsResponseItem();
  });
  ...
  describe('NewUnconfirmedTokensTransactionsResponseItem', function() {
    it('should create an instance of NewUnconfirmedTokensTransactionsResponseItem', function() {
      // uncomment below and update the code to test NewUnconfirmedTokensTransactionsResponseItem
      //var instane = new CryptoApis.NewUnconfirmedTokensTransactionsResponseItem();
      //expect(instance).to.be.a(CryptoApis.NewUnconfirmedTokensTransactionsResponseItem);
    });

    it('should have the property address (base name: "address")', function() {
      // uncomment below and update the code to test the property address
      //var instance = new CryptoApis.NewUnconfirmedTokensTransactionsResponseItem();
