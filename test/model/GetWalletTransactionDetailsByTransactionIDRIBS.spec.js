...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBS();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBS', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBS', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBS
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBS();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBS);
    });
