...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.AddTokensToExistingFromAddressResponseItem();
  });
  ...
  describe('AddTokensToExistingFromAddressResponseItem', function() {
    it('should create an instance of AddTokensToExistingFromAddressResponseItem', function() {
      // uncomment below and update the code to test AddTokensToExistingFromAddressResponseItem
      //var instane = new CryptoApis.AddTokensToExistingFromAddressResponseItem();
      //expect(instance).to.be.a(CryptoApis.AddTokensToExistingFromAddressResponseItem);
    });
    ...
    it('should have the property callbackUrl (base name: "callbackUrl")', function() {
      ...
      //var instance = new CryptoApis.AddTokensToExistingFromAddressResponseItem();
