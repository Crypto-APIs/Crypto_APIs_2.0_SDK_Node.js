...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashRIBSZ2();
  });
  ...
  describe('GetBlockDetailsByBlockHashRIBSZ2', function() {
    it('should create an instance of GetBlockDetailsByBlockHashRIBSZ2', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashRIBSZ2
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashRIBSZ2();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashRIBSZ2);
    });
