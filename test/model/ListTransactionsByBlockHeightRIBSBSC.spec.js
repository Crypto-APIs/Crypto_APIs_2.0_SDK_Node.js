...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSBSC();
  });
  ...
  describe('ListTransactionsByBlockHeightRIBSBSC', function() {
    it('should create an instance of ListTransactionsByBlockHeightRIBSBSC', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightRIBSBSC
      //var instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSBSC();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHeightRIBSBSC);
    });
