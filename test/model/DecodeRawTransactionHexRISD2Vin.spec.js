...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISD2Vin();
  });
  ...
  describe('DecodeRawTransactionHexRISD2Vin', function() {
    it('should create an instance of DecodeRawTransactionHexRISD2Vin', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISD2Vin
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISD2Vin();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISD2Vin);
    });
