...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllAssetsFromAllWalletsRI();
  });
  ...
  describe('ListAllAssetsFromAllWalletsRI', function() {
    it('should create an instance of ListAllAssetsFromAllWalletsRI', function() {
      // uncomment below and update the code to test ListAllAssetsFromAllWalletsRI
      //var instance = new Cryptoapis.ListAllAssetsFromAllWalletsRI();
      //expect(instance).to.be.a(Cryptoapis.ListAllAssetsFromAllWalletsRI);
    });
