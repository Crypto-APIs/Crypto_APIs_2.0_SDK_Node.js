...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificDash();
  });
  ...
  describe('GetLatestMinedBlockResponseItemBlockchainSpecificDash', function() {
    it('should create an instance of GetLatestMinedBlockResponseItemBlockchainSpecificDash', function() {
      // uncomment below and update the code to test GetLatestMinedBlockResponseItemBlockchainSpecificDash
      //var instane = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificDash();
      //expect(instance).to.be.a(CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificDash);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificDash();
