...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSE();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSE', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSE', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSE
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSE();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSE);
    });
