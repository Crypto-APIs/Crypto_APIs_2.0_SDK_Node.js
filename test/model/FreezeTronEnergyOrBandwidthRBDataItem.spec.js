...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.FreezeTronEnergyOrBandwidthRBDataItem();
  });
  ...
  describe('FreezeTronEnergyOrBandwidthRBDataItem', function() {
    it('should create an instance of FreezeTronEnergyOrBandwidthRBDataItem', function() {
      // uncomment below and update the code to test FreezeTronEnergyOrBandwidthRBDataItem
      //var instance = new Cryptoapis.FreezeTronEnergyOrBandwidthRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.FreezeTronEnergyOrBandwidthRBDataItem);
    });
