...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSLVinInner();
  });
  ...
  describe('ListTransactionsByBlockHeightRIBSLVinInner', function() {
    it('should create an instance of ListTransactionsByBlockHeightRIBSLVinInner', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightRIBSLVinInner
      //var instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSLVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHeightRIBSLVinInner);
    });
