...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListLatestMinedBlocksRIBSBC();
  });
  ...
  describe('ListLatestMinedBlocksRIBSBC', function() {
    it('should create an instance of ListLatestMinedBlocksRIBSBC', function() {
      // uncomment below and update the code to test ListLatestMinedBlocksRIBSBC
      //var instance = new Cryptoapis.ListLatestMinedBlocksRIBSBC();
      //expect(instance).to.be.a(Cryptoapis.ListLatestMinedBlocksRIBSBC);
    });
