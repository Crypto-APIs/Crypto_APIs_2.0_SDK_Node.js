...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListUnconfirmedOmniTransactionsByAddressResponseItem();
  });
  ...
  describe('ListUnconfirmedOmniTransactionsByAddressResponseItem', function() {
    it('should create an instance of ListUnconfirmedOmniTransactionsByAddressResponseItem', function() {
      // uncomment below and update the code to test ListUnconfirmedOmniTransactionsByAddressResponseItem
      //var instane = new CryptoApis.ListUnconfirmedOmniTransactionsByAddressResponseItem();
      //expect(instance).to.be.a(CryptoApis.ListUnconfirmedOmniTransactionsByAddressResponseItem);
    });

    it('should have the property amount (base name: "amount")', function() {
      // uncomment below and update the code to test the property amount
      //var instance = new CryptoApis.ListUnconfirmedOmniTransactionsByAddressResponseItem();
