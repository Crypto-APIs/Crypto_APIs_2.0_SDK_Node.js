...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSB();
  });
  ...
  describe('GetBlockDetailsByBlockHeightFromCallbackRIBSB', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSB', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightFromCallbackRIBSB
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSB();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSB);
    });
