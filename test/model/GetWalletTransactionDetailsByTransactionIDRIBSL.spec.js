...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSL();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSL', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSL', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSL
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSL();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSL);
    });
