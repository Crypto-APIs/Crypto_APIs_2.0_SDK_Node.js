...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRI();
  });
  ...
  describe('GetBlockDetailsByBlockHashFromCallbackRI', function() {
    it('should create an instance of GetBlockDetailsByBlockHashFromCallbackRI', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashFromCallbackRI
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRI();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRI);
    });
