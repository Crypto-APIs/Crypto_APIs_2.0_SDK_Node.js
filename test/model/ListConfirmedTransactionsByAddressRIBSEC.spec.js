...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSEC();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSEC', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSEC', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSEC
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSEC();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSEC);
    });
