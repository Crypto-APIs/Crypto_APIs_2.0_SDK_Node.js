...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHashRIBSZVin();
  });
  ...
  describe('ListTransactionsByBlockHashRIBSZVin', function() {
    it('should create an instance of ListTransactionsByBlockHashRIBSZVin', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashRIBSZVin
      //var instance = new Cryptoapis.ListTransactionsByBlockHashRIBSZVin();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHashRIBSZVin);
    });
