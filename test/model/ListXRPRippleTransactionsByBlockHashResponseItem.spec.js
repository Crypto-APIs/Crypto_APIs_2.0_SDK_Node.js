...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListXRPRippleTransactionsByBlockHashResponseItem();
  });
  ...
  describe('ListXRPRippleTransactionsByBlockHashResponseItem', function() {
    it('should create an instance of ListXRPRippleTransactionsByBlockHashResponseItem', function() {
      // uncomment below and update the code to test ListXRPRippleTransactionsByBlockHashResponseItem
      //var instane = new CryptoApis.ListXRPRippleTransactionsByBlockHashResponseItem();
      //expect(instance).to.be.a(CryptoApis.ListXRPRippleTransactionsByBlockHashResponseItem);
    });
    ...
    it('should have the property additionalData (base name: "additionalData")', function() {
      ...
      //var instance = new CryptoApis.ListXRPRippleTransactionsByBlockHashResponseItem();
