...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSZ2();
  });
  ...
  describe('GetBlockDetailsByBlockHeightFromCallbackRIBSZ2', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSZ2', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightFromCallbackRIBSZ2
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSZ2();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSZ2);
    });
