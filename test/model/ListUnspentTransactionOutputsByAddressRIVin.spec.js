...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnspentTransactionOutputsByAddressRIVin();
  });
  ...
  describe('ListUnspentTransactionOutputsByAddressRIVin', function() {
    it('should create an instance of ListUnspentTransactionOutputsByAddressRIVin', function() {
      // uncomment below and update the code to test ListUnspentTransactionOutputsByAddressRIVin
      //var instance = new Cryptoapis.ListUnspentTransactionOutputsByAddressRIVin();
      //expect(instance).to.be.a(Cryptoapis.ListUnspentTransactionOutputsByAddressRIVin);
    });
