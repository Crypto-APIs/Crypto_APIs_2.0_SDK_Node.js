...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareTransactionFromAddressRBDataItem();
  });
  ...
  describe('PrepareTransactionFromAddressRBDataItem', function() {
    it('should create an instance of PrepareTransactionFromAddressRBDataItem', function() {
      // uncomment below and update the code to test PrepareTransactionFromAddressRBDataItem
      //var instance = new Cryptoapis.PrepareTransactionFromAddressRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.PrepareTransactionFromAddressRBDataItem);
    });
