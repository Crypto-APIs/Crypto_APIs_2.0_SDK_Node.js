...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSBCVinInner);
    });
