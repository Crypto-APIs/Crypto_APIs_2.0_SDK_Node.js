...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin();
  });
  ...
  describe('GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin', function() {
    it('should create an instance of GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin', function() {
      // uncomment below and update the code to test GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin
      //var instane = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin();
      //expect(instance).to.be.a(CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin();
