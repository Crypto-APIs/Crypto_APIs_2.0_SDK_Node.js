...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRI();
  });
  ...
  describe('GetBlockDetailsByBlockHeightFromCallbackRI', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightFromCallbackRI', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightFromCallbackRI
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRI();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRI);
    });
