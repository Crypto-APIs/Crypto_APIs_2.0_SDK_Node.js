...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetAssetDetailsByAssetIDRISC();
  });
  ...
  describe('GetAssetDetailsByAssetIDRISC', function() {
    it('should create an instance of GetAssetDetailsByAssetIDRISC', function() {
      // uncomment below and update the code to test GetAssetDetailsByAssetIDRISC
      //var instance = new Cryptoapis.GetAssetDetailsByAssetIDRISC();
      //expect(instance).to.be.a(Cryptoapis.GetAssetDetailsByAssetIDRISC);
    });
