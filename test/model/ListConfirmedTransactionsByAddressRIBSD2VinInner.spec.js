...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSD2VinInner();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSD2VinInner', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSD2VinInner', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSD2VinInner
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSD2VinInner();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSD2VinInner);
    });
