...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLastMinedBlockRIBSZ2();
  });
  ...
  describe('GetLastMinedBlockRIBSZ2', function() {
    it('should create an instance of GetLastMinedBlockRIBSZ2', function() {
      // uncomment below and update the code to test GetLastMinedBlockRIBSZ2
      //var instance = new Cryptoapis.GetLastMinedBlockRIBSZ2();
      //expect(instance).to.be.a(Cryptoapis.GetLastMinedBlockRIBSZ2);
    });
