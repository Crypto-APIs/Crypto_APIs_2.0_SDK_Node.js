...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner);
    });
