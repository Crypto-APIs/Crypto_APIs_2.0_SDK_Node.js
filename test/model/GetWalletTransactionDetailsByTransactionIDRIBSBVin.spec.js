...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSBVin();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSBVin', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSBVin', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSBVin
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSBVin();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSBVin);
    });
