...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.MinedTransactionResponseItem();
  });
  ...
  describe('MinedTransactionResponseItem', function() {
    it('should create an instance of MinedTransactionResponseItem', function() {
      // uncomment below and update the code to test MinedTransactionResponseItem
      //var instane = new CryptoApis.MinedTransactionResponseItem();
      //expect(instance).to.be.a(CryptoApis.MinedTransactionResponseItem);
    });

    it('should have the property address (base name: "address")', function() {
      // uncomment below and update the code to test the property address
      //var instance = new CryptoApis.MinedTransactionResponseItem();
