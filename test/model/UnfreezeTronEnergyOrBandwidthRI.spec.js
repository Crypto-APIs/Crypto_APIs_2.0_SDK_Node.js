...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.UnfreezeTronEnergyOrBandwidthRI();
  });
  ...
  describe('UnfreezeTronEnergyOrBandwidthRI', function() {
    it('should create an instance of UnfreezeTronEnergyOrBandwidthRI', function() {
      // uncomment below and update the code to test UnfreezeTronEnergyOrBandwidthRI
      //var instance = new Cryptoapis.UnfreezeTronEnergyOrBandwidthRI();
      //expect(instance).to.be.a(Cryptoapis.UnfreezeTronEnergyOrBandwidthRI);
    });
