...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash();
  });
  ...
  describe('GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash
      //var instane = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash();
      //expect(instance).to.be.a(CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificDash();
