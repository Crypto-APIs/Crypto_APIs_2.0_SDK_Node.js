...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHashRIBSBCVinInner();
  });
  ...
  describe('ListTransactionsByBlockHashRIBSBCVinInner', function() {
    it('should create an instance of ListTransactionsByBlockHashRIBSBCVinInner', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashRIBSBCVinInner
      //var instance = new Cryptoapis.ListTransactionsByBlockHashRIBSBCVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHashRIBSBCVinInner);
    });
