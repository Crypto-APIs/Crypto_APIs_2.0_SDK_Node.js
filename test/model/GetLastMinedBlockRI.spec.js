...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLastMinedBlockRI();
  });
  ...
  describe('GetLastMinedBlockRI', function() {
    it('should create an instance of GetLastMinedBlockRI', function() {
      // uncomment below and update the code to test GetLastMinedBlockRI
      //var instance = new Cryptoapis.GetLastMinedBlockRI();
      //expect(instance).to.be.a(Cryptoapis.GetLastMinedBlockRI);
    });
