...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllAssetsFromAllWalletsRICoins();
  });
  ...
  describe('ListAllAssetsFromAllWalletsRICoins', function() {
    it('should create an instance of ListAllAssetsFromAllWalletsRICoins', function() {
      // uncomment below and update the code to test ListAllAssetsFromAllWalletsRICoins
      //var instance = new Cryptoapis.ListAllAssetsFromAllWalletsRICoins();
      //expect(instance).to.be.a(Cryptoapis.ListAllAssetsFromAllWalletsRICoins);
    });
