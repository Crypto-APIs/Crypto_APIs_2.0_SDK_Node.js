...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSBSC);
    });
