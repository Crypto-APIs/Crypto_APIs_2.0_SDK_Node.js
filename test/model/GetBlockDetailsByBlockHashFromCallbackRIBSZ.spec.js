...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSZ();
  });
  ...
  describe('GetBlockDetailsByBlockHashFromCallbackRIBSZ', function() {
    it('should create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSZ', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashFromCallbackRIBSZ
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSZ();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSZ);
    });
