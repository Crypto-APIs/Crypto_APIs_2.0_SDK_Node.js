...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash();
  });
  ...
  describe('GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash', function() {
    it('should create an instance of GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash', function() {
      // uncomment below and update the code to test GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash
      //var instane = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash();
      //expect(instance).to.be.a(CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash();
