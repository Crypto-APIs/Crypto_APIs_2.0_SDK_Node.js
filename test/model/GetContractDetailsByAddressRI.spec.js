...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetContractDetailsByAddressRI();
  });
  ...
  describe('GetContractDetailsByAddressRI', function() {
    it('should create an instance of GetContractDetailsByAddressRI', function() {
      // uncomment below and update the code to test GetContractDetailsByAddressRI
      //var instane = new Cryptoapis.GetContractDetailsByAddressRI();
      //expect(instance).to.be.a(Cryptoapis.GetContractDetailsByAddressRI);
    });
    ...
    it('should have the property tokenDecimals (base name: "tokenDecimals")', function() {
      ...
      //var instance = new Cryptoapis.GetContractDetailsByAddressRI();
