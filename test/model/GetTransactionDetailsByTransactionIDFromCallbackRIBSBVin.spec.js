...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSBVin);
    });
