...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSLScriptPubKey();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSLScriptPubKey', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSLScriptPubKey', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSLScriptPubKey
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSLScriptPubKey();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSLScriptPubKey);
    });
