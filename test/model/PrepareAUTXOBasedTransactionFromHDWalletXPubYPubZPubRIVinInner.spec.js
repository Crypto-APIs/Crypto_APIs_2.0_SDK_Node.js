...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIVinInner();
  });
  ...
  describe('PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIVinInner', function() {
    it('should create an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIVinInner', function() {
      // uncomment below and update the code to test PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIVinInner
      //var instance = new Cryptoapis.PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIVinInner();
      //expect(instance).to.be.a(Cryptoapis.PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIVinInner);
    });
