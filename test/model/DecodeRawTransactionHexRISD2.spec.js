...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISD2();
  });
  ...
  describe('DecodeRawTransactionHexRISD2', function() {
    it('should create an instance of DecodeRawTransactionHexRISD2', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISD2
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISD2();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISD2);
    });
