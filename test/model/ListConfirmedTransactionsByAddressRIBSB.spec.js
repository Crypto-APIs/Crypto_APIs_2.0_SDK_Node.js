...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSB();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSB', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSB', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSB
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSB();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSB);
    });
