...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC();
  });
  ...
  describe('ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC);
    });
