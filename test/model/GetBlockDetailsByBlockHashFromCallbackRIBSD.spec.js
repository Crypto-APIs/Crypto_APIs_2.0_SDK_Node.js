...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSD();
  });
  ...
  describe('GetBlockDetailsByBlockHashFromCallbackRIBSD', function() {
    it('should create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSD', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashFromCallbackRIBSD
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSD();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSD);
    });
