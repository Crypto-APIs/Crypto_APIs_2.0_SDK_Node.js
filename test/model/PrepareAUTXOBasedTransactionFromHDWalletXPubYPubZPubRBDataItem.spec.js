...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBDataItem();
  });
  ...
  describe('PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBDataItem', function() {
    it('should create an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBDataItem', function() {
      // uncomment below and update the code to test PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBDataItem
      //var instance = new Cryptoapis.PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRBDataItem);
    });
