...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLatestMinedBlockRIBS();
  });
  ...
  describe('GetLatestMinedBlockRIBS', function() {
    it('should create an instance of GetLatestMinedBlockRIBS', function() {
      // uncomment below and update the code to test GetLatestMinedBlockRIBS
      //var instane = new Cryptoapis.GetLatestMinedBlockRIBS();
      //expect(instance).to.be.a(Cryptoapis.GetLatestMinedBlockRIBS);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new Cryptoapis.GetLatestMinedBlockRIBS();
