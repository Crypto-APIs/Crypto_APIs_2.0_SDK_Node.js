...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIFee();
  });
  ...
  describe('PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIFee', function() {
    it('should create an instance of PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIFee', function() {
      // uncomment below and update the code to test PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIFee
      //var instance = new Cryptoapis.PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIFee();
      //expect(instance).to.be.a(Cryptoapis.PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRIFee);
    });
