...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightRIBSZ2();
  });
  ...
  describe('GetBlockDetailsByBlockHeightRIBSZ2', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightRIBSZ2', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightRIBSZ2
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightRIBSZ2();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightRIBSZ2);
    });
