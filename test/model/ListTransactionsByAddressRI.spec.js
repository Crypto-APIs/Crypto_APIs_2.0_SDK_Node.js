...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByAddressRI();
  });
  ...
  describe('ListTransactionsByAddressRI', function() {
    it('should create an instance of ListTransactionsByAddressRI', function() {
      // uncomment below and update the code to test ListTransactionsByAddressRI
      //var instane = new Cryptoapis.ListTransactionsByAddressRI();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByAddressRI);
    });

    it('should have the property index (base name: "index")', function() {
      // uncomment below and update the code to test the property index
      //var instance = new Cryptoapis.ListTransactionsByAddressRI();
