...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLatestMinedBlockRIBSD();
  });
  ...
  describe('GetLatestMinedBlockRIBSD', function() {
    it('should create an instance of GetLatestMinedBlockRIBSD', function() {
      // uncomment below and update the code to test GetLatestMinedBlockRIBSD
      //var instane = new Cryptoapis.GetLatestMinedBlockRIBSD();
      //expect(instance).to.be.a(Cryptoapis.GetLatestMinedBlockRIBSD);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new Cryptoapis.GetLatestMinedBlockRIBSD();
