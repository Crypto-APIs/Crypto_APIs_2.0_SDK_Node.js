...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetEIP1559FeeRecommendationsRI();
  });
  ...
  describe('GetEIP1559FeeRecommendationsRI', function() {
    it('should create an instance of GetEIP1559FeeRecommendationsRI', function() {
      // uncomment below and update the code to test GetEIP1559FeeRecommendationsRI
      //var instance = new Cryptoapis.GetEIP1559FeeRecommendationsRI();
      //expect(instance).to.be.a(Cryptoapis.GetEIP1559FeeRecommendationsRI);
    });
