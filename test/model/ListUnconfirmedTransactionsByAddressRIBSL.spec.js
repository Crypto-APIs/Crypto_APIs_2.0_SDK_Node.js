...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSL();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSL', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSL', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSL
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSL();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSL);
    });
