...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSLVinInner();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSLVinInner', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSLVinInner', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSLVinInner
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSLVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSLVinInner);
    });
