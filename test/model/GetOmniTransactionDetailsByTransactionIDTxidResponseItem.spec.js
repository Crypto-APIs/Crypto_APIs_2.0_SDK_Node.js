...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetOmniTransactionDetailsByTransactionIDTxidResponseItem();
  });
  ...
  describe('GetOmniTransactionDetailsByTransactionIDTxidResponseItem', function() {
    it('should create an instance of GetOmniTransactionDetailsByTransactionIDTxidResponseItem', function() {
      // uncomment below and update the code to test GetOmniTransactionDetailsByTransactionIDTxidResponseItem
      //var instane = new CryptoApis.GetOmniTransactionDetailsByTransactionIDTxidResponseItem();
      //expect(instance).to.be.a(CryptoApis.GetOmniTransactionDetailsByTransactionIDTxidResponseItem);
    });

    it('should have the property amount (base name: "amount")', function() {
      // uncomment below and update the code to test the property amount
      //var instance = new CryptoApis.GetOmniTransactionDetailsByTransactionIDTxidResponseItem();
