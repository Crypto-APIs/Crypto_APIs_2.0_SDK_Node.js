...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetExchangeRateByAssetsIDsResponseItem();
  });
  ...
  describe('GetExchangeRateByAssetsIDsResponseItem', function() {
    it('should create an instance of GetExchangeRateByAssetsIDsResponseItem', function() {
      // uncomment below and update the code to test GetExchangeRateByAssetsIDsResponseItem
      //var instane = new CryptoApis.GetExchangeRateByAssetsIDsResponseItem();
      //expect(instance).to.be.a(CryptoApis.GetExchangeRateByAssetsIDsResponseItem);
    });
    ...
    it('should have the property calculationTimestamp (base name: "calculationTimestamp")', function() {
      ...
      //var instance = new CryptoApis.GetExchangeRateByAssetsIDsResponseItem();
