...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListWalletTransactionsRIInternalTransactions();
  });
  ...
  describe('ListWalletTransactionsRIInternalTransactions', function() {
    it('should create an instance of ListWalletTransactionsRIInternalTransactions', function() {
      // uncomment below and update the code to test ListWalletTransactionsRIInternalTransactions
      //var instance = new Cryptoapis.ListWalletTransactionsRIInternalTransactions();
      //expect(instance).to.be.a(Cryptoapis.ListWalletTransactionsRIInternalTransactions);
    });
