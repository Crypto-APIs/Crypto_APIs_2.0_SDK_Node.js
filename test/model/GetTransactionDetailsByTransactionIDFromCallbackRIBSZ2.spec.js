...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSZ2();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDFromCallbackRIBSZ2', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSZ2', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDFromCallbackRIBSZ2
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSZ2();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSZ2);
    });
