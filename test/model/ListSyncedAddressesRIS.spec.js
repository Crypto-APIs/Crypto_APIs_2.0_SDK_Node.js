...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListSyncedAddressesRIS();
  });
  ...
  describe('ListSyncedAddressesRIS', function() {
    it('should create an instance of ListSyncedAddressesRIS', function() {
      // uncomment below and update the code to test ListSyncedAddressesRIS
      //var instance = new Cryptoapis.ListSyncedAddressesRIS();
      //expect(instance).to.be.a(Cryptoapis.ListSyncedAddressesRIS);
    });
