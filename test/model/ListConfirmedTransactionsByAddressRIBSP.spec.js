...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSP();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSP', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSP', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSP
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSP();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSP);
    });
