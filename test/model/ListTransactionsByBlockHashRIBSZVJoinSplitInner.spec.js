...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHashRIBSZVJoinSplitInner();
  });
  ...
  describe('ListTransactionsByBlockHashRIBSZVJoinSplitInner', function() {
    it('should create an instance of ListTransactionsByBlockHashRIBSZVJoinSplitInner', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashRIBSZVJoinSplitInner
      //var instance = new Cryptoapis.ListTransactionsByBlockHashRIBSZVJoinSplitInner();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHashRIBSZVJoinSplitInner);
    });
