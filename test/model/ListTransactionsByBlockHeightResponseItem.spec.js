...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByBlockHeightResponseItem();
  });
  ...
  describe('ListTransactionsByBlockHeightResponseItem', function() {
    it('should create an instance of ListTransactionsByBlockHeightResponseItem', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightResponseItem
      //var instane = new CryptoApis.ListTransactionsByBlockHeightResponseItem();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByBlockHeightResponseItem);
    });

    it('should have the property index (base name: "index")', function() {
      // uncomment below and update the code to test the property index
      //var instance = new CryptoApis.ListTransactionsByBlockHeightResponseItem();
