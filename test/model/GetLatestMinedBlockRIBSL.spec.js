...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLatestMinedBlockRIBSL();
  });
  ...
  describe('GetLatestMinedBlockRIBSL', function() {
    it('should create an instance of GetLatestMinedBlockRIBSL', function() {
      // uncomment below and update the code to test GetLatestMinedBlockRIBSL
      //var instane = new Cryptoapis.GetLatestMinedBlockRIBSL();
      //expect(instance).to.be.a(Cryptoapis.GetLatestMinedBlockRIBSL);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new Cryptoapis.GetLatestMinedBlockRIBSL();
