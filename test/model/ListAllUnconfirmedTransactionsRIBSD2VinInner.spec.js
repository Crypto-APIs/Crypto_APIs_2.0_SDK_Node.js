...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSD2VinInner();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSD2VinInner', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSD2VinInner', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSD2VinInner
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSD2VinInner();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSD2VinInner);
    });
