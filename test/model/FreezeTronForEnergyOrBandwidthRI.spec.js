...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.FreezeTronForEnergyOrBandwidthRI();
  });
  ...
  describe('FreezeTronForEnergyOrBandwidthRI', function() {
    it('should create an instance of FreezeTronForEnergyOrBandwidthRI', function() {
      // uncomment below and update the code to test FreezeTronForEnergyOrBandwidthRI
      //var instance = new Cryptoapis.FreezeTronForEnergyOrBandwidthRI();
      //expect(instance).to.be.a(Cryptoapis.FreezeTronForEnergyOrBandwidthRI);
    });
