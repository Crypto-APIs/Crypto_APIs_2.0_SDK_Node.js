...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHashRIBSLVinInner();
  });
  ...
  describe('ListTransactionsByBlockHashRIBSLVinInner', function() {
    it('should create an instance of ListTransactionsByBlockHashRIBSLVinInner', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashRIBSLVinInner
      //var instance = new Cryptoapis.ListTransactionsByBlockHashRIBSLVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHashRIBSLVinInner);
    });
