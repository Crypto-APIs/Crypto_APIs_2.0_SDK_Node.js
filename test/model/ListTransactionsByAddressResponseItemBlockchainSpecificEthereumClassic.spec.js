...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificEthereumClassic();
  });
  ...
  describe('ListTransactionsByAddressResponseItemBlockchainSpecificEthereumClassic', function() {
    it('should create an instance of ListTransactionsByAddressResponseItemBlockchainSpecificEthereumClassic', function() {
      // uncomment below and update the code to test ListTransactionsByAddressResponseItemBlockchainSpecificEthereumClassic
      //var instane = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificEthereumClassic();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificEthereumClassic);
    });
    ...
    it('should have the property contract (base name: "contract")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificEthereumClassic();
