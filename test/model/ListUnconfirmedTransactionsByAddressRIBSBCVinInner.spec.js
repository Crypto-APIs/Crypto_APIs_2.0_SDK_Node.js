...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSBCVinInner();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSBCVinInner', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSBCVinInner', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSBCVinInner
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSBCVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSBCVinInner);
    });
