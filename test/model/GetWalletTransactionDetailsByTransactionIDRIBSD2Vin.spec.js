...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSD2Vin();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSD2Vin', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSD2Vin', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSD2Vin
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSD2Vin();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSD2Vin);
    });
