...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByAddressRIBSLVin();
  });
  ...
  describe('ListTransactionsByAddressRIBSLVin', function() {
    it('should create an instance of ListTransactionsByAddressRIBSLVin', function() {
      // uncomment below and update the code to test ListTransactionsByAddressRIBSLVin
      //var instane = new Cryptoapis.ListTransactionsByAddressRIBSLVin();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByAddressRIBSLVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new Cryptoapis.ListTransactionsByAddressRIBSLVin();
