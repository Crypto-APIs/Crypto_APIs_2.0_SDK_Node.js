...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareAnAccountBasedTransactionFromXPubRIFee();
  });
  ...
  describe('PrepareAnAccountBasedTransactionFromXPubRIFee', function() {
    it('should create an instance of PrepareAnAccountBasedTransactionFromXPubRIFee', function() {
      // uncomment below and update the code to test PrepareAnAccountBasedTransactionFromXPubRIFee
      //var instance = new Cryptoapis.PrepareAnAccountBasedTransactionFromXPubRIFee();
      //expect(instance).to.be.a(Cryptoapis.PrepareAnAccountBasedTransactionFromXPubRIFee);
    });
