...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSD2VinInner();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDRIBSD2VinInner', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDRIBSD2VinInner', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDRIBSD2VinInner
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSD2VinInner();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDRIBSD2VinInner);
    });
