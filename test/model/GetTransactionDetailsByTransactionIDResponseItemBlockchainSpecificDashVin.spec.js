...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashVin();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashVin', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashVin', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashVin
      //var instane = new CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashVin();
      //expect(instance).to.be.a(CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDashVin();
