...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBCVinInner();
  });
  ...
  describe('PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBCVinInner', function() {
    it('should create an instance of PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBCVinInner', function() {
      // uncomment below and update the code to test PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBCVinInner
      //var instance = new Cryptoapis.PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBCVinInner();
      //expect(instance).to.be.a(Cryptoapis.PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSBCVinInner);
    });
