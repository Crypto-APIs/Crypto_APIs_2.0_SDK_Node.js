...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSBC();
  });
  ...
  describe('GetBlockDetailsByBlockHashFromCallbackRIBSBC', function() {
    it('should create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSBC', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashFromCallbackRIBSBC
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSBC();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSBC);
    });
