...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetAssetDetailsByAssetSymbolRI();
  });
  ...
  describe('GetAssetDetailsByAssetSymbolRI', function() {
    it('should create an instance of GetAssetDetailsByAssetSymbolRI', function() {
      // uncomment below and update the code to test GetAssetDetailsByAssetSymbolRI
      //var instance = new Cryptoapis.GetAssetDetailsByAssetSymbolRI();
      //expect(instance).to.be.a(Cryptoapis.GetAssetDetailsByAssetSymbolRI);
    });
