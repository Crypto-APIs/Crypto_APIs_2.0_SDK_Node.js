...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISZVinInner();
  });
  ...
  describe('DecodeRawTransactionHexRISZVinInner', function() {
    it('should create an instance of DecodeRawTransactionHexRISZVinInner', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISZVinInner
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISZVinInner();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISZVinInner);
    });
