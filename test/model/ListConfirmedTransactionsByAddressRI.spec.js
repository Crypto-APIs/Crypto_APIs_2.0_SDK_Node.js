...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRI();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRI', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRI', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRI
