...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISDVin();
  });
  ...
  describe('DecodeRawTransactionHexRISDVin', function() {
    it('should create an instance of DecodeRawTransactionHexRISDVin', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISDVin
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISDVin();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISDVin);
    });
