...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHashRIBSZ();
  });
  ...
  describe('ListTransactionsByBlockHashRIBSZ', function() {
    it('should create an instance of ListTransactionsByBlockHashRIBSZ', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashRIBSZ
      //var instance = new Cryptoapis.ListTransactionsByBlockHashRIBSZ();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHashRIBSZ);
    });
