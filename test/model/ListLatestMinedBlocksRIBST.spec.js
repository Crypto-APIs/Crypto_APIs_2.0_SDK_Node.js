...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListLatestMinedBlocksRIBST();
  });
  ...
  describe('ListLatestMinedBlocksRIBST', function() {
    it('should create an instance of ListLatestMinedBlocksRIBST', function() {
      // uncomment below and update the code to test ListLatestMinedBlocksRIBST
      //var instance = new Cryptoapis.ListLatestMinedBlocksRIBST();
      //expect(instance).to.be.a(Cryptoapis.ListLatestMinedBlocksRIBST);
    });
