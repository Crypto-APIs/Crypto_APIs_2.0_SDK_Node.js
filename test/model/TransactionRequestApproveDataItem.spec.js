...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.TransactionRequestApproveDataItem();
  });
  ...
  describe('TransactionRequestApproveDataItem', function() {
    it('should create an instance of TransactionRequestApproveDataItem', function() {
      // uncomment below and update the code to test TransactionRequestApproveDataItem
      //var instane = new Cryptoapis.TransactionRequestApproveDataItem();
      //expect(instance).to.be.a(Cryptoapis.TransactionRequestApproveDataItem);
    });
    ...
    it('should have the property blockchain (base name: "blockchain")', function() {
      ...
      //var instance = new Cryptoapis.TransactionRequestApproveDataItem();
