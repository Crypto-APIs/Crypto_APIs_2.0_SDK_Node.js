...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSEC();
  });
  ...
  describe('GetBlockDetailsByBlockHashFromCallbackRIBSEC', function() {
    it('should create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSEC', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashFromCallbackRIBSEC
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSEC();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSEC);
    });
