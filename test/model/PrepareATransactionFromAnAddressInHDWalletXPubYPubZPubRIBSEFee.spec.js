...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee();
  });
  ...
  describe('PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee', function() {
    it('should create an instance of PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee', function() {
      // uncomment below and update the code to test PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee
      //var instance = new Cryptoapis.PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee();
      //expect(instance).to.be.a(Cryptoapis.PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee);
    });
