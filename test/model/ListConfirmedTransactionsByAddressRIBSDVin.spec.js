...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSDVin();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSDVin', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSDVin', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSDVin
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSDVin();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSDVin);
    });
