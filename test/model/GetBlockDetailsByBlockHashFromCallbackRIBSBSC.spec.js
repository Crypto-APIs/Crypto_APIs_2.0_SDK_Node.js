...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSBSC();
  });
  ...
  describe('GetBlockDetailsByBlockHashFromCallbackRIBSBSC', function() {
    it('should create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSBSC', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashFromCallbackRIBSBSC
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSBSC();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSBSC);
    });
