...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSBSC();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSBSC', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSBSC', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSBSC
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSBSC();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSBSC);
    });
