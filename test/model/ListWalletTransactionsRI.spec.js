...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListWalletTransactionsRI();
  });
  ...
  describe('ListWalletTransactionsRI', function() {
    it('should create an instance of ListWalletTransactionsRI', function() {
      // uncomment below and update the code to test ListWalletTransactionsRI
      //var instance = new Cryptoapis.ListWalletTransactionsRI();
      //expect(instance).to.be.a(Cryptoapis.ListWalletTransactionsRI);
    });
