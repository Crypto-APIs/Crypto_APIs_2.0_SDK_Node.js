...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBS();
  });
  ...
  describe('ListConfirmedTransactionsByAddressAndTimeRangeRIBS', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBS', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressAndTimeRangeRIBS
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBS();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBS);
    });
