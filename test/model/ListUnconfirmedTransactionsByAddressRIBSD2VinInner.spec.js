...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSD2VinInner();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSD2VinInner', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSD2VinInner', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSD2VinInner
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSD2VinInner();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSD2VinInner);
    });
