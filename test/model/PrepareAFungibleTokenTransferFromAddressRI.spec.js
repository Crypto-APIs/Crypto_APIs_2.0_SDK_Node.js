...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareAFungibleTokenTransferFromAddressRI();
  });
  ...
  describe('PrepareAFungibleTokenTransferFromAddressRI', function() {
    it('should create an instance of PrepareAFungibleTokenTransferFromAddressRI', function() {
      // uncomment below and update the code to test PrepareAFungibleTokenTransferFromAddressRI
      //var instance = new Cryptoapis.PrepareAFungibleTokenTransferFromAddressRI();
      //expect(instance).to.be.a(Cryptoapis.PrepareAFungibleTokenTransferFromAddressRI);
    });
