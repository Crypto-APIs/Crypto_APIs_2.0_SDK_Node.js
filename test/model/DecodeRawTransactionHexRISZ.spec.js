...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISZ();
  });
  ...
  describe('DecodeRawTransactionHexRISZ', function() {
    it('should create an instance of DecodeRawTransactionHexRISZ', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISZ
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISZ();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISZ);
    });
