...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.NewConfirmedCoinsTransactionsForSpecificAmountRI();
  });
  ...
  describe('NewConfirmedCoinsTransactionsForSpecificAmountRI', function() {
    it('should create an instance of NewConfirmedCoinsTransactionsForSpecificAmountRI', function() {
      // uncomment below and update the code to test NewConfirmedCoinsTransactionsForSpecificAmountRI
      //var instance = new Cryptoapis.NewConfirmedCoinsTransactionsForSpecificAmountRI();
      //expect(instance).to.be.a(Cryptoapis.NewConfirmedCoinsTransactionsForSpecificAmountRI);
    });
