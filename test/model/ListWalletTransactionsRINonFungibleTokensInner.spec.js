...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListWalletTransactionsRINonFungibleTokensInner();
  });
  ...
  describe('ListWalletTransactionsRINonFungibleTokensInner', function() {
    it('should create an instance of ListWalletTransactionsRINonFungibleTokensInner', function() {
      // uncomment below and update the code to test ListWalletTransactionsRINonFungibleTokensInner
      //var instance = new Cryptoapis.ListWalletTransactionsRINonFungibleTokensInner();
      //expect(instance).to.be.a(Cryptoapis.ListWalletTransactionsRINonFungibleTokensInner);
    });
