...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListCoinsForwardingAutomationsResponseItem();
  });
  ...
  describe('ListCoinsForwardingAutomationsResponseItem', function() {
    it('should create an instance of ListCoinsForwardingAutomationsResponseItem', function() {
      // uncomment below and update the code to test ListCoinsForwardingAutomationsResponseItem
      //var instane = new CryptoApis.ListCoinsForwardingAutomationsResponseItem();
      //expect(instance).to.be.a(CryptoApis.ListCoinsForwardingAutomationsResponseItem);
    });
    ...
    it('should have the property callbackUrl (base name: "callbackUrl")', function() {
      ...
      //var instance = new CryptoApis.ListCoinsForwardingAutomationsResponseItem();
      //expect(instance).to.be();
    });

    it('should have the property confirmationsCountTrigger (base name: "confirmationsCountTrigger")', function() {
      // uncomment below and update the code to test the property confirmationsCountTrigger
      //var instance = new CryptoApis.ListCoinsForwardingAutomationsResponseItem();
      //expect(instance).to.be();
    });
