...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.EstimateTokenGasLimitRBDataItem();
  });
  ...
  describe('EstimateTokenGasLimitRBDataItem', function() {
    it('should create an instance of EstimateTokenGasLimitRBDataItem', function() {
      // uncomment below and update the code to test EstimateTokenGasLimitRBDataItem
      //var instance = new Cryptoapis.EstimateTokenGasLimitRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.EstimateTokenGasLimitRBDataItem);
    });
