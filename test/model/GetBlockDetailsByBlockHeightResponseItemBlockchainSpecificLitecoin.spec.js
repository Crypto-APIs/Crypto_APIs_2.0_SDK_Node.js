...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificLitecoin();
  });
  ...
  describe('GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificLitecoin', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificLitecoin', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificLitecoin
      //var instane = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificLitecoin();
      //expect(instance).to.be.a(CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificLitecoin);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificLitecoin();
