...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListLatestMinedBlocksRIBSZ2();
  });
  ...
  describe('ListLatestMinedBlocksRIBSZ2', function() {
    it('should create an instance of ListLatestMinedBlocksRIBSZ2', function() {
      // uncomment below and update the code to test ListLatestMinedBlocksRIBSZ2
      //var instance = new Cryptoapis.ListLatestMinedBlocksRIBSZ2();
      //expect(instance).to.be.a(Cryptoapis.ListLatestMinedBlocksRIBSZ2);
    });
