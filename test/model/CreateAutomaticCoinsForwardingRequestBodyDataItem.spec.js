...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.CreateAutomaticCoinsForwardingRequestBodyDataItem();
  });
  ...
  describe('CreateAutomaticCoinsForwardingRequestBodyDataItem', function() {
    it('should create an instance of CreateAutomaticCoinsForwardingRequestBodyDataItem', function() {
      // uncomment below and update the code to test CreateAutomaticCoinsForwardingRequestBodyDataItem
      //var instane = new CryptoApis.CreateAutomaticCoinsForwardingRequestBodyDataItem();
      //expect(instance).to.be.a(CryptoApis.CreateAutomaticCoinsForwardingRequestBodyDataItem);
    });
    ...
    it('should have the property callbackSecretKey (base name: "callbackSecretKey")', function() {
      ...
      //var instance = new CryptoApis.CreateAutomaticCoinsForwardingRequestBodyDataItem();
