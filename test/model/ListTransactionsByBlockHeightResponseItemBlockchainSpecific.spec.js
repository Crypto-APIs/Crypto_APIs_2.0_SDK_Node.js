...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecific();
  });
  ...
  describe('ListTransactionsByBlockHeightResponseItemBlockchainSpecific', function() {
    it('should create an instance of ListTransactionsByBlockHeightResponseItemBlockchainSpecific', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightResponseItemBlockchainSpecific
      //var instane = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecific();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecific);
    });
    ...
    it('should have the property locktime (base name: "locktime")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByBlockHeightResponseItemBlockchainSpecific();
