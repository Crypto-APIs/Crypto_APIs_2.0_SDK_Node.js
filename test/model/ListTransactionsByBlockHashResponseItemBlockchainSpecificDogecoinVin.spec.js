...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin();
  });
  ...
  describe('ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin', function() {
    it('should create an instance of ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin
      //var instane = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificDogecoinVin();
