...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByAddressRIBSEC();
  });
  ...
  describe('ListTransactionsByAddressRIBSEC', function() {
    it('should create an instance of ListTransactionsByAddressRIBSEC', function() {
      // uncomment below and update the code to test ListTransactionsByAddressRIBSEC
      //var instane = new Cryptoapis.ListTransactionsByAddressRIBSEC();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByAddressRIBSEC);
    });
    ...
    it('should have the property contract (base name: "contract")', function() {
      ...
      //var instance = new Cryptoapis.ListTransactionsByAddressRIBSEC();
