...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum();
  });
  ...
  describe('GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum
      //var instane = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum();
      //expect(instance).to.be.a(CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum();
