...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin();
  });
  ...
  describe('ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin', function() {
    it('should create an instance of ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin', function() {
      // uncomment below and update the code to test ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin
      //var instane = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByAddressResponseItemBlockchainSpecificBitcoinVin();
