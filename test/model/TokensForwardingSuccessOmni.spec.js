...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.TokensForwardingSuccessOmni();
  });
  ...
  describe('TokensForwardingSuccessOmni', function() {
    it('should create an instance of TokensForwardingSuccessOmni', function() {
      // uncomment below and update the code to test TokensForwardingSuccessOmni
      //var instance = new Cryptoapis.TokensForwardingSuccessOmni();
      //expect(instance).to.be.a(Cryptoapis.TokensForwardingSuccessOmni);
    });
