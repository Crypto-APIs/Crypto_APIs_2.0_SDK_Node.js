...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin();
  });
  ...
  describe('GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin', function() {
    it('should create an instance of GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin', function() {
      // uncomment below and update the code to test GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin
      //var instane = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin();
      //expect(instance).to.be.a(CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetLatestMinedBlockResponseItemBlockchainSpecificDogecoin();
