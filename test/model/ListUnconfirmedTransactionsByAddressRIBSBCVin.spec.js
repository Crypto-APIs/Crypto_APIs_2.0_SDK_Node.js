...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSBCVin();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSBCVin', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSBCVin', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSBCVin
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSBCVin();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSBCVin);
    });
