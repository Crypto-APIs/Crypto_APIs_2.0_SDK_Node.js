...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLatestMinedBlockRIBSBC();
  });
  ...
  describe('GetLatestMinedBlockRIBSBC', function() {
    it('should create an instance of GetLatestMinedBlockRIBSBC', function() {
      // uncomment below and update the code to test GetLatestMinedBlockRIBSBC
      //var instane = new Cryptoapis.GetLatestMinedBlockRIBSBC();
      //expect(instance).to.be.a(Cryptoapis.GetLatestMinedBlockRIBSBC);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new Cryptoapis.GetLatestMinedBlockRIBSBC();
