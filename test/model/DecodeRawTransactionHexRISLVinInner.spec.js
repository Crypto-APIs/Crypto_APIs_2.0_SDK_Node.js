...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISLVinInner();
  });
  ...
  describe('DecodeRawTransactionHexRISLVinInner', function() {
    it('should create an instance of DecodeRawTransactionHexRISLVinInner', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISLVinInner
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISLVinInner();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISLVinInner);
    });
