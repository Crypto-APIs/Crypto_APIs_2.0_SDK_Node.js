...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSE();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDFromCallbackRIBSE', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSE', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDFromCallbackRIBSE
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSE();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSE);
    });
