...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.NewConfirmedTokensTransactionsResponseItem();
  });
  ...
  describe('NewConfirmedTokensTransactionsResponseItem', function() {
    it('should create an instance of NewConfirmedTokensTransactionsResponseItem', function() {
      // uncomment below and update the code to test NewConfirmedTokensTransactionsResponseItem
      //var instane = new CryptoApis.NewConfirmedTokensTransactionsResponseItem();
      //expect(instance).to.be.a(CryptoApis.NewConfirmedTokensTransactionsResponseItem);
    });

    it('should have the property address (base name: "address")', function() {
      // uncomment below and update the code to test the property address
      //var instance = new CryptoApis.NewConfirmedTokensTransactionsResponseItem();
