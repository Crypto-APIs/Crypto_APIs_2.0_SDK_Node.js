...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSDVin();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSDVin', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSDVin', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSDVin
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSDVin();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSDVin);
    });
