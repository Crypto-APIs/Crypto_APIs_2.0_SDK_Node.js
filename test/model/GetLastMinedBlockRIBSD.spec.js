...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLastMinedBlockRIBSD();
  });
  ...
  describe('GetLastMinedBlockRIBSD', function() {
    it('should create an instance of GetLastMinedBlockRIBSD', function() {
      // uncomment below and update the code to test GetLastMinedBlockRIBSD
      //var instance = new Cryptoapis.GetLastMinedBlockRIBSD();
      //expect(instance).to.be.a(Cryptoapis.GetLastMinedBlockRIBSD);
    });
