...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.NewRevertedBlockRI();
  });
  ...
  describe('NewRevertedBlockRI', function() {
    it('should create an instance of NewRevertedBlockRI', function() {
      // uncomment below and update the code to test NewRevertedBlockRI
      //var instance = new Cryptoapis.NewRevertedBlockRI();
      //expect(instance).to.be.a(Cryptoapis.NewRevertedBlockRI);
    });
