...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.CreateCoinsTransactionFromAddressForWholeAmountRBDataItem();
  });
  ...
  describe('CreateCoinsTransactionFromAddressForWholeAmountRBDataItem', function() {
    it('should create an instance of CreateCoinsTransactionFromAddressForWholeAmountRBDataItem', function() {
      // uncomment below and update the code to test CreateCoinsTransactionFromAddressForWholeAmountRBDataItem
      //var instance = new Cryptoapis.CreateCoinsTransactionFromAddressForWholeAmountRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.CreateCoinsTransactionFromAddressForWholeAmountRBDataItem);
    });
