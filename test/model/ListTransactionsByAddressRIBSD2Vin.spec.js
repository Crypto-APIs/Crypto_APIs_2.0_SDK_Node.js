...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByAddressRIBSD2Vin();
  });
  ...
  describe('ListTransactionsByAddressRIBSD2Vin', function() {
    it('should create an instance of ListTransactionsByAddressRIBSD2Vin', function() {
      // uncomment below and update the code to test ListTransactionsByAddressRIBSD2Vin
      //var instane = new Cryptoapis.ListTransactionsByAddressRIBSD2Vin();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByAddressRIBSD2Vin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new Cryptoapis.ListTransactionsByAddressRIBSD2Vin();
