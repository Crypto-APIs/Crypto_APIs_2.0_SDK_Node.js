...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSX();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDFromCallbackRIBSX', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSX', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDFromCallbackRIBSX
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSX();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSX);
    });
