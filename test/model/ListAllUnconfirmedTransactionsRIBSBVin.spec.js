...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSBVin();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSBVin', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSBVin', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSBVin
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSBVin();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSBVin);
    });
