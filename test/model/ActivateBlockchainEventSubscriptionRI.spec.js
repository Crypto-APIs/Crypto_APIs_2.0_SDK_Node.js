...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ActivateBlockchainEventSubscriptionRI();
  });
  ...
  describe('ActivateBlockchainEventSubscriptionRI', function() {
    it('should create an instance of ActivateBlockchainEventSubscriptionRI', function() {
      // uncomment below and update the code to test ActivateBlockchainEventSubscriptionRI
      //var instance = new Cryptoapis.ActivateBlockchainEventSubscriptionRI();
      //expect(instance).to.be.a(Cryptoapis.ActivateBlockchainEventSubscriptionRI);
    });
