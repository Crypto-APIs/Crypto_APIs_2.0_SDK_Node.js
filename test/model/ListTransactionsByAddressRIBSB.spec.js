...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByAddressRIBSB();
  });
  ...
  describe('ListTransactionsByAddressRIBSB', function() {
    it('should create an instance of ListTransactionsByAddressRIBSB', function() {
      // uncomment below and update the code to test ListTransactionsByAddressRIBSB
      //var instane = new Cryptoapis.ListTransactionsByAddressRIBSB();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByAddressRIBSB);
    });
    ...
    it('should have the property locktime (base name: "locktime")', function() {
      ...
      //var instance = new Cryptoapis.ListTransactionsByAddressRIBSB();
