...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListLatestMinedBlocksRIBSD();
  });
  ...
  describe('ListLatestMinedBlocksRIBSD', function() {
    it('should create an instance of ListLatestMinedBlocksRIBSD', function() {
      // uncomment below and update the code to test ListLatestMinedBlocksRIBSD
      //var instance = new Cryptoapis.ListLatestMinedBlocksRIBSD();
      //expect(instance).to.be.a(Cryptoapis.ListLatestMinedBlocksRIBSD);
    });
