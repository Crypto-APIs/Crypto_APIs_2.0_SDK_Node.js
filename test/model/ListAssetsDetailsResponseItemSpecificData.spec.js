...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListAssetsDetailsResponseItemSpecificData();
  });
  ...
  describe('ListAssetsDetailsResponseItemSpecificData', function() {
    it('should create an instance of ListAssetsDetailsResponseItemSpecificData', function() {
      // uncomment below and update the code to test ListAssetsDetailsResponseItemSpecificData
      //var instane = new CryptoApis.ListAssetsDetailsResponseItemSpecificData();
      //expect(instance).to.be.a(CryptoApis.ListAssetsDetailsResponseItemSpecificData);
    });
    ...
    it('should have the property _1hourPriceChangeInPercentage (base name: "1HourPriceChangeInPercentage")', function() {
      ...
      //var instance = new CryptoApis.ListAssetsDetailsResponseItemSpecificData();
