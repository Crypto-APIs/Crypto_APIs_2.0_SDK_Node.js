...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSZ();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSZ', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSZ', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSZ
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSZ();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSZ);
    });
