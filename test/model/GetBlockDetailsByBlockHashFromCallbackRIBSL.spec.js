...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSL();
  });
  ...
  describe('GetBlockDetailsByBlockHashFromCallbackRIBSL', function() {
    it('should create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSL', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashFromCallbackRIBSL
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSL();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSL);
    });
