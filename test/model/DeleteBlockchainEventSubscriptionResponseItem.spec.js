...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.DeleteBlockchainEventSubscriptionResponseItem();
  });
  ...
  describe('DeleteBlockchainEventSubscriptionResponseItem', function() {
    it('should create an instance of DeleteBlockchainEventSubscriptionResponseItem', function() {
      // uncomment below and update the code to test DeleteBlockchainEventSubscriptionResponseItem
      //var instane = new CryptoApis.DeleteBlockchainEventSubscriptionResponseItem();
      //expect(instance).to.be.a(CryptoApis.DeleteBlockchainEventSubscriptionResponseItem);
    });
    ...
    it('should have the property callbackSecretKey (base name: "callbackSecretKey")', function() {
      ...
      //var instance = new CryptoApis.DeleteBlockchainEventSubscriptionResponseItem();
