...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.NewBlockResponseItem();
  });
  ...
  describe('NewBlockResponseItem', function() {
    it('should create an instance of NewBlockResponseItem', function() {
      // uncomment below and update the code to test NewBlockResponseItem
      //var instane = new CryptoApis.NewBlockResponseItem();
      //expect(instance).to.be.a(CryptoApis.NewBlockResponseItem);
    });
    ...
    it('should have the property callbackSecretKey (base name: "callbackSecretKey")', function() {
      ...
      //var instance = new CryptoApis.NewBlockResponseItem();
