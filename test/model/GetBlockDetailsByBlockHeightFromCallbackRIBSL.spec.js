...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSL();
  });
  ...
  describe('GetBlockDetailsByBlockHeightFromCallbackRIBSL', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSL', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightFromCallbackRIBSL
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSL();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSL);
    });
