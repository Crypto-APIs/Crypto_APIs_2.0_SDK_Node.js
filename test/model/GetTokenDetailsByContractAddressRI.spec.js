...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTokenDetailsByContractAddressRI();
  });
  ...
  describe('GetTokenDetailsByContractAddressRI', function() {
    it('should create an instance of GetTokenDetailsByContractAddressRI', function() {
      // uncomment below and update the code to test GetTokenDetailsByContractAddressRI
      //var instance = new Cryptoapis.GetTokenDetailsByContractAddressRI();
      //expect(instance).to.be.a(Cryptoapis.GetTokenDetailsByContractAddressRI);
    });
