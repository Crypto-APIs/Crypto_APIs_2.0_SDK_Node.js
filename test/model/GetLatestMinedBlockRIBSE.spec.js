...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLatestMinedBlockRIBSE();
  });
  ...
  describe('GetLatestMinedBlockRIBSE', function() {
    it('should create an instance of GetLatestMinedBlockRIBSE', function() {
      // uncomment below and update the code to test GetLatestMinedBlockRIBSE
      //var instane = new Cryptoapis.GetLatestMinedBlockRIBSE();
      //expect(instance).to.be.a(Cryptoapis.GetLatestMinedBlockRIBSE);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new Cryptoapis.GetLatestMinedBlockRIBSE();
