...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.NewUnconfirmedCoinsTransactionsResponseItem();
  });
  ...
  describe('NewUnconfirmedCoinsTransactionsResponseItem', function() {
    it('should create an instance of NewUnconfirmedCoinsTransactionsResponseItem', function() {
      // uncomment below and update the code to test NewUnconfirmedCoinsTransactionsResponseItem
      //var instane = new CryptoApis.NewUnconfirmedCoinsTransactionsResponseItem();
      //expect(instance).to.be.a(CryptoApis.NewUnconfirmedCoinsTransactionsResponseItem);
    });
    ...
    it('should have the property callbackSecretKey (base name: "callbackSecretKey")', function() {
      ...
      //var instance = new CryptoApis.NewUnconfirmedCoinsTransactionsResponseItem();
