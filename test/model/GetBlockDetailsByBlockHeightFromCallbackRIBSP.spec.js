...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSP();
  });
  ...
  describe('GetBlockDetailsByBlockHeightFromCallbackRIBSP', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSP', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightFromCallbackRIBSP
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSP();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSP);
    });
