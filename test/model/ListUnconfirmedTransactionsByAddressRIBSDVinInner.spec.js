...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSDVinInner();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBSDVinInner', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBSDVinInner', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBSDVinInner
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSDVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBSDVinInner);
    });
