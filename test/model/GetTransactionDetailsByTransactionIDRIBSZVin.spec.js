...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSZVin();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDRIBSZVin', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDRIBSZVin', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDRIBSZVin
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSZVin();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDRIBSZVin);
    });
