...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSBCVin();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSBCVin', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSBCVin', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSBCVin
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSBCVin();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSBCVin);
    });
