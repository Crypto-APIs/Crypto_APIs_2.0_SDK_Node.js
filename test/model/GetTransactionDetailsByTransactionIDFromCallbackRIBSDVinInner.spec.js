...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSDVinInner();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDFromCallbackRIBSDVinInner', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSDVinInner', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDFromCallbackRIBSDVinInner
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSDVinInner();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSDVinInner);
    });
