...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHashRIBSBVinInner();
  });
  ...
  describe('ListTransactionsByBlockHashRIBSBVinInner', function() {
    it('should create an instance of ListTransactionsByBlockHashRIBSBVinInner', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashRIBSBVinInner
      //var instance = new Cryptoapis.ListTransactionsByBlockHashRIBSBVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHashRIBSBVinInner);
    });
