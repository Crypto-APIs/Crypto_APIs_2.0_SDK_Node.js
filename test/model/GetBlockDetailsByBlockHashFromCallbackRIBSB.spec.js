...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSB();
  });
  ...
  describe('GetBlockDetailsByBlockHashFromCallbackRIBSB', function() {
    it('should create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSB', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashFromCallbackRIBSB
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSB();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSB);
    });
