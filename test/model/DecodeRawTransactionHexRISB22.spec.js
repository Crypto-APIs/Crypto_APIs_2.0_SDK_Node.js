...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISB22();
  });
  ...
  describe('DecodeRawTransactionHexRISB22', function() {
    it('should create an instance of DecodeRawTransactionHexRISB22', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISB22
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISB22();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISB22);
    });
