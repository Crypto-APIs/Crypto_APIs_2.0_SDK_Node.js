...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSZVJoinSplitInner);
    });
