...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListHDWalletxPubYPubZPubTransactionsResponseItem();
  });
  ...
  describe('ListHDWalletxPubYPubZPubTransactionsResponseItem', function() {
    it('should create an instance of ListHDWalletxPubYPubZPubTransactionsResponseItem', function() {
      // uncomment below and update the code to test ListHDWalletxPubYPubZPubTransactionsResponseItem
      //var instane = new CryptoApis.ListHDWalletxPubYPubZPubTransactionsResponseItem();
      //expect(instance).to.be.a(CryptoApis.ListHDWalletxPubYPubZPubTransactionsResponseItem);
    });

    it('should have the property index (base name: "index")', function() {
      // uncomment below and update the code to test the property index
      //var instance = new CryptoApis.ListHDWalletxPubYPubZPubTransactionsResponseItem();
