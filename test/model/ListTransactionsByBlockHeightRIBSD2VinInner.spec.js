...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSD2VinInner();
  });
  ...
  describe('ListTransactionsByBlockHeightRIBSD2VinInner', function() {
    it('should create an instance of ListTransactionsByBlockHeightRIBSD2VinInner', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightRIBSD2VinInner
      //var instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSD2VinInner();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHeightRIBSD2VinInner);
    });
