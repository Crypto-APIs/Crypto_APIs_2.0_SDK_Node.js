...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLatestMinedBlockRIBSB();
  });
  ...
  describe('GetLatestMinedBlockRIBSB', function() {
    it('should create an instance of GetLatestMinedBlockRIBSB', function() {
      // uncomment below and update the code to test GetLatestMinedBlockRIBSB
      //var instane = new Cryptoapis.GetLatestMinedBlockRIBSB();
      //expect(instance).to.be.a(Cryptoapis.GetLatestMinedBlockRIBSB);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new Cryptoapis.GetLatestMinedBlockRIBSB();
