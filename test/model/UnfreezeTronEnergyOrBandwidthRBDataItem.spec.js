...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.UnfreezeTronEnergyOrBandwidthRBDataItem();
  });
  ...
  describe('UnfreezeTronEnergyOrBandwidthRBDataItem', function() {
    it('should create an instance of UnfreezeTronEnergyOrBandwidthRBDataItem', function() {
      // uncomment below and update the code to test UnfreezeTronEnergyOrBandwidthRBDataItem
      //var instance = new Cryptoapis.UnfreezeTronEnergyOrBandwidthRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.UnfreezeTronEnergyOrBandwidthRBDataItem);
    });
