...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBS();
  });
  ...
  describe('GetBlockDetailsByBlockHashFromCallbackRIBS', function() {
    it('should create an instance of GetBlockDetailsByBlockHashFromCallbackRIBS', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashFromCallbackRIBS
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBS();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBS);
    });
