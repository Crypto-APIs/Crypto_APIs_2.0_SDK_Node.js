...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSBCVin();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSBCVin', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSBCVin', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSBCVin
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSBCVin();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSBCVin);
    });
