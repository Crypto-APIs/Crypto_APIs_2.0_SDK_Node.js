...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSD2();
  });
  ...
  describe('GetBlockDetailsByBlockHeightFromCallbackRIBSD2', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSD2', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightFromCallbackRIBSD2
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSD2();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSD2);
    });
