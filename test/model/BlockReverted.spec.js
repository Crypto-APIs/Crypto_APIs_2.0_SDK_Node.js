...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.BlockReverted();
  });
  ...
  describe('BlockReverted', function() {
    it('should create an instance of BlockReverted', function() {
      // uncomment below and update the code to test BlockReverted
      //var instance = new Cryptoapis.BlockReverted();
      //expect(instance).to.be.a(Cryptoapis.BlockReverted);
    });
