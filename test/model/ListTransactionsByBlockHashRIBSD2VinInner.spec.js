...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHashRIBSD2VinInner();
  });
  ...
  describe('ListTransactionsByBlockHashRIBSD2VinInner', function() {
    it('should create an instance of ListTransactionsByBlockHashRIBSD2VinInner', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashRIBSD2VinInner
      //var instance = new Cryptoapis.ListTransactionsByBlockHashRIBSD2VinInner();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHashRIBSD2VinInner);
    });
