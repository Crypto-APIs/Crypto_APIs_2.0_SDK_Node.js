...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetXRPRippleBlockDetailsByBlockHashResponseItem();
  });
  ...
  describe('GetXRPRippleBlockDetailsByBlockHashResponseItem', function() {
    it('should create an instance of GetXRPRippleBlockDetailsByBlockHashResponseItem', function() {
      // uncomment below and update the code to test GetXRPRippleBlockDetailsByBlockHashResponseItem
      //var instane = new CryptoApis.GetXRPRippleBlockDetailsByBlockHashResponseItem();
      //expect(instance).to.be.a(CryptoApis.GetXRPRippleBlockDetailsByBlockHashResponseItem);
    });
    ...
    it('should have the property blockHash (base name: "blockHash")', function() {
      ...
      //var instance = new CryptoApis.GetXRPRippleBlockDetailsByBlockHashResponseItem();
