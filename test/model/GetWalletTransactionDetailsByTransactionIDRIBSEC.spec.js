...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSEC();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSEC', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSEC', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSEC
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSEC();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSEC);
    });
