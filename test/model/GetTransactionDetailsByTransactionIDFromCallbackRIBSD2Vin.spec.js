...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSD2Vin);
    });
