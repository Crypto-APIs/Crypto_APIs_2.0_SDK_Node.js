...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific
      //var instane = new CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific();
      //expect(instance).to.be.a(CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific);
    });
    ...
    it('should have the property locktime (base name: "locktime")', function() {
      ...
      //var instance = new CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecific();
