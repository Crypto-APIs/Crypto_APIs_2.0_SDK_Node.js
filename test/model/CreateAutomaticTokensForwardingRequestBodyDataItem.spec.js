...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.CreateAutomaticTokensForwardingRequestBodyDataItem();
  });
  ...
  describe('CreateAutomaticTokensForwardingRequestBodyDataItem', function() {
    it('should create an instance of CreateAutomaticTokensForwardingRequestBodyDataItem', function() {
      // uncomment below and update the code to test CreateAutomaticTokensForwardingRequestBodyDataItem
      //var instane = new CryptoApis.CreateAutomaticTokensForwardingRequestBodyDataItem();
      //expect(instance).to.be.a(CryptoApis.CreateAutomaticTokensForwardingRequestBodyDataItem);
    });
    ...
    it('should have the property callbackSecretKey (base name: "callbackSecretKey")', function() {
      ...
      //var instance = new CryptoApis.CreateAutomaticTokensForwardingRequestBodyDataItem();
