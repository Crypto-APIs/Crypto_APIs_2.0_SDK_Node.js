...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBDataItem();
  });
  ...
  describe('PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBDataItem', function() {
    it('should create an instance of PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBDataItem', function() {
      // uncomment below and update the code to test PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBDataItem
      //var instance = new Cryptoapis.PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBDataItem);
    });
