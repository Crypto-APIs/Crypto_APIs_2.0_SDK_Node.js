...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISLVin();
  });
  ...
  describe('DecodeRawTransactionHexRISLVin', function() {
    it('should create an instance of DecodeRawTransactionHexRISLVin', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISLVin
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISLVin();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISLVin);
    });
