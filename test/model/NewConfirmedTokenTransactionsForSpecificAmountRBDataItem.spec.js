...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.NewConfirmedTokenTransactionsForSpecificAmountRBDataItem();
  });
  ...
  describe('NewConfirmedTokenTransactionsForSpecificAmountRBDataItem', function() {
    it('should create an instance of NewConfirmedTokenTransactionsForSpecificAmountRBDataItem', function() {
      // uncomment below and update the code to test NewConfirmedTokenTransactionsForSpecificAmountRBDataItem
      //var instance = new Cryptoapis.NewConfirmedTokenTransactionsForSpecificAmountRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.NewConfirmedTokenTransactionsForSpecificAmountRBDataItem);
    });
