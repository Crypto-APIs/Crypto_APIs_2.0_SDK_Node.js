...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSP();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSP', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSP', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSP
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSP();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSP);
    });
