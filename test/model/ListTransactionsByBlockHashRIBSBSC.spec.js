...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHashRIBSBSC();
  });
  ...
  describe('ListTransactionsByBlockHashRIBSBSC', function() {
    it('should create an instance of ListTransactionsByBlockHashRIBSBSC', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashRIBSBSC
      //var instance = new Cryptoapis.ListTransactionsByBlockHashRIBSBSC();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHashRIBSBSC);
    });
