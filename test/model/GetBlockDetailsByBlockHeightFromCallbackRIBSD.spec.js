...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSD();
  });
  ...
  describe('GetBlockDetailsByBlockHeightFromCallbackRIBSD', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightFromCallbackRIBSD', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightFromCallbackRIBSD
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSD();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHeightFromCallbackRIBSD);
    });
