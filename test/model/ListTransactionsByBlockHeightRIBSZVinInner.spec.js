...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSZVinInner();
  });
  ...
  describe('ListTransactionsByBlockHeightRIBSZVinInner', function() {
    it('should create an instance of ListTransactionsByBlockHeightRIBSZVinInner', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightRIBSZVinInner
      //var instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSZVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHeightRIBSZVinInner);
    });
