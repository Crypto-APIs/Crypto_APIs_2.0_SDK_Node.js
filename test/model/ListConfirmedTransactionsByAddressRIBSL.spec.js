...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSL();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSL', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSL', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSL
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSL();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSL);
    });
