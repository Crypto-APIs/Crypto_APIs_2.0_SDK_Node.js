...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLastMinedBlockRIBSD2();
  });
  ...
  describe('GetLastMinedBlockRIBSD2', function() {
    it('should create an instance of GetLastMinedBlockRIBSD2', function() {
      // uncomment below and update the code to test GetLastMinedBlockRIBSD2
      //var instance = new Cryptoapis.GetLastMinedBlockRIBSD2();
      //expect(instance).to.be.a(Cryptoapis.GetLastMinedBlockRIBSD2);
    });
