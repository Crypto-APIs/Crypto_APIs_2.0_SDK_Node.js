...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.NewConfirmedCoinsTransactionsAndEachConfirmationResponseItem();
  });
  ...
  describe('NewConfirmedCoinsTransactionsAndEachConfirmationResponseItem', function() {
    it('should create an instance of NewConfirmedCoinsTransactionsAndEachConfirmationResponseItem', function() {
      // uncomment below and update the code to test NewConfirmedCoinsTransactionsAndEachConfirmationResponseItem
      //var instane = new CryptoApis.NewConfirmedCoinsTransactionsAndEachConfirmationResponseItem();
      //expect(instance).to.be.a(CryptoApis.NewConfirmedCoinsTransactionsAndEachConfirmationResponseItem);
    });

    it('should have the property address (base name: "address")', function() {
      // uncomment below and update the code to test the property address
      //var instance = new CryptoApis.NewConfirmedCoinsTransactionsAndEachConfirmationResponseItem();
