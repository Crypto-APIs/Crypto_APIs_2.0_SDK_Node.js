...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListXRPRippleTransactionsByAddressAndTimeRangeRI();
  });
  ...
  describe('ListXRPRippleTransactionsByAddressAndTimeRangeRI', function() {
    it('should create an instance of ListXRPRippleTransactionsByAddressAndTimeRangeRI', function() {
      // uncomment below and update the code to test ListXRPRippleTransactionsByAddressAndTimeRangeRI
      //var instance = new Cryptoapis.ListXRPRippleTransactionsByAddressAndTimeRangeRI();
      //expect(instance).to.be.a(Cryptoapis.ListXRPRippleTransactionsByAddressAndTimeRangeRI);
    });
