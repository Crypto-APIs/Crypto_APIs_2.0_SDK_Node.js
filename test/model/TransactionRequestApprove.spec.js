...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.TransactionRequestApprove();
  });
  ...
  describe('TransactionRequestApprove', function() {
    it('should create an instance of TransactionRequestApprove', function() {
      // uncomment below and update the code to test TransactionRequestApprove
      //var instane = new Cryptoapis.TransactionRequestApprove();
      //expect(instance).to.be.a(Cryptoapis.TransactionRequestApprove);
    });
    ...
    it('should have the property apiVersion (base name: "apiVersion")', function() {
      ...
      //var instance = new Cryptoapis.TransactionRequestApprove();
