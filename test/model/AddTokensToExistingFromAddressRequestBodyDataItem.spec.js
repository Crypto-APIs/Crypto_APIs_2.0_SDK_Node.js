...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.AddTokensToExistingFromAddressRequestBodyDataItem();
  });
  ...
  describe('AddTokensToExistingFromAddressRequestBodyDataItem', function() {
    it('should create an instance of AddTokensToExistingFromAddressRequestBodyDataItem', function() {
      // uncomment below and update the code to test AddTokensToExistingFromAddressRequestBodyDataItem
      //var instane = new CryptoApis.AddTokensToExistingFromAddressRequestBodyDataItem();
      //expect(instance).to.be.a(CryptoApis.AddTokensToExistingFromAddressRequestBodyDataItem);
    });
    ...
    it('should have the property callbackSecretKey (base name: "callbackSecretKey")', function() {
      ...
      //var instance = new CryptoApis.AddTokensToExistingFromAddressRequestBodyDataItem();
