...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSDVinInner();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDRIBSDVinInner', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDRIBSDVinInner', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDRIBSDVinInner
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSDVinInner();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDRIBSDVinInner);
    });
