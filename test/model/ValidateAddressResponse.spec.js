...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ValidateAddressResponse();
  });
  ...
  describe('ValidateAddressResponse', function() {
    it('should create an instance of ValidateAddressResponse', function() {
      ...
      //var instane = new CryptoApis.ValidateAddressResponse();
      //expect(instance).to.be.a(CryptoApis.ValidateAddressResponse);
    });
    ...
    it('should have the property apiVersion (base name: "apiVersion")', function() {
      ...
      //var instance = new CryptoApis.ValidateAddressResponse();
