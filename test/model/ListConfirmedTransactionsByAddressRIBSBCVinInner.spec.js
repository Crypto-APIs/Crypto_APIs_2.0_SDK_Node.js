...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSBCVinInner();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSBCVinInner', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSBCVinInner', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSBCVinInner
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSBCVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSBCVinInner);
    });
