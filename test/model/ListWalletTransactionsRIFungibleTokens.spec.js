...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListWalletTransactionsRIFungibleTokens();
  });
  ...
  describe('ListWalletTransactionsRIFungibleTokens', function() {
    it('should create an instance of ListWalletTransactionsRIFungibleTokens', function() {
      // uncomment below and update the code to test ListWalletTransactionsRIFungibleTokens
      //var instance = new Cryptoapis.ListWalletTransactionsRIFungibleTokens();
      //expect(instance).to.be.a(Cryptoapis.ListWalletTransactionsRIFungibleTokens);
    });
