...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSEC();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDFromCallbackRIBSEC', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSEC', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDFromCallbackRIBSEC
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSEC();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSEC);
    });
