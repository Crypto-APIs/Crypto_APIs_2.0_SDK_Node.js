...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic();
  });
  ...
  describe('ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic', function() {
    it('should create an instance of ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic
      //var instane = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic);
    });
    ...
    it('should have the property contract (base name: "contract")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic();
