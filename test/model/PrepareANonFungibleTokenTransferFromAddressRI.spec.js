...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRI();
  });
  ...
  describe('PrepareANonFungibleTokenTransferFromAddressRI', function() {
    it('should create an instance of PrepareANonFungibleTokenTransferFromAddressRI', function() {
      // uncomment below and update the code to test PrepareANonFungibleTokenTransferFromAddressRI
      //var instance = new Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRI();
      //expect(instance).to.be.a(Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRI);
    });
