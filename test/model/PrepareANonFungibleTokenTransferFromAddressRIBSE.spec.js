...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRIBSE();
  });
  ...
  describe('PrepareANonFungibleTokenTransferFromAddressRIBSE', function() {
    it('should create an instance of PrepareANonFungibleTokenTransferFromAddressRIBSE', function() {
      // uncomment below and update the code to test PrepareANonFungibleTokenTransferFromAddressRIBSE
      //var instance = new Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRIBSE();
      //expect(instance).to.be.a(Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRIBSE);
    });
