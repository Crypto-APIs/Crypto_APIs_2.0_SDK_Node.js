...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSB();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSB', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSB', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSB
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSB();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSB);
    });
