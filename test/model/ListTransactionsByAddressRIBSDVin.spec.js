...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByAddressRIBSDVin();
  });
  ...
  describe('ListTransactionsByAddressRIBSDVin', function() {
    it('should create an instance of ListTransactionsByAddressRIBSDVin', function() {
      // uncomment below and update the code to test ListTransactionsByAddressRIBSDVin
      //var instane = new Cryptoapis.ListTransactionsByAddressRIBSDVin();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByAddressRIBSDVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new Cryptoapis.ListTransactionsByAddressRIBSDVin();
