...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSLVin();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSLVin', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSLVin', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSLVin
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSLVin();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSLVin);
    });
