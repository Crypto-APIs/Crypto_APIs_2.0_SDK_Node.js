...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBST();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBST', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBST', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBST
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBST();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBST);
    });
