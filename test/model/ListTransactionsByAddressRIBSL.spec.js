...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByAddressRIBSL();
  });
  ...
  describe('ListTransactionsByAddressRIBSL', function() {
    it('should create an instance of ListTransactionsByAddressRIBSL', function() {
      // uncomment below and update the code to test ListTransactionsByAddressRIBSL
      //var instane = new Cryptoapis.ListTransactionsByAddressRIBSL();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByAddressRIBSL);
    });
    ...
    it('should have the property locktime (base name: "locktime")', function() {
      ...
      //var instance = new Cryptoapis.ListTransactionsByAddressRIBSL();
