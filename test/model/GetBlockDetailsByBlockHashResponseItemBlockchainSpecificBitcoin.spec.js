...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin();
  });
  ...
  describe('GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin', function() {
    it('should create an instance of GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin
      //var instane = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin();
      //expect(instance).to.be.a(CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin();
