...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin();
  });
  ...
  describe('ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin', function() {
    it('should create an instance of ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin
      //var instane = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVin();
