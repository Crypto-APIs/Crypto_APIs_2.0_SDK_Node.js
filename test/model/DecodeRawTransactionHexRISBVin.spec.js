...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISBVin();
  });
  ...
  describe('DecodeRawTransactionHexRISBVin', function() {
    it('should create an instance of DecodeRawTransactionHexRISBVin', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISBVin
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISBVin();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISBVin);
    });
