...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSE();
  });
  ...
  describe('GetBlockDetailsByBlockHashFromCallbackRIBSE', function() {
    it('should create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSE', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashFromCallbackRIBSE
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSE();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSE);
    });
