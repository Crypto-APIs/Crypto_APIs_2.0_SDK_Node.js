...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBS();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBS', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBS', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBS
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBS();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBS);
    });
