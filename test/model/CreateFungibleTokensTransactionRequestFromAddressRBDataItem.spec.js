...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.CreateFungibleTokensTransactionRequestFromAddressRBDataItem();
  });
  ...
  describe('CreateFungibleTokensTransactionRequestFromAddressRBDataItem', function() {
    it('should create an instance of CreateFungibleTokensTransactionRequestFromAddressRBDataItem', function() {
      // uncomment below and update the code to test CreateFungibleTokensTransactionRequestFromAddressRBDataItem
      //var instance = new Cryptoapis.CreateFungibleTokensTransactionRequestFromAddressRBDataItem();
      //expect(instance).to.be.a(Cryptoapis.CreateFungibleTokensTransactionRequestFromAddressRBDataItem);
    });
