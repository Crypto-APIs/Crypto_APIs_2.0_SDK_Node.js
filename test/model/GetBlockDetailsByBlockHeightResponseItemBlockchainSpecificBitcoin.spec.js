...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin();
  });
  ...
  describe('GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin
      //var instane = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin();
      //expect(instance).to.be.a(CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin();
