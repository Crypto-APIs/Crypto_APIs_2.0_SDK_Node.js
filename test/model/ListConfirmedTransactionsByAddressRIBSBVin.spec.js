...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSBVin();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSBVin', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSBVin', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSBVin
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSBVin();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSBVin);
    });
