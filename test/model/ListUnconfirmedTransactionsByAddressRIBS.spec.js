...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBS();
  });
  ...
  describe('ListUnconfirmedTransactionsByAddressRIBS', function() {
    it('should create an instance of ListUnconfirmedTransactionsByAddressRIBS', function() {
      // uncomment below and update the code to test ListUnconfirmedTransactionsByAddressRIBS
      //var instance = new Cryptoapis.ListUnconfirmedTransactionsByAddressRIBS();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTransactionsByAddressRIBS);
    });
