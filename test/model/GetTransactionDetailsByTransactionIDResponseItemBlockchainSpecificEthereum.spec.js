...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereum();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereum', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereum', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereum
      //var instane = new CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereum();
      //expect(instance).to.be.a(CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereum);
    });
    ...
    it('should have the property contract (base name: "contract")', function() {
      ...
      //var instance = new CryptoApis.GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificEthereum();
