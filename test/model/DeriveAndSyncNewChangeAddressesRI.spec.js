...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DeriveAndSyncNewChangeAddressesRI();
  });
  ...
  describe('DeriveAndSyncNewChangeAddressesRI', function() {
    it('should create an instance of DeriveAndSyncNewChangeAddressesRI', function() {
      // uncomment below and update the code to test DeriveAndSyncNewChangeAddressesRI
      //var instance = new Cryptoapis.DeriveAndSyncNewChangeAddressesRI();
      //expect(instance).to.be.a(Cryptoapis.DeriveAndSyncNewChangeAddressesRI);
    });
