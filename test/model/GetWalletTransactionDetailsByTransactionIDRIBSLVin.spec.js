...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSLVin();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSLVin', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSLVin', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSLVin
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSLVin();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSLVin);
    });
