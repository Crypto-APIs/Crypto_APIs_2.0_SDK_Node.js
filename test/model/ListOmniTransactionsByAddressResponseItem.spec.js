...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListOmniTransactionsByAddressResponseItem();
  });
  ...
  describe('ListOmniTransactionsByAddressResponseItem', function() {
    it('should create an instance of ListOmniTransactionsByAddressResponseItem', function() {
      // uncomment below and update the code to test ListOmniTransactionsByAddressResponseItem
      //var instane = new CryptoApis.ListOmniTransactionsByAddressResponseItem();
      //expect(instance).to.be.a(CryptoApis.ListOmniTransactionsByAddressResponseItem);
    });

    it('should have the property amount (base name: "amount")', function() {
      // uncomment below and update the code to test the property amount
      //var instance = new CryptoApis.ListOmniTransactionsByAddressResponseItem();
