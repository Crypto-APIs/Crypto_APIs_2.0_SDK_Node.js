...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSBCVinInner();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDRIBSBCVinInner', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDRIBSBCVinInner', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDRIBSBCVinInner
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSBCVinInner();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDRIBSBCVinInner);
    });
