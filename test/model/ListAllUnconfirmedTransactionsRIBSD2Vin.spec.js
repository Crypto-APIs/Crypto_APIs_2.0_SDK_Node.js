...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSD2Vin();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSD2Vin', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSD2Vin', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSD2Vin
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSD2Vin();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSD2Vin);
    });
