...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSZScriptPubKey();
  });
  ...
  describe('ListTransactionsByBlockHeightRIBSZScriptPubKey', function() {
    it('should create an instance of ListTransactionsByBlockHeightRIBSZScriptPubKey', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightRIBSZScriptPubKey
      //var instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSZScriptPubKey();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHeightRIBSZScriptPubKey);
    });
