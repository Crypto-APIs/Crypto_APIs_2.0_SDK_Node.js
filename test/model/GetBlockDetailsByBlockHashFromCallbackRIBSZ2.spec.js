...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSZ2();
  });
  ...
  describe('GetBlockDetailsByBlockHashFromCallbackRIBSZ2', function() {
    it('should create an instance of GetBlockDetailsByBlockHashFromCallbackRIBSZ2', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashFromCallbackRIBSZ2
      //var instance = new Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSZ2();
      //expect(instance).to.be.a(Cryptoapis.GetBlockDetailsByBlockHashFromCallbackRIBSZ2);
    });
