...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBSE();
  });
  ...
  describe('ListConfirmedTransactionsByAddressAndTimeRangeRIBSE', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSE', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressAndTimeRangeRIBSE
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBSE();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBSE);
    });
