...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin();
  });
  ...
  describe('GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin', function() {
    it('should create an instance of GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin
      //var instane = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin();
      //expect(instance).to.be.a(CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin();
