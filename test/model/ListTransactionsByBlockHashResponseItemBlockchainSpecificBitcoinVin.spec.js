...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinVin();
  });
  ...
  describe('ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinVin', function() {
    it('should create an instance of ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinVin', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinVin
      //var instane = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinVin();
      //expect(instance).to.be.a(CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new CryptoApis.ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinVin();
