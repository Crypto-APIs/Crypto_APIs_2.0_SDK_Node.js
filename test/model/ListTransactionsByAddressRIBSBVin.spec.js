...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByAddressRIBSBVin();
  });
  ...
  describe('ListTransactionsByAddressRIBSBVin', function() {
    it('should create an instance of ListTransactionsByAddressRIBSBVin', function() {
      // uncomment below and update the code to test ListTransactionsByAddressRIBSBVin
      //var instane = new Cryptoapis.ListTransactionsByAddressRIBSBVin();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByAddressRIBSBVin);
    });
    ...
    it('should have the property addresses (base name: "addresses")', function() {
      ...
      //var instance = new Cryptoapis.ListTransactionsByAddressRIBSBVin();
