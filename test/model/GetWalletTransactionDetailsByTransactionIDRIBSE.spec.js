...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSE();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSE', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSE', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSE
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSE();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSE);
    });
