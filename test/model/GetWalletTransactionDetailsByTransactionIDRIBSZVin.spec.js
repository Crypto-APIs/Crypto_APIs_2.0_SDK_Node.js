...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSZVin();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSZVin', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSZVin', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSZVin
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSZVin();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSZVin);
    });
