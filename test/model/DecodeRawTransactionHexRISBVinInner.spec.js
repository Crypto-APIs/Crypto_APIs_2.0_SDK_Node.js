...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.DecodeRawTransactionHexRISBVinInner();
  });
  ...
  describe('DecodeRawTransactionHexRISBVinInner', function() {
    it('should create an instance of DecodeRawTransactionHexRISBVinInner', function() {
      // uncomment below and update the code to test DecodeRawTransactionHexRISBVinInner
      //var instance = new Cryptoapis.DecodeRawTransactionHexRISBVinInner();
      //expect(instance).to.be.a(Cryptoapis.DecodeRawTransactionHexRISBVinInner);
    });
