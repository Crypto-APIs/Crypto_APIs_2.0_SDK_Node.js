...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSP();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDFromCallbackRIBSP', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDFromCallbackRIBSP', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDFromCallbackRIBSP
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSP();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDFromCallbackRIBSP);
    });
