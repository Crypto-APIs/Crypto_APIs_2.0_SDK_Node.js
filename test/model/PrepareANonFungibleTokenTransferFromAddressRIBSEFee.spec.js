...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRIBSEFee();
  });
  ...
  describe('PrepareANonFungibleTokenTransferFromAddressRIBSEFee', function() {
    it('should create an instance of PrepareANonFungibleTokenTransferFromAddressRIBSEFee', function() {
      // uncomment below and update the code to test PrepareANonFungibleTokenTransferFromAddressRIBSEFee
      //var instance = new Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRIBSEFee();
      //expect(instance).to.be.a(Cryptoapis.PrepareANonFungibleTokenTransferFromAddressRIBSEFee);
    });
