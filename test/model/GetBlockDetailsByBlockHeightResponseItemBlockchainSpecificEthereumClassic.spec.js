...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic();
  });
  ...
  describe('GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic', function() {
    it('should create an instance of GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic', function() {
      // uncomment below and update the code to test GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic
      //var instane = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic();
      //expect(instance).to.be.a(CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic);
    });
    ...
    it('should have the property difficulty (base name: "difficulty")', function() {
      ...
      //var instance = new CryptoApis.GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic();
