...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListUnconfirmedTokensTransfersByAddressRI();
  });
  ...
  describe('ListUnconfirmedTokensTransfersByAddressRI', function() {
    it('should create an instance of ListUnconfirmedTokensTransfersByAddressRI', function() {
      // uncomment below and update the code to test ListUnconfirmedTokensTransfersByAddressRI
      //var instance = new Cryptoapis.ListUnconfirmedTokensTransfersByAddressRI();
      //expect(instance).to.be.a(Cryptoapis.ListUnconfirmedTokensTransfersByAddressRI);
    });
