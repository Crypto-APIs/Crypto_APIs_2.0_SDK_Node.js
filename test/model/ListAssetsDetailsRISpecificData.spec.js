...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAssetsDetailsRISpecificData();
  });
  ...
  describe('ListAssetsDetailsRISpecificData', function() {
    it('should create an instance of ListAssetsDetailsRISpecificData', function() {
      // uncomment below and update the code to test ListAssetsDetailsRISpecificData
      //var instane = new Cryptoapis.ListAssetsDetailsRISpecificData();
      //expect(instance).to.be.a(Cryptoapis.ListAssetsDetailsRISpecificData);
    });
    ...
    it('should have the property _1hourPriceChangeInPercentage (base name: "1HourPriceChangeInPercentage")', function() {
      ...
      //var instance = new Cryptoapis.ListAssetsDetailsRISpecificData();
