...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSZ();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDRIBSZ', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDRIBSZ', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDRIBSZ
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSZ();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDRIBSZ);
    });
