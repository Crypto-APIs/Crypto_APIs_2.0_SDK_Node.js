...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSDVinInner();
  });
  ...
  describe('ListTransactionsByBlockHeightRIBSDVinInner', function() {
    it('should create an instance of ListTransactionsByBlockHeightRIBSDVinInner', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightRIBSDVinInner
      //var instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSDVinInner();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHeightRIBSDVinInner);
    });
