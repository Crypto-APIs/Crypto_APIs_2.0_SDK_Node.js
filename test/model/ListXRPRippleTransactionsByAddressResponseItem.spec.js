...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CryptoApis.ListXRPRippleTransactionsByAddressResponseItem();
  });
  ...
  describe('ListXRPRippleTransactionsByAddressResponseItem', function() {
    it('should create an instance of ListXRPRippleTransactionsByAddressResponseItem', function() {
      // uncomment below and update the code to test ListXRPRippleTransactionsByAddressResponseItem
      //var instane = new CryptoApis.ListXRPRippleTransactionsByAddressResponseItem();
      //expect(instance).to.be.a(CryptoApis.ListXRPRippleTransactionsByAddressResponseItem);
    });
    ...
    it('should have the property additionalData (base name: "additionalData")', function() {
      ...
      //var instance = new CryptoApis.ListXRPRippleTransactionsByAddressResponseItem();
