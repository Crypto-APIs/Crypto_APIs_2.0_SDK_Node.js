...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSEC();
  });
  ...
  describe('ListAllUnconfirmedTransactionsRIBSEC', function() {
    it('should create an instance of ListAllUnconfirmedTransactionsRIBSEC', function() {
      // uncomment below and update the code to test ListAllUnconfirmedTransactionsRIBSEC
      //var instance = new Cryptoapis.ListAllUnconfirmedTransactionsRIBSEC();
      //expect(instance).to.be.a(Cryptoapis.ListAllUnconfirmedTransactionsRIBSEC);
    });
