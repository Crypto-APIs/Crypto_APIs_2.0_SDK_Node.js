...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSLVinInner();
  });
  ...
  describe('GetWalletTransactionDetailsByTransactionIDRIBSLVinInner', function() {
    it('should create an instance of GetWalletTransactionDetailsByTransactionIDRIBSLVinInner', function() {
      // uncomment below and update the code to test GetWalletTransactionDetailsByTransactionIDRIBSLVinInner
      //var instance = new Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSLVinInner();
      //expect(instance).to.be.a(Cryptoapis.GetWalletTransactionDetailsByTransactionIDRIBSLVinInner);
    });
