...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetLastMinedBlockRIBSBC();
  });
  ...
  describe('GetLastMinedBlockRIBSBC', function() {
    it('should create an instance of GetLastMinedBlockRIBSBC', function() {
      // uncomment below and update the code to test GetLastMinedBlockRIBSBC
      //var instance = new Cryptoapis.GetLastMinedBlockRIBSBC();
      //expect(instance).to.be.a(Cryptoapis.GetLastMinedBlockRIBSBC);
    });
