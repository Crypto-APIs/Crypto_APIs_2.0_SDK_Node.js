...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSZ();
  });
  ...
  describe('ListTransactionsByBlockHeightRIBSZ', function() {
    it('should create an instance of ListTransactionsByBlockHeightRIBSZ', function() {
      // uncomment below and update the code to test ListTransactionsByBlockHeightRIBSZ
      //var instance = new Cryptoapis.ListTransactionsByBlockHeightRIBSZ();
      //expect(instance).to.be.a(Cryptoapis.ListTransactionsByBlockHeightRIBSZ);
    });
