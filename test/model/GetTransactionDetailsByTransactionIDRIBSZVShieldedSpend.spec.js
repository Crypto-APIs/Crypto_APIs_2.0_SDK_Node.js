...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSZVShieldedSpend();
  });
  ...
  describe('GetTransactionDetailsByTransactionIDRIBSZVShieldedSpend', function() {
    it('should create an instance of GetTransactionDetailsByTransactionIDRIBSZVShieldedSpend', function() {
      // uncomment below and update the code to test GetTransactionDetailsByTransactionIDRIBSZVShieldedSpend
      //var instance = new Cryptoapis.GetTransactionDetailsByTransactionIDRIBSZVShieldedSpend();
      //expect(instance).to.be.a(Cryptoapis.GetTransactionDetailsByTransactionIDRIBSZVShieldedSpend);
    });
