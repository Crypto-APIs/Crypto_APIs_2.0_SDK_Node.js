...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ();
  });
  ...
  describe('ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressAndTimeRangeRIBSZ);
    });
