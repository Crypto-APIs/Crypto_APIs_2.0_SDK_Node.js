...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSLVin();
  });
  ...
  describe('ListConfirmedTransactionsByAddressRIBSLVin', function() {
    it('should create an instance of ListConfirmedTransactionsByAddressRIBSLVin', function() {
      // uncomment below and update the code to test ListConfirmedTransactionsByAddressRIBSLVin
      //var instance = new Cryptoapis.ListConfirmedTransactionsByAddressRIBSLVin();
      //expect(instance).to.be.a(Cryptoapis.ListConfirmedTransactionsByAddressRIBSLVin);
    });
