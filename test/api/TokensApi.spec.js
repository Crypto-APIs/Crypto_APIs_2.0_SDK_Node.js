...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cryptoapis.TokensApi();
  });
  ...
  describe('TokensApi', function() {
    ...
    describe('listTokensByAddress', function() {
    ...
    describe('listTokensTransfersByTransactionHash', function() {
      it('should call listTokensTransfersByTransactionHash successfully', function(done) {
        //uncomment below and update the code to test listTokensTransfersByTransactionHash
        //instance.listTokensTransfersByTransactionHash(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
