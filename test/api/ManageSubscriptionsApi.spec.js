...
(function(root, factory) {
  ...
  describe('ManageSubscriptionsApi', function() {
    describe('activateBlockchainEventSubscription', function() {
      it('should call activateBlockchainEventSubscription successfully', function(done) {
        //uncomment below and update the code to test activateBlockchainEventSubscription
        //instance.activateBlockchainEventSubscription(function(error) {
