...
var GetBlockDetailsByBlockHeightRIBSZ = /*#__PURE__*/function () {
  ...
  _createClass(GetBlockDetailsByBlockHeightRIBSZ, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHeightRIBSZ</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHeightRIBSZ</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHeightRIBSZ.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHeightRIBSZ.RequiredProperties = ["difficulty", "bits", "chainwork", "merkleRoot", "nonce", "size", "version"];
