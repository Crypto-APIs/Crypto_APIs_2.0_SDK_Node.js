...
var GetXRPRippleTransactionDetailsByTransactionIDRData = /*#__PURE__*/function () {
  ...
  _createClass(GetXRPRippleTransactionDetailsByTransactionIDRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetXRPRippleTransactionDetailsByTransactionIDRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _GetXRPRippleTransactionDetailsByTransactionIDRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
