...
var NewConfirmedTokensTransactionsAndEachConfirmationE400 = /*#__PURE__*/function () {
  ...
  function NewConfirmedTokensTransactionsAndEachConfirmationE400() {
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `NewConfirmedTokensTransactionsAndEachConfirmationE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(NewConfirmedTokensTransactionsAndEachConfirmationE400, [{
 ...
 * @member {String} code
 */
_defineProperty(NewConfirmedTokensTransactionsAndEachConfirmationE400, "fromJSON", function (json_string) {
