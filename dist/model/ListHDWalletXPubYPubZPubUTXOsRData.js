...
var ListHDWalletXPubYPubZPubUTXOsRData = /*#__PURE__*/function () {
  ...
  _createClass(ListHDWalletXPubYPubZPubUTXOsRData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListHDWalletXPubYPubZPubUTXOsRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListHDWalletXPubYPubZPubUTXOsRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListHDWalletXPubYPubZPubUTXOsRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListHDWalletXPubYPubZPubUTXOsRI["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
ListHDWalletXPubYPubZPubUTXOsRData.RequiredProperties = ["limit", "offset", "total", "items"];
