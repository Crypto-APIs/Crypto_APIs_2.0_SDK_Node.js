...
var ConfirmedTokensTransactionForCertainAmountOrHigherBep20 = /*#__PURE__*/function () {
  ...
  _createClass(ConfirmedTokensTransactionForCertainAmountOrHigherBep20, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmedTokensTransactionForCertainAmountOrHigherBep20</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmedTokensTransactionForCertainAmountOrHigherBep20</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ConfirmedTokensTransactionForCertainAmountOrHigherBep20.RequiredProperties),
        _step;
      try {
...
ConfirmedTokensTransactionForCertainAmountOrHigherBep20.RequiredProperties = ["name", "symbol", "amount", "contractAddress"];
