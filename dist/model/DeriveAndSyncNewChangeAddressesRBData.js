...
var DeriveAndSyncNewChangeAddressesRBData = /*#__PURE__*/function () {
  ...
  _createClass(DeriveAndSyncNewChangeAddressesRBData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DeriveAndSyncNewChangeAddressesRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _DeriveAndSyncNewChangeAddressesRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
