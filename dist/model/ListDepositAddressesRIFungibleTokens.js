 ...
 * @version 1.4.0
 */
var ListDepositAddressesRIFungibleTokens = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListDepositAddressesRIFungibleTokens(amount, identifier, name, symbol, tokenDecimals, type) {
    _classCallCheck(this, ListDepositAddressesRIFungibleTokens);
  ...
  _createClass(ListDepositAddressesRIFungibleTokens, null, [{
    key: "initialize",
  ...
  return ListDepositAddressesRIFungibleTokens;
}();
/**
...
var _default = ListDepositAddressesRIFungibleTokens;
