...
var ListTransactionsByBlockHashRIBSLVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHashRIBSLVoutInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIBSLVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _ListTransactionsByBlockHashRIBSLVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
