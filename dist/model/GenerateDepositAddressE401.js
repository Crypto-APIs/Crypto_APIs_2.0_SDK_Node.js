...
var GenerateDepositAddressE401 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidApiKey|module:model/MissingApiKey)} instance The actual instance to initialize GenerateDepositAddressE401.
   */
  function GenerateDepositAddressE401() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GenerateDepositAddressE401);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GenerateDepositAddressE401` with oneOf schemas InvalidApiKey, MissingApiKey. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GenerateDepositAddressE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>GenerateDepositAddressE401</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GenerateDepositAddressE401} obj Optional instance to populate.
   * @return {module:model/GenerateDepositAddressE401} The populated <code>GenerateDepositAddressE401</code> instance.
   */
  _createClass(GenerateDepositAddressE401, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GenerateDepositAddressE401.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GenerateDepositAddressE401(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GenerateDepositAddressE401, "fromJSON", function (json_string) {
  return GenerateDepositAddressE401.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GenerateDepositAddressE401.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
GenerateDepositAddressE401.prototype['details'] = undefined;
GenerateDepositAddressE401.OneOf = ["InvalidApiKey", "MissingApiKey"];
var _default = GenerateDepositAddressE401;
