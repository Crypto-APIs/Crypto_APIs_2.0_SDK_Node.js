...
/**
 * The ListOmniTokensByAddressE400 model module.
 * @module model/ListOmniTokensByAddressE400
 * @version 1.5.0
 */
var ListOmniTokensByAddressE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListOmniTokensByAddressE400</code>.
   * @alias module:model/ListOmniTokensByAddressE400
   ...
   */
  function ListOmniTokensByAddressE400(code, message) {
    _classCallCheck(this, ListOmniTokensByAddressE400);
    ...
    ListOmniTokensByAddressE400.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListOmniTokensByAddressE400, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListOmniTokensByAddressE400</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListOmniTokensByAddressE400} obj Optional instance to populate.
     * @return {module:model/ListOmniTokensByAddressE400} The populated <code>ListOmniTokensByAddressE400</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListOmniTokensByAddressE400();
...
ListOmniTokensByAddressE400.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListOmniTokensByAddressE400.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetails>} details
 */

ListOmniTokensByAddressE400.prototype['details'] = undefined; // Implement UriNotFound interface:
...
var _default = ListOmniTokensByAddressE400;
