...
var GetTransactionDetailsByTransactionIDRIBSD2 = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDRIBSD2, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDRIBSD2.RequiredProperties),
        _step;
      try {
      ...
      if (data['vin']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _GetTransactionDetailsByTransactionIDRIBSD2VinInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
