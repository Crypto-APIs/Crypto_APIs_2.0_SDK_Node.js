...
var PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEC = /*#__PURE__*/function () {
  ...
  _createClass(PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEC, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEC.RequiredProperties),
        _step;
      try {
      ...
      if (data['fee']) {
        // data not null
        _PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSECFee["default"].validateJSON(data['fee']);
      }
      // ensure the json data is a string
