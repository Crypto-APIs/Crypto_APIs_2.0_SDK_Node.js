...
var NewRevertedBlockE401 = /*#__PURE__*/function () {
   ...
   */
  function NewRevertedBlockE401(code, message) {
    ...
    NewRevertedBlockE401.initialize(this, code, message);
  }
   ...
   */
  _createClass(NewRevertedBlockE401, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new NewRevertedBlockE401();
