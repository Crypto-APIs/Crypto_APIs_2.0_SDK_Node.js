...
var _ListTransactionsByAddressRIBSLVin = _interopRequireDefault(require("./ListTransactionsByAddressRIBSLVin"));
 ...
 * @version 1.2.1
 */
var ListTransactionsByAddressRIBSL = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListTransactionsByAddressRIBSL(locktime, size, vSize, version, vin, vout) {
    _classCallCheck(this, ListTransactionsByAddressRIBSL);
  ...
  _createClass(ListTransactionsByAddressRIBSL, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('vin')) {
          obj['vin'] = _ApiClient["default"].convertToType(data['vin'], [_ListTransactionsByAddressRIBSLVin["default"]]);
        }
  ...
  return ListTransactionsByAddressRIBSL;
}();
/**
...
var _default = ListTransactionsByAddressRIBSL;
