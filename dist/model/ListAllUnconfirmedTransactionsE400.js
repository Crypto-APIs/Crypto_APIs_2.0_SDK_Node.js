...
/**
 * The ListAllUnconfirmedTransactionsE400 model module.
 * @module model/ListAllUnconfirmedTransactionsE400
 * @version 1.7.2
 */
var ListAllUnconfirmedTransactionsE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListAllUnconfirmedTransactionsE400</code>.
   * @alias module:model/ListAllUnconfirmedTransactionsE400
   ...
   */
  function ListAllUnconfirmedTransactionsE400(code, message) {
    _classCallCheck(this, ListAllUnconfirmedTransactionsE400);
    ...
    ListAllUnconfirmedTransactionsE400.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListAllUnconfirmedTransactionsE400, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListAllUnconfirmedTransactionsE400</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAllUnconfirmedTransactionsE400} obj Optional instance to populate.
     * @return {module:model/ListAllUnconfirmedTransactionsE400} The populated <code>ListAllUnconfirmedTransactionsE400</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListAllUnconfirmedTransactionsE400();
  ...
  return ListAllUnconfirmedTransactionsE400;
}();
/**
...
ListAllUnconfirmedTransactionsE400.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListAllUnconfirmedTransactionsE400.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

ListAllUnconfirmedTransactionsE400.prototype['details'] = undefined; // Implement UriNotFound interface:
...
var _default = ListAllUnconfirmedTransactionsE400;
