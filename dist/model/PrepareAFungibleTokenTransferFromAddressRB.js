...
var _PrepareAFungibleTokenTransferFromAddressRBData = _interopRequireDefault(require("./PrepareAFungibleTokenTransferFromAddressRBData"));
 ...
 * @version 1.13.0
 */
var PrepareAFungibleTokenTransferFromAddressRB = /*#__PURE__*/function () {
  /**
   ...
   */
  function PrepareAFungibleTokenTransferFromAddressRB(data) {
    _classCallCheck(this, PrepareAFungibleTokenTransferFromAddressRB);
   ...
   */
  _createClass(PrepareAFungibleTokenTransferFromAddressRB, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _PrepareAFungibleTokenTransferFromAddressRBData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
...
var _default = PrepareAFungibleTokenTransferFromAddressRB;
