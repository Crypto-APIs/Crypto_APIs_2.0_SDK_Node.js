...
var ListUnconfirmedTransactionsByAddressRIBSD2VinInner = /*#__PURE__*/function () {
  ...
  _createClass(ListUnconfirmedTransactionsByAddressRIBSD2VinInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListUnconfirmedTransactionsByAddressRIBSD2VinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUnconfirmedTransactionsByAddressRIBSD2VinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListUnconfirmedTransactionsByAddressRIBSD2VinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _ListConfirmedTransactionsByAddressRIBSD2VinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
...
ListUnconfirmedTransactionsByAddressRIBSD2VinInner.RequiredProperties = ["addresses", "scriptSig", "sequence", "txid", "txinwitness", "vout"];
