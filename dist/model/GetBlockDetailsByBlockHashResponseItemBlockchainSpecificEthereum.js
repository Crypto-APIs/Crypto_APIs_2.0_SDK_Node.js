...
/**
 * The GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum model module.
 * @module model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum
 * @version 2.0.0
 */
var GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum</code>.
   * Ethereum
   * @alias module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum
   ...
   */
  function GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles) {
    _classCallCheck(this, GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum);

    GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum.initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles);
  }
  /**
  ...
  _createClass(GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum} The populated <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum();
  ...
  return GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum;
}();
/**
...
var _default = GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereum;
