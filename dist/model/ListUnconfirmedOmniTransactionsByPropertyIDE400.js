...
/**
 * The ListUnconfirmedOmniTransactionsByPropertyIDE400 model module.
 * @module model/ListUnconfirmedOmniTransactionsByPropertyIDE400
 * @version 1.5.0
 */
var ListUnconfirmedOmniTransactionsByPropertyIDE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListUnconfirmedOmniTransactionsByPropertyIDE400</code>.
   * @alias module:model/ListUnconfirmedOmniTransactionsByPropertyIDE400
   ...
   */
  function ListUnconfirmedOmniTransactionsByPropertyIDE400(code, message) {
    _classCallCheck(this, ListUnconfirmedOmniTransactionsByPropertyIDE400);
    ...
    ListUnconfirmedOmniTransactionsByPropertyIDE400.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListUnconfirmedOmniTransactionsByPropertyIDE400, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListUnconfirmedOmniTransactionsByPropertyIDE400</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUnconfirmedOmniTransactionsByPropertyIDE400} obj Optional instance to populate.
     * @return {module:model/ListUnconfirmedOmniTransactionsByPropertyIDE400} The populated <code>ListUnconfirmedOmniTransactionsByPropertyIDE400</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListUnconfirmedOmniTransactionsByPropertyIDE400();
  ...
  return ListUnconfirmedOmniTransactionsByPropertyIDE400;
}();
/**
...
ListUnconfirmedOmniTransactionsByPropertyIDE400.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListUnconfirmedOmniTransactionsByPropertyIDE400.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetails>} details
 */

ListUnconfirmedOmniTransactionsByPropertyIDE400.prototype['details'] = undefined; // Implement UriNotFound interface:
...
var _default = ListUnconfirmedOmniTransactionsByPropertyIDE400;
