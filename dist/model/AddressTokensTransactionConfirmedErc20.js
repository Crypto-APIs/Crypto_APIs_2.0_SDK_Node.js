...
var AddressTokensTransactionConfirmedErc20 = /*#__PURE__*/function () {
  ...
  _createClass(AddressTokensTransactionConfirmedErc20, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddressTokensTransactionConfirmedErc20</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressTokensTransactionConfirmedErc20</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressTokensTransactionConfirmedErc20.RequiredProperties),
        _step;
      try {
...
AddressTokensTransactionConfirmedErc20.RequiredProperties = ["name", "symbol", "amount", "contractAddress"];
