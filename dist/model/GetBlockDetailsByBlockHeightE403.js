...
var GetBlockDetailsByBlockHeightE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize GetBlockDetailsByBlockHeightE403.
   */
  function GetBlockDetailsByBlockHeightE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetBlockDetailsByBlockHeightE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetBlockDetailsByBlockHeightE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetBlockDetailsByBlockHeightE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(GetBlockDetailsByBlockHeightE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetBlockDetailsByBlockHeightE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetBlockDetailsByBlockHeightE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetBlockDetailsByBlockHeightE403, "fromJSON", function (json_string) {
  return GetBlockDetailsByBlockHeightE403.constructFromObject(JSON.parse(json_string));
});
...
GetBlockDetailsByBlockHeightE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = GetBlockDetailsByBlockHeightE403;
