...
var GetLatestMinedZilliqaBlockE403 = /*#__PURE__*/function () {
   ...
   */
  function GetLatestMinedZilliqaBlockE403(code, message) {
    ...
    GetLatestMinedZilliqaBlockE403.initialize(this, code, message);
  }
   ...
   */
  _createClass(GetLatestMinedZilliqaBlockE403, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLatestMinedZilliqaBlockE403();
