...
var GetWalletTransactionDetailsByTransactionIDRIBSD2 = /*#__PURE__*/function () {
  ...
  _createClass(GetWalletTransactionDetailsByTransactionIDRIBSD2, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetWalletTransactionDetailsByTransactionIDRIBSD2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetWalletTransactionDetailsByTransactionIDRIBSD2</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetWalletTransactionDetailsByTransactionIDRIBSD2.RequiredProperties),
        _step;
      try {
      ...
      if (data['vin']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _GetWalletTransactionDetailsByTransactionIDRIBSD2VinInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['vout']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _GetTransactionDetailsByTransactionIDRIBSD2VoutInner["default"].validateJsonObject(_item);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
...
GetWalletTransactionDetailsByTransactionIDRIBSD2.RequiredProperties = ["locktime", "size", "version", "vin", "vout"];
