...
var ListTransactionsByBlockHeightRIBSECGasPrice = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHeightRIBSECGasPrice, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRIBSECGasPrice</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRIBSECGasPrice</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSECGasPrice.RequiredProperties),
        _step;
      try {
...
ListTransactionsByBlockHeightRIBSECGasPrice.RequiredProperties = ["amount", "unit"];
