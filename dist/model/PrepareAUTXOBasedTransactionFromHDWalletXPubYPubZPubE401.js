 ...
 * @version 1.11.0
 */
var PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401 = /*#__PURE__*/function () {
  /**
   ...
   * @param {(module:model/InvalidApiKey|module:model/MissingApiKey)} instance The actual instance to initialize PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401.
   */
  function PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401` with oneOf schemas InvalidApiKey, MissingApiKey. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401, "fromJSON", function (json_string) {
  return PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401.constructFromObject(JSON.parse(json_string));
});
...
PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401.OneOf = ["InvalidApiKey", "MissingApiKey"];
var _default = PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubE401;
