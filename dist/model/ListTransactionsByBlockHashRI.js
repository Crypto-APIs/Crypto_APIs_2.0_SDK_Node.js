...
var ListTransactionsByBlockHashRI = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHashRI, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHashRI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHashRI</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['recipients']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListTransactionsByBlockHashRIRecipientsInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['senders']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _ListTransactionsByBlockHashRISendersInner["default"].validateJsonObject(_item);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (data['fee']) {
        // data not null
        _ListTransactionsByBlockHashRIFee["default"].validateJSON(data['fee']);
      }
      // validate the optional field `blockchainSpecific`
      if (data['blockchainSpecific']) {
        // data not null
        _ListTransactionsByBlockHashRIBS["default"].validateJSON(data['blockchainSpecific']);
      }
      return true;
    }
  }]);
...
ListTransactionsByBlockHashRI.RequiredProperties = ["index", "minedInBlockHash", "minedInBlockHeight", "recipients", "senders", "timestamp", "transactionHash", "transactionId", "fee", "blockchainSpecific"];
