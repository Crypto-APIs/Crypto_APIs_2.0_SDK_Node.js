...
var PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRData = /*#__PURE__*/function () {
  ...
  _createClass(PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
