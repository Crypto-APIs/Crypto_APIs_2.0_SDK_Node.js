...
var _CoinsForwardingSuccessData = _interopRequireDefault(require("./CoinsForwardingSuccessData"));
 ...
 * @version 1.11.0
 */
var CoinsForwardingSuccess = /*#__PURE__*/function () {
  /**
   ...
   */
  function CoinsForwardingSuccess(apiVersion, referenceId, idempotencyKey, data) {
    _classCallCheck(this, CoinsForwardingSuccess);
   ...
   */
  _createClass(CoinsForwardingSuccess, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _CoinsForwardingSuccessData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CoinsForwardingSuccess.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _CoinsForwardingSuccessData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
var _default = CoinsForwardingSuccess;
