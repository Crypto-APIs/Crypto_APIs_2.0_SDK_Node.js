...
var GetTransactionRequestDetailsRI = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionRequestDetailsRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetTransactionRequestDetailsRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['recipients']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _GetTransactionRequestDetailsRIRecipientsInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
