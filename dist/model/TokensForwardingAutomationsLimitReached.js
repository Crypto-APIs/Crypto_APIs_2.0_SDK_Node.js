...
var TokensForwardingAutomationsLimitReached = /*#__PURE__*/function () {
  ...
  _createClass(TokensForwardingAutomationsLimitReached, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>TokensForwardingAutomationsLimitReached</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TokensForwardingAutomationsLimitReached</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TokensForwardingAutomationsLimitReached.RequiredProperties),
        _step;
      try {
...
TokensForwardingAutomationsLimitReached.RequiredProperties = ["code", "message"];
