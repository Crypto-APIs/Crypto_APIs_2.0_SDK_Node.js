...
var _TokensForwardingAutomationsLimitReachedError = _interopRequireDefault(require("./TokensForwardingAutomationsLimitReachedError"));
...
var TokensForwardingAutomationsLimitReached = /*#__PURE__*/function () {
   ...
   */
  function TokensForwardingAutomationsLimitReached(apiVersion, requestId, error) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _TokensForwardingAutomationsLimitReachedError["default"].constructFromObject(data['error']);
        }
      }
