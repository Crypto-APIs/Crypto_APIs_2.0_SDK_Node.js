 ...
 * @version 1.6.0
 */
var ListOmniTransactionsByAddressRIRecipientsInner = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListOmniTransactionsByAddressRIRecipientsInner(address, amount) {
    _classCallCheck(this, ListOmniTransactionsByAddressRIRecipientsInner);
  ...
  _createClass(ListOmniTransactionsByAddressRIRecipientsInner, null, [{
    key: "initialize",
  ...
  return ListOmniTransactionsByAddressRIRecipientsInner;
}();
/**
...
var _default = ListOmniTransactionsByAddressRIRecipientsInner;
