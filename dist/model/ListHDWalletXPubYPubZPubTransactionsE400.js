...
var ListHDWalletXPubYPubZPubTransactionsE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListHDWalletXPubYPubZPubTransactionsE400</code>.
   * @alias module:model/ListHDWalletXPubYPubZPubTransactionsE400
   * @param {(module:model/InvalidBlockchain|module:model/InvalidNetwork|module:model/InvalidPagination|module:model/InvalidXpub|module:model/LimitGreaterThanAllowed|module:model/UriNotFound|module:model/XpubNotSynced)} instance The actual instance to initialize ListHDWalletXPubYPubZPubTransactionsE400.
   */
  function ListHDWalletXPubYPubZPubTransactionsE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, ListHDWalletXPubYPubZPubTransactionsE400);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListHDWalletXPubYPubZPubTransactionsE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListHDWalletXPubYPubZPubTransactionsE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>ListHDWalletXPubYPubZPubTransactionsE400</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListHDWalletXPubYPubZPubTransactionsE400} obj Optional instance to populate.
   * @return {module:model/ListHDWalletXPubYPubZPubTransactionsE400} The populated <code>ListHDWalletXPubYPubZPubTransactionsE400</code> instance.
   */
  _createClass(ListHDWalletXPubYPubZPubTransactionsE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListHDWalletXPubYPubZPubTransactionsE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListHDWalletXPubYPubZPubTransactionsE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListHDWalletXPubYPubZPubTransactionsE400, "fromJSON", function (json_string) {
  return ListHDWalletXPubYPubZPubTransactionsE400.constructFromObject(JSON.parse(json_string));
});
ListHDWalletXPubYPubZPubTransactionsE400.prototype['code'] = undefined;
 ...
 */
ListHDWalletXPubYPubZPubTransactionsE400.prototype['details'] = undefined;
ListHDWalletXPubYPubZPubTransactionsE400.OneOf = ["InvalidBlockchain", "InvalidNetwork", "InvalidPagination", "InvalidXpub", "LimitGreaterThanAllowed", "UriNotFound", "XpubNotSynced"];
var _default = ListHDWalletXPubYPubZPubTransactionsE400;
