 ...
 * @version 1.11.0
 */
var PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee = /*#__PURE__*/function () {
  /**
   ...
   */
  function PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee(gasLimit, gasPrice, maxFeePerGas, maxPriorityFeePerGas) {
    _classCallCheck(this, PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee);
   ...
   */
  _createClass(PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee.RequiredProperties),
        _step;
      try {
...
var _default = PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee;
