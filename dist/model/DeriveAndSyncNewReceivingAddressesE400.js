...
var DeriveAndSyncNewReceivingAddressesE400 = /*#__PURE__*/function () {
   ...
   */
  function DeriveAndSyncNewReceivingAddressesE400() {
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `DeriveAndSyncNewReceivingAddressesE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(DeriveAndSyncNewReceivingAddressesE400, [{
 ...
 * @member {String} code
 */
_defineProperty(DeriveAndSyncNewReceivingAddressesE400, "fromJSON", function (json_string) {
