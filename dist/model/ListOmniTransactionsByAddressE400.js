...
/**
 * The ListOmniTransactionsByAddressE400 model module.
 * @module model/ListOmniTransactionsByAddressE400
 * @version 1.4.0
 */
var ListOmniTransactionsByAddressE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListOmniTransactionsByAddressE400</code>.
   * @alias module:model/ListOmniTransactionsByAddressE400
   ...
   */
  function ListOmniTransactionsByAddressE400(code, message) {
    _classCallCheck(this, ListOmniTransactionsByAddressE400);
    ...
    ListOmniTransactionsByAddressE400.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListOmniTransactionsByAddressE400, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListOmniTransactionsByAddressE400</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListOmniTransactionsByAddressE400} obj Optional instance to populate.
     * @return {module:model/ListOmniTransactionsByAddressE400} The populated <code>ListOmniTransactionsByAddressE400</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListOmniTransactionsByAddressE400();
...
ListOmniTransactionsByAddressE400.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListOmniTransactionsByAddressE400.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetails>} details
 */

ListOmniTransactionsByAddressE400.prototype['details'] = undefined; // Implement UriNotFound interface:
...
var _default = ListOmniTransactionsByAddressE400;
