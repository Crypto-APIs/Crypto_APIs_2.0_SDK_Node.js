...
var NewUnconfirmedTokensTransactionsRBData = /*#__PURE__*/function () {
  ...
  _createClass(NewUnconfirmedTokensTransactionsRBData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>NewUnconfirmedTokensTransactionsRBData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewUnconfirmedTokensTransactionsRBData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewUnconfirmedTokensTransactionsRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _NewUnconfirmedTokensTransactionsRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
NewUnconfirmedTokensTransactionsRBData.RequiredProperties = ["item"];
