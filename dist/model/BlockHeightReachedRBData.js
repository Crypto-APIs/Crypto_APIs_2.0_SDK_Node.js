...
var BlockHeightReachedRBData = /*#__PURE__*/function () {
  ...
  _createClass(BlockHeightReachedRBData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>BlockHeightReachedRBData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlockHeightReachedRBData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(BlockHeightReachedRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _BlockHeightReachedRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
BlockHeightReachedRBData.RequiredProperties = ["item"];
