...
var DeriveAndSyncNewChangeAddressesR = /*#__PURE__*/function () {
  ...
  _createClass(DeriveAndSyncNewChangeAddressesR, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DeriveAndSyncNewChangeAddressesR.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _DeriveAndSyncNewChangeAddressesRData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
