 ...
 * @version 1.11.0
 */
var GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner(addresses, scriptSig, sequence, txinwitness, value) {
    _classCallCheck(this, GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner);
   ...
   */
  _createClass(GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _GetTransactionDetailsByTransactionIDRIBSDVinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
      // ensure the json data is a string
...
GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner.RequiredProperties = ["addresses", "scriptSig", "sequence", "txinwitness", "value"];
...
var _default = GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VinInner;
