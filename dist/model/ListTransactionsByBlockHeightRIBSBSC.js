...
var ListTransactionsByBlockHeightRIBSBSC = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHeightRIBSBSC, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRIBSBSC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRIBSBSC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSBSC.RequiredProperties),
        _step;
      try {
      ...
      if (data['gasPrice']) {
        // data not null
        _ListTransactionsByBlockHeightRIBSBSCGasPrice["default"].validateJSON(data['gasPrice']);
      }
      // ensure the json data is a string
...
ListTransactionsByBlockHeightRIBSBSC.RequiredProperties = ["gasLimit", "gasPrice", "gasUsed", "inputData", "nonce", "transactionStatus"];
