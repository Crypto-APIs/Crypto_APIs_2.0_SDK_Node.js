...
var NewRevertedBlockE403 = /*#__PURE__*/function () {
   ...
   */
  function NewRevertedBlockE403(code, message) {
    ...
    NewRevertedBlockE403.initialize(this, code, message);
  }
   ...
   */
  _createClass(NewRevertedBlockE403, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new NewRevertedBlockE403();
