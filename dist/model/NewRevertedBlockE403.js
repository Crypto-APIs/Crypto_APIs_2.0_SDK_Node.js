...
var NewRevertedBlockE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/BlockchainEventsCallbacksLimitReached|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize NewRevertedBlockE403.
   */
  function NewRevertedBlockE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, NewRevertedBlockE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewRevertedBlockE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewRevertedBlockE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>NewRevertedBlockE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NewRevertedBlockE403} obj Optional instance to populate.
   * @return {module:model/NewRevertedBlockE403} The populated <code>NewRevertedBlockE403</code> instance.
   */
  _createClass(NewRevertedBlockE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewRevertedBlockE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new NewRevertedBlockE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(NewRevertedBlockE403, "fromJSON", function (json_string) {
  return NewRevertedBlockE403.constructFromObject(JSON.parse(json_string));
});
 ...
 */
NewRevertedBlockE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
NewRevertedBlockE403.prototype['details'] = undefined;
NewRevertedBlockE403.OneOf = ["BannedIpAddress", "BlockchainEventsCallbacksLimitReached", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = NewRevertedBlockE403;
