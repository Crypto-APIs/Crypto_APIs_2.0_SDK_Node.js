...
var UnfreezeTronEnergyOrBandwidthRBData = /*#__PURE__*/function () {
  ...
  _createClass(UnfreezeTronEnergyOrBandwidthRBData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(UnfreezeTronEnergyOrBandwidthRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _UnfreezeTronEnergyOrBandwidthRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
