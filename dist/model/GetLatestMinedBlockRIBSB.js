 ...
 * @version 1.2.1
 */
var GetLatestMinedBlockRIBSB = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetLatestMinedBlockRIBSB(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, GetLatestMinedBlockRIBSB);
  ...
  _createClass(GetLatestMinedBlockRIBSB, null, [{
    key: "initialize",
  ...
  return GetLatestMinedBlockRIBSB;
}();
/**
...
var _default = GetLatestMinedBlockRIBSB;
