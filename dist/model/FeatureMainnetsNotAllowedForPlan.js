...
var _FeatureMainnetsNotAllowedForPlanError = _interopRequireDefault(require("./FeatureMainnetsNotAllowedForPlanError"));
...
var FeatureMainnetsNotAllowedForPlan = /*#__PURE__*/function () {
   ...
   * @param error {module:model/FeatureMainnetsNotAllowedForPlanError} 
   */
  function FeatureMainnetsNotAllowedForPlan(apiVersion, requestId, error) {
    _classCallCheck(this, FeatureMainnetsNotAllowedForPlan);

    FeatureMainnetsNotAllowedForPlan.initialize(this, apiVersion, requestId, error);
  }
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _FeatureMainnetsNotAllowedForPlanError["default"].constructFromObject(data['error']);
        }
      }
...
FeatureMainnetsNotAllowedForPlan.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

FeatureMainnetsNotAllowedForPlan.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

FeatureMainnetsNotAllowedForPlan.prototype['context'] = undefined;
/**
 * @member {module:model/FeatureMainnetsNotAllowedForPlanError} error
 */

FeatureMainnetsNotAllowedForPlan.prototype['error'] = undefined;
