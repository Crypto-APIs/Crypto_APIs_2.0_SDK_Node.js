...
var PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response = /*#__PURE__*/function () {
  ...
  _createClass(PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response.RequiredProperties),
        _step;
      try {
...
PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPub403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
