...
var GetTransactionDetailsByTransactionIDRIBSZVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDRIBSZVoutInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDRIBSZVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _GetTransactionDetailsByTransactionIDRIBSZVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
