...
/**
 * The GetLatestMinedBlockResponseItemBlockchainSpecificEthereum model module.
 * @module model/GetLatestMinedBlockResponseItemBlockchainSpecificEthereum
 * @version 2.0.0
 */
var GetLatestMinedBlockResponseItemBlockchainSpecificEthereum = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetLatestMinedBlockResponseItemBlockchainSpecificEthereum</code>.
   * Ethereum
   * @alias module:model/GetLatestMinedBlockResponseItemBlockchainSpecificEthereum
   ...
   */
  function GetLatestMinedBlockResponseItemBlockchainSpecificEthereum(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty) {
    _classCallCheck(this, GetLatestMinedBlockResponseItemBlockchainSpecificEthereum);

    GetLatestMinedBlockResponseItemBlockchainSpecificEthereum.initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty);
  }
  /**
  ...
  _createClass(GetLatestMinedBlockResponseItemBlockchainSpecificEthereum, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetLatestMinedBlockResponseItemBlockchainSpecificEthereum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLatestMinedBlockResponseItemBlockchainSpecificEthereum} obj Optional instance to populate.
     * @return {module:model/GetLatestMinedBlockResponseItemBlockchainSpecificEthereum} The populated <code>GetLatestMinedBlockResponseItemBlockchainSpecificEthereum</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLatestMinedBlockResponseItemBlockchainSpecificEthereum();
  ...
  return GetLatestMinedBlockResponseItemBlockchainSpecificEthereum;
}();
/**
...
var _default = GetLatestMinedBlockResponseItemBlockchainSpecificEthereum;
