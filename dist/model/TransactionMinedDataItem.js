...
var TransactionMinedDataItem = /*#__PURE__*/function () {
  ...
  _createClass(TransactionMinedDataItem, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TransactionMinedDataItem.RequiredProperties),
        _step;
      try {
      ...
      if (data['minedInBlock']) {
        // data not null
        _TransactionMinedDataItemMinedInBlock["default"].validateJSON(data['minedInBlock']);
      }
      return true;
    }
  }]);
