 ...
 * @version 1.11.0
 */
var ListZilliqaTransactionsByBlockHeight400Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListZilliqaTransactionsByBlockHeight400Response(apiVersion, requestId, error) {
    _classCallCheck(this, ListZilliqaTransactionsByBlockHeight400Response);
   ...
   */
  _createClass(ListZilliqaTransactionsByBlockHeight400Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListZilliqaTransactionsByBlockHeight400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListZilliqaTransactionsByBlockHeight400Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListZilliqaTransactionsByBlockHeight400Response.RequiredProperties),
        _step;
      try {
...
ListZilliqaTransactionsByBlockHeight400Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = ListZilliqaTransactionsByBlockHeight400Response;
