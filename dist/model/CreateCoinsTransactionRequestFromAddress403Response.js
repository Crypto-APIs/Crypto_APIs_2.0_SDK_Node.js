 ...
 * @version 1.11.0
 */
var CreateCoinsTransactionRequestFromAddress403Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateCoinsTransactionRequestFromAddress403Response(apiVersion, requestId, error) {
    _classCallCheck(this, CreateCoinsTransactionRequestFromAddress403Response);
   ...
   */
  _createClass(CreateCoinsTransactionRequestFromAddress403Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCoinsTransactionRequestFromAddress403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCoinsTransactionRequestFromAddress403Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateCoinsTransactionRequestFromAddress403Response.RequiredProperties),
        _step;
      try {
...
CreateCoinsTransactionRequestFromAddress403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = CreateCoinsTransactionRequestFromAddress403Response;
