...
var _GetZilliqaTransactionDetailsByTransactionIDRI = _interopRequireDefault(require("./GetZilliqaTransactionDetailsByTransactionIDRI"));
...
var GetZilliqaTransactionDetailsByTransactionIDRData = /*#__PURE__*/function () {
   ...
   */
  function GetZilliqaTransactionDetailsByTransactionIDRData(item) {
    _classCallCheck(this, GetZilliqaTransactionDetailsByTransactionIDRData);
   ...
   */
  _createClass(GetZilliqaTransactionDetailsByTransactionIDRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _GetZilliqaTransactionDetailsByTransactionIDRI["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetZilliqaTransactionDetailsByTransactionIDRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetZilliqaTransactionDetailsByTransactionIDRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetZilliqaTransactionDetailsByTransactionIDRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _GetZilliqaTransactionDetailsByTransactionIDRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
GetZilliqaTransactionDetailsByTransactionIDRData.RequiredProperties = ["item"];
