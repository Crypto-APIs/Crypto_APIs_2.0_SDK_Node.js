 ...
 * @version 1.7.2
 */
var PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403</code>.
   * @alias module:model/PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403
   ...
   */
  function PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403(code, message) {
    _classCallCheck(this, PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403);
    ...
    PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403} obj Optional instance to populate.
     * @return {module:model/PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403} The populated <code>PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403();
  ...
  return PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403;
}();
/**
...
PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
...
var _default = PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubE403;
