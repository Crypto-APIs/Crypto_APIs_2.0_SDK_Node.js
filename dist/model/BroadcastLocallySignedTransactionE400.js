 ...
 * @version 1.11.0
 */
var BroadcastLocallySignedTransactionE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>BroadcastLocallySignedTransactionE400</code>.
   * @alias module:model/BroadcastLocallySignedTransactionE400
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize BroadcastLocallySignedTransactionE400.
   */
  function BroadcastLocallySignedTransactionE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, BroadcastLocallySignedTransactionE400);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `BroadcastLocallySignedTransactionE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `BroadcastLocallySignedTransactionE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>BroadcastLocallySignedTransactionE400</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BroadcastLocallySignedTransactionE400} obj Optional instance to populate.
   * @return {module:model/BroadcastLocallySignedTransactionE400} The populated <code>BroadcastLocallySignedTransactionE400</code> instance.
   */
  _createClass(BroadcastLocallySignedTransactionE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = BroadcastLocallySignedTransactionE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new BroadcastLocallySignedTransactionE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(BroadcastLocallySignedTransactionE400, "fromJSON", function (json_string) {
  return BroadcastLocallySignedTransactionE400.constructFromObject(JSON.parse(json_string));
});
BroadcastLocallySignedTransactionE400.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
BroadcastLocallySignedTransactionE400.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
BroadcastLocallySignedTransactionE400.prototype['details'] = undefined;
BroadcastLocallySignedTransactionE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
var _default = BroadcastLocallySignedTransactionE400;
