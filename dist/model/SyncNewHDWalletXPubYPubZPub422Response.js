...
var _SyncNewHDWalletXPubYPubZPubE = _interopRequireDefault(require("./SyncNewHDWalletXPubYPubZPubE422"));
 ...
 * @version 1.11.0
 */
var SyncNewHDWalletXPubYPubZPub422Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function SyncNewHDWalletXPubYPubZPub422Response(apiVersion, requestId, error) {
    _classCallCheck(this, SyncNewHDWalletXPubYPubZPub422Response);
   ...
   */
  _createClass(SyncNewHDWalletXPubYPubZPub422Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>SyncNewHDWalletXPubYPubZPub422Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SyncNewHDWalletXPubYPubZPub422Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(SyncNewHDWalletXPubYPubZPub422Response.RequiredProperties),
        _step;
      try {
...
SyncNewHDWalletXPubYPubZPub422Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = SyncNewHDWalletXPubYPubZPub422Response;
