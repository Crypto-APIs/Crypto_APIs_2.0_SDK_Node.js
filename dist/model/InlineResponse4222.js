...
var InlineResponse4222 = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse4222(apiVersion, requestId, error) {
    _classCallCheck(this, InlineResponse4222);

    InlineResponse4222.initialize(this, apiVersion, requestId, error);
  }
  /**
...
InlineResponse4222.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

InlineResponse4222.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

InlineResponse4222.prototype['context'] = undefined;
/**
 * @member {module:model/GetHDWalletXPubYPubZPubAssetsE422} error
 */

InlineResponse4222.prototype['error'] = undefined;
