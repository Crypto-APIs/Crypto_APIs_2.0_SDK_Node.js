...
var InlineResponse40010 = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse40010(apiVersion, requestId, error) {
    _classCallCheck(this, InlineResponse40010);

    InlineResponse40010.initialize(this, apiVersion, requestId, error);
  }
  /**
...
InlineResponse40010.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

InlineResponse40010.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

InlineResponse40010.prototype['context'] = undefined;
/**
 * @member {module:model/ListConfirmedTransactionsByAddressE400} error
 */

InlineResponse40010.prototype['error'] = undefined;
