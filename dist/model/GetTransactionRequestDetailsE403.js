...
var GetTransactionRequestDetailsE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize GetTransactionRequestDetailsE403.
   */
  function GetTransactionRequestDetailsE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetTransactionRequestDetailsE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetTransactionRequestDetailsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetTransactionRequestDetailsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>GetTransactionRequestDetailsE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetTransactionRequestDetailsE403} obj Optional instance to populate.
   * @return {module:model/GetTransactionRequestDetailsE403} The populated <code>GetTransactionRequestDetailsE403</code> instance.
   */
  _createClass(GetTransactionRequestDetailsE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetTransactionRequestDetailsE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetTransactionRequestDetailsE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetTransactionRequestDetailsE403, "fromJSON", function (json_string) {
  return GetTransactionRequestDetailsE403.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GetTransactionRequestDetailsE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
GetTransactionRequestDetailsE403.prototype['details'] = undefined;
GetTransactionRequestDetailsE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = GetTransactionRequestDetailsE403;
