...
var NewUnconfirmedCoinsTransactionsE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>NewUnconfirmedCoinsTransactionsE403</code>.
   * @alias module:model/NewUnconfirmedCoinsTransactionsE403
   * @param {(module:model/BannedIpAddress|module:model/BlockchainEventsCallbacksLimitReached|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize NewUnconfirmedCoinsTransactionsE403.
   */
  function NewUnconfirmedCoinsTransactionsE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, NewUnconfirmedCoinsTransactionsE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewUnconfirmedCoinsTransactionsE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewUnconfirmedCoinsTransactionsE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>NewUnconfirmedCoinsTransactionsE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NewUnconfirmedCoinsTransactionsE403} obj Optional instance to populate.
   * @return {module:model/NewUnconfirmedCoinsTransactionsE403} The populated <code>NewUnconfirmedCoinsTransactionsE403</code> instance.
   */
  _createClass(NewUnconfirmedCoinsTransactionsE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewUnconfirmedCoinsTransactionsE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new NewUnconfirmedCoinsTransactionsE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(NewUnconfirmedCoinsTransactionsE403, "fromJSON", function (json_string) {
  return NewUnconfirmedCoinsTransactionsE403.constructFromObject(JSON.parse(json_string));
});
NewUnconfirmedCoinsTransactionsE403.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
NewUnconfirmedCoinsTransactionsE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
NewUnconfirmedCoinsTransactionsE403.prototype['details'] = undefined;
NewUnconfirmedCoinsTransactionsE403.OneOf = ["BannedIpAddress", "BlockchainEventsCallbacksLimitReached", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = NewUnconfirmedCoinsTransactionsE403;
