 ...
 * @version 1.7.0
 */
var SyncNewXPubE422 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SyncNewXPubE422</code>.
   * @alias module:model/SyncNewXPubE422
   ...
   */
  function SyncNewXPubE422(code, message) {
    _classCallCheck(this, SyncNewXPubE422);
    ...
    SyncNewXPubE422.initialize(this, code, message);
  }
  /**
  ...
  _createClass(SyncNewXPubE422, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>SyncNewXPubE422</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SyncNewXPubE422} obj Optional instance to populate.
     * @return {module:model/SyncNewXPubE422} The populated <code>SyncNewXPubE422</code> instance.
     */
...
SyncNewXPubE422.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

SyncNewXPubE422.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

SyncNewXPubE422.prototype['details'] = undefined; // Implement InvalidRequestBodyStructure interface:
