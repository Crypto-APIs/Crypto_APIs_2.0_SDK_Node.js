...
var PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSTRawDataContract = /*#__PURE__*/function () {
  ...
  _createClass(PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSTRawDataContract, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSTRawDataContract</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSTRawDataContract</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSTRawDataContract.RequiredProperties),
        _step;
      try {
      ...
      if (data['parameter']) {
        // data not null
        _PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSTRawDataContractParameter["default"].validateJSON(data['parameter']);
      }
      return true;
    }
  }]);
...
PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSTRawDataContract.RequiredProperties = ["parameter"];
