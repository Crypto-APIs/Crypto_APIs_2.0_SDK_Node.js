...
var GetBlockDetailsByBlockHashRIBS = /*#__PURE__*/function () {
   ...
   * @param merkleroot {String} Defines the single and final (root) node of a Merkle tree. It is the combined hash of all transactions' hashes that are part of a blockchain block.
   */
  function GetBlockDetailsByBlockHashRIBS(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles, merkleroot) {
    _classCallCheck(this, GetBlockDetailsByBlockHashRIBS);

    _GetBlockDetailsByBlockHashRIBSB["default"].initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight);

    _GetBlockDetailsByBlockHashRIBSE["default"].initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles);

    _GetBlockDetailsByBlockHashRIBSEC["default"].initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles);

    _GetBlockDetailsByBlockHashRIBSBC["default"].initialize(this, difficulty, nonce, size, bits, chainwork, merkleroot, version, versionHex);

    _GetBlockDetailsByBlockHashRIBSL["default"].initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight);

    _GetBlockDetailsByBlockHashRIBSD["default"].initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, weight);

    _GetBlockDetailsByBlockHashRIBSD2["default"].initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, version, versionHex);

    _GetBlockDetailsByBlockHashRIBSBSC["default"].initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty);

    _GetBlockDetailsByBlockHashRIBSZ["default"].initialize(this, difficulty, nonce, size, bits, chainwork, merkleroot, version);
...
GetBlockDetailsByBlockHashRIBS.prototype['merkleroot'] = undefined; // Implement GetBlockDetailsByBlockHashRIBSB interface:
...
_GetBlockDetailsByBlockHashRIBSB["default"].prototype['weight'] = undefined; // Implement GetBlockDetailsByBlockHashRIBSE interface:
...
_GetBlockDetailsByBlockHashRIBSE["default"].prototype['uncles'] = undefined; // Implement GetBlockDetailsByBlockHashRIBSEC interface:
...
_GetBlockDetailsByBlockHashRIBSEC["default"].prototype['uncles'] = undefined; // Implement GetBlockDetailsByBlockHashRIBSBC interface:
...
_GetBlockDetailsByBlockHashRIBSBC["default"].prototype['versionHex'] = undefined; // Implement GetBlockDetailsByBlockHashRIBSL interface:
...
_GetBlockDetailsByBlockHashRIBSL["default"].prototype['weight'] = undefined; // Implement GetBlockDetailsByBlockHashRIBSD interface:
...
_GetBlockDetailsByBlockHashRIBSD["default"].prototype['weight'] = undefined; // Implement GetBlockDetailsByBlockHashRIBSD2 interface:
...
_GetBlockDetailsByBlockHashRIBSD2["default"].prototype['versionHex'] = undefined; // Implement GetBlockDetailsByBlockHashRIBSBSC interface:
...
_GetBlockDetailsByBlockHashRIBSBSC["default"].prototype['totalDifficulty'] = undefined; // Implement GetBlockDetailsByBlockHashRIBSZ interface:
