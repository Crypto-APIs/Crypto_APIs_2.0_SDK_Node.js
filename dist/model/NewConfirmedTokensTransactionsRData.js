...
var NewConfirmedTokensTransactionsRData = /*#__PURE__*/function () {
  ...
  _createClass(NewConfirmedTokensTransactionsRData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>NewConfirmedTokensTransactionsRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewConfirmedTokensTransactionsRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewConfirmedTokensTransactionsRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _NewConfirmedTokensTransactionsRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
NewConfirmedTokensTransactionsRData.RequiredProperties = ["item"];
