...
var ListLatestMinedBlocksRIBSD = /*#__PURE__*/function () {
   ...
   */
  function ListLatestMinedBlocksRIBSD(bits, chainwork, difficulty, merkleRoot, nonce, size, version, versionHex) {
  ...
  _createClass(ListLatestMinedBlocksRIBSD, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListLatestMinedBlocksRIBSD</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLatestMinedBlocksRIBSD</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListLatestMinedBlocksRIBSD.RequiredProperties),
        _step;
      try {
...
ListLatestMinedBlocksRIBSD.RequiredProperties = ["bits", "chainwork", "difficulty", "merkleRoot", "nonce", "size", "version", "versionHex"];
