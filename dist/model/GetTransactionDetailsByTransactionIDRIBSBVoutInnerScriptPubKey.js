...
var GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey.RequiredProperties),
        _step;
      try {
...
GetTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey.RequiredProperties = ["addresses", "asm", "hex", "type"];
