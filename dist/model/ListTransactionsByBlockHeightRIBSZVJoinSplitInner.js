...
var ListTransactionsByBlockHeightRIBSZVJoinSplitInner = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHeightRIBSZVJoinSplitInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRIBSZVJoinSplitInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRIBSZVJoinSplitInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSZVJoinSplitInner.RequiredProperties),
        _step;
      try {
...
ListTransactionsByBlockHeightRIBSZVJoinSplitInner.RequiredProperties = ["anchor", "cipherTexts", "commitments", "macs", "nullifiers", "oneTimePubKey", "proof", "randomSeed", "vPubNew", "vPubOld"];
