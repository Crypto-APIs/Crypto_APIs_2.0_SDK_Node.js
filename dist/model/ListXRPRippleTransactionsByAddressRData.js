...
var ListXRPRippleTransactionsByAddressRData = /*#__PURE__*/function () {
   ...
   */
  function ListXRPRippleTransactionsByAddressRData(limit, offset, total, items) {
  ...
  _createClass(ListXRPRippleTransactionsByAddressRData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListXRPRippleTransactionsByAddressRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListXRPRippleTransactionsByAddressRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListXRPRippleTransactionsByAddressRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListXRPRippleTransactionsByAddressRI["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
ListXRPRippleTransactionsByAddressRData.RequiredProperties = ["limit", "offset", "total", "items"];
