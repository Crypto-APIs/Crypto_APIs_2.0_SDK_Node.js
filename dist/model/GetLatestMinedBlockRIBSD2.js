...
/**
 * The GetLatestMinedBlockRIBSD2 model module.
 * @module model/GetLatestMinedBlockRIBSD2
 * @version 1.2.0
 */
var GetLatestMinedBlockRIBSD2 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetLatestMinedBlockRIBSD2</code>.
   * Dash
   * @alias module:model/GetLatestMinedBlockRIBSD2
   ...
   */
  function GetLatestMinedBlockRIBSD2(difficulty, nonce, size, bits, chainwork, merkleRoot, version, versionHex) {
    _classCallCheck(this, GetLatestMinedBlockRIBSD2);

    GetLatestMinedBlockRIBSD2.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, version, versionHex);
  }
  /**
  ...
  _createClass(GetLatestMinedBlockRIBSD2, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetLatestMinedBlockRIBSD2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLatestMinedBlockRIBSD2} obj Optional instance to populate.
     * @return {module:model/GetLatestMinedBlockRIBSD2} The populated <code>GetLatestMinedBlockRIBSD2</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLatestMinedBlockRIBSD2();
  ...
  return GetLatestMinedBlockRIBSD2;
}();
/**
...
var _default = GetLatestMinedBlockRIBSD2;
