...
var GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
...
GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInner.RequiredProperties = ["isSpent", "scriptPubKey", "value"];
