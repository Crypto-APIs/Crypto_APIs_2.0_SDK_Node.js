...
var NewRevertedBlockE409 = /*#__PURE__*/function () {
   ...
   */
  function NewRevertedBlockE409(code, message) {
    ...
    NewRevertedBlockE409.initialize(this, code, message);
  }
   ...
   */
  _createClass(NewRevertedBlockE409, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new NewRevertedBlockE409();
