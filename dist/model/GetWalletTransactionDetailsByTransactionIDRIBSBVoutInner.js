...
var GetWalletTransactionDetailsByTransactionIDRIBSBVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(GetWalletTransactionDetailsByTransactionIDRIBSBVoutInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetWalletTransactionDetailsByTransactionIDRIBSBVoutInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetWalletTransactionDetailsByTransactionIDRIBSBVoutInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetWalletTransactionDetailsByTransactionIDRIBSBVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
...
GetWalletTransactionDetailsByTransactionIDRIBSBVoutInner.RequiredProperties = ["isSpent", "scriptPubKey", "value"];
