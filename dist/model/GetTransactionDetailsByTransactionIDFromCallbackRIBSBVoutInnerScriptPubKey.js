...
var GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInnerScriptPubKey = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInnerScriptPubKey, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInnerScriptPubKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInnerScriptPubKey</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInnerScriptPubKey.RequiredProperties),
        _step;
      try {
...
GetTransactionDetailsByTransactionIDFromCallbackRIBSBVoutInnerScriptPubKey.RequiredProperties = ["addresses", "asm", "hex", "reqSigs", "type"];
