...
var _AddTokensToExistingFromAddressRBTokenData = _interopRequireDefault(require("./AddTokensToExistingFromAddressRBTokenData"));
 ...
 * @version 1.11.0
 */
var AddTokensToExistingFromAddressRBDataItem = /*#__PURE__*/function () {
  /**
   ...
   */
  function AddTokensToExistingFromAddressRBDataItem(callbackUrl, confirmationsCount, feePriority, fromAddress, minimumTransferAmount, toAddress, tokenData) {
    _classCallCheck(this, AddTokensToExistingFromAddressRBDataItem);
   ...
   */
  _createClass(AddTokensToExistingFromAddressRBDataItem, null, [{
    key: "initialize",
    value: function initialize(obj, callbackUrl, confirmationsCount, feePriority, fromAddress, minimumTransferAmount, toAddress, tokenData) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('tokenData')) {
          obj['tokenData'] = _AddTokensToExistingFromAddressRBTokenData["default"].constructFromObject(data['tokenData']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddTokensToExistingFromAddressRBDataItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddTokensToExistingFromAddressRBDataItem</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddTokensToExistingFromAddressRBDataItem.RequiredProperties),
        _step;
      try {
      ...
      if (data['tokenData']) {
        // data not null
        _AddTokensToExistingFromAddressRBTokenData["default"].validateJSON(data['tokenData']);
      }
      return true;
    }
  }]);
...
AddTokensToExistingFromAddressRBDataItem.RequiredProperties = ["callbackUrl", "confirmationsCount", "feePriority", "fromAddress", "minimumTransferAmount", "toAddress", "tokenData"];
...
var _default = AddTokensToExistingFromAddressRBDataItem;
