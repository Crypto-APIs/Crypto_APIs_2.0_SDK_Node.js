...
var ListLatestMinedBlocksRIBSB = /*#__PURE__*/function () {
   ...
   */
  function ListLatestMinedBlocksRIBSB(bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, ListLatestMinedBlocksRIBSB);
   ...
   */
  _createClass(ListLatestMinedBlocksRIBSB, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListLatestMinedBlocksRIBSB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLatestMinedBlocksRIBSB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListLatestMinedBlocksRIBSB.RequiredProperties),
        _step;
      try {
...
ListLatestMinedBlocksRIBSB.RequiredProperties = ["bits", "chainwork", "merkleRoot", "strippedSize", "version", "versionHex", "weight"];
...
var _default = ListLatestMinedBlocksRIBSB;
