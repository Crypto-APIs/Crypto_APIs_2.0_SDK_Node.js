...
var EncodeXAddressE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize EncodeXAddressE403.
   */
  function EncodeXAddressE403() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `EncodeXAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `EncodeXAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(EncodeXAddressE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = EncodeXAddressE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new EncodeXAddressE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(EncodeXAddressE403, "fromJSON", function (json_string) {
  return EncodeXAddressE403.constructFromObject(JSON.parse(json_string));
});
...
EncodeXAddressE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
