...
var SyncHDWalletXPubYPubZPubE409 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/AlreadyExists|module:model/InvalidData)} instance The actual instance to initialize SyncHDWalletXPubYPubZPubE409.
   */
  function SyncHDWalletXPubYPubZPubE409() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `SyncHDWalletXPubYPubZPubE409` with oneOf schemas AlreadyExists, InvalidData. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `SyncHDWalletXPubYPubZPubE409` with oneOf schemas AlreadyExists, InvalidData. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(SyncHDWalletXPubYPubZPubE409, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = SyncHDWalletXPubYPubZPubE409.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new SyncHDWalletXPubYPubZPubE409(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(SyncHDWalletXPubYPubZPubE409, "fromJSON", function (json_string) {
  return SyncHDWalletXPubYPubZPubE409.constructFromObject(JSON.parse(json_string));
});
 ...
 */
SyncHDWalletXPubYPubZPubE409.prototype['details'] = undefined;
SyncHDWalletXPubYPubZPubE409.OneOf = ["AlreadyExists", "InvalidData"];
