 ...
 * @version 1.11.0
 */
var ListTransactionsByBlockHashRIRecipientsInner = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListTransactionsByBlockHashRIRecipientsInner(address, amount) {
    _classCallCheck(this, ListTransactionsByBlockHashRIRecipientsInner);
   ...
   */
  _createClass(ListTransactionsByBlockHashRIRecipientsInner, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHashRIRecipientsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHashRIRecipientsInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIRecipientsInner.RequiredProperties),
        _step;
      try {
...
ListTransactionsByBlockHashRIRecipientsInner.RequiredProperties = ["address", "amount"];
...
var _default = ListTransactionsByBlockHashRIRecipientsInner;
