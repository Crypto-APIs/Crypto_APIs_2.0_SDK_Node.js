...
var WalletAsAServiceWalletBalanceNotEnough = /*#__PURE__*/function () {
  ...
  _createClass(WalletAsAServiceWalletBalanceNotEnough, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>WalletAsAServiceWalletBalanceNotEnough</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WalletAsAServiceWalletBalanceNotEnough</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(WalletAsAServiceWalletBalanceNotEnough.RequiredProperties),
        _step;
      try {
...
WalletAsAServiceWalletBalanceNotEnough.RequiredProperties = ["code", "message"];
