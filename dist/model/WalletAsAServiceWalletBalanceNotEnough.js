...
var _WalletAsAServiceWalletBalanceNotEnoughError = _interopRequireDefault(require("./WalletAsAServiceWalletBalanceNotEnoughError"));
...
var WalletAsAServiceWalletBalanceNotEnough = /*#__PURE__*/function () {
   ...
   * @param error {module:model/WalletAsAServiceWalletBalanceNotEnoughError} 
   */
  function WalletAsAServiceWalletBalanceNotEnough(apiVersion, requestId, error) {
    _classCallCheck(this, WalletAsAServiceWalletBalanceNotEnough);

    WalletAsAServiceWalletBalanceNotEnough.initialize(this, apiVersion, requestId, error);
  }
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _WalletAsAServiceWalletBalanceNotEnoughError["default"].constructFromObject(data['error']);
        }
      }
...
WalletAsAServiceWalletBalanceNotEnough.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

WalletAsAServiceWalletBalanceNotEnough.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

WalletAsAServiceWalletBalanceNotEnough.prototype['context'] = undefined;
/**
 * @member {module:model/WalletAsAServiceWalletBalanceNotEnoughError} error
 */

WalletAsAServiceWalletBalanceNotEnough.prototype['error'] = undefined;
