...
var ListHDWalletXPubYPubZPubTransactionsE422 = /*#__PURE__*/function () {
   ...
   */
  function ListHDWalletXPubYPubZPubTransactionsE422() {
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `ListHDWalletXPubYPubZPubTransactionsE422` with oneOf schemas InvalidRequestBodyStructure, XpubSyncInProgress. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(ListHDWalletXPubYPubZPubTransactionsE422, [{
 ...
 * @member {String} code
 */
_defineProperty(ListHDWalletXPubYPubZPubTransactionsE422, "fromJSON", function (json_string) {
