...
/**
 * The GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash model module.
 * @module model/GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash
 * @version 2.0.0
 */
var GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash</code>.
   * Dash
   * @alias module:model/GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash
   ...
   */
  function GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash(locktime, size, version, vin, vout) {
    _classCallCheck(this, GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash);

    GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash.initialize(this, locktime, size, version, vin, vout);
  }
  /**
  ...
  _createClass(GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash} obj Optional instance to populate.
     * @return {module:model/GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash} The populated <code>GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash();
  ...
  return GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash;
}();
/**
...
var _default = GetTransactionDetailsByTransactionIDResponseItemBlockchainSpecificDash;
