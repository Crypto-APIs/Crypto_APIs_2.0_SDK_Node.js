 ...
 * @version 1.11.0
 */
var ListTransactionsByBlockHashE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListTransactionsByBlockHashE403</code>.
   * @alias module:model/ListTransactionsByBlockHashE403
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize ListTransactionsByBlockHashE403.
   */
  function ListTransactionsByBlockHashE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, ListTransactionsByBlockHashE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListTransactionsByBlockHashE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListTransactionsByBlockHashE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>ListTransactionsByBlockHashE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListTransactionsByBlockHashE403} obj Optional instance to populate.
   * @return {module:model/ListTransactionsByBlockHashE403} The populated <code>ListTransactionsByBlockHashE403</code> instance.
   */
  _createClass(ListTransactionsByBlockHashE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListTransactionsByBlockHashE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListTransactionsByBlockHashE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListTransactionsByBlockHashE403, "fromJSON", function (json_string) {
  return ListTransactionsByBlockHashE403.constructFromObject(JSON.parse(json_string));
});
ListTransactionsByBlockHashE403.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
ListTransactionsByBlockHashE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
ListTransactionsByBlockHashE403.prototype['details'] = undefined;
ListTransactionsByBlockHashE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = ListTransactionsByBlockHashE403;
