...
var GetBlockDetailsByBlockHeightFromCallbackRIBSD = /*#__PURE__*/function () {
   ...
   */
  function GetBlockDetailsByBlockHeightFromCallbackRIBSD(bits, chainwork, difficulty, merkleRoot, nonce, size, version, versionHex) {
    _classCallCheck(this, GetBlockDetailsByBlockHeightFromCallbackRIBSD);
   ...
   */
  _createClass(GetBlockDetailsByBlockHeightFromCallbackRIBSD, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHeightFromCallbackRIBSD</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHeightFromCallbackRIBSD</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHeightFromCallbackRIBSD.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHeightFromCallbackRIBSD.RequiredProperties = ["bits", "chainwork", "difficulty", "merkleRoot", "nonce", "size", "version", "versionHex"];
...
var _default = GetBlockDetailsByBlockHeightFromCallbackRIBSD;
