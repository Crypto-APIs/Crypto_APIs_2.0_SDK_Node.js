...
var GetBlockDetailsByBlockHashRI = /*#__PURE__*/function () {
  ...
  _createClass(GetBlockDetailsByBlockHashRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['blockchainSpecific']) {
        // data not null
        _GetBlockDetailsByBlockHashRIBS["default"].validateJSON(data['blockchainSpecific']);
      }
      return true;
    }
  }]);
