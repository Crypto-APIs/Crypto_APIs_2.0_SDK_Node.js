...
var NewConfirmedInternalTransactionsAndEachConfirmationRBDataItem = /*#__PURE__*/function () {
  ...
  _createClass(NewConfirmedInternalTransactionsAndEachConfirmationRBDataItem, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>NewConfirmedInternalTransactionsAndEachConfirmationRBDataItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewConfirmedInternalTransactionsAndEachConfirmationRBDataItem</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewConfirmedInternalTransactionsAndEachConfirmationRBDataItem.RequiredProperties),
        _step;
      try {
...
NewConfirmedInternalTransactionsAndEachConfirmationRBDataItem.RequiredProperties = ["address", "allowDuplicates", "callbackSecretKey", "callbackUrl", "confirmationsCount"];
