...
var ActivateBlockchainEventSubscriptionRData = /*#__PURE__*/function () {
  ...
  _createClass(ActivateBlockchainEventSubscriptionRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ActivateBlockchainEventSubscriptionRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _ActivateBlockchainEventSubscriptionRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
