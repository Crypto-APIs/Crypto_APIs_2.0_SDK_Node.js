 ...
 * @version 1.11.0
 */
var GetBlockDetailsByBlockHashFromCallbackRIBSE = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetBlockDetailsByBlockHashFromCallbackRIBSE(difficulty, extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty) {
    _classCallCheck(this, GetBlockDetailsByBlockHashFromCallbackRIBSE);
   ...
   */
  _createClass(GetBlockDetailsByBlockHashFromCallbackRIBSE, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHashFromCallbackRIBSE</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHashFromCallbackRIBSE</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashFromCallbackRIBSE.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHashFromCallbackRIBSE.RequiredProperties = ["difficulty", "extraData", "gasLimit", "gasUsed", "minedInSeconds", "nonce", "sha3Uncles", "size", "totalDifficulty"];
...
var _default = GetBlockDetailsByBlockHashFromCallbackRIBSE;
