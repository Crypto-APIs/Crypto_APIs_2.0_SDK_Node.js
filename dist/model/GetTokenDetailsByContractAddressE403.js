...
var GetTokenDetailsByContractAddressE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize GetTokenDetailsByContractAddressE403.
   */
  function GetTokenDetailsByContractAddressE403() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetTokenDetailsByContractAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetTokenDetailsByContractAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(GetTokenDetailsByContractAddressE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetTokenDetailsByContractAddressE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetTokenDetailsByContractAddressE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetTokenDetailsByContractAddressE403, "fromJSON", function (json_string) {
  return GetTokenDetailsByContractAddressE403.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GetTokenDetailsByContractAddressE403.prototype['details'] = undefined;
GetTokenDetailsByContractAddressE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
