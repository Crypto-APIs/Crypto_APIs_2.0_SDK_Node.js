...
var ListTransactionsByBlockHeightRIBSBVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHeightRIBSBVoutInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSBVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
