...
var GetAssetDetailsByAssetSymbolRI = /*#__PURE__*/function () {
  ...
  _createClass(GetAssetDetailsByAssetSymbolRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetAssetDetailsByAssetSymbolRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['specificData']) {
        // data not null
        _GetAssetDetailsByAssetSymbolRIS["default"].validateJSON(data['specificData']);
      }
      return true;
    }
  }]);
