...
var GetBlockDetailsByBlockHeightFromCallbackRIBSL = /*#__PURE__*/function () {
   ...
   */
  function GetBlockDetailsByBlockHeightFromCallbackRIBSL(bits, chainwork, difficulty, merkleRoot, nonce, size, strippedsize, version, versionHex, weight) {
    _classCallCheck(this, GetBlockDetailsByBlockHeightFromCallbackRIBSL);
   ...
   */
  _createClass(GetBlockDetailsByBlockHeightFromCallbackRIBSL, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHeightFromCallbackRIBSL</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHeightFromCallbackRIBSL</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHeightFromCallbackRIBSL.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHeightFromCallbackRIBSL.RequiredProperties = ["bits", "chainwork", "difficulty", "merkleRoot", "nonce", "size", "strippedsize", "version", "versionHex", "weight"];
...
var _default = GetBlockDetailsByBlockHeightFromCallbackRIBSL;
