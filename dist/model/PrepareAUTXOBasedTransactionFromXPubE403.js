 ...
 * @version 1.7.1
 */
var PrepareAUTXOBasedTransactionFromXPubE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PrepareAUTXOBasedTransactionFromXPubE403</code>.
   * @alias module:model/PrepareAUTXOBasedTransactionFromXPubE403
   ...
   */
  function PrepareAUTXOBasedTransactionFromXPubE403(code, message) {
    _classCallCheck(this, PrepareAUTXOBasedTransactionFromXPubE403);
    ...
    PrepareAUTXOBasedTransactionFromXPubE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(PrepareAUTXOBasedTransactionFromXPubE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>PrepareAUTXOBasedTransactionFromXPubE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrepareAUTXOBasedTransactionFromXPubE403} obj Optional instance to populate.
     * @return {module:model/PrepareAUTXOBasedTransactionFromXPubE403} The populated <code>PrepareAUTXOBasedTransactionFromXPubE403</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new PrepareAUTXOBasedTransactionFromXPubE403();
  ...
  return PrepareAUTXOBasedTransactionFromXPubE403;
}();
/**
...
PrepareAUTXOBasedTransactionFromXPubE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

PrepareAUTXOBasedTransactionFromXPubE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

PrepareAUTXOBasedTransactionFromXPubE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
...
var _default = PrepareAUTXOBasedTransactionFromXPubE403;
