...
var _WalletAsAServiceAddressBalanceNotEnoughError = _interopRequireDefault(require("./WalletAsAServiceAddressBalanceNotEnoughError"));
...
var WalletAsAServiceAddressBalanceNotEnough = /*#__PURE__*/function () {
   ...
   * @param error {module:model/WalletAsAServiceAddressBalanceNotEnoughError} 
   */
  function WalletAsAServiceAddressBalanceNotEnough(apiVersion, requestId, error) {
    _classCallCheck(this, WalletAsAServiceAddressBalanceNotEnough);

    WalletAsAServiceAddressBalanceNotEnough.initialize(this, apiVersion, requestId, error);
  }
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _WalletAsAServiceAddressBalanceNotEnoughError["default"].constructFromObject(data['error']);
        }
      }
...
WalletAsAServiceAddressBalanceNotEnough.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

WalletAsAServiceAddressBalanceNotEnough.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

WalletAsAServiceAddressBalanceNotEnough.prototype['context'] = undefined;
/**
 * @member {module:model/WalletAsAServiceAddressBalanceNotEnoughError} error
 */

WalletAsAServiceAddressBalanceNotEnough.prototype['error'] = undefined;
