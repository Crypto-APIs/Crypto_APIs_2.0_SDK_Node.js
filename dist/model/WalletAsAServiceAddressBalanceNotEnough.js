...
var WalletAsAServiceAddressBalanceNotEnough = /*#__PURE__*/function () {
  ...
  _createClass(WalletAsAServiceAddressBalanceNotEnough, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>WalletAsAServiceAddressBalanceNotEnough</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WalletAsAServiceAddressBalanceNotEnough</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(WalletAsAServiceAddressBalanceNotEnough.RequiredProperties),
        _step;
      try {
...
WalletAsAServiceAddressBalanceNotEnough.RequiredProperties = ["code", "message"];
