...
var GetAssetDetailsByAssetSymbolRData = /*#__PURE__*/function () {
  ...
  _createClass(GetAssetDetailsByAssetSymbolRData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetAssetDetailsByAssetSymbolRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAssetDetailsByAssetSymbolRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetAssetDetailsByAssetSymbolRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _GetAssetDetailsByAssetSymbolRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
GetAssetDetailsByAssetSymbolRData.RequiredProperties = ["item"];
