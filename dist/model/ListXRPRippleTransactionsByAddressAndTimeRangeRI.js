...
var ListXRPRippleTransactionsByAddressAndTimeRangeRI = /*#__PURE__*/function () {
  ...
  _createClass(ListXRPRippleTransactionsByAddressAndTimeRangeRI, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListXRPRippleTransactionsByAddressAndTimeRangeRI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListXRPRippleTransactionsByAddressAndTimeRangeRI</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListXRPRippleTransactionsByAddressAndTimeRangeRI.RequiredProperties),
        _step;
      try {
...
ListXRPRippleTransactionsByAddressAndTimeRangeRI.RequiredProperties = ["index", "minedInBlockHash", "minedInBlockHeight", "recipients", "senders", "sequence", "status", "timestamp", "transactionHash", "type", "fee", "offer", "receive", "value"];
