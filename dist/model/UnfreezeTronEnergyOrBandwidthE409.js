...
/**
 * The UnfreezeTronEnergyOrBandwidthE409 model module.
 * @module model/UnfreezeTronEnergyOrBandwidthE409
 * @version 1.11.0
 */
var UnfreezeTronEnergyOrBandwidthE409 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UnfreezeTronEnergyOrBandwidthE409</code>.
   * @alias module:model/UnfreezeTronEnergyOrBandwidthE409
   * @param {(module:model/InvalidData|module:model/WalletAsAServiceAddressBalanceNotEnough|module:model/WalletAsAServiceTokenNotSupported|module:model/WalletAsAServiceWalletBalanceNotEnough)} instance The actual instance to initialize UnfreezeTronEnergyOrBandwidthE409.
   */
  function UnfreezeTronEnergyOrBandwidthE409() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, UnfreezeTronEnergyOrBandwidthE409);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `UnfreezeTronEnergyOrBandwidthE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceTokenNotSupported, WalletAsAServiceWalletBalanceNotEnough. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `UnfreezeTronEnergyOrBandwidthE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceTokenNotSupported, WalletAsAServiceWalletBalanceNotEnough. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>UnfreezeTronEnergyOrBandwidthE409</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UnfreezeTronEnergyOrBandwidthE409} obj Optional instance to populate.
   * @return {module:model/UnfreezeTronEnergyOrBandwidthE409} The populated <code>UnfreezeTronEnergyOrBandwidthE409</code> instance.
   */
  _createClass(UnfreezeTronEnergyOrBandwidthE409, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = UnfreezeTronEnergyOrBandwidthE409.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new UnfreezeTronEnergyOrBandwidthE409(data);
    }
  }]);
  return UnfreezeTronEnergyOrBandwidthE409;
}();
/**
 * Specifies an error code, e.g. error 404.
 * @member {String} code
 */
_defineProperty(UnfreezeTronEnergyOrBandwidthE409, "fromJSON", function (json_string) {
  return UnfreezeTronEnergyOrBandwidthE409.constructFromObject(JSON.parse(json_string));
});
UnfreezeTronEnergyOrBandwidthE409.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
UnfreezeTronEnergyOrBandwidthE409.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
UnfreezeTronEnergyOrBandwidthE409.prototype['details'] = undefined;
UnfreezeTronEnergyOrBandwidthE409.OneOf = ["InvalidData", "WalletAsAServiceAddressBalanceNotEnough", "WalletAsAServiceTokenNotSupported", "WalletAsAServiceWalletBalanceNotEnough"];
var _default = UnfreezeTronEnergyOrBandwidthE409;
