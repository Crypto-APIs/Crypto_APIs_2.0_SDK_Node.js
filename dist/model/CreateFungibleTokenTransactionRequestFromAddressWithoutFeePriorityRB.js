...
var CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRB = /*#__PURE__*/function () {
  ...
  _createClass(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRB, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
