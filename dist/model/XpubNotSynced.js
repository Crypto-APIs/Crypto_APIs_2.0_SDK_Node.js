...
var XpubNotSynced = /*#__PURE__*/function () {
  ...
  _createClass(XpubNotSynced, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>XpubNotSynced</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XpubNotSynced</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(XpubNotSynced.RequiredProperties),
        _step;
      try {
...
XpubNotSynced.RequiredProperties = ["code", "message"];
