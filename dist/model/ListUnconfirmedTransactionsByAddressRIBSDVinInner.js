...
var ListUnconfirmedTransactionsByAddressRIBSDVinInner = /*#__PURE__*/function () {
   ...
   */
  function ListUnconfirmedTransactionsByAddressRIBSDVinInner(addresses, scriptSig, sequence, txinwitness, value) {
    _classCallCheck(this, ListUnconfirmedTransactionsByAddressRIBSDVinInner);
   ...
   */
  _createClass(ListUnconfirmedTransactionsByAddressRIBSDVinInner, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListUnconfirmedTransactionsByAddressRIBSDVinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUnconfirmedTransactionsByAddressRIBSDVinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListUnconfirmedTransactionsByAddressRIBSDVinInner.RequiredProperties),
        _step;
      try {
...
ListUnconfirmedTransactionsByAddressRIBSDVinInner.RequiredProperties = ["addresses", "scriptSig", "sequence", "txinwitness", "value"];
...
var _default = ListUnconfirmedTransactionsByAddressRIBSDVinInner;
