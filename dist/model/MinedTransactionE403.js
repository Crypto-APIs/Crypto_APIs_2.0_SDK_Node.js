...
var MinedTransactionE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/BlockchainEventsCallbacksLimitReached|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize MinedTransactionE403.
   */
  function MinedTransactionE403() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `MinedTransactionE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `MinedTransactionE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(MinedTransactionE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = MinedTransactionE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new MinedTransactionE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(MinedTransactionE403, "fromJSON", function (json_string) {
  return MinedTransactionE403.constructFromObject(JSON.parse(json_string));
});
 ...
 */
MinedTransactionE403.prototype['details'] = undefined;
MinedTransactionE403.OneOf = ["BannedIpAddress", "BlockchainEventsCallbacksLimitReached", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
