 ...
 * @version 1.11.0
 */
var PrepareTransactionFromAddressRIBSEC = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PrepareTransactionFromAddressRIBSEC</code>.
   * Ethereum Classic
   * @alias module:model/PrepareTransactionFromAddressRIBSEC
   * @param fee {module:model/PrepareTransactionFromAddressRIBSBSCFee} 
   * @param transactionType {module:model/PrepareTransactionFromAddressRIBSEC.TransactionTypeEnum} Representation of the transaction type
   * @param unit {String} Represents the unit of the amount transacted.
   */
  function PrepareTransactionFromAddressRIBSEC(fee, transactionType, unit) {
    _classCallCheck(this, PrepareTransactionFromAddressRIBSEC);
    PrepareTransactionFromAddressRIBSEC.initialize(this, fee, transactionType, unit);
  }
   ...
   */
  _createClass(PrepareTransactionFromAddressRIBSEC, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>PrepareTransactionFromAddressRIBSEC</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrepareTransactionFromAddressRIBSEC} obj Optional instance to populate.
     * @return {module:model/PrepareTransactionFromAddressRIBSEC} The populated <code>PrepareTransactionFromAddressRIBSEC</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new PrepareTransactionFromAddressRIBSEC();
    ...
    /**
     * Validates the JSON data with respect to <code>PrepareTransactionFromAddressRIBSEC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrepareTransactionFromAddressRIBSEC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(PrepareTransactionFromAddressRIBSEC.RequiredProperties),
        _step;
      try {
...
PrepareTransactionFromAddressRIBSEC.RequiredProperties = ["fee", "transactionType", "unit"];
 ...
 * @readonly
 */
PrepareTransactionFromAddressRIBSEC['TransactionTypeEnum'] = {
  /**
...
var _default = PrepareTransactionFromAddressRIBSEC;
