...
var GetInternalTransactionByTransactionHashAndOperationIdE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize GetInternalTransactionByTransactionHashAndOperationIdE403.
   */
  function GetInternalTransactionByTransactionHashAndOperationIdE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetInternalTransactionByTransactionHashAndOperationIdE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetInternalTransactionByTransactionHashAndOperationIdE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetInternalTransactionByTransactionHashAndOperationIdE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>GetInternalTransactionByTransactionHashAndOperationIdE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetInternalTransactionByTransactionHashAndOperationIdE403} obj Optional instance to populate.
   * @return {module:model/GetInternalTransactionByTransactionHashAndOperationIdE403} The populated <code>GetInternalTransactionByTransactionHashAndOperationIdE403</code> instance.
   */
  _createClass(GetInternalTransactionByTransactionHashAndOperationIdE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetInternalTransactionByTransactionHashAndOperationIdE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetInternalTransactionByTransactionHashAndOperationIdE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetInternalTransactionByTransactionHashAndOperationIdE403, "fromJSON", function (json_string) {
  return GetInternalTransactionByTransactionHashAndOperationIdE403.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GetInternalTransactionByTransactionHashAndOperationIdE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
GetInternalTransactionByTransactionHashAndOperationIdE403.prototype['details'] = undefined;
GetInternalTransactionByTransactionHashAndOperationIdE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = GetInternalTransactionByTransactionHashAndOperationIdE403;
