...
var GetTransactionDetailsByTransactionIDRData = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _GetTransactionDetailsByTransactionIDRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
