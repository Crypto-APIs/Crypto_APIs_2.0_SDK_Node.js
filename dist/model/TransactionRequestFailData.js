...
var _TransactionRequestFailDataItem = _interopRequireDefault(require("./TransactionRequestFailDataItem"));
...
var TransactionRequestFailData = /*#__PURE__*/function () {
   ...
   */
  function TransactionRequestFailData(product, event, item) {
    _classCallCheck(this, TransactionRequestFailData);
   ...
   */
  _createClass(TransactionRequestFailData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _TransactionRequestFailDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TransactionRequestFailData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransactionRequestFailData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TransactionRequestFailData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _TransactionRequestFailDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
TransactionRequestFailData.RequiredProperties = ["product", "event", "item"];
...
var _default = TransactionRequestFailData;
