...
var GetLatestMinedXRPRippleBlockRITotalFees = /*#__PURE__*/function () {
  ...
  _createClass(GetLatestMinedXRPRippleBlockRITotalFees, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetLatestMinedXRPRippleBlockRITotalFees</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLatestMinedXRPRippleBlockRITotalFees</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetLatestMinedXRPRippleBlockRITotalFees.RequiredProperties),
        _step;
      try {
...
GetLatestMinedXRPRippleBlockRITotalFees.RequiredProperties = ["amount", "unit"];
