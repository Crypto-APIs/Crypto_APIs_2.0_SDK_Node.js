 ...
 * @version 1.6.0
 */
var GetUnconfirmedOmniTransactionByTransactionIDTxidE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetUnconfirmedOmniTransactionByTransactionIDTxidE400</code>.
   * @alias module:model/GetUnconfirmedOmniTransactionByTransactionIDTxidE400
   ...
   */
  function GetUnconfirmedOmniTransactionByTransactionIDTxidE400(code, message) {
    _classCallCheck(this, GetUnconfirmedOmniTransactionByTransactionIDTxidE400);
    ...
    GetUnconfirmedOmniTransactionByTransactionIDTxidE400.initialize(this, code, message);
  }
  /**
  ...
  _createClass(GetUnconfirmedOmniTransactionByTransactionIDTxidE400, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetUnconfirmedOmniTransactionByTransactionIDTxidE400</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUnconfirmedOmniTransactionByTransactionIDTxidE400} obj Optional instance to populate.
     * @return {module:model/GetUnconfirmedOmniTransactionByTransactionIDTxidE400} The populated <code>GetUnconfirmedOmniTransactionByTransactionIDTxidE400</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetUnconfirmedOmniTransactionByTransactionIDTxidE400();
...
GetUnconfirmedOmniTransactionByTransactionIDTxidE400.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

GetUnconfirmedOmniTransactionByTransactionIDTxidE400.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

GetUnconfirmedOmniTransactionByTransactionIDTxidE400.prototype['details'] = undefined; // Implement UriNotFound interface:
...
var _default = GetUnconfirmedOmniTransactionByTransactionIDTxidE400;
