...
var GetZilliqaBlockDetailsByBlockHashE400 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize GetZilliqaBlockDetailsByBlockHashE400.
   */
  function GetZilliqaBlockDetailsByBlockHashE400() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetZilliqaBlockDetailsByBlockHashE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetZilliqaBlockDetailsByBlockHashE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(GetZilliqaBlockDetailsByBlockHashE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetZilliqaBlockDetailsByBlockHashE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetZilliqaBlockDetailsByBlockHashE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetZilliqaBlockDetailsByBlockHashE400, "fromJSON", function (json_string) {
  return GetZilliqaBlockDetailsByBlockHashE400.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GetZilliqaBlockDetailsByBlockHashE400.prototype['details'] = undefined;
GetZilliqaBlockDetailsByBlockHashE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
