...
var _ListAllUnconfirmedTransactionsRIBSLVin = _interopRequireDefault(require("./ListAllUnconfirmedTransactionsRIBSLVin"));

var _ListAllUnconfirmedTransactionsRIBSLVout = _interopRequireDefault(require("./ListAllUnconfirmedTransactionsRIBSLVout"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('vin')) {
          obj['vin'] = _ApiClient["default"].convertToType(data['vin'], [_ListAllUnconfirmedTransactionsRIBSLVin["default"]]);
        }

        if (data.hasOwnProperty('vout')) {
          obj['vout'] = _ApiClient["default"].convertToType(data['vout'], [_ListAllUnconfirmedTransactionsRIBSLVout["default"]]);
        }
      }
