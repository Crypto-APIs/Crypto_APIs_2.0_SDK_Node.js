...
var ListTransactionsByBlockHashRIFee = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHashRIFee, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHashRIFee</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHashRIFee</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIFee.RequiredProperties),
        _step;
      try {
...
ListTransactionsByBlockHashRIFee.RequiredProperties = ["amount", "unit"];
