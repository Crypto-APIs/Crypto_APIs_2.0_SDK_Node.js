...
var _NewConfirmedCoinsTransactionsForSpecificAmountE = _interopRequireDefault(require("./NewConfirmedCoinsTransactionsForSpecificAmountE403"));
 ...
 * @version 1.11.0
 */
var NewConfirmedCoinsTransactionsForSpecificAmount403Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function NewConfirmedCoinsTransactionsForSpecificAmount403Response(apiVersion, requestId, error) {
    _classCallCheck(this, NewConfirmedCoinsTransactionsForSpecificAmount403Response);
   ...
   */
  _createClass(NewConfirmedCoinsTransactionsForSpecificAmount403Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>NewConfirmedCoinsTransactionsForSpecificAmount403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewConfirmedCoinsTransactionsForSpecificAmount403Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewConfirmedCoinsTransactionsForSpecificAmount403Response.RequiredProperties),
        _step;
      try {
  ...
  return NewConfirmedCoinsTransactionsForSpecificAmount403Response;
}();
NewConfirmedCoinsTransactionsForSpecificAmount403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = NewConfirmedCoinsTransactionsForSpecificAmount403Response;
