...
var MissingApiKey = /*#__PURE__*/function () {
   ...
   */
  function MissingApiKey(code, message) {
    _classCallCheck(this, MissingApiKey);
    MissingApiKey.initialize(this, code, message);
  }
  ...
  _createClass(MissingApiKey, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>MissingApiKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MissingApiKey</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(MissingApiKey.RequiredProperties),
        _step;
      try {
...
MissingApiKey.RequiredProperties = ["code", "message"];
