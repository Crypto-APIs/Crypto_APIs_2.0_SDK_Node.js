...
var EndpointNotAllowedForPlan = /*#__PURE__*/function () {
  ...
  _createClass(EndpointNotAllowedForPlan, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>EndpointNotAllowedForPlan</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EndpointNotAllowedForPlan</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(EndpointNotAllowedForPlan.RequiredProperties),
        _step;
      try {
...
EndpointNotAllowedForPlan.RequiredProperties = ["code", "message"];
