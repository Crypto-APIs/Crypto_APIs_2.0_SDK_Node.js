...
var _EndpointNotAllowedForPlanError = _interopRequireDefault(require("./EndpointNotAllowedForPlanError"));
...
var EndpointNotAllowedForPlan = /*#__PURE__*/function () {
   ...
   * @param error {module:model/EndpointNotAllowedForPlanError} 
   */
  function EndpointNotAllowedForPlan(apiVersion, requestId, error) {
    _classCallCheck(this, EndpointNotAllowedForPlan);

    EndpointNotAllowedForPlan.initialize(this, apiVersion, requestId, error);
  }
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _EndpointNotAllowedForPlanError["default"].constructFromObject(data['error']);
        }
      }
...
EndpointNotAllowedForPlan.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

EndpointNotAllowedForPlan.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

EndpointNotAllowedForPlan.prototype['context'] = undefined;
/**
 * @member {module:model/EndpointNotAllowedForPlanError} error
 */

EndpointNotAllowedForPlan.prototype['error'] = undefined;
