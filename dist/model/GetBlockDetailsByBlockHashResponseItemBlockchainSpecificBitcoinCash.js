...
/**
 * The GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash model module.
 * @module model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash
 * @version 2.0.0
 */
var GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash</code>.
   * Bitcoin Cash
   * @alias module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash
   ...
   */
  function GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash(difficulty, nonce, size, bits, chainwork, merkleroot, version, versionHex) {
    _classCallCheck(this, GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash);

    GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash.initialize(this, difficulty, nonce, size, bits, chainwork, merkleroot, version, versionHex);
  }
  /**
  ...
  _createClass(GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash} The populated <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash();
  ...
  return GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash;
}();
/**
...
var _default = GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoinCash;
