 ...
 * @version 1.11.0
 */
var ListTransactionsByBlockHashRIBSDVinInner = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListTransactionsByBlockHashRIBSDVinInner(addresses, scriptSig, sequence, txinwitness, value) {
    _classCallCheck(this, ListTransactionsByBlockHashRIBSDVinInner);
   ...
   */
  _createClass(ListTransactionsByBlockHashRIBSDVinInner, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHashRIBSDVinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHashRIBSDVinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIBSDVinInner.RequiredProperties),
        _step;
      try {
...
ListTransactionsByBlockHashRIBSDVinInner.RequiredProperties = ["addresses", "scriptSig", "sequence", "txinwitness", "value"];
...
var _default = ListTransactionsByBlockHashRIBSDVinInner;
