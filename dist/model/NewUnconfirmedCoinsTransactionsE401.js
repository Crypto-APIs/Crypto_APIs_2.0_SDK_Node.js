...
var NewUnconfirmedCoinsTransactionsE401 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidApiKey|module:model/MissingApiKey)} instance The actual instance to initialize NewUnconfirmedCoinsTransactionsE401.
   */
  function NewUnconfirmedCoinsTransactionsE401() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewUnconfirmedCoinsTransactionsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewUnconfirmedCoinsTransactionsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(NewUnconfirmedCoinsTransactionsE401, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewUnconfirmedCoinsTransactionsE401.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new NewUnconfirmedCoinsTransactionsE401(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(NewUnconfirmedCoinsTransactionsE401, "fromJSON", function (json_string) {
  return NewUnconfirmedCoinsTransactionsE401.constructFromObject(JSON.parse(json_string));
});
...
NewUnconfirmedCoinsTransactionsE401.OneOf = ["InvalidApiKey", "MissingApiKey"];
