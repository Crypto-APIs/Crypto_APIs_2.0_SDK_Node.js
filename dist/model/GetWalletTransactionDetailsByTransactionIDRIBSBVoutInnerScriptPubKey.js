...
var GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey = /*#__PURE__*/function () {
  ...
  _createClass(GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey.RequiredProperties),
        _step;
      try {
...
GetWalletTransactionDetailsByTransactionIDRIBSBVoutInnerScriptPubKey.RequiredProperties = ["addresses", "asm", "hex", "type"];
