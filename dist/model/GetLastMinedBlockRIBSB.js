...
var GetLastMinedBlockRIBSB = /*#__PURE__*/function () {
  ...
  _createClass(GetLastMinedBlockRIBSB, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetLastMinedBlockRIBSB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLastMinedBlockRIBSB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetLastMinedBlockRIBSB.RequiredProperties),
        _step;
      try {
...
GetLastMinedBlockRIBSB.RequiredProperties = ["bits", "chainwork", "merkleRoot", "nonce", "size", "strippedSize", "version", "versionHex", "weight"];
