...
var DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesRI = /*#__PURE__*/function () {
  ...
  _createClass(DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['addresses']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesRIAddressesInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
