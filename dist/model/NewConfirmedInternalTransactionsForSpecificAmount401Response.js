...
var _NewConfirmedInternalTransactionsForSpecificAmountE = _interopRequireDefault(require("./NewConfirmedInternalTransactionsForSpecificAmountE401"));
 ...
 * @version 1.11.0
 */
var NewConfirmedInternalTransactionsForSpecificAmount401Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function NewConfirmedInternalTransactionsForSpecificAmount401Response(apiVersion, requestId, error) {
    _classCallCheck(this, NewConfirmedInternalTransactionsForSpecificAmount401Response);
   ...
   */
  _createClass(NewConfirmedInternalTransactionsForSpecificAmount401Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>NewConfirmedInternalTransactionsForSpecificAmount401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewConfirmedInternalTransactionsForSpecificAmount401Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewConfirmedInternalTransactionsForSpecificAmount401Response.RequiredProperties),
        _step;
      try {
  ...
  return NewConfirmedInternalTransactionsForSpecificAmount401Response;
}();
NewConfirmedInternalTransactionsForSpecificAmount401Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = NewConfirmedInternalTransactionsForSpecificAmount401Response;
