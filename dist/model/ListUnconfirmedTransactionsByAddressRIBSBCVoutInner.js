...
var ListUnconfirmedTransactionsByAddressRIBSBCVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(ListUnconfirmedTransactionsByAddressRIBSBCVoutInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListUnconfirmedTransactionsByAddressRIBSBCVoutInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUnconfirmedTransactionsByAddressRIBSBCVoutInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListUnconfirmedTransactionsByAddressRIBSBCVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
...
ListUnconfirmedTransactionsByAddressRIBSBCVoutInner.RequiredProperties = ["isSpent", "scriptPubKey", "value"];
