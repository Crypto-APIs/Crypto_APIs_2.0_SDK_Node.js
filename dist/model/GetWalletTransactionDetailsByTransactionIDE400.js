...
var GetWalletTransactionDetailsByTransactionIDE400 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize GetWalletTransactionDetailsByTransactionIDE400.
   */
  function GetWalletTransactionDetailsByTransactionIDE400() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetWalletTransactionDetailsByTransactionIDE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetWalletTransactionDetailsByTransactionIDE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(GetWalletTransactionDetailsByTransactionIDE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetWalletTransactionDetailsByTransactionIDE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetWalletTransactionDetailsByTransactionIDE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetWalletTransactionDetailsByTransactionIDE400, "fromJSON", function (json_string) {
  return GetWalletTransactionDetailsByTransactionIDE400.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GetWalletTransactionDetailsByTransactionIDE400.prototype['details'] = undefined;
GetWalletTransactionDetailsByTransactionIDE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
