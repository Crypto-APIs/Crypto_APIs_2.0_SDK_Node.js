...
var NewUnconfirmedTokensTransactionsRB = /*#__PURE__*/function () {
  ...
  _createClass(NewUnconfirmedTokensTransactionsRB, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(NewUnconfirmedTokensTransactionsRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _NewUnconfirmedTokensTransactionsRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
