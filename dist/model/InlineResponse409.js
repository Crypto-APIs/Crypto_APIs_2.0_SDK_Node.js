 ...
 * @version 1.5.0
 */
var InlineResponse409 = /*#__PURE__*/function () {
  /**
   ...
   */
  function InlineResponse409(apiVersion, requestId, error) {
    _classCallCheck(this, InlineResponse409);

    InlineResponse409.initialize(this, apiVersion, requestId, error);
  }
  /**
  ...
  _createClass(InlineResponse409, null, [{
    key: "initialize",
...
InlineResponse409.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

InlineResponse409.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

InlineResponse409.prototype['context'] = undefined;
/**
 * @member {module:model/InvalidData} error
 */

InlineResponse409.prototype['error'] = undefined;
var _default = InlineResponse409;
