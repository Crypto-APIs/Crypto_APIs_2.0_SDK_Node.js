...
/**
 * The ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum model module.
 * @module model/ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum
 * @version 2.0.0
 */
var ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum</code>.
   * Ethereum
   * @alias module:model/ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum
   ...
   */
  function ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum(contract, gasLimit, gasPrice, gasUsed, inputData, nonce, transactionStatus) {
    _classCallCheck(this, ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum);

    ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum.initialize(this, contract, gasLimit, gasPrice, gasUsed, inputData, nonce, transactionStatus);
  }
  /**
  ...
  _createClass(ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum} obj Optional instance to populate.
     * @return {module:model/ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum} The populated <code>ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum();
  ...
  return ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum;
}();
/**
...
var _default = ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereum;
