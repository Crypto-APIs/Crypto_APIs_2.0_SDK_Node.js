 ...
 * @version 1.11.0
 */
var ListTransactionsByBlockHeightRIBSEC = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListTransactionsByBlockHeightRIBSEC(contract, gasLimit, gasPrice, gasUsed, inputData, nonce) {
    _classCallCheck(this, ListTransactionsByBlockHeightRIBSEC);
   ...
   */
  _createClass(ListTransactionsByBlockHeightRIBSEC, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRIBSEC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRIBSEC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSEC.RequiredProperties),
        _step;
      try {
      ...
      if (data['gasPrice']) {
        // data not null
        _ListTransactionsByBlockHeightRIBSECGasPrice["default"].validateJSON(data['gasPrice']);
      }
      // ensure the json data is a string
...
ListTransactionsByBlockHeightRIBSEC.RequiredProperties = ["contract", "gasLimit", "gasPrice", "gasUsed", "inputData", "nonce"];
...
var _default = ListTransactionsByBlockHeightRIBSEC;
