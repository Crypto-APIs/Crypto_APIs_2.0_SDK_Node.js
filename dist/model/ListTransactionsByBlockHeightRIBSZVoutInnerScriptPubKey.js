...
var ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey.RequiredProperties),
        _step;
      try {
...
ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey.RequiredProperties = ["addresses", "asm", "hex", "type"];
