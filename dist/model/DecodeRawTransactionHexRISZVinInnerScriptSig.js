...
var DecodeRawTransactionHexRISZVinInnerScriptSig = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISZVinInnerScriptSig, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>DecodeRawTransactionHexRISZVinInnerScriptSig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DecodeRawTransactionHexRISZVinInnerScriptSig</code>.
     */
  }, {
    key: "validateJSON",
