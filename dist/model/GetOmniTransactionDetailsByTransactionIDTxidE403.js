...
/**
 * The GetOmniTransactionDetailsByTransactionIDTxidE403 model module.
 * @module model/GetOmniTransactionDetailsByTransactionIDTxidE403
 * @version 1.4.0
 */
var GetOmniTransactionDetailsByTransactionIDTxidE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetOmniTransactionDetailsByTransactionIDTxidE403</code>.
   * @alias module:model/GetOmniTransactionDetailsByTransactionIDTxidE403
   ...
   */
  function GetOmniTransactionDetailsByTransactionIDTxidE403(code, message) {
    _classCallCheck(this, GetOmniTransactionDetailsByTransactionIDTxidE403);
    ...
    GetOmniTransactionDetailsByTransactionIDTxidE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(GetOmniTransactionDetailsByTransactionIDTxidE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetOmniTransactionDetailsByTransactionIDTxidE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOmniTransactionDetailsByTransactionIDTxidE403} obj Optional instance to populate.
     * @return {module:model/GetOmniTransactionDetailsByTransactionIDTxidE403} The populated <code>GetOmniTransactionDetailsByTransactionIDTxidE403</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetOmniTransactionDetailsByTransactionIDTxidE403();
  ...
  return GetOmniTransactionDetailsByTransactionIDTxidE403;
}();
/**
...
GetOmniTransactionDetailsByTransactionIDTxidE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

GetOmniTransactionDetailsByTransactionIDTxidE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetails>} details
 */

GetOmniTransactionDetailsByTransactionIDTxidE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
...
var _default = GetOmniTransactionDetailsByTransactionIDTxidE403;
