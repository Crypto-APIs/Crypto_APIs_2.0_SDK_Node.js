...
var AddressCoinsTransactionConfirmedDataItem = /*#__PURE__*/function () {
  ...
  _createClass(AddressCoinsTransactionConfirmedDataItem, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddressCoinsTransactionConfirmedDataItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressCoinsTransactionConfirmedDataItem</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressCoinsTransactionConfirmedDataItem.RequiredProperties),
        _step;
      try {
      ...
      if (data['minedInBlock']) {
        // data not null
        _AddressCoinsTransactionConfirmedDataItemMinedInBlock["default"].validateJSON(data['minedInBlock']);
      }
      // ensure the json data is a string
...
AddressCoinsTransactionConfirmedDataItem.RequiredProperties = ["blockchain", "network", "address", "minedInBlock", "transactionId", "amount", "unit", "direction"];
