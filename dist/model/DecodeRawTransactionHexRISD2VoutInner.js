...
var _DecodeRawTransactionHexRISD2VoutInnerScriptPubKey = _interopRequireDefault(require("./DecodeRawTransactionHexRISD2VoutInnerScriptPubKey"));
...
var DecodeRawTransactionHexRISD2VoutInner = /*#__PURE__*/function () {
   ...
   */
  function DecodeRawTransactionHexRISD2VoutInner(scriptPubKey) {
    _classCallCheck(this, DecodeRawTransactionHexRISD2VoutInner);
   ...
   */
  _createClass(DecodeRawTransactionHexRISD2VoutInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('scriptPubKey')) {
          obj['scriptPubKey'] = _DecodeRawTransactionHexRISD2VoutInnerScriptPubKey["default"].constructFromObject(data['scriptPubKey']);
        }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRISD2VoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _DecodeRawTransactionHexRISD2VoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
...
var _default = DecodeRawTransactionHexRISD2VoutInner;
