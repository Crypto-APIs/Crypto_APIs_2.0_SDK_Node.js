...
var ListUnconfirmedTransactionsByAddressRIBSEC = /*#__PURE__*/function () {
  ...
  _createClass(ListUnconfirmedTransactionsByAddressRIBSEC, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListUnconfirmedTransactionsByAddressRIBSEC.RequiredProperties),
        _step;
      try {
      ...
      if (data['fee']) {
        // data not null
        _ListUnconfirmedTransactionsByAddressRIBSECFee["default"].validateJSON(data['fee']);
      }
      ...
      if (data['gasPrice']) {
        // data not null
        _ListUnconfirmedTransactionsByAddressRIBSECGasPrice["default"].validateJSON(data['gasPrice']);
      }
      // ensure the json data is a string
