...
var _SyncHDWalletXPubYPubZPubRI = _interopRequireDefault(require("./SyncHDWalletXPubYPubZPubRI"));
...
var SyncHDWalletXPubYPubZPubRData = /*#__PURE__*/function () {
   ...
   */
  function SyncHDWalletXPubYPubZPubRData(item) {
    _classCallCheck(this, SyncHDWalletXPubYPubZPubRData);
   ...
   */
  _createClass(SyncHDWalletXPubYPubZPubRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _SyncHDWalletXPubYPubZPubRI["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(SyncHDWalletXPubYPubZPubRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _SyncHDWalletXPubYPubZPubRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
