...
var ListZilliqaTransactionsByBlockHash403Response = /*#__PURE__*/function () {
  ...
  _createClass(ListZilliqaTransactionsByBlockHash403Response, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListZilliqaTransactionsByBlockHash403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListZilliqaTransactionsByBlockHash403Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListZilliqaTransactionsByBlockHash403Response.RequiredProperties),
        _step;
      try {
...
ListZilliqaTransactionsByBlockHash403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
