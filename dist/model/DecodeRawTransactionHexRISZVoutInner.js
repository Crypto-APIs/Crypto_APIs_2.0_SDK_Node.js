...
var DecodeRawTransactionHexRISZVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISZVoutInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRISZVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _DecodeRawTransactionHexRISZVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
