...
var _GetExchangeRateByAssetsIDsRI = _interopRequireDefault(require("./GetExchangeRateByAssetsIDsRI"));
 ...
 * @version 1.11.0
 */
var GetExchangeRateByAssetsIDsRData = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetExchangeRateByAssetsIDsRData(item) {
    _classCallCheck(this, GetExchangeRateByAssetsIDsRData);
   ...
   */
  _createClass(GetExchangeRateByAssetsIDsRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _GetExchangeRateByAssetsIDsRI["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetExchangeRateByAssetsIDsRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _GetExchangeRateByAssetsIDsRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
var _default = GetExchangeRateByAssetsIDsRData;
