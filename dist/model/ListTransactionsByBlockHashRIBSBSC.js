...
var ListTransactionsByBlockHashRIBSBSC = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHashRIBSBSC, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHashRIBSBSC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHashRIBSBSC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIBSBSC.RequiredProperties),
        _step;
      try {
      ...
      if (data['gasPrice']) {
        // data not null
        _ListTransactionsByBlockHashRIBSBSCGasPrice["default"].validateJSON(data['gasPrice']);
      }
      // ensure the json data is a string
...
ListTransactionsByBlockHashRIBSBSC.RequiredProperties = ["gasLimit", "gasPrice", "gasUsed", "inputData", "nonce", "transactionStatus"];
