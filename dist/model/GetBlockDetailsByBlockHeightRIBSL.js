...
var GetBlockDetailsByBlockHeightRIBSL = /*#__PURE__*/function () {
  ...
  _createClass(GetBlockDetailsByBlockHeightRIBSL, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHeightRIBSL</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHeightRIBSL</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHeightRIBSL.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHeightRIBSL.RequiredProperties = ["difficulty", "bits", "chainwork", "merkleRoot", "nonce", "size", "strippedSize", "version", "versionHex", "weight"];
