...
var AddTokensToExistingFromAddressRB = /*#__PURE__*/function () {
  ...
  _createClass(AddTokensToExistingFromAddressRB, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddTokensToExistingFromAddressRB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddTokensToExistingFromAddressRB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddTokensToExistingFromAddressRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _AddTokensToExistingFromAddressRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
AddTokensToExistingFromAddressRB.RequiredProperties = ["data"];
