...
var EstimateGasLimitE403 = /*#__PURE__*/function () {
  ...
  function EstimateGasLimitE403() {
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `EstimateGasLimitE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(EstimateGasLimitE403, [{
 ...
 * @member {String} code
 */
_defineProperty(EstimateGasLimitE403, "fromJSON", function (json_string) {
