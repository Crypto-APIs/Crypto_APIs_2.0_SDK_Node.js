...
var _SyncHDWalletxPubYPubZPubResponseItem = _interopRequireDefault(require("./SyncHDWalletxPubYPubZPubResponseItem"));
 ...
 * @version 2.0.0
 */
var SyncHDWalletxPubYPubZPubResponseData = /*#__PURE__*/function () {
  /**
   ...
   */
  function SyncHDWalletxPubYPubZPubResponseData(item) {
    _classCallCheck(this, SyncHDWalletxPubYPubZPubResponseData);
  ...
  _createClass(SyncHDWalletxPubYPubZPubResponseData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _SyncHDWalletxPubYPubZPubResponseItem["default"].constructFromObject(data['item']);
        }
      }
  ...
  return SyncHDWalletxPubYPubZPubResponseData;
}();
/**
...
var _default = SyncHDWalletxPubYPubZPubResponseData;
