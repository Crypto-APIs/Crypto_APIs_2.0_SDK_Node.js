...
var MinedTransactionRI = /*#__PURE__*/function () {
   ...
   */
  function MinedTransactionRI(callbackSecretKey, callbackUrl, createdTimestamp, eventType, isActive, referenceId, transactionId) {
    _classCallCheck(this, MinedTransactionRI);
   ...
   */
  _createClass(MinedTransactionRI, null, [{
    key: "initialize",
    value: function initialize(obj, callbackSecretKey, callbackUrl, createdTimestamp, eventType, isActive, referenceId, transactionId) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(MinedTransactionRI.RequiredProperties),
        _step;
      try {
...
var _default = MinedTransactionRI;
