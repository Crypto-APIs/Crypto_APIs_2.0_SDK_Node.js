...
var ListLatestMinedBlocksRIBSD2 = /*#__PURE__*/function () {
  ...
  _createClass(ListLatestMinedBlocksRIBSD2, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListLatestMinedBlocksRIBSD2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLatestMinedBlocksRIBSD2</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListLatestMinedBlocksRIBSD2.RequiredProperties),
        _step;
      try {
...
ListLatestMinedBlocksRIBSD2.RequiredProperties = ["bits", "chainwork", "difficulty", "merkleRoot", "nonce", "size", "strippedSize", "version", "weight"];
