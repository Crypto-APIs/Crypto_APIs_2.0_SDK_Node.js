...
var _DeriveAndSyncNewReceivingAddressesRBDataItem = _interopRequireDefault(require("./DeriveAndSyncNewReceivingAddressesRBDataItem"));
...
var DeriveAndSyncNewReceivingAddressesRBData = /*#__PURE__*/function () {
   ...
   */
  function DeriveAndSyncNewReceivingAddressesRBData(item) {
    _classCallCheck(this, DeriveAndSyncNewReceivingAddressesRBData);
   ...
   */
  _createClass(DeriveAndSyncNewReceivingAddressesRBData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _DeriveAndSyncNewReceivingAddressesRBDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DeriveAndSyncNewReceivingAddressesRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _DeriveAndSyncNewReceivingAddressesRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
