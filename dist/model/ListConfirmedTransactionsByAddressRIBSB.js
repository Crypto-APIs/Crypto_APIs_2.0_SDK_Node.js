...
/**
 * The ListConfirmedTransactionsByAddressRIBSB model module.
 * @module model/ListConfirmedTransactionsByAddressRIBSB
 * @version 1.11.0
 */
var ListConfirmedTransactionsByAddressRIBSB = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListConfirmedTransactionsByAddressRIBSB</code>.
   * Bitcoin
   * @alias module:model/ListConfirmedTransactionsByAddressRIBSB
   ...
   */
  function ListConfirmedTransactionsByAddressRIBSB(locktime, size, vSize, version, vin, vout) {
    _classCallCheck(this, ListConfirmedTransactionsByAddressRIBSB);
    ListConfirmedTransactionsByAddressRIBSB.initialize(this, locktime, size, vSize, version, vin, vout);
  }
   ...
   */
  _createClass(ListConfirmedTransactionsByAddressRIBSB, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListConfirmedTransactionsByAddressRIBSB</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListConfirmedTransactionsByAddressRIBSB} obj Optional instance to populate.
     * @return {module:model/ListConfirmedTransactionsByAddressRIBSB} The populated <code>ListConfirmedTransactionsByAddressRIBSB</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListConfirmedTransactionsByAddressRIBSB();
    ...
    /**
     * Validates the JSON data with respect to <code>ListConfirmedTransactionsByAddressRIBSB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListConfirmedTransactionsByAddressRIBSB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListConfirmedTransactionsByAddressRIBSB.RequiredProperties),
        _step;
      try {
...
ListConfirmedTransactionsByAddressRIBSB.RequiredProperties = ["locktime", "size", "vSize", "version", "vin", "vout"];
...
var _default = ListConfirmedTransactionsByAddressRIBSB;
