...
var _CoinsForwardingSuccessDataItem = _interopRequireDefault(require("./CoinsForwardingSuccessDataItem"));
...
var CoinsForwardingSuccessData = /*#__PURE__*/function () {
   ...
   */
  function CoinsForwardingSuccessData(product, event, item) {
    _classCallCheck(this, CoinsForwardingSuccessData);
   ...
   */
  _createClass(CoinsForwardingSuccessData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _CoinsForwardingSuccessDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CoinsForwardingSuccessData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CoinsForwardingSuccessData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CoinsForwardingSuccessData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _CoinsForwardingSuccessDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
CoinsForwardingSuccessData.RequiredProperties = ["product", "event", "item"];
...
var _default = CoinsForwardingSuccessData;
