...
var DecodeRawTransactionHexRISLVinInner = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISLVinInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRISLVinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _DecodeRawTransactionHexRISLVinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
      // ensure the json data is a string
