...
var ConfirmedTokensTransactionForCertainAmountOrHigherDataItem = /*#__PURE__*/function () {
  ...
  _createClass(ConfirmedTokensTransactionForCertainAmountOrHigherDataItem, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ConfirmedTokensTransactionForCertainAmountOrHigherDataItem.RequiredProperties),
        _step;
      try {
      ...
      if (data['token']) {
        // data not null
        _ConfirmedTokensTransactionForCertainAmountOrHigherToken["default"].validateJSON(data['token']);
      }
      return true;
    }
  }]);
