...
var ListSupportedTokensE400 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize ListSupportedTokensE400.
   */
  function ListSupportedTokensE400() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListSupportedTokensE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListSupportedTokensE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(ListSupportedTokensE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListSupportedTokensE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListSupportedTokensE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListSupportedTokensE400, "fromJSON", function (json_string) {
  return ListSupportedTokensE400.constructFromObject(JSON.parse(json_string));
});
 ...
 */
ListSupportedTokensE400.prototype['details'] = undefined;
ListSupportedTokensE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
