...
var _NewConfirmedInternalTransactionsForSpecificAmountRI = _interopRequireDefault(require("./NewConfirmedInternalTransactionsForSpecificAmountRI"));
...
var NewConfirmedInternalTransactionsForSpecificAmountRData = /*#__PURE__*/function () {
   ...
   */
  function NewConfirmedInternalTransactionsForSpecificAmountRData(item) {
    _classCallCheck(this, NewConfirmedInternalTransactionsForSpecificAmountRData);
   ...
   */
  _createClass(NewConfirmedInternalTransactionsForSpecificAmountRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _NewConfirmedInternalTransactionsForSpecificAmountRI["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>NewConfirmedInternalTransactionsForSpecificAmountRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewConfirmedInternalTransactionsForSpecificAmountRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewConfirmedInternalTransactionsForSpecificAmountRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _NewConfirmedInternalTransactionsForSpecificAmountRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
NewConfirmedInternalTransactionsForSpecificAmountRData.RequiredProperties = ["item"];
