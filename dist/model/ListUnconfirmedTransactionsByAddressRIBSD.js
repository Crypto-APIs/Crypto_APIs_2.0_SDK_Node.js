...
var _ListUnconfirmedTransactionsByAddressRIBSDVin = _interopRequireDefault(require("./ListUnconfirmedTransactionsByAddressRIBSDVin"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('vin')) {
          obj['vin'] = _ApiClient["default"].convertToType(data['vin'], [_ListUnconfirmedTransactionsByAddressRIBSDVin["default"]]);
        }
