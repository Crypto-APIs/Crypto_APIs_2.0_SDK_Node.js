...
var _PrepareANonFungibleTokenTransferFromAddressRBData = _interopRequireDefault(require("./PrepareANonFungibleTokenTransferFromAddressRBData"));
 ...
 * @version 1.13.0
 */
var PrepareANonFungibleTokenTransferFromAddressRB = /*#__PURE__*/function () {
  /**
   ...
   */
  function PrepareANonFungibleTokenTransferFromAddressRB(data) {
    _classCallCheck(this, PrepareANonFungibleTokenTransferFromAddressRB);
   ...
   */
  _createClass(PrepareANonFungibleTokenTransferFromAddressRB, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _PrepareANonFungibleTokenTransferFromAddressRBData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
...
var _default = PrepareANonFungibleTokenTransferFromAddressRB;
