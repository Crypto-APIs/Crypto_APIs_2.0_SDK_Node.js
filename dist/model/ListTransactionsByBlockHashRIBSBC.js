...
var ListTransactionsByBlockHashRIBSBC = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHashRIBSBC, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHashRIBSBC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHashRIBSBC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIBSBC.RequiredProperties),
        _step;
      try {
...
ListTransactionsByBlockHashRIBSBC.RequiredProperties = ["locktime", "size", "version", "vin", "vout"];
