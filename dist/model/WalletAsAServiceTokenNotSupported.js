...
var _WalletAsAServiceTokenNotSupportedError = _interopRequireDefault(require("./WalletAsAServiceTokenNotSupportedError"));
...
var WalletAsAServiceTokenNotSupported = /*#__PURE__*/function () {
   ...
   */
  function WalletAsAServiceTokenNotSupported(apiVersion, requestId, error) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _WalletAsAServiceTokenNotSupportedError["default"].constructFromObject(data['error']);
        }
      }
