...
var WalletAsAServiceTokenNotSupported = /*#__PURE__*/function () {
  ...
  _createClass(WalletAsAServiceTokenNotSupported, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>WalletAsAServiceTokenNotSupported</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>WalletAsAServiceTokenNotSupported</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(WalletAsAServiceTokenNotSupported.RequiredProperties),
        _step;
      try {
...
WalletAsAServiceTokenNotSupported.RequiredProperties = ["code", "message"];
