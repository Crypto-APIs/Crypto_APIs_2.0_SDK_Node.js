...
var NewConfirmedCoinsTransactionsRBData = /*#__PURE__*/function () {
  ...
  _createClass(NewConfirmedCoinsTransactionsRBData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(NewConfirmedCoinsTransactionsRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _NewConfirmedCoinsTransactionsRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
