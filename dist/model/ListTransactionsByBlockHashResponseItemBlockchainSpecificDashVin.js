...
var _ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptSig = _interopRequireDefault(require("./ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptSig"));
 ...
 * @version 2.0.0
 */
var ListTransactionsByBlockHashResponseItemBlockchainSpecificDashVin = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListTransactionsByBlockHashResponseItemBlockchainSpecificDashVin(addresses, scriptSig, sequence, txinwitness, vout) {
    _classCallCheck(this, ListTransactionsByBlockHashResponseItemBlockchainSpecificDashVin);
  ...
  _createClass(ListTransactionsByBlockHashResponseItemBlockchainSpecificDashVin, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('scriptSig')) {
          obj['scriptSig'] = _ListTransactionsByBlockHashResponseItemBlockchainSpecificDashScriptSig["default"].constructFromObject(data['scriptSig']);
        }
  ...
  return ListTransactionsByBlockHashResponseItemBlockchainSpecificDashVin;
}();
/**
...
var _default = ListTransactionsByBlockHashResponseItemBlockchainSpecificDashVin;
