 ...
 * @version 1.7.0
 */
var SyncNewXPubE401 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SyncNewXPubE401</code>.
   * @alias module:model/SyncNewXPubE401
   * @implements module:model/MissingApiKey
   * @implements module:model/InvalidApiKey
   * @param code {String} Specifies an error code, e.g. error 404.
   * @param message {String} Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
   */
  function SyncNewXPubE401(code, message) {
    _classCallCheck(this, SyncNewXPubE401);

    _MissingApiKey["default"].initialize(this, code, message);

    _InvalidApiKey["default"].initialize(this, code, message);

    SyncNewXPubE401.initialize(this, code, message);
  }
  /**
  ...
  _createClass(SyncNewXPubE401, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>SyncNewXPubE401</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SyncNewXPubE401} obj Optional instance to populate.
     * @return {module:model/SyncNewXPubE401} The populated <code>SyncNewXPubE401</code> instance.
     */
...
SyncNewXPubE401.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

SyncNewXPubE401.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

SyncNewXPubE401.prototype['details'] = undefined; // Implement MissingApiKey interface:
