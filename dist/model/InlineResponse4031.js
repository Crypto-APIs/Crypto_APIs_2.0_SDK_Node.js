...
var InlineResponse4031 = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse4031(apiVersion, requestId, error) {
    _classCallCheck(this, InlineResponse4031);

    InlineResponse4031.initialize(this, apiVersion, requestId, error);
  }
  /**
  ...
  _createClass(InlineResponse4031, null, [{
    key: "initialize",
...
InlineResponse4031.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

InlineResponse4031.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

InlineResponse4031.prototype['context'] = undefined;
/**
