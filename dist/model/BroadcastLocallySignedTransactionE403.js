...
var BroadcastLocallySignedTransactionE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize BroadcastLocallySignedTransactionE403.
   */
  function BroadcastLocallySignedTransactionE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, BroadcastLocallySignedTransactionE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `BroadcastLocallySignedTransactionE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `BroadcastLocallySignedTransactionE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>BroadcastLocallySignedTransactionE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BroadcastLocallySignedTransactionE403} obj Optional instance to populate.
   * @return {module:model/BroadcastLocallySignedTransactionE403} The populated <code>BroadcastLocallySignedTransactionE403</code> instance.
   */
  _createClass(BroadcastLocallySignedTransactionE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = BroadcastLocallySignedTransactionE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new BroadcastLocallySignedTransactionE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(BroadcastLocallySignedTransactionE403, "fromJSON", function (json_string) {
  return BroadcastLocallySignedTransactionE403.constructFromObject(JSON.parse(json_string));
});
 ...
 */
BroadcastLocallySignedTransactionE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
BroadcastLocallySignedTransactionE403.prototype['details'] = undefined;
BroadcastLocallySignedTransactionE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = BroadcastLocallySignedTransactionE403;
