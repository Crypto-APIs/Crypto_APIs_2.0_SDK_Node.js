...
var _ListOmniTransactionsByBlockHashResponseItemFee = _interopRequireDefault(require("./ListOmniTransactionsByBlockHashResponseItemFee"));
 ...
 * @version 2.0.0
 */
var ListOmniTransactionsByBlockHashResponseItem = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListOmniTransactionsByBlockHashResponseItem(amount, divisible, minedInBlockHash, minedInBlockHeight, positionInBlock, propertyId, recipients, senders, timestamp, transactionId, type, typeInt, valid, version, fee) {
    _classCallCheck(this, ListOmniTransactionsByBlockHashResponseItem);
  ...
  _createClass(ListOmniTransactionsByBlockHashResponseItem, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('fee')) {
          obj['fee'] = _ListOmniTransactionsByBlockHashResponseItemFee["default"].constructFromObject(data['fee']);
        }
      }
  ...
  return ListOmniTransactionsByBlockHashResponseItem;
}();
/**
...
var _default = ListOmniTransactionsByBlockHashResponseItem;
