...
var DecodeRawTransactionHexRISDVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISDVoutInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRISDVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _DecodeRawTransactionHexRISDVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
