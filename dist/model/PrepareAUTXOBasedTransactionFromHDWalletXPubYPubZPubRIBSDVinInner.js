...
var PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSDVinInner = /*#__PURE__*/function () {
  ...
  _createClass(PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSDVinInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSDVinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSDVinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSDVinInner.RequiredProperties),
        _step;
      try {
...
PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRIBSDVinInner.RequiredProperties = ["address", "change", "derivationIndex", "outputIndex", "satoshis", "script", "sighash", "transactionId"];
