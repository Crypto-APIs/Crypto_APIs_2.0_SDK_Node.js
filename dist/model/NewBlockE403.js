...
var NewBlockE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>NewBlockE403</code>.
   * @alias module:model/NewBlockE403
   * @param {(module:model/BannedIpAddress|module:model/BlockchainEventsCallbacksLimitReached|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize NewBlockE403.
   */
  function NewBlockE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, NewBlockE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewBlockE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewBlockE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>NewBlockE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NewBlockE403} obj Optional instance to populate.
   * @return {module:model/NewBlockE403} The populated <code>NewBlockE403</code> instance.
   */
  _createClass(NewBlockE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewBlockE403.constructFromObject(obj).getActualInstance();
    }
 ...
 * @member {String} code
 */
_defineProperty(NewBlockE403, "fromJSON", function (json_string) {
  return NewBlockE403.constructFromObject(JSON.parse(json_string));
});
NewBlockE403.prototype['code'] = undefined;
...
NewBlockE403.OneOf = ["BannedIpAddress", "BlockchainEventsCallbacksLimitReached", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = NewBlockE403;
