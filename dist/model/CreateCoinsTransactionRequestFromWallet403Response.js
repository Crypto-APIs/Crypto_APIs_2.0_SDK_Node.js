...
var CreateCoinsTransactionRequestFromWallet403Response = /*#__PURE__*/function () {
   ...
   */
  function CreateCoinsTransactionRequestFromWallet403Response(apiVersion, requestId, error) {
    _classCallCheck(this, CreateCoinsTransactionRequestFromWallet403Response);
   ...
   */
  _createClass(CreateCoinsTransactionRequestFromWallet403Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCoinsTransactionRequestFromWallet403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCoinsTransactionRequestFromWallet403Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateCoinsTransactionRequestFromWallet403Response.RequiredProperties),
        _step;
      try {
  ...
  return CreateCoinsTransactionRequestFromWallet403Response;
}();
CreateCoinsTransactionRequestFromWallet403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = CreateCoinsTransactionRequestFromWallet403Response;
