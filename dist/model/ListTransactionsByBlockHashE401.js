...
var ListTransactionsByBlockHashE401 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidApiKey|module:model/MissingApiKey)} instance The actual instance to initialize ListTransactionsByBlockHashE401.
   */
  function ListTransactionsByBlockHashE401() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, ListTransactionsByBlockHashE401);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListTransactionsByBlockHashE401` with oneOf schemas InvalidApiKey, MissingApiKey. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListTransactionsByBlockHashE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>ListTransactionsByBlockHashE401</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListTransactionsByBlockHashE401} obj Optional instance to populate.
   * @return {module:model/ListTransactionsByBlockHashE401} The populated <code>ListTransactionsByBlockHashE401</code> instance.
   */
  _createClass(ListTransactionsByBlockHashE401, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListTransactionsByBlockHashE401.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListTransactionsByBlockHashE401(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListTransactionsByBlockHashE401, "fromJSON", function (json_string) {
  return ListTransactionsByBlockHashE401.constructFromObject(JSON.parse(json_string));
});
 ...
 */
ListTransactionsByBlockHashE401.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
ListTransactionsByBlockHashE401.prototype['details'] = undefined;
ListTransactionsByBlockHashE401.OneOf = ["InvalidApiKey", "MissingApiKey"];
var _default = ListTransactionsByBlockHashE401;
