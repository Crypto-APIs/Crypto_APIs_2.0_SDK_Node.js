...
/**
 * The GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin model module.
 * @module model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin
 * @version 2.0.0
 */
var GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin</code>.
   * Bitcoin
   * @alias module:model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin
   ...
   */
  function GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin);

    GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight);
  }
  /**
  ...
  _createClass(GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin} The populated <code>GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin();
  ...
  return GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin;
}();
/**
...
var _default = GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoin;
