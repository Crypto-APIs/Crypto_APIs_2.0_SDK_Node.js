...
var EstimateTokenGasLimit403Response = /*#__PURE__*/function () {
   ...
   */
  function EstimateTokenGasLimit403Response(apiVersion, requestId, error) {
    _classCallCheck(this, EstimateTokenGasLimit403Response);
   ...
   */
  _createClass(EstimateTokenGasLimit403Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>EstimateTokenGasLimit403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EstimateTokenGasLimit403Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(EstimateTokenGasLimit403Response.RequiredProperties),
        _step;
      try {
...
EstimateTokenGasLimit403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = EstimateTokenGasLimit403Response;
