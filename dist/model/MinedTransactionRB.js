...
var _MinedTransactionRBData = _interopRequireDefault(require("./MinedTransactionRBData"));
 ...
 * @version 1.11.0
 */
var MinedTransactionRB = /*#__PURE__*/function () {
  /**
   ...
   */
  function MinedTransactionRB(data) {
    _classCallCheck(this, MinedTransactionRB);
   ...
   */
  _createClass(MinedTransactionRB, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _MinedTransactionRBData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>MinedTransactionRB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>MinedTransactionRB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(MinedTransactionRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _MinedTransactionRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
MinedTransactionRB.RequiredProperties = ["data"];
...
var _default = MinedTransactionRB;
