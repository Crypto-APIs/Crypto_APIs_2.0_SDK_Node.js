...
var ListConfirmedTransactionsByAddressRIFee = /*#__PURE__*/function () {
  ...
  _createClass(ListConfirmedTransactionsByAddressRIFee, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListConfirmedTransactionsByAddressRIFee</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListConfirmedTransactionsByAddressRIFee</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListConfirmedTransactionsByAddressRIFee.RequiredProperties),
        _step;
      try {
...
ListConfirmedTransactionsByAddressRIFee.RequiredProperties = ["amount", "unit"];
