...
var _AddTokensToExistingFromAddressRequestBodyTokenData = _interopRequireDefault(require("./AddTokensToExistingFromAddressRequestBodyTokenData"));
 ...
 * @version 2.0.0
 */
var AddTokensToExistingFromAddressRequestBodyDataItem = /*#__PURE__*/function () {
  /**
   ...
   */
  function AddTokensToExistingFromAddressRequestBodyDataItem(callbackUrl, confirmationsCount, feePriority, fromAddress, minimumTransferAmount, toAddress, tokenData) {
    _classCallCheck(this, AddTokensToExistingFromAddressRequestBodyDataItem);
  ...
  _createClass(AddTokensToExistingFromAddressRequestBodyDataItem, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('tokenData')) {
          obj['tokenData'] = _AddTokensToExistingFromAddressRequestBodyTokenData["default"].constructFromObject(data['tokenData']);
        }
      }
  ...
  return AddTokensToExistingFromAddressRequestBodyDataItem;
}();
/**
...
var _default = AddTokensToExistingFromAddressRequestBodyDataItem;
