...
var EstimateGasLimitRData = /*#__PURE__*/function () {
  ...
  _createClass(EstimateGasLimitRData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>EstimateGasLimitRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EstimateGasLimitRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(EstimateGasLimitRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _EstimateGasLimitRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
EstimateGasLimitRData.RequiredProperties = ["item"];
