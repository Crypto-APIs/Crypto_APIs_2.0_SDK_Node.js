...
var AddressTokensTransactionConfirmedEachConfirmationDataItem = /*#__PURE__*/function () {
  ...
  _createClass(AddressTokensTransactionConfirmedEachConfirmationDataItem, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddressTokensTransactionConfirmedEachConfirmationDataItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressTokensTransactionConfirmedEachConfirmationDataItem</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressTokensTransactionConfirmedEachConfirmationDataItem.RequiredProperties),
        _step;
      try {
      ...
      if (data['token']) {
        // data not null
        _AddressTokensTransactionConfirmedEachConfirmationToken["default"].validateJSON(data['token']);
      }
      // ensure the json data is a string
...
AddressTokensTransactionConfirmedEachConfirmationDataItem.RequiredProperties = ["blockchain", "network", "address", "minedInBlock", "transactionId", "currentConfirmations", "targetConfirmations", "tokenType", "token", "direction"];
