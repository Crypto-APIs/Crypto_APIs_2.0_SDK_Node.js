...
var InlineResponse4003 = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse4003(apiVersion, requestId, error) {
    _classCallCheck(this, InlineResponse4003);

    InlineResponse4003.initialize(this, apiVersion, requestId, error);
  }
  /**
...
InlineResponse4003.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

InlineResponse4003.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

InlineResponse4003.prototype['context'] = undefined;
/**
 * @member {module:model/GetZilliqaAddressDetailsE400} error
 */

InlineResponse4003.prototype['error'] = undefined;
