...
var _UnexpectedServerErrorError = _interopRequireDefault(require("./UnexpectedServerErrorError"));
...
var UnexpectedServerError = /*#__PURE__*/function () {
   ...
   * @param error {module:model/UnexpectedServerErrorError} 
   */
  function UnexpectedServerError(apiVersion, requestId, error) {
    _classCallCheck(this, UnexpectedServerError);

    UnexpectedServerError.initialize(this, apiVersion, requestId, error);
  }
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _UnexpectedServerErrorError["default"].constructFromObject(data['error']);
        }
      }
...
UnexpectedServerError.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

UnexpectedServerError.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

UnexpectedServerError.prototype['context'] = undefined;
/**
 * @member {module:model/UnexpectedServerErrorError} error
 */

UnexpectedServerError.prototype['error'] = undefined;
