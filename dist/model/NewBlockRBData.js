...
var _NewBlockRBDataItem = _interopRequireDefault(require("./NewBlockRBDataItem"));
...
var NewBlockRBData = /*#__PURE__*/function () {
   ...
   */
  function NewBlockRBData(item) {
    _classCallCheck(this, NewBlockRBData);
   ...
   */
  _createClass(NewBlockRBData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _NewBlockRBDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(NewBlockRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _NewBlockRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
