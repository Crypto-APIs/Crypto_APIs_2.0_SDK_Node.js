...
/**
 * The GetLatestMinedBlockResponseItemBlockchainSpecificDash model module.
 * @module model/GetLatestMinedBlockResponseItemBlockchainSpecificDash
 * @version 2.0.0
 */
var GetLatestMinedBlockResponseItemBlockchainSpecificDash = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetLatestMinedBlockResponseItemBlockchainSpecificDash</code>.
   * Dash
   * @alias module:model/GetLatestMinedBlockResponseItemBlockchainSpecificDash
   ...
   */
  function GetLatestMinedBlockResponseItemBlockchainSpecificDash(difficulty, nonce, size, bits, chainwork, merkleRoot, version, versionHex) {
    _classCallCheck(this, GetLatestMinedBlockResponseItemBlockchainSpecificDash);

    GetLatestMinedBlockResponseItemBlockchainSpecificDash.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, version, versionHex);
  }
  /**
  ...
  _createClass(GetLatestMinedBlockResponseItemBlockchainSpecificDash, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetLatestMinedBlockResponseItemBlockchainSpecificDash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLatestMinedBlockResponseItemBlockchainSpecificDash} obj Optional instance to populate.
     * @return {module:model/GetLatestMinedBlockResponseItemBlockchainSpecificDash} The populated <code>GetLatestMinedBlockResponseItemBlockchainSpecificDash</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLatestMinedBlockResponseItemBlockchainSpecificDash();
  ...
  return GetLatestMinedBlockResponseItemBlockchainSpecificDash;
}();
/**
...
var _default = GetLatestMinedBlockResponseItemBlockchainSpecificDash;
