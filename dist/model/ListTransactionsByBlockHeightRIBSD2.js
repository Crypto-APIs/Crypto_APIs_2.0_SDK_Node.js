...
var _ListTransactionsByBlockHeightRIBSD2Vin = _interopRequireDefault(require("./ListTransactionsByBlockHeightRIBSD2Vin"));
...
var ListTransactionsByBlockHeightRIBSD2 = /*#__PURE__*/function () {
   ...
   * @param vin {Array.<module:model/ListTransactionsByBlockHeightRIBSD2Vin>} Represents the transaction inputs.
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('vin')) {
          obj['vin'] = _ApiClient["default"].convertToType(data['vin'], [_ListTransactionsByBlockHeightRIBSD2Vin["default"]]);
        }
