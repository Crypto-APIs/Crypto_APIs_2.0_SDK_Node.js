...
var GetBlockDetailsByBlockHashFromCallbackRIBSZ = /*#__PURE__*/function () {
  ...
  _createClass(GetBlockDetailsByBlockHashFromCallbackRIBSZ, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHashFromCallbackRIBSZ</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHashFromCallbackRIBSZ</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashFromCallbackRIBSZ.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHashFromCallbackRIBSZ.RequiredProperties = ["difficulty", "dsBlock", "dsDifficulty", "dsLeader", "gasLimit", "gasUsed", "microBlocks"];
