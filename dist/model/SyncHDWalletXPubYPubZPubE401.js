...
var SyncHDWalletXPubYPubZPubE401 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidApiKey|module:model/MissingApiKey)} instance The actual instance to initialize SyncHDWalletXPubYPubZPubE401.
   */
  function SyncHDWalletXPubYPubZPubE401() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `SyncHDWalletXPubYPubZPubE401` with oneOf schemas InvalidApiKey, MissingApiKey. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `SyncHDWalletXPubYPubZPubE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(SyncHDWalletXPubYPubZPubE401, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = SyncHDWalletXPubYPubZPubE401.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new SyncHDWalletXPubYPubZPubE401(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(SyncHDWalletXPubYPubZPubE401, "fromJSON", function (json_string) {
  return SyncHDWalletXPubYPubZPubE401.constructFromObject(JSON.parse(json_string));
});
 ...
 */
SyncHDWalletXPubYPubZPubE401.prototype['details'] = undefined;
SyncHDWalletXPubYPubZPubE401.OneOf = ["InvalidApiKey", "MissingApiKey"];
