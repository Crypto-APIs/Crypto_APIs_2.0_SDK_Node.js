...
var _GetWalletTransactionDetailsByTransactionIDRIRecipients = _interopRequireDefault(require("./GetWalletTransactionDetailsByTransactionIDRIRecipients"));

var _GetWalletTransactionDetailsByTransactionIDRISenders = _interopRequireDefault(require("./GetWalletTransactionDetailsByTransactionIDRISenders"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('recipients')) {
          obj['recipients'] = _ApiClient["default"].convertToType(data['recipients'], [_GetWalletTransactionDetailsByTransactionIDRIRecipients["default"]]);
        }

        if (data.hasOwnProperty('senders')) {
          obj['senders'] = _ApiClient["default"].convertToType(data['senders'], [_GetWalletTransactionDetailsByTransactionIDRISenders["default"]]);
        }
