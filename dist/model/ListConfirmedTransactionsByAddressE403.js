...
var ListConfirmedTransactionsByAddressE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListConfirmedTransactionsByAddressE403</code>.
   * @alias module:model/ListConfirmedTransactionsByAddressE403
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize ListConfirmedTransactionsByAddressE403.
   */
  function ListConfirmedTransactionsByAddressE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, ListConfirmedTransactionsByAddressE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListConfirmedTransactionsByAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListConfirmedTransactionsByAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>ListConfirmedTransactionsByAddressE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListConfirmedTransactionsByAddressE403} obj Optional instance to populate.
   * @return {module:model/ListConfirmedTransactionsByAddressE403} The populated <code>ListConfirmedTransactionsByAddressE403</code> instance.
   */
  _createClass(ListConfirmedTransactionsByAddressE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListConfirmedTransactionsByAddressE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListConfirmedTransactionsByAddressE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListConfirmedTransactionsByAddressE403, "fromJSON", function (json_string) {
  return ListConfirmedTransactionsByAddressE403.constructFromObject(JSON.parse(json_string));
});
ListConfirmedTransactionsByAddressE403.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
ListConfirmedTransactionsByAddressE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
ListConfirmedTransactionsByAddressE403.prototype['details'] = undefined;
ListConfirmedTransactionsByAddressE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = ListConfirmedTransactionsByAddressE403;
