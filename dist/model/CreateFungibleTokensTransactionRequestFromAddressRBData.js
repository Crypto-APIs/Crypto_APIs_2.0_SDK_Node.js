...
var CreateFungibleTokensTransactionRequestFromAddressRBData = /*#__PURE__*/function () {
  ...
  _createClass(CreateFungibleTokensTransactionRequestFromAddressRBData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateFungibleTokensTransactionRequestFromAddressRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _CreateFungibleTokensTransactionRequestFromAddressRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
