...
var ListConfirmedTransactionsByAddressRIBSE = /*#__PURE__*/function () {
   ...
   */
  function ListConfirmedTransactionsByAddressRIBSE(contract, gasLimit, gasPrice, gasUsed, inputData, internalTransactionsCount, nonce, tokenTransfersCount, transactionStatus) {
  ...
  _createClass(ListConfirmedTransactionsByAddressRIBSE, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListConfirmedTransactionsByAddressRIBSE.RequiredProperties),
        _step;
      try {
