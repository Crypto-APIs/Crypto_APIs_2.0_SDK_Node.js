...
var _ValidateAddressRI = _interopRequireDefault(require("./ValidateAddressRI"));
...
var ValidateAddressRData = /*#__PURE__*/function () {
   ...
   */
  function ValidateAddressRData(item) {
    _classCallCheck(this, ValidateAddressRData);
   ...
   */
  _createClass(ValidateAddressRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _ValidateAddressRI["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ValidateAddressRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidateAddressRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ValidateAddressRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _ValidateAddressRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
ValidateAddressRData.RequiredProperties = ["item"];
