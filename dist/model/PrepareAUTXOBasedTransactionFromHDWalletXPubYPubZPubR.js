...
var PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR = /*#__PURE__*/function () {
  ...
  _createClass(PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubRData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
PrepareAUTXOBasedTransactionFromHDWalletXPubYPubZPubR.RequiredProperties = ["apiVersion", "requestId", "data"];
