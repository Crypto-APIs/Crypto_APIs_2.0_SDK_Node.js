...
var NewConfirmedTokensTransactionsRB = /*#__PURE__*/function () {
  ...
  _createClass(NewConfirmedTokensTransactionsRB, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>NewConfirmedTokensTransactionsRB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewConfirmedTokensTransactionsRB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewConfirmedTokensTransactionsRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _NewConfirmedTokensTransactionsRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
NewConfirmedTokensTransactionsRB.RequiredProperties = ["data"];
