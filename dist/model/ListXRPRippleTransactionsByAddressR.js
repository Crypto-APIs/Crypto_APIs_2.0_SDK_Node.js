...
var _ListXRPRippleTransactionsByAddressRData = _interopRequireDefault(require("./ListXRPRippleTransactionsByAddressRData"));
 ...
 * @version 1.11.0
 */
var ListXRPRippleTransactionsByAddressR = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListXRPRippleTransactionsByAddressR(apiVersion, requestId, data) {
    _classCallCheck(this, ListXRPRippleTransactionsByAddressR);
   ...
   */
  _createClass(ListXRPRippleTransactionsByAddressR, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ListXRPRippleTransactionsByAddressRData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListXRPRippleTransactionsByAddressR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListXRPRippleTransactionsByAddressR</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListXRPRippleTransactionsByAddressR.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _ListXRPRippleTransactionsByAddressRData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
ListXRPRippleTransactionsByAddressR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
var _default = ListXRPRippleTransactionsByAddressR;
