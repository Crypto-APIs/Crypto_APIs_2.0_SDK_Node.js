...
var ListHDWalletXPubYPubZPubTransactionsRI = /*#__PURE__*/function () {
  ...
  _createClass(ListHDWalletXPubYPubZPubTransactionsRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListHDWalletXPubYPubZPubTransactionsRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['recipients']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListHDWalletXPubYPubZPubTransactionsRIRecipientsInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['senders']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _ListHDWalletXPubYPubZPubTransactionsRISendersInner["default"].validateJsonObject(_item);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (data['fee']) {
        // data not null
        _ListHDWalletXPubYPubZPubTransactionsRIFee["default"].validateJSON(data['fee']);
      }
      return true;
    }
  }]);
