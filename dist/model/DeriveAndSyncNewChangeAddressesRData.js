...
var DeriveAndSyncNewChangeAddressesRData = /*#__PURE__*/function () {
  ...
  _createClass(DeriveAndSyncNewChangeAddressesRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DeriveAndSyncNewChangeAddressesRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _DeriveAndSyncNewChangeAddressesRI["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
