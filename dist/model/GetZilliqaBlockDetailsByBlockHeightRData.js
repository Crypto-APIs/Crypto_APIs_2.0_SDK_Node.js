...
var GetZilliqaBlockDetailsByBlockHeightRData = /*#__PURE__*/function () {
  ...
  _createClass(GetZilliqaBlockDetailsByBlockHeightRData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetZilliqaBlockDetailsByBlockHeightRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetZilliqaBlockDetailsByBlockHeightRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetZilliqaBlockDetailsByBlockHeightRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _GetZilliqaBlockDetailsByBlockHeightRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
GetZilliqaBlockDetailsByBlockHeightRData.RequiredProperties = ["item"];
