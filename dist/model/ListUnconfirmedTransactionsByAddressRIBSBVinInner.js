...
var ListUnconfirmedTransactionsByAddressRIBSBVinInner = /*#__PURE__*/function () {
  ...
  _createClass(ListUnconfirmedTransactionsByAddressRIBSBVinInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListUnconfirmedTransactionsByAddressRIBSBVinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUnconfirmedTransactionsByAddressRIBSBVinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListUnconfirmedTransactionsByAddressRIBSBVinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _ListUnconfirmedTransactionsByAddressRIBSBVinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
...
ListUnconfirmedTransactionsByAddressRIBSBVinInner.RequiredProperties = ["addresses", "scriptSig", "sequence"];
