...
var EstimateTokenGasLimitRData = /*#__PURE__*/function () {
  ...
  _createClass(EstimateTokenGasLimitRData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>EstimateTokenGasLimitRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EstimateTokenGasLimitRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(EstimateTokenGasLimitRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _EstimateTokenGasLimitRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
EstimateTokenGasLimitRData.RequiredProperties = ["item"];
