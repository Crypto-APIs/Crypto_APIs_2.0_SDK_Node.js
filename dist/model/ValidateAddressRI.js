...
var ValidateAddressRI = /*#__PURE__*/function () {
  ...
  _createClass(ValidateAddressRI, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ValidateAddressRI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidateAddressRI</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ValidateAddressRI.RequiredProperties),
        _step;
      try {
...
ValidateAddressRI.RequiredProperties = ["address", "isValid"];
