...
/**
 * The GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin model module.
 * @module model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin
 * @version 2.0.0
 */
var GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin</code>.
   * Dogecoin
   * @alias module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin
   ...
   */
  function GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, weight) {
    _classCallCheck(this, GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin);

    GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, weight);
  }
  /**
  ...
  _createClass(GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin} The populated <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin();
  ...
  return GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin;
}();
/**
...
var _default = GetBlockDetailsByBlockHashResponseItemBlockchainSpecificDogecoin;
