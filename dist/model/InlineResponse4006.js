...
var InlineResponse4006 = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse4006(apiVersion, requestId, error) {
    _classCallCheck(this, InlineResponse4006);

    InlineResponse4006.initialize(this, apiVersion, requestId, error);
  }
  /**
...
InlineResponse4006.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

InlineResponse4006.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

InlineResponse4006.prototype['context'] = undefined;
/**
 * @member {module:model/GetXRPRippleTransactionDetailsByTransactionIDE400} error
 */

InlineResponse4006.prototype['error'] = undefined;
