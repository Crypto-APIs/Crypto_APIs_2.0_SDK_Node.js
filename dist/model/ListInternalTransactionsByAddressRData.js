...
var ListInternalTransactionsByAddressRData = /*#__PURE__*/function () {
  ...
  _createClass(ListInternalTransactionsByAddressRData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListInternalTransactionsByAddressRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListInternalTransactionsByAddressRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListInternalTransactionsByAddressRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListInternalTransactionsByAddressRI["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
ListInternalTransactionsByAddressRData.RequiredProperties = ["limit", "offset", "total", "items"];
