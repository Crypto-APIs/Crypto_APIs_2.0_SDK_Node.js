...
var CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidData|module:model/WalletAsAServiceAddressBalanceNotEnough|module:model/WalletAsAServiceWalletBalanceNotEnough)} instance The actual instance to initialize CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409.
   */
  function CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceWalletBalanceNotEnough. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceWalletBalanceNotEnough. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409, "fromJSON", function (json_string) {
  return CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409.constructFromObject(JSON.parse(json_string));
});
 ...
 */
CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409.prototype['details'] = undefined;
CreateSingleTransactionRequestFromAddressWithoutFeePriorityE409.OneOf = ["InvalidData", "WalletAsAServiceAddressBalanceNotEnough", "WalletAsAServiceWalletBalanceNotEnough"];
