 ...
 * @version 1.7.1
 */
var PrepareAnAccountBasedTransactionFromXPubE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PrepareAnAccountBasedTransactionFromXPubE403</code>.
   * @alias module:model/PrepareAnAccountBasedTransactionFromXPubE403
   ...
   */
  function PrepareAnAccountBasedTransactionFromXPubE403(code, message) {
    _classCallCheck(this, PrepareAnAccountBasedTransactionFromXPubE403);
    ...
    PrepareAnAccountBasedTransactionFromXPubE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(PrepareAnAccountBasedTransactionFromXPubE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>PrepareAnAccountBasedTransactionFromXPubE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrepareAnAccountBasedTransactionFromXPubE403} obj Optional instance to populate.
     * @return {module:model/PrepareAnAccountBasedTransactionFromXPubE403} The populated <code>PrepareAnAccountBasedTransactionFromXPubE403</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new PrepareAnAccountBasedTransactionFromXPubE403();
  ...
  return PrepareAnAccountBasedTransactionFromXPubE403;
}();
/**
...
PrepareAnAccountBasedTransactionFromXPubE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

PrepareAnAccountBasedTransactionFromXPubE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

PrepareAnAccountBasedTransactionFromXPubE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
...
var _default = PrepareAnAccountBasedTransactionFromXPubE403;
