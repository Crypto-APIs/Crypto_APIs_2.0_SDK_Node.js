 ...
 * @version 1.4.0
 */
var CreateFungibleTokensTransactionRequestFromAddressE401 = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateFungibleTokensTransactionRequestFromAddressE401(code, message) {
    _classCallCheck(this, CreateFungibleTokensTransactionRequestFromAddressE401);

    _MissingApiKey["default"].initialize(this, code, message);

    _InvalidApiKey["default"].initialize(this, code, message);

    CreateFungibleTokensTransactionRequestFromAddressE401.initialize(this, code, message);
  }
  /**
  ...
  _createClass(CreateFungibleTokensTransactionRequestFromAddressE401, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CreateFungibleTokensTransactionRequestFromAddressE401();
...
CreateFungibleTokensTransactionRequestFromAddressE401.prototype['details'] = undefined; // Implement MissingApiKey interface:
...
var _default = CreateFungibleTokensTransactionRequestFromAddressE401;
