...
var CreateFungibleTokensTransactionRequestFromAddressE401 = /*#__PURE__*/function () {
   ...
   */
  function CreateFungibleTokensTransactionRequestFromAddressE401() {
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `CreateFungibleTokensTransactionRequestFromAddressE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(CreateFungibleTokensTransactionRequestFromAddressE401, [{
 ...
 * @member {String} code
 */
_defineProperty(CreateFungibleTokensTransactionRequestFromAddressE401, "fromJSON", function (json_string) {
