...
var _BroadcastLocallySignedTransactionRBDataItem = _interopRequireDefault(require("./BroadcastLocallySignedTransactionRBDataItem"));
...
var BroadcastLocallySignedTransactionRBData = /*#__PURE__*/function () {
   ...
   */
  function BroadcastLocallySignedTransactionRBData(item) {
    _classCallCheck(this, BroadcastLocallySignedTransactionRBData);
   ...
   */
  _createClass(BroadcastLocallySignedTransactionRBData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _BroadcastLocallySignedTransactionRBDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BroadcastLocallySignedTransactionRBData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BroadcastLocallySignedTransactionRBData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(BroadcastLocallySignedTransactionRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _BroadcastLocallySignedTransactionRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
BroadcastLocallySignedTransactionRBData.RequiredProperties = ["item"];
