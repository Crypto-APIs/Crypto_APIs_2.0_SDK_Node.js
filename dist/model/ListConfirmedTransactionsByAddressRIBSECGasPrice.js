...
var ListConfirmedTransactionsByAddressRIBSECGasPrice = /*#__PURE__*/function () {
  ...
  _createClass(ListConfirmedTransactionsByAddressRIBSECGasPrice, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListConfirmedTransactionsByAddressRIBSECGasPrice</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListConfirmedTransactionsByAddressRIBSECGasPrice</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListConfirmedTransactionsByAddressRIBSECGasPrice.RequiredProperties),
        _step;
      try {
...
ListConfirmedTransactionsByAddressRIBSECGasPrice.RequiredProperties = ["amount", "unit"];
