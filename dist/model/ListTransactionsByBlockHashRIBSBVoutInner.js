...
var ListTransactionsByBlockHashRIBSBVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHashRIBSBVoutInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHashRIBSBVoutInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHashRIBSBVoutInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIBSBVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _ListTransactionsByBlockHashRIBSBVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
...
ListTransactionsByBlockHashRIBSBVoutInner.RequiredProperties = ["isSpent", "scriptPubKey", "value"];
