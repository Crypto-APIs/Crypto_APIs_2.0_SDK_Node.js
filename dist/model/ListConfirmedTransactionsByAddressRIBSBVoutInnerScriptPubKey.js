...
var ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey = /*#__PURE__*/function () {
   ...
   */
  function ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey(addresses, asm, hex, reqSigs, type) {
    _classCallCheck(this, ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey);

    ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey.initialize(this, addresses, asm, hex, reqSigs, type);
  }
  /**
