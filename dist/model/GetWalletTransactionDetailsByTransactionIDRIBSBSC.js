...
var GetWalletTransactionDetailsByTransactionIDRIBSBSC = /*#__PURE__*/function () {
   ...
   */
  function GetWalletTransactionDetailsByTransactionIDRIBSBSC(contract, gasLimit, gasPrice, gasUsed, inputData, nonce) {
    _classCallCheck(this, GetWalletTransactionDetailsByTransactionIDRIBSBSC);
   ...
   */
  _createClass(GetWalletTransactionDetailsByTransactionIDRIBSBSC, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetWalletTransactionDetailsByTransactionIDRIBSBSC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetWalletTransactionDetailsByTransactionIDRIBSBSC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetWalletTransactionDetailsByTransactionIDRIBSBSC.RequiredProperties),
        _step;
      try {
      ...
      if (data['gasPrice']) {
        // data not null
        _GetTransactionDetailsByTransactionIDRIBSBSCGasPrice["default"].validateJSON(data['gasPrice']);
      }
      // ensure the json data is a string
...
GetWalletTransactionDetailsByTransactionIDRIBSBSC.RequiredProperties = ["contract", "gasLimit", "gasPrice", "gasUsed", "inputData", "nonce"];
...
var _default = GetWalletTransactionDetailsByTransactionIDRIBSBSC;
