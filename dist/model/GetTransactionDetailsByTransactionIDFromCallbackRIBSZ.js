...
var GetTransactionDetailsByTransactionIDFromCallbackRIBSZ = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDFromCallbackRIBSZ, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSZ</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSZ</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDFromCallbackRIBSZ.RequiredProperties),
        _step;
      try {
      ...
      if (data['vout']) {
        ...
        try {
          for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
            ...
            _GetTransactionDetailsByTransactionIDFromCallbackRIBSZVoutInner["default"].validateJsonObject(_item4);
          }
        } catch (err) {
          _iterator6.e(err);
        } finally {
...
GetTransactionDetailsByTransactionIDFromCallbackRIBSZ.RequiredProperties = ["bindingSig", "expiryHeight", "joinSplitPubKey", "joinSplitSig", "locktime", "overwintered", "size", "vJoinSplit", "vShieldedOutput", "vShieldedSpend", "valueBalance", "version", "versionGroupId", "vin", "vout"];
