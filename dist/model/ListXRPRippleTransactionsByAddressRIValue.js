...
var ListXRPRippleTransactionsByAddressRIValue = /*#__PURE__*/function () {
  ...
  _createClass(ListXRPRippleTransactionsByAddressRIValue, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListXRPRippleTransactionsByAddressRIValue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListXRPRippleTransactionsByAddressRIValue</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListXRPRippleTransactionsByAddressRIValue.RequiredProperties),
        _step;
      try {
...
ListXRPRippleTransactionsByAddressRIValue.RequiredProperties = ["amount", "unit"];
