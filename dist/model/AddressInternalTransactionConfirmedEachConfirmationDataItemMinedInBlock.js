...
var AddressInternalTransactionConfirmedEachConfirmationDataItemMinedInBlock = /*#__PURE__*/function () {
  ...
  _createClass(AddressInternalTransactionConfirmedEachConfirmationDataItemMinedInBlock, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddressInternalTransactionConfirmedEachConfirmationDataItemMinedInBlock</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressInternalTransactionConfirmedEachConfirmationDataItemMinedInBlock</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressInternalTransactionConfirmedEachConfirmationDataItemMinedInBlock.RequiredProperties),
        _step;
      try {
...
AddressInternalTransactionConfirmedEachConfirmationDataItemMinedInBlock.RequiredProperties = ["height", "hash", "timestamp"];
