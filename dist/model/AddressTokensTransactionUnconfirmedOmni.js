...
var AddressTokensTransactionUnconfirmedOmni = /*#__PURE__*/function () {
  ...
  _createClass(AddressTokensTransactionUnconfirmedOmni, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddressTokensTransactionUnconfirmedOmni</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressTokensTransactionUnconfirmedOmni</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressTokensTransactionUnconfirmedOmni.RequiredProperties),
        _step;
      try {
...
AddressTokensTransactionUnconfirmedOmni.RequiredProperties = ["name", "propertyId", "transactionType", "createdByTransactionId", "amount"];
