...
var _ResourceNotFoundError = _interopRequireDefault(require("./ResourceNotFoundError"));
...
var ResourceNotFound = /*#__PURE__*/function () {
   ...
   * @param error {module:model/ResourceNotFoundError} 
   */
  function ResourceNotFound(apiVersion, requestId, error) {
    _classCallCheck(this, ResourceNotFound);

    ResourceNotFound.initialize(this, apiVersion, requestId, error);
  }
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _ResourceNotFoundError["default"].constructFromObject(data['error']);
        }
      }
...
ResourceNotFound.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

ResourceNotFound.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

ResourceNotFound.prototype['context'] = undefined;
/**
 * @member {module:model/ResourceNotFoundError} error
 */

ResourceNotFound.prototype['error'] = undefined;
