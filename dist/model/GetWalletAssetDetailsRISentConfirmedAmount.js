...
var GetWalletAssetDetailsRISentConfirmedAmount = /*#__PURE__*/function () {
   ...
   */
  _createClass(GetWalletAssetDetailsRISentConfirmedAmount, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetWalletAssetDetailsRISentConfirmedAmount</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetWalletAssetDetailsRISentConfirmedAmount</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetWalletAssetDetailsRISentConfirmedAmount.RequiredProperties),
        _step;
      try {
...
GetWalletAssetDetailsRISentConfirmedAmount.RequiredProperties = ["amount", "unit"];
...
var _default = GetWalletAssetDetailsRISentConfirmedAmount;
