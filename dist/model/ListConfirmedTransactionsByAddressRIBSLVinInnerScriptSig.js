...
var ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig = /*#__PURE__*/function () {
  ...
  _createClass(ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig.RequiredProperties),
        _step;
      try {
...
ListConfirmedTransactionsByAddressRIBSLVinInnerScriptSig.RequiredProperties = ["asm", "hex", "type"];
