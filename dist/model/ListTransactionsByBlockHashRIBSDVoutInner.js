...
var ListTransactionsByBlockHashRIBSDVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHashRIBSDVoutInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHashRIBSDVoutInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHashRIBSDVoutInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIBSDVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _ListTransactionsByBlockHashRIBSDVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
...
ListTransactionsByBlockHashRIBSDVoutInner.RequiredProperties = ["isSpent", "scriptPubKey", "value"];
