...
var _GetLatestMinedBlockRI = _interopRequireDefault(require("./GetLatestMinedBlockRI"));
 ...
 * @version 1.2.1
 */
var GetLatestMinedBlockRData = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetLatestMinedBlockRData(item) {
    _classCallCheck(this, GetLatestMinedBlockRData);
  ...
  _createClass(GetLatestMinedBlockRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _GetLatestMinedBlockRI["default"].constructFromObject(data['item']);
        }
      }
  ...
  return GetLatestMinedBlockRData;
}();
/**
...
var _default = GetLatestMinedBlockRData;
