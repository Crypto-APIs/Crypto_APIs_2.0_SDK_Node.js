...
var ListWalletTransactionsE401 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidApiKey|module:model/MissingApiKey)} instance The actual instance to initialize ListWalletTransactionsE401.
   */
  function ListWalletTransactionsE401() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, ListWalletTransactionsE401);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListWalletTransactionsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListWalletTransactionsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>ListWalletTransactionsE401</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListWalletTransactionsE401} obj Optional instance to populate.
   * @return {module:model/ListWalletTransactionsE401} The populated <code>ListWalletTransactionsE401</code> instance.
   */
  _createClass(ListWalletTransactionsE401, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListWalletTransactionsE401.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListWalletTransactionsE401(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListWalletTransactionsE401, "fromJSON", function (json_string) {
  return ListWalletTransactionsE401.constructFromObject(JSON.parse(json_string));
});
 ...
 */
ListWalletTransactionsE401.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
ListWalletTransactionsE401.prototype['details'] = undefined;
ListWalletTransactionsE401.OneOf = ["InvalidApiKey", "MissingApiKey"];
var _default = ListWalletTransactionsE401;
