...
var _ListOmniTransactionsByBlockHeightRI = _interopRequireDefault(require("./ListOmniTransactionsByBlockHeightRI"));
 ...
 * @version 1.1.0
 */
var ListOmniTransactionsByBlockHeightRData = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListOmniTransactionsByBlockHeightRData(offset, limit, total, items) {
    _classCallCheck(this, ListOmniTransactionsByBlockHeightRData);

    ListOmniTransactionsByBlockHeightRData.initialize(this, offset, limit, total, items);
  }
  /**
  ...
  _createClass(ListOmniTransactionsByBlockHeightRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('items')) {
          obj['items'] = _ApiClient["default"].convertToType(data['items'], [_ListOmniTransactionsByBlockHeightRI["default"]]);
        }
      }
  ...
  return ListOmniTransactionsByBlockHeightRData;
}();
/**
...
var _default = ListOmniTransactionsByBlockHeightRData;
