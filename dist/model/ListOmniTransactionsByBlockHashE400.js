...
/**
 * The ListOmniTransactionsByBlockHashE400 model module.
 * @module model/ListOmniTransactionsByBlockHashE400
 * @version 1.6.0
 */
var ListOmniTransactionsByBlockHashE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListOmniTransactionsByBlockHashE400</code>.
   * @alias module:model/ListOmniTransactionsByBlockHashE400
   ...
   */
  function ListOmniTransactionsByBlockHashE400(code, message) {
    _classCallCheck(this, ListOmniTransactionsByBlockHashE400);
    ...
    ListOmniTransactionsByBlockHashE400.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListOmniTransactionsByBlockHashE400, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListOmniTransactionsByBlockHashE400</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListOmniTransactionsByBlockHashE400} obj Optional instance to populate.
     * @return {module:model/ListOmniTransactionsByBlockHashE400} The populated <code>ListOmniTransactionsByBlockHashE400</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListOmniTransactionsByBlockHashE400();
...
ListOmniTransactionsByBlockHashE400.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListOmniTransactionsByBlockHashE400.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

ListOmniTransactionsByBlockHashE400.prototype['details'] = undefined; // Implement UriNotFound interface:
...
var _default = ListOmniTransactionsByBlockHashE400;
