...
/**
 * The GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash model module.
 * @module model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash
 * @version 2.0.0
 */
var GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash</code>.
   * Bitcoin Cash
   * @alias module:model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash
   ...
   */
  function GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash(difficulty, nonce, size, bits, chainwork, merkleRoot, version, versionHex) {
    _classCallCheck(this, GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash);

    GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, version, versionHex);
  }
  /**
  ...
  _createClass(GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash} The populated <code>GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash();
  ...
  return GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash;
}();
/**
...
var _default = GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificBitcoinCash;
