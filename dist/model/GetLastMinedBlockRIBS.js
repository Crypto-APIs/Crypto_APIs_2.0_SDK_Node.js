...
var GetLastMinedBlockRIBS = /*#__PURE__*/function () {
   ...
   * @param merkleroot {String} Defines the single and final (root) node of a Merkle tree. It is the combined hash of all transactions' hashes that are part of a blockchain block.
   */
  function GetLastMinedBlockRIBS(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles, merkleroot) {
...
GetLastMinedBlockRIBS.prototype['merkleroot'] = undefined; // Implement GetLastMinedBlockRIBSB interface:
...
_GetLastMinedBlockRIBSB["default"].prototype['weight'] = undefined; // Implement GetLastMinedBlockRIBSE interface:
...
_GetLastMinedBlockRIBSE["default"].prototype['uncles'] = undefined; // Implement GetLastMinedBlockRIBSEC interface:
...
_GetLastMinedBlockRIBSEC["default"].prototype['uncles'] = undefined; // Implement GetLastMinedBlockRIBSBC interface:
...
_GetLastMinedBlockRIBSBC["default"].prototype['versionHex'] = undefined; // Implement GetLastMinedBlockRIBSL interface:
...
_GetLastMinedBlockRIBSL["default"].prototype['weight'] = undefined; // Implement GetLastMinedBlockRIBSD interface:
...
_GetLastMinedBlockRIBSD["default"].prototype['weight'] = undefined; // Implement GetLastMinedBlockRIBSD2 interface:
...
_GetLastMinedBlockRIBSD2["default"].prototype['versionHex'] = undefined; // Implement GetLastMinedBlockRIBSBSC interface:
...
_GetLastMinedBlockRIBSBSC["default"].prototype['uncles'] = undefined; // Implement GetLastMinedBlockRIBSZ interface:
