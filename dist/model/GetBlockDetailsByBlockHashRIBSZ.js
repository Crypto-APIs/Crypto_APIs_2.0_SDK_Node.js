...
var GetBlockDetailsByBlockHashRIBSZ = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHashRIBSZ</code>.
   * Zcash
   * @alias module:model/GetBlockDetailsByBlockHashRIBSZ
   ...
   */
  function GetBlockDetailsByBlockHashRIBSZ(difficulty, bits, chainwork, merkleRoot, nonce, size, version) {
    _classCallCheck(this, GetBlockDetailsByBlockHashRIBSZ);
    GetBlockDetailsByBlockHashRIBSZ.initialize(this, difficulty, bits, chainwork, merkleRoot, nonce, size, version);
  }
  ...
  _createClass(GetBlockDetailsByBlockHashRIBSZ, null, [{
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHashRIBSZ</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHashRIBSZ} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHashRIBSZ} The populated <code>GetBlockDetailsByBlockHashRIBSZ</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHashRIBSZ();
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHashRIBSZ</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHashRIBSZ</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashRIBSZ.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHashRIBSZ.RequiredProperties = ["difficulty", "bits", "chainwork", "merkleRoot", "nonce", "size", "version"];

/**
 * Represents a mathematical value of how hard it is to find a valid hash for this block.
 * @member {String} difficulty
 */
GetBlockDetailsByBlockHashRIBSZ.prototype['difficulty'] = undefined;

/**
 * Represents a specific sub-unit of Zcash. Bits have two-decimal precision
 * @member {String} bits
 */
GetBlockDetailsByBlockHashRIBSZ.prototype['bits'] = undefined;
 ...
 * @member {String} nonce
 */
GetBlockDetailsByBlockHashRIBSZ.prototype['nonce'] = undefined;

/**
 * Represents the total size of the block in Bytes.
 * @member {Number} size
 */
GetBlockDetailsByBlockHashRIBSZ.prototype['size'] = undefined;

/**
 * Represents the block version number.
 * @member {Number} version
 */
GetBlockDetailsByBlockHashRIBSZ.prototype['version'] = undefined;
var _default = GetBlockDetailsByBlockHashRIBSZ;
