...
var NewConfirmedTokenTransactionsForSpecificAmountE409 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/AlreadyExists|module:model/InvalidData)} instance The actual instance to initialize NewConfirmedTokenTransactionsForSpecificAmountE409.
   */
  function NewConfirmedTokenTransactionsForSpecificAmountE409() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, NewConfirmedTokenTransactionsForSpecificAmountE409);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewConfirmedTokenTransactionsForSpecificAmountE409` with oneOf schemas AlreadyExists, InvalidData. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewConfirmedTokenTransactionsForSpecificAmountE409` with oneOf schemas AlreadyExists, InvalidData. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(NewConfirmedTokenTransactionsForSpecificAmountE409, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewConfirmedTokenTransactionsForSpecificAmountE409.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new NewConfirmedTokenTransactionsForSpecificAmountE409(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(NewConfirmedTokenTransactionsForSpecificAmountE409, "fromJSON", function (json_string) {
  return NewConfirmedTokenTransactionsForSpecificAmountE409.constructFromObject(JSON.parse(json_string));
});
...
NewConfirmedTokenTransactionsForSpecificAmountE409.OneOf = ["AlreadyExists", "InvalidData"];
var _default = NewConfirmedTokenTransactionsForSpecificAmountE409;
