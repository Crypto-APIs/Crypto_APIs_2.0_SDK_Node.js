...
var DecodeRawTransactionHexRISB2VinInner = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISB2VinInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>DecodeRawTransactionHexRISB2VinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DecodeRawTransactionHexRISB2VinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRISB2VinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _DecodeRawTransactionHexRISBVinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
      // ensure the json data is a string
...
DecodeRawTransactionHexRISB2VinInner.RequiredProperties = ["scriptSig"];
