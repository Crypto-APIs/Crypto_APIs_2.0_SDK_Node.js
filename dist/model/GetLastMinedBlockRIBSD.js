...
var GetLastMinedBlockRIBSD = /*#__PURE__*/function () {
   ...
   */
  function GetLastMinedBlockRIBSD(bits, chainwork, merkleRoot, nonce, size, strippedSize, version, weight) {
  ...
  _createClass(GetLastMinedBlockRIBSD, null, [{
    key: "initialize",
    value: function initialize(obj, bits, chainwork, merkleRoot, nonce, size, strippedSize, version, weight) {
      obj['bits'] = bits;
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetLastMinedBlockRIBSD.RequiredProperties),
        _step;
      try {
