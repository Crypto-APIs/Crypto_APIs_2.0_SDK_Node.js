...
var GetLastMinedBlockRIBSD = /*#__PURE__*/function () {
   ...
   */
  function GetLastMinedBlockRIBSD(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, weight) {
    _classCallCheck(this, GetLastMinedBlockRIBSD);

    GetLastMinedBlockRIBSD.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, weight);
  }
  /**
