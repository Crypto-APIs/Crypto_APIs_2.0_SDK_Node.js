 ...
 * @version 1.11.0
 */
var ListInternalTransactionsByAddressAndTimeRange401Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListInternalTransactionsByAddressAndTimeRange401Response(apiVersion, requestId, error) {
    _classCallCheck(this, ListInternalTransactionsByAddressAndTimeRange401Response);
   ...
   */
  _createClass(ListInternalTransactionsByAddressAndTimeRange401Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListInternalTransactionsByAddressAndTimeRange401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListInternalTransactionsByAddressAndTimeRange401Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListInternalTransactionsByAddressAndTimeRange401Response.RequiredProperties),
        _step;
      try {
...
ListInternalTransactionsByAddressAndTimeRange401Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = ListInternalTransactionsByAddressAndTimeRange401Response;
