...
var ActivateBlockchainEventSubscriptionE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ActivateBlockchainEventSubscriptionE400</code>.
   * @alias module:model/ActivateBlockchainEventSubscriptionE400
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize ActivateBlockchainEventSubscriptionE400.
   */
  function ActivateBlockchainEventSubscriptionE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, ActivateBlockchainEventSubscriptionE400);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ActivateBlockchainEventSubscriptionE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ActivateBlockchainEventSubscriptionE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>ActivateBlockchainEventSubscriptionE400</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ActivateBlockchainEventSubscriptionE400} obj Optional instance to populate.
   * @return {module:model/ActivateBlockchainEventSubscriptionE400} The populated <code>ActivateBlockchainEventSubscriptionE400</code> instance.
   */
  _createClass(ActivateBlockchainEventSubscriptionE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ActivateBlockchainEventSubscriptionE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ActivateBlockchainEventSubscriptionE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ActivateBlockchainEventSubscriptionE400, "fromJSON", function (json_string) {
  return ActivateBlockchainEventSubscriptionE400.constructFromObject(JSON.parse(json_string));
});
ActivateBlockchainEventSubscriptionE400.prototype['code'] = undefined;
 ...
 */
ActivateBlockchainEventSubscriptionE400.prototype['details'] = undefined;
ActivateBlockchainEventSubscriptionE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
var _default = ActivateBlockchainEventSubscriptionE400;
