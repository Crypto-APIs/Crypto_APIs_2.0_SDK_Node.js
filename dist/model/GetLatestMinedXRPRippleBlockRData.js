...
var _GetLatestMinedXRPRippleBlockRI = _interopRequireDefault(require("./GetLatestMinedXRPRippleBlockRI"));
...
var GetLatestMinedXRPRippleBlockRData = /*#__PURE__*/function () {
   ...
   */
  function GetLatestMinedXRPRippleBlockRData(item) {
    _classCallCheck(this, GetLatestMinedXRPRippleBlockRData);
   ...
   */
  _createClass(GetLatestMinedXRPRippleBlockRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _GetLatestMinedXRPRippleBlockRI["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetLatestMinedXRPRippleBlockRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLatestMinedXRPRippleBlockRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetLatestMinedXRPRippleBlockRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _GetLatestMinedXRPRippleBlockRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
GetLatestMinedXRPRippleBlockRData.RequiredProperties = ["item"];
