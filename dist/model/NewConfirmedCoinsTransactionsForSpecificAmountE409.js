...
var NewConfirmedCoinsTransactionsForSpecificAmountE409 = /*#__PURE__*/function () {
   ...
   */
  function NewConfirmedCoinsTransactionsForSpecificAmountE409() {
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `NewConfirmedCoinsTransactionsForSpecificAmountE409` with oneOf schemas AlreadyExists, InvalidData. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(NewConfirmedCoinsTransactionsForSpecificAmountE409, [{
 ...
 * @member {String} code
 */
_defineProperty(NewConfirmedCoinsTransactionsForSpecificAmountE409, "fromJSON", function (json_string) {
