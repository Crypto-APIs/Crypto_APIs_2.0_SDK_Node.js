...
var _GetTransactionDetailsByTransactionIDFromCallbackRIRecipients = _interopRequireDefault(require("./GetTransactionDetailsByTransactionIDFromCallbackRIRecipients"));

var _GetTransactionDetailsByTransactionIDFromCallbackRISenders = _interopRequireDefault(require("./GetTransactionDetailsByTransactionIDFromCallbackRISenders"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('recipients')) {
          obj['recipients'] = _ApiClient["default"].convertToType(data['recipients'], [_GetTransactionDetailsByTransactionIDFromCallbackRIRecipients["default"]]);
        }

        if (data.hasOwnProperty('senders')) {
          obj['senders'] = _ApiClient["default"].convertToType(data['senders'], [_GetTransactionDetailsByTransactionIDFromCallbackRISenders["default"]]);
        }
