...
var GetBlockDetailsByBlockHeightRIBS = /*#__PURE__*/function () {
  ...
  function GetBlockDetailsByBlockHeightRIBS(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, merkleroot) {
    ...
    _GetBlockDetailsByBlockHeightRIBSE["default"].initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty);

    _GetBlockDetailsByBlockHeightRIBSEC["default"].initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty);

    _GetBlockDetailsByBlockHeightRIBSBC["default"].initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, version, versionHex);

    _GetBlockDetailsByBlockHeightRIBSL["default"].initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight);

    _GetBlockDetailsByBlockHeightRIBSD["default"].initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, weight);

    _GetBlockDetailsByBlockHeightRIBSD2["default"].initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, version, versionHex);
...
_GetBlockDetailsByBlockHeightRIBSB["default"].prototype['weight'] = undefined; // Implement GetBlockDetailsByBlockHeightRIBSE interface:
...
_GetBlockDetailsByBlockHeightRIBSE["default"].prototype['totalDifficulty'] = undefined; // Implement GetBlockDetailsByBlockHeightRIBSEC interface:
...
_GetBlockDetailsByBlockHeightRIBSEC["default"].prototype['totalDifficulty'] = undefined; // Implement GetBlockDetailsByBlockHeightRIBSBC interface:
...
_GetBlockDetailsByBlockHeightRIBSBC["default"].prototype['versionHex'] = undefined; // Implement GetBlockDetailsByBlockHeightRIBSL interface:
...
_GetBlockDetailsByBlockHeightRIBSL["default"].prototype['weight'] = undefined; // Implement GetBlockDetailsByBlockHeightRIBSD interface:
...
_GetBlockDetailsByBlockHeightRIBSD["default"].prototype['weight'] = undefined; // Implement GetBlockDetailsByBlockHeightRIBSD2 interface:
...
_GetBlockDetailsByBlockHeightRIBSD2["default"].prototype['versionHex'] = undefined; // Implement GetBlockDetailsByBlockHeightRIBSBSC interface:
...
_GetBlockDetailsByBlockHeightRIBSBSC["default"].prototype['totalDifficulty'] = undefined; // Implement GetBlockDetailsByBlockHeightRIBSZ interface:
