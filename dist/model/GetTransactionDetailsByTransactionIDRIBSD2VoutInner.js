...
var GetTransactionDetailsByTransactionIDRIBSD2VoutInner = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDRIBSD2VoutInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransactionDetailsByTransactionIDRIBSD2VoutInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransactionDetailsByTransactionIDRIBSD2VoutInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDRIBSD2VoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _GetTransactionDetailsByTransactionIDRIBSD2VoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
...
GetTransactionDetailsByTransactionIDRIBSD2VoutInner.RequiredProperties = ["isSpent", "scriptPubKey", "value"];
