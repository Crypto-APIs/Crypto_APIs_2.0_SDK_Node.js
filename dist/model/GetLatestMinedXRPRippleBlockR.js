...
var _GetLatestMinedXRPRippleBlockRData = _interopRequireDefault(require("./GetLatestMinedXRPRippleBlockRData"));
...
var GetLatestMinedXRPRippleBlockR = /*#__PURE__*/function () {
   ...
   */
  function GetLatestMinedXRPRippleBlockR(apiVersion, requestId, data) {
    _classCallCheck(this, GetLatestMinedXRPRippleBlockR);
   ...
   */
  _createClass(GetLatestMinedXRPRippleBlockR, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _GetLatestMinedXRPRippleBlockRData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetLatestMinedXRPRippleBlockR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLatestMinedXRPRippleBlockR</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetLatestMinedXRPRippleBlockR.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _GetLatestMinedXRPRippleBlockRData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
GetLatestMinedXRPRippleBlockR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
var _default = GetLatestMinedXRPRippleBlockR;
