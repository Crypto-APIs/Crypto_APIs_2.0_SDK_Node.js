...
var ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC = /*#__PURE__*/function () {
   ...
   */
  function ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC(contract, gasLimit, gasPrice, gasUsed, inputData, nonce, transactionStatus) {
    _classCallCheck(this, ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC);
   ...
   */
  _createClass(ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC.RequiredProperties),
        _step;
      try {
...
ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC.RequiredProperties = ["contract", "gasLimit", "gasPrice", "gasUsed", "inputData", "nonce", "transactionStatus"];
...
var _default = ListConfirmedTransactionsByAddressAndTimeRangeRIBSEC;
