 ...
 * @version 1.11.0
 */
var ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey(addresses, asm, hex, type) {
    _classCallCheck(this, ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey);
   ...
   */
  _createClass(ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey.RequiredProperties),
        _step;
      try {
  ...
  return ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey;
}();
ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey.RequiredProperties = ["addresses", "asm", "hex", "type"];
...
var _default = ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey;
