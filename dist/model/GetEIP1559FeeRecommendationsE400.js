 ...
 * @version 1.11.0
 */
var GetEIP1559FeeRecommendationsE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetEIP1559FeeRecommendationsE400</code>.
   * @alias module:model/GetEIP1559FeeRecommendationsE400
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize GetEIP1559FeeRecommendationsE400.
   */
  function GetEIP1559FeeRecommendationsE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetEIP1559FeeRecommendationsE400);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetEIP1559FeeRecommendationsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetEIP1559FeeRecommendationsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>GetEIP1559FeeRecommendationsE400</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetEIP1559FeeRecommendationsE400} obj Optional instance to populate.
   * @return {module:model/GetEIP1559FeeRecommendationsE400} The populated <code>GetEIP1559FeeRecommendationsE400</code> instance.
   */
  _createClass(GetEIP1559FeeRecommendationsE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetEIP1559FeeRecommendationsE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetEIP1559FeeRecommendationsE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetEIP1559FeeRecommendationsE400, "fromJSON", function (json_string) {
  return GetEIP1559FeeRecommendationsE400.constructFromObject(JSON.parse(json_string));
});
GetEIP1559FeeRecommendationsE400.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
GetEIP1559FeeRecommendationsE400.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
GetEIP1559FeeRecommendationsE400.prototype['details'] = undefined;
GetEIP1559FeeRecommendationsE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
var _default = GetEIP1559FeeRecommendationsE400;
