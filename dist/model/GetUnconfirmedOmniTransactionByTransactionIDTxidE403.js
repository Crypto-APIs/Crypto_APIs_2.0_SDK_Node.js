...
var GetUnconfirmedOmniTransactionByTransactionIDTxidE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetUnconfirmedOmniTransactionByTransactionIDTxidE403</code>.
   * @alias module:model/GetUnconfirmedOmniTransactionByTransactionIDTxidE403
   ...
   */
  function GetUnconfirmedOmniTransactionByTransactionIDTxidE403(code, message) {
    _classCallCheck(this, GetUnconfirmedOmniTransactionByTransactionIDTxidE403);
    ...
    GetUnconfirmedOmniTransactionByTransactionIDTxidE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(GetUnconfirmedOmniTransactionByTransactionIDTxidE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetUnconfirmedOmniTransactionByTransactionIDTxidE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetUnconfirmedOmniTransactionByTransactionIDTxidE403} obj Optional instance to populate.
     * @return {module:model/GetUnconfirmedOmniTransactionByTransactionIDTxidE403} The populated <code>GetUnconfirmedOmniTransactionByTransactionIDTxidE403</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetUnconfirmedOmniTransactionByTransactionIDTxidE403();
...
GetUnconfirmedOmniTransactionByTransactionIDTxidE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

GetUnconfirmedOmniTransactionByTransactionIDTxidE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetails>} details
 */

GetUnconfirmedOmniTransactionByTransactionIDTxidE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
...
var _default = GetUnconfirmedOmniTransactionByTransactionIDTxidE403;
