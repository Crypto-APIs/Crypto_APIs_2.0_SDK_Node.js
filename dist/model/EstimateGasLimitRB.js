...
var EstimateGasLimitRB = /*#__PURE__*/function () {
  ...
  _createClass(EstimateGasLimitRB, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>EstimateGasLimitRB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EstimateGasLimitRB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(EstimateGasLimitRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _EstimateGasLimitRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
EstimateGasLimitRB.RequiredProperties = ["data"];
