...
var NewConfirmedCoinsTransactionsRI = /*#__PURE__*/function () {
  ...
  _createClass(NewConfirmedCoinsTransactionsRI, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>NewConfirmedCoinsTransactionsRI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewConfirmedCoinsTransactionsRI</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewConfirmedCoinsTransactionsRI.RequiredProperties),
        _step;
      try {
...
NewConfirmedCoinsTransactionsRI.RequiredProperties = ["address", "callbackSecretKey", "callbackUrl", "createdTimestamp", "eventType", "isActive", "receiveCallbackOn", "referenceId"];
