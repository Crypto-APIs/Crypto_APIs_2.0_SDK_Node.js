...
var _PrepareANonFungibleTokenTransferFromAddressRI = _interopRequireDefault(require("./PrepareANonFungibleTokenTransferFromAddressRI"));
 ...
 * @version 1.13.0
 */
var PrepareANonFungibleTokenTransferFromAddressRData = /*#__PURE__*/function () {
  /**
   ...
   */
  function PrepareANonFungibleTokenTransferFromAddressRData(item) {
    _classCallCheck(this, PrepareANonFungibleTokenTransferFromAddressRData);
   ...
   */
  _createClass(PrepareANonFungibleTokenTransferFromAddressRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _PrepareANonFungibleTokenTransferFromAddressRI["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
...
var _default = PrepareANonFungibleTokenTransferFromAddressRData;
