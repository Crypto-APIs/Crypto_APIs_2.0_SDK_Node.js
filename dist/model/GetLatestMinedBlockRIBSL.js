...
/**
 * The GetLatestMinedBlockRIBSL model module.
 * @module model/GetLatestMinedBlockRIBSL
 * @version 1.2.0
 */
var GetLatestMinedBlockRIBSL = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetLatestMinedBlockRIBSL</code>.
   * Litecoin
   * @alias module:model/GetLatestMinedBlockRIBSL
   ...
   */
  function GetLatestMinedBlockRIBSL(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, GetLatestMinedBlockRIBSL);

    GetLatestMinedBlockRIBSL.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight);
  }
  /**
  ...
  _createClass(GetLatestMinedBlockRIBSL, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetLatestMinedBlockRIBSL</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLatestMinedBlockRIBSL} obj Optional instance to populate.
     * @return {module:model/GetLatestMinedBlockRIBSL} The populated <code>GetLatestMinedBlockRIBSL</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLatestMinedBlockRIBSL();
  ...
  return GetLatestMinedBlockRIBSL;
}();
/**
...
var _default = GetLatestMinedBlockRIBSL;
