...
var NewUnconfirmedCoinsTransactionsRB = /*#__PURE__*/function () {
  ...
  _createClass(NewUnconfirmedCoinsTransactionsRB, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(NewUnconfirmedCoinsTransactionsRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _NewUnconfirmedCoinsTransactionsRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
