...
var NewConfirmedInternalTransactionsRB = /*#__PURE__*/function () {
  ...
  _createClass(NewConfirmedInternalTransactionsRB, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(NewConfirmedInternalTransactionsRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _NewConfirmedInternalTransactionsRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
