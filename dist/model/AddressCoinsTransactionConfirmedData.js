...
var AddressCoinsTransactionConfirmedData = /*#__PURE__*/function () {
  ...
  _createClass(AddressCoinsTransactionConfirmedData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AddressCoinsTransactionConfirmedData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _AddressCoinsTransactionConfirmedDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
