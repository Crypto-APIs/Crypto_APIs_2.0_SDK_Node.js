 ...
 * @version 1.4.0
 */
var ListAssetsDetailsE401 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListAssetsDetailsE401</code>.
   * @alias module:model/ListAssetsDetailsE401
   * @implements module:model/MissingApiKey
   * @implements module:model/InvalidApiKey
   * @param code {String} Specifies an error code, e.g. error 404.
   * @param message {String} Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
   */
  function ListAssetsDetailsE401(code, message) {
    _classCallCheck(this, ListAssetsDetailsE401);

    _MissingApiKey["default"].initialize(this, code, message);

    _InvalidApiKey["default"].initialize(this, code, message);

    ListAssetsDetailsE401.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListAssetsDetailsE401, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListAssetsDetailsE401</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAssetsDetailsE401} obj Optional instance to populate.
     * @return {module:model/ListAssetsDetailsE401} The populated <code>ListAssetsDetailsE401</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListAssetsDetailsE401();
...
ListAssetsDetailsE401.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListAssetsDetailsE401.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetails>} details
 */

ListAssetsDetailsE401.prototype['details'] = undefined; // Implement MissingApiKey interface:
...
var _default = ListAssetsDetailsE401;
