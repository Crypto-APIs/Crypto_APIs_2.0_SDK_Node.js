...
var ListZilliqaTransactionsByBlockHeightE401 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidApiKey|module:model/MissingApiKey)} instance The actual instance to initialize ListZilliqaTransactionsByBlockHeightE401.
   */
  function ListZilliqaTransactionsByBlockHeightE401() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListZilliqaTransactionsByBlockHeightE401` with oneOf schemas InvalidApiKey, MissingApiKey. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListZilliqaTransactionsByBlockHeightE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(ListZilliqaTransactionsByBlockHeightE401, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListZilliqaTransactionsByBlockHeightE401.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListZilliqaTransactionsByBlockHeightE401(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListZilliqaTransactionsByBlockHeightE401, "fromJSON", function (json_string) {
  return ListZilliqaTransactionsByBlockHeightE401.constructFromObject(JSON.parse(json_string));
});
 ...
 */
ListZilliqaTransactionsByBlockHeightE401.prototype['details'] = undefined;
ListZilliqaTransactionsByBlockHeightE401.OneOf = ["InvalidApiKey", "MissingApiKey"];
