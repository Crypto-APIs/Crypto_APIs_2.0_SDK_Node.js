...
var ListTransactionsByBlockHeightRIBSLVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHeightRIBSLVoutInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRIBSLVoutInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRIBSLVoutInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSLVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _ListTransactionsByBlockHeightRIBSLVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
...
ListTransactionsByBlockHeightRIBSLVoutInner.RequiredProperties = ["isSpent", "scriptPubKey", "value"];
