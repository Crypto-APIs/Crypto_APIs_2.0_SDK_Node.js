...
var NewConfirmedInternalTransactionsRBData = /*#__PURE__*/function () {
  ...
  _createClass(NewConfirmedInternalTransactionsRBData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(NewConfirmedInternalTransactionsRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _NewConfirmedInternalTransactionsRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
