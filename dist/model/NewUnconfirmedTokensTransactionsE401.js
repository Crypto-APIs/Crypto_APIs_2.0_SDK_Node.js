 ...
 * @version 1.11.0
 */
var NewUnconfirmedTokensTransactionsE401 = /*#__PURE__*/function () {
  /**
   ...
   */
  function NewUnconfirmedTokensTransactionsE401() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, NewUnconfirmedTokensTransactionsE401);
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `NewUnconfirmedTokensTransactionsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>NewUnconfirmedTokensTransactionsE401</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NewUnconfirmedTokensTransactionsE401} obj Optional instance to populate.
   ...
   */
  _createClass(NewUnconfirmedTokensTransactionsE401, [{
 ...
 * @member {String} code
 */
_defineProperty(NewUnconfirmedTokensTransactionsE401, "fromJSON", function (json_string) {
  return NewUnconfirmedTokensTransactionsE401.constructFromObject(JSON.parse(json_string));
});
NewUnconfirmedTokensTransactionsE401.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
NewUnconfirmedTokensTransactionsE401.prototype['message'] = undefined;
...
var _default = NewUnconfirmedTokensTransactionsE401;
