...
var _GetXRPRippleTransactionDetailsByTransactionIDRData = _interopRequireDefault(require("./GetXRPRippleTransactionDetailsByTransactionIDRData"));
 ...
 * @version 1.11.0
 */
var GetXRPRippleTransactionDetailsByTransactionIDR = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetXRPRippleTransactionDetailsByTransactionIDR(apiVersion, requestId, data) {
    _classCallCheck(this, GetXRPRippleTransactionDetailsByTransactionIDR);
   ...
   */
  _createClass(GetXRPRippleTransactionDetailsByTransactionIDR, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _GetXRPRippleTransactionDetailsByTransactionIDRData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetXRPRippleTransactionDetailsByTransactionIDR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetXRPRippleTransactionDetailsByTransactionIDR</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetXRPRippleTransactionDetailsByTransactionIDR.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _GetXRPRippleTransactionDetailsByTransactionIDRData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
GetXRPRippleTransactionDetailsByTransactionIDR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
var _default = GetXRPRippleTransactionDetailsByTransactionIDR;
