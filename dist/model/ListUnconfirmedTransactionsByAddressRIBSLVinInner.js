...
var ListUnconfirmedTransactionsByAddressRIBSLVinInner = /*#__PURE__*/function () {
  ...
  _createClass(ListUnconfirmedTransactionsByAddressRIBSLVinInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListUnconfirmedTransactionsByAddressRIBSLVinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUnconfirmedTransactionsByAddressRIBSLVinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListUnconfirmedTransactionsByAddressRIBSLVinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _ListUnconfirmedTransactionsByAddressRIBSLVinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
...
ListUnconfirmedTransactionsByAddressRIBSLVinInner.RequiredProperties = ["addresses", "scriptSig", "sequence", "txid", "txinwitness", "value"];
