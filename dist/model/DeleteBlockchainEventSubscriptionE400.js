...
var DeleteBlockchainEventSubscriptionE400 = /*#__PURE__*/function () {
  ...
  function DeleteBlockchainEventSubscriptionE400() {
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `DeleteBlockchainEventSubscriptionE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(DeleteBlockchainEventSubscriptionE400, [{
 ...
 * @member {String} code
 */
_defineProperty(DeleteBlockchainEventSubscriptionE400, "fromJSON", function (json_string) {
