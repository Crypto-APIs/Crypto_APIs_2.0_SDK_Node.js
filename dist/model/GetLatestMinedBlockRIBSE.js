...
/**
 * The GetLatestMinedBlockRIBSE model module.
 * @module model/GetLatestMinedBlockRIBSE
 * @version 1.2.1
 */
var GetLatestMinedBlockRIBSE = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetLatestMinedBlockRIBSE</code>.
   * Ethereum
   * @alias module:model/GetLatestMinedBlockRIBSE
   ...
   */
  function GetLatestMinedBlockRIBSE(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty) {
    _classCallCheck(this, GetLatestMinedBlockRIBSE);

    GetLatestMinedBlockRIBSE.initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty);
  }
  /**
  ...
  _createClass(GetLatestMinedBlockRIBSE, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetLatestMinedBlockRIBSE</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLatestMinedBlockRIBSE} obj Optional instance to populate.
     * @return {module:model/GetLatestMinedBlockRIBSE} The populated <code>GetLatestMinedBlockRIBSE</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLatestMinedBlockRIBSE();
  ...
  return GetLatestMinedBlockRIBSE;
}();
/**
...
var _default = GetLatestMinedBlockRIBSE;
