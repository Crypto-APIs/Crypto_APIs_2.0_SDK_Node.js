...
var _CreateFungibleTokensTransactionRequestFromAddressRISenders = _interopRequireDefault(require("./CreateFungibleTokensTransactionRequestFromAddressRISenders"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('senders')) {
          obj['senders'] = _CreateFungibleTokensTransactionRequestFromAddressRISenders["default"].constructFromObject(data['senders']);
        }
