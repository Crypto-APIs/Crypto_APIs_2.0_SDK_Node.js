...
/**
 * The NewConfirmedCoinsTransactionsAndEachConfirmationE403 model module.
 * @module model/NewConfirmedCoinsTransactionsAndEachConfirmationE403
 * @version 1.11.0
 */
var NewConfirmedCoinsTransactionsAndEachConfirmationE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>NewConfirmedCoinsTransactionsAndEachConfirmationE403</code>.
   * @alias module:model/NewConfirmedCoinsTransactionsAndEachConfirmationE403
   * @param {(module:model/BannedIpAddress|module:model/BlockchainEventsCallbacksLimitReached|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize NewConfirmedCoinsTransactionsAndEachConfirmationE403.
   */
  function NewConfirmedCoinsTransactionsAndEachConfirmationE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, NewConfirmedCoinsTransactionsAndEachConfirmationE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewConfirmedCoinsTransactionsAndEachConfirmationE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewConfirmedCoinsTransactionsAndEachConfirmationE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>NewConfirmedCoinsTransactionsAndEachConfirmationE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NewConfirmedCoinsTransactionsAndEachConfirmationE403} obj Optional instance to populate.
   * @return {module:model/NewConfirmedCoinsTransactionsAndEachConfirmationE403} The populated <code>NewConfirmedCoinsTransactionsAndEachConfirmationE403</code> instance.
   */
  _createClass(NewConfirmedCoinsTransactionsAndEachConfirmationE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewConfirmedCoinsTransactionsAndEachConfirmationE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new NewConfirmedCoinsTransactionsAndEachConfirmationE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(NewConfirmedCoinsTransactionsAndEachConfirmationE403, "fromJSON", function (json_string) {
  return NewConfirmedCoinsTransactionsAndEachConfirmationE403.constructFromObject(JSON.parse(json_string));
});
NewConfirmedCoinsTransactionsAndEachConfirmationE403.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
NewConfirmedCoinsTransactionsAndEachConfirmationE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
NewConfirmedCoinsTransactionsAndEachConfirmationE403.prototype['details'] = undefined;
NewConfirmedCoinsTransactionsAndEachConfirmationE403.OneOf = ["BannedIpAddress", "BlockchainEventsCallbacksLimitReached", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = NewConfirmedCoinsTransactionsAndEachConfirmationE403;
