...
var ListCoinsForwardingAutomationsRI = /*#__PURE__*/function () {
  ...
  _createClass(ListCoinsForwardingAutomationsRI, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListCoinsForwardingAutomationsRI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListCoinsForwardingAutomationsRI</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListCoinsForwardingAutomationsRI.RequiredProperties),
        _step;
      try {
...
ListCoinsForwardingAutomationsRI.RequiredProperties = ["callbackUrl", "confirmationsCountTrigger", "createdTimestamp", "feePriority", "fromAddress", "minimumTransferAmount", "referenceId", "toAddress"];
