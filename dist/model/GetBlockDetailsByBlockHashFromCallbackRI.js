...
var GetBlockDetailsByBlockHashFromCallbackRI = /*#__PURE__*/function () {
  ...
  _createClass(GetBlockDetailsByBlockHashFromCallbackRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashFromCallbackRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['blockchainSpecific']) {
        // data not null
        _GetBlockDetailsByBlockHashFromCallbackRIBS["default"].validateJSON(data['blockchainSpecific']);
      }
      return true;
    }
  }]);
