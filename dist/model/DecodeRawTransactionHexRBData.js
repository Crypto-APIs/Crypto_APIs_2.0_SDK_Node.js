...
var DecodeRawTransactionHexRBData = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRBData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>DecodeRawTransactionHexRBData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DecodeRawTransactionHexRBData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _DecodeRawTransactionHexRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
DecodeRawTransactionHexRBData.RequiredProperties = ["item"];
