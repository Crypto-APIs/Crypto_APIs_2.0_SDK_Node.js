...
var GetBlockDetailsByBlockHeightFromCallbackRI = /*#__PURE__*/function () {
  ...
  _createClass(GetBlockDetailsByBlockHeightFromCallbackRI, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHeightFromCallbackRI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHeightFromCallbackRI</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHeightFromCallbackRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['blockchainSpecific']) {
        // data not null
        _GetBlockDetailsByBlockHeightFromCallbackRIBS["default"].validateJSON(data['blockchainSpecific']);
      }
      return true;
    }
  }]);
...
GetBlockDetailsByBlockHeightFromCallbackRI.RequiredProperties = ["hash", "height", "previousBlockHash", "timestamp", "transactionsCount", "blockchainSpecific"];
