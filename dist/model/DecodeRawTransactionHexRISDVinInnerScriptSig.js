...
var DecodeRawTransactionHexRISDVinInnerScriptSig = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISDVinInnerScriptSig, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>DecodeRawTransactionHexRISDVinInnerScriptSig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DecodeRawTransactionHexRISDVinInnerScriptSig</code>.
     */
  }, {
    key: "validateJSON",
