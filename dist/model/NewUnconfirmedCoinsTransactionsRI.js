...
var NewUnconfirmedCoinsTransactionsRI = /*#__PURE__*/function () {
  ...
  _createClass(NewUnconfirmedCoinsTransactionsRI, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>NewUnconfirmedCoinsTransactionsRI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewUnconfirmedCoinsTransactionsRI</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewUnconfirmedCoinsTransactionsRI.RequiredProperties),
        _step;
      try {
...
NewUnconfirmedCoinsTransactionsRI.RequiredProperties = ["address", "callbackSecretKey", "callbackUrl", "createdTimestamp", "eventType", "isActive", "referenceId"];
