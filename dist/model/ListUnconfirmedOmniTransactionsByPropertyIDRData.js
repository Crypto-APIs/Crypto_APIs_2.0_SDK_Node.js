...
var ListUnconfirmedOmniTransactionsByPropertyIDRData = /*#__PURE__*/function () {
   ...
   */
  function ListUnconfirmedOmniTransactionsByPropertyIDRData(limit, offset, total, items) {
    _classCallCheck(this, ListUnconfirmedOmniTransactionsByPropertyIDRData);

    ListUnconfirmedOmniTransactionsByPropertyIDRData.initialize(this, limit, offset, total, items);
  }
  /**
