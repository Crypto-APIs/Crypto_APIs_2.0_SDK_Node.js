...
var AddressTokensTransactionConfirmedEachConfirmationBep20 = /*#__PURE__*/function () {
  ...
  _createClass(AddressTokensTransactionConfirmedEachConfirmationBep20, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddressTokensTransactionConfirmedEachConfirmationBep20</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressTokensTransactionConfirmedEachConfirmationBep20</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressTokensTransactionConfirmedEachConfirmationBep20.RequiredProperties),
        _step;
      try {
...
AddressTokensTransactionConfirmedEachConfirmationBep20.RequiredProperties = ["name", "symbol", "amount", "contractAddress"];
