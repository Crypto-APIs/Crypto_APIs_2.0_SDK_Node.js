...
var CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE409 = /*#__PURE__*/function () {
   ...
   */
  function CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE409() {
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceTokenNotSupported, WalletAsAServiceWalletBalanceNotEnough. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE409, [{
 ...
 * @member {String} code
 */
_defineProperty(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE409, "fromJSON", function (json_string) {
