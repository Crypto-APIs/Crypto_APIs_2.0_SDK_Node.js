...
var PrepareAnAccountBasedTransactionFromXPubE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PrepareAnAccountBasedTransactionFromXPubE400</code>.
   * @alias module:model/PrepareAnAccountBasedTransactionFromXPubE400
   ...
   */
  function PrepareAnAccountBasedTransactionFromXPubE400(code, message) {
    _classCallCheck(this, PrepareAnAccountBasedTransactionFromXPubE400);
    ...
    PrepareAnAccountBasedTransactionFromXPubE400.initialize(this, code, message);
  }
  /**
  ...
  _createClass(PrepareAnAccountBasedTransactionFromXPubE400, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>PrepareAnAccountBasedTransactionFromXPubE400</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrepareAnAccountBasedTransactionFromXPubE400} obj Optional instance to populate.
     * @return {module:model/PrepareAnAccountBasedTransactionFromXPubE400} The populated <code>PrepareAnAccountBasedTransactionFromXPubE400</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new PrepareAnAccountBasedTransactionFromXPubE400();
  ...
  return PrepareAnAccountBasedTransactionFromXPubE400;
}();
/**
...
PrepareAnAccountBasedTransactionFromXPubE400.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

PrepareAnAccountBasedTransactionFromXPubE400.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

PrepareAnAccountBasedTransactionFromXPubE400.prototype['details'] = undefined; // Implement UriNotFound interface:
...
var _default = PrepareAnAccountBasedTransactionFromXPubE400;
