...
var ListUnconfirmedOmniTransactionsByAddressRData = /*#__PURE__*/function () {
   ...
   */
  function ListUnconfirmedOmniTransactionsByAddressRData(limit, offset, total, items) {
    _classCallCheck(this, ListUnconfirmedOmniTransactionsByAddressRData);

    ListUnconfirmedOmniTransactionsByAddressRData.initialize(this, limit, offset, total, items);
  }
  /**
