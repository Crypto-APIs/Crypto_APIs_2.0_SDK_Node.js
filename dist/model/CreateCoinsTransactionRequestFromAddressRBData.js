...
var _CreateCoinsTransactionRequestFromAddressRBDataItem = _interopRequireDefault(require("./CreateCoinsTransactionRequestFromAddressRBDataItem"));
...
var CreateCoinsTransactionRequestFromAddressRBData = /*#__PURE__*/function () {
   ...
   */
  function CreateCoinsTransactionRequestFromAddressRBData(item) {
    _classCallCheck(this, CreateCoinsTransactionRequestFromAddressRBData);
   ...
   */
  _createClass(CreateCoinsTransactionRequestFromAddressRBData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _CreateCoinsTransactionRequestFromAddressRBDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCoinsTransactionRequestFromAddressRBData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCoinsTransactionRequestFromAddressRBData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateCoinsTransactionRequestFromAddressRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _CreateCoinsTransactionRequestFromAddressRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
CreateCoinsTransactionRequestFromAddressRBData.RequiredProperties = ["item"];
