...
var _NewBlockRequestBodyDataItem = _interopRequireDefault(require("./NewBlockRequestBodyDataItem"));
 ...
 * @version 2.0.0
 */
var NewBlockRequestBodyData = /*#__PURE__*/function () {
  /**
   ...
   */
  function NewBlockRequestBodyData(item) {
    _classCallCheck(this, NewBlockRequestBodyData);
  ...
  _createClass(NewBlockRequestBodyData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _NewBlockRequestBodyDataItem["default"].constructFromObject(data['item']);
        }
      }
  ...
  return NewBlockRequestBodyData;
}();
/**
...
var _default = NewBlockRequestBodyData;
