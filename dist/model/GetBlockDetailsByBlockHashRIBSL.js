 ...
 * @version 1.11.0
 */
var GetBlockDetailsByBlockHashRIBSL = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetBlockDetailsByBlockHashRIBSL(difficulty, bits, chainwork, merkleRoot, nonce, size, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, GetBlockDetailsByBlockHashRIBSL);
   ...
   */
  _createClass(GetBlockDetailsByBlockHashRIBSL, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHashRIBSL</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHashRIBSL</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashRIBSL.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHashRIBSL.RequiredProperties = ["difficulty", "bits", "chainwork", "merkleRoot", "nonce", "size", "strippedSize", "version", "versionHex", "weight"];
...
var _default = GetBlockDetailsByBlockHashRIBSL;
