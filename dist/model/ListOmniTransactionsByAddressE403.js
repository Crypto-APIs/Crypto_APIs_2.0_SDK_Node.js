...
/**
 * The ListOmniTransactionsByAddressE403 model module.
 * @module model/ListOmniTransactionsByAddressE403
 * @version 1.6.0
 */
var ListOmniTransactionsByAddressE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListOmniTransactionsByAddressE403</code>.
   * @alias module:model/ListOmniTransactionsByAddressE403
   ...
   */
  function ListOmniTransactionsByAddressE403(code, message) {
    _classCallCheck(this, ListOmniTransactionsByAddressE403);
    ...
    ListOmniTransactionsByAddressE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListOmniTransactionsByAddressE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListOmniTransactionsByAddressE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListOmniTransactionsByAddressE403} obj Optional instance to populate.
     * @return {module:model/ListOmniTransactionsByAddressE403} The populated <code>ListOmniTransactionsByAddressE403</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListOmniTransactionsByAddressE403();
  ...
  return ListOmniTransactionsByAddressE403;
}();
/**
...
ListOmniTransactionsByAddressE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListOmniTransactionsByAddressE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

ListOmniTransactionsByAddressE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
...
var _default = ListOmniTransactionsByAddressE403;
