...
var GetFeeRecommendationsE400 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize GetFeeRecommendationsE400.
   */
  function GetFeeRecommendationsE400() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetFeeRecommendationsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetFeeRecommendationsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(GetFeeRecommendationsE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetFeeRecommendationsE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetFeeRecommendationsE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetFeeRecommendationsE400, "fromJSON", function (json_string) {
  return GetFeeRecommendationsE400.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GetFeeRecommendationsE400.prototype['details'] = undefined;
GetFeeRecommendationsE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
