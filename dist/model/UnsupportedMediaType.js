...
var _UnsupportedMediaTypeError = _interopRequireDefault(require("./UnsupportedMediaTypeError"));
...
var UnsupportedMediaType = /*#__PURE__*/function () {
   ...
   */
  function UnsupportedMediaType(apiVersion, requestId, error) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _UnsupportedMediaTypeError["default"].constructFromObject(data['error']);
        }
      }
