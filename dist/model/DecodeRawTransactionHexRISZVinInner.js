...
var DecodeRawTransactionHexRISZVinInner = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISZVinInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRISZVinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _DecodeRawTransactionHexRISZVinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
      // ensure the json data is a string
