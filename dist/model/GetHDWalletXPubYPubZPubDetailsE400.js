...
var GetHDWalletXPubYPubZPubDetailsE400 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidBlockchain|module:model/InvalidNetwork|module:model/InvalidPagination|module:model/InvalidXpub|module:model/LimitGreaterThanAllowed|module:model/UriNotFound|module:model/XpubNotSynced)} instance The actual instance to initialize GetHDWalletXPubYPubZPubDetailsE400.
   */
  function GetHDWalletXPubYPubZPubDetailsE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetHDWalletXPubYPubZPubDetailsE400);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetHDWalletXPubYPubZPubDetailsE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetHDWalletXPubYPubZPubDetailsE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>GetHDWalletXPubYPubZPubDetailsE400</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetHDWalletXPubYPubZPubDetailsE400} obj Optional instance to populate.
   * @return {module:model/GetHDWalletXPubYPubZPubDetailsE400} The populated <code>GetHDWalletXPubYPubZPubDetailsE400</code> instance.
   */
  _createClass(GetHDWalletXPubYPubZPubDetailsE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetHDWalletXPubYPubZPubDetailsE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetHDWalletXPubYPubZPubDetailsE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetHDWalletXPubYPubZPubDetailsE400, "fromJSON", function (json_string) {
  return GetHDWalletXPubYPubZPubDetailsE400.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GetHDWalletXPubYPubZPubDetailsE400.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
GetHDWalletXPubYPubZPubDetailsE400.prototype['details'] = undefined;
GetHDWalletXPubYPubZPubDetailsE400.OneOf = ["InvalidBlockchain", "InvalidNetwork", "InvalidPagination", "InvalidXpub", "LimitGreaterThanAllowed", "UriNotFound", "XpubNotSynced"];
var _default = GetHDWalletXPubYPubZPubDetailsE400;
