...
var CreateCoinsTransactionFromAddressForWholeAmountE409 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidData|module:model/WalletAsAServiceAddressBalanceNotEnough|module:model/WalletAsAServiceWalletBalanceNotEnough)} instance The actual instance to initialize CreateCoinsTransactionFromAddressForWholeAmountE409.
   */
  function CreateCoinsTransactionFromAddressForWholeAmountE409() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `CreateCoinsTransactionFromAddressForWholeAmountE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceWalletBalanceNotEnough. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `CreateCoinsTransactionFromAddressForWholeAmountE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceWalletBalanceNotEnough. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(CreateCoinsTransactionFromAddressForWholeAmountE409, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = CreateCoinsTransactionFromAddressForWholeAmountE409.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new CreateCoinsTransactionFromAddressForWholeAmountE409(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(CreateCoinsTransactionFromAddressForWholeAmountE409, "fromJSON", function (json_string) {
  return CreateCoinsTransactionFromAddressForWholeAmountE409.constructFromObject(JSON.parse(json_string));
});
 ...
 */
CreateCoinsTransactionFromAddressForWholeAmountE409.prototype['details'] = undefined;
CreateCoinsTransactionFromAddressForWholeAmountE409.OneOf = ["InvalidData", "WalletAsAServiceAddressBalanceNotEnough", "WalletAsAServiceWalletBalanceNotEnough"];
