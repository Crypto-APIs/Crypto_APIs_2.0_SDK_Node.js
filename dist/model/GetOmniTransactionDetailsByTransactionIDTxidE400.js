...
/**
 * The GetOmniTransactionDetailsByTransactionIDTxidE400 model module.
 * @module model/GetOmniTransactionDetailsByTransactionIDTxidE400
 * @version 1.5.0
 */
var GetOmniTransactionDetailsByTransactionIDTxidE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetOmniTransactionDetailsByTransactionIDTxidE400</code>.
   * @alias module:model/GetOmniTransactionDetailsByTransactionIDTxidE400
   ...
   */
  function GetOmniTransactionDetailsByTransactionIDTxidE400(code, message) {
    _classCallCheck(this, GetOmniTransactionDetailsByTransactionIDTxidE400);
    ...
    GetOmniTransactionDetailsByTransactionIDTxidE400.initialize(this, code, message);
  }
  /**
  ...
  _createClass(GetOmniTransactionDetailsByTransactionIDTxidE400, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetOmniTransactionDetailsByTransactionIDTxidE400</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetOmniTransactionDetailsByTransactionIDTxidE400} obj Optional instance to populate.
     * @return {module:model/GetOmniTransactionDetailsByTransactionIDTxidE400} The populated <code>GetOmniTransactionDetailsByTransactionIDTxidE400</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetOmniTransactionDetailsByTransactionIDTxidE400();
  ...
  return GetOmniTransactionDetailsByTransactionIDTxidE400;
}();
/**
...
GetOmniTransactionDetailsByTransactionIDTxidE400.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

GetOmniTransactionDetailsByTransactionIDTxidE400.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetails>} details
 */

GetOmniTransactionDetailsByTransactionIDTxidE400.prototype['details'] = undefined; // Implement UriNotFound interface:
...
var _default = GetOmniTransactionDetailsByTransactionIDTxidE400;
