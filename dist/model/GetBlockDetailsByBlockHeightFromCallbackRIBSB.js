...
var GetBlockDetailsByBlockHeightFromCallbackRIBSB = /*#__PURE__*/function () {
  ...
  _createClass(GetBlockDetailsByBlockHeightFromCallbackRIBSB, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHeightFromCallbackRIBSB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHeightFromCallbackRIBSB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHeightFromCallbackRIBSB.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHeightFromCallbackRIBSB.RequiredProperties = ["bits", "chainwork", "difficulty", "merkleRoot", "nonce", "size", "strippedSize", "version", "versionHex", "weight"];
