 ...
 * @version 1.11.0
 */
var GetBlockDetailsByBlockHashFromCallbackRIBSBC = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHashFromCallbackRIBSBC</code>.
   * Bitcoin Cash
   * @alias module:model/GetBlockDetailsByBlockHashFromCallbackRIBSBC
   ...
   */
  function GetBlockDetailsByBlockHashFromCallbackRIBSBC(bits, chainwork, difficulty, merkleRoot, nonce, size, version, versionHex) {
    _classCallCheck(this, GetBlockDetailsByBlockHashFromCallbackRIBSBC);
    GetBlockDetailsByBlockHashFromCallbackRIBSBC.initialize(this, bits, chainwork, difficulty, merkleRoot, nonce, size, version, versionHex);
  }
   ...
   */
  _createClass(GetBlockDetailsByBlockHashFromCallbackRIBSBC, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHashFromCallbackRIBSBC</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHashFromCallbackRIBSBC} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHashFromCallbackRIBSBC} The populated <code>GetBlockDetailsByBlockHashFromCallbackRIBSBC</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHashFromCallbackRIBSBC();
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashFromCallbackRIBSBC.RequiredProperties),
        _step;
      try {
...
var _default = GetBlockDetailsByBlockHashFromCallbackRIBSBC;
