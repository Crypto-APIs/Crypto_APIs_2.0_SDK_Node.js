...
/**
 * The ListOmniTokensByAddressE403 model module.
 * @module model/ListOmniTokensByAddressE403
 * @version 1.6.0
 */
var ListOmniTokensByAddressE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListOmniTokensByAddressE403</code>.
   * @alias module:model/ListOmniTokensByAddressE403
   ...
   */
  function ListOmniTokensByAddressE403(code, message) {
    _classCallCheck(this, ListOmniTokensByAddressE403);
    ...
    ListOmniTokensByAddressE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListOmniTokensByAddressE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListOmniTokensByAddressE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListOmniTokensByAddressE403} obj Optional instance to populate.
     * @return {module:model/ListOmniTokensByAddressE403} The populated <code>ListOmniTokensByAddressE403</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListOmniTokensByAddressE403();
  ...
  return ListOmniTokensByAddressE403;
}();
/**
...
ListOmniTokensByAddressE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListOmniTokensByAddressE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

ListOmniTokensByAddressE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
...
var _default = ListOmniTokensByAddressE403;
