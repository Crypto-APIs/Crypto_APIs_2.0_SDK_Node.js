...
var GetBlockDetailsByBlockHashFromCallbackRIBSEC = /*#__PURE__*/function () {
   ...
   * Ethereum Classic
   * @alias module:model/GetBlockDetailsByBlockHashFromCallbackRIBSEC
   ...
   */
  function GetBlockDetailsByBlockHashFromCallbackRIBSEC(difficulty, extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty) {
    _classCallCheck(this, GetBlockDetailsByBlockHashFromCallbackRIBSEC);
    GetBlockDetailsByBlockHashFromCallbackRIBSEC.initialize(this, difficulty, extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty);
  }
   ...
   */
  _createClass(GetBlockDetailsByBlockHashFromCallbackRIBSEC, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHashFromCallbackRIBSEC</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHashFromCallbackRIBSEC} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHashFromCallbackRIBSEC} The populated <code>GetBlockDetailsByBlockHashFromCallbackRIBSEC</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHashFromCallbackRIBSEC();
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHashFromCallbackRIBSEC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHashFromCallbackRIBSEC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashFromCallbackRIBSEC.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHashFromCallbackRIBSEC.RequiredProperties = ["difficulty", "extraData", "gasLimit", "gasUsed", "minedInSeconds", "nonce", "sha3Uncles", "size", "totalDifficulty"];
...
var _default = GetBlockDetailsByBlockHashFromCallbackRIBSEC;
