...
var _NewConfirmedTokensTransactionsRBDataItem = _interopRequireDefault(require("./NewConfirmedTokensTransactionsRBDataItem"));
 ...
 * @version 1.11.0
 */
var NewConfirmedTokensTransactionsRBData = /*#__PURE__*/function () {
  /**
   ...
   */
  function NewConfirmedTokensTransactionsRBData(item) {
    _classCallCheck(this, NewConfirmedTokensTransactionsRBData);
   ...
   */
  _createClass(NewConfirmedTokensTransactionsRBData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _NewConfirmedTokensTransactionsRBDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(NewConfirmedTokensTransactionsRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _NewConfirmedTokensTransactionsRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
var _default = NewConfirmedTokensTransactionsRBData;
