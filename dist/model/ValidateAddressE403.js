 ...
 * @version 1.11.0
 */
var ValidateAddressE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ValidateAddressE403</code>.
   * @alias module:model/ValidateAddressE403
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize ValidateAddressE403.
   */
  function ValidateAddressE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, ValidateAddressE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ValidateAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ValidateAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(ValidateAddressE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ValidateAddressE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ValidateAddressE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ValidateAddressE403, "fromJSON", function (json_string) {
  return ValidateAddressE403.constructFromObject(JSON.parse(json_string));
});
...
ValidateAddressE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = ValidateAddressE403;
