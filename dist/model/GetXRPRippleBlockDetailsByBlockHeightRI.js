...
var GetXRPRippleBlockDetailsByBlockHeightRI = /*#__PURE__*/function () {
  ...
  _createClass(GetXRPRippleBlockDetailsByBlockHeightRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetXRPRippleBlockDetailsByBlockHeightRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['totalCoins']) {
        // data not null
        _GetXRPRippleBlockDetailsByBlockHeightRITotalCoins["default"].validateJSON(data['totalCoins']);
      }
