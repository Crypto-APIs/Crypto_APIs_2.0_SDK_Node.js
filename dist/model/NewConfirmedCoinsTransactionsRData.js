...
var NewConfirmedCoinsTransactionsRData = /*#__PURE__*/function () {
  ...
  _createClass(NewConfirmedCoinsTransactionsRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(NewConfirmedCoinsTransactionsRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _NewConfirmedCoinsTransactionsRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
