...
var _FreezeTronForEnergyOrBandwidthRI = _interopRequireDefault(require("./FreezeTronForEnergyOrBandwidthRI"));
 ...
 * @version 1.11.0
 */
var FreezeTronForEnergyOrBandwidthRData = /*#__PURE__*/function () {
  /**
   ...
   */
  function FreezeTronForEnergyOrBandwidthRData(item) {
    _classCallCheck(this, FreezeTronForEnergyOrBandwidthRData);
   ...
   */
  _createClass(FreezeTronForEnergyOrBandwidthRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _FreezeTronForEnergyOrBandwidthRI["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(FreezeTronForEnergyOrBandwidthRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _FreezeTronForEnergyOrBandwidthRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
  return FreezeTronForEnergyOrBandwidthRData;
}();
...
var _default = FreezeTronForEnergyOrBandwidthRData;
