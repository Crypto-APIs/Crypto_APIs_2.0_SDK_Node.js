...
var GetTransactionDetailsByTransactionIDFromCallbackRIBSZ2 = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDFromCallbackRIBSZ2, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDFromCallbackRIBSZ2.RequiredProperties),
        _step;
      try {
      ...
      if (data['gasPrice']) {
        // data not null
        _GetTransactionDetailsByTransactionIDFromCallbackRIBSZ2GasPrice["default"].validateJSON(data['gasPrice']);
      }
