...
var AddTokensToExistingFromAddress403Response = /*#__PURE__*/function () {
   ...
   */
  function AddTokensToExistingFromAddress403Response(apiVersion, requestId, error) {
    _classCallCheck(this, AddTokensToExistingFromAddress403Response);
   ...
   */
  _createClass(AddTokensToExistingFromAddress403Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>AddTokensToExistingFromAddress403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddTokensToExistingFromAddress403Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddTokensToExistingFromAddress403Response.RequiredProperties),
        _step;
      try {
...
AddTokensToExistingFromAddress403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = AddTokensToExistingFromAddress403Response;
