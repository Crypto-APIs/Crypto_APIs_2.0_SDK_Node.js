...
var GetLatestMinedZilliqaBlockRI = /*#__PURE__*/function () {
  ...
  _createClass(GetLatestMinedZilliqaBlockRI, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetLatestMinedZilliqaBlockRI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLatestMinedZilliqaBlockRI</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetLatestMinedZilliqaBlockRI.RequiredProperties),
        _step;
      try {
...
GetLatestMinedZilliqaBlockRI.RequiredProperties = ["blockHash", "blockHeight", "difficulty", "dsBlock", "dsDifficulty", "dsLeader", "gasLimit", "gasUsed", "microBlocks", "previousBlockHash", "timestamp", "transactionsCount"];
