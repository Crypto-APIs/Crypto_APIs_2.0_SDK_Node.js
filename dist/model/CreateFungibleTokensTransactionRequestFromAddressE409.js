...
var CreateFungibleTokensTransactionRequestFromAddressE409 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidData|module:model/WalletAsAServiceAddressBalanceNotEnough|module:model/WalletAsAServiceTokenNotSupported|module:model/WalletAsAServiceWalletBalanceNotEnough)} instance The actual instance to initialize CreateFungibleTokensTransactionRequestFromAddressE409.
   */
  function CreateFungibleTokensTransactionRequestFromAddressE409() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, CreateFungibleTokensTransactionRequestFromAddressE409);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `CreateFungibleTokensTransactionRequestFromAddressE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceTokenNotSupported, WalletAsAServiceWalletBalanceNotEnough. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `CreateFungibleTokensTransactionRequestFromAddressE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceTokenNotSupported, WalletAsAServiceWalletBalanceNotEnough. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(CreateFungibleTokensTransactionRequestFromAddressE409, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = CreateFungibleTokensTransactionRequestFromAddressE409.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new CreateFungibleTokensTransactionRequestFromAddressE409(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(CreateFungibleTokensTransactionRequestFromAddressE409, "fromJSON", function (json_string) {
  return CreateFungibleTokensTransactionRequestFromAddressE409.constructFromObject(JSON.parse(json_string));
});
...
CreateFungibleTokensTransactionRequestFromAddressE409.OneOf = ["InvalidData", "WalletAsAServiceAddressBalanceNotEnough", "WalletAsAServiceTokenNotSupported", "WalletAsAServiceWalletBalanceNotEnough"];
var _default = CreateFungibleTokensTransactionRequestFromAddressE409;
