...
/**
 * The ListConfirmedTransactionsByAddressRIBSZVJoinSplit model module.
 * @module model/ListConfirmedTransactionsByAddressRIBSZVJoinSplit
 * @version 1.3.0
 */
var ListConfirmedTransactionsByAddressRIBSZVJoinSplit = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListConfirmedTransactionsByAddressRIBSZVJoinSplit</code>.
   * @alias module:model/ListConfirmedTransactionsByAddressRIBSZVJoinSplit
   ...
   */
  function ListConfirmedTransactionsByAddressRIBSZVJoinSplit(anchor, cipherTexts, commitments, macs, nullifiers, oneTimePubKey, proof, randomSeed, vPubNew, vPubOld) {
    _classCallCheck(this, ListConfirmedTransactionsByAddressRIBSZVJoinSplit);

    ListConfirmedTransactionsByAddressRIBSZVJoinSplit.initialize(this, anchor, cipherTexts, commitments, macs, nullifiers, oneTimePubKey, proof, randomSeed, vPubNew, vPubOld);
  }
  /**
  ...
  _createClass(ListConfirmedTransactionsByAddressRIBSZVJoinSplit, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListConfirmedTransactionsByAddressRIBSZVJoinSplit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListConfirmedTransactionsByAddressRIBSZVJoinSplit} obj Optional instance to populate.
     * @return {module:model/ListConfirmedTransactionsByAddressRIBSZVJoinSplit} The populated <code>ListConfirmedTransactionsByAddressRIBSZVJoinSplit</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListConfirmedTransactionsByAddressRIBSZVJoinSplit();
  ...
  return ListConfirmedTransactionsByAddressRIBSZVJoinSplit;
}();
/**
...
ListConfirmedTransactionsByAddressRIBSZVJoinSplit.prototype['anchor'] = undefined;
/**
 * @member {Array.<String>} cipherTexts
 */

ListConfirmedTransactionsByAddressRIBSZVJoinSplit.prototype['cipherTexts'] = undefined;
/**
 * @member {Array.<String>} commitments
 */

ListConfirmedTransactionsByAddressRIBSZVJoinSplit.prototype['commitments'] = undefined;
/**
 * @member {Array.<String>} macs
 */

ListConfirmedTransactionsByAddressRIBSZVJoinSplit.prototype['macs'] = undefined;
/**
 * @member {Array.<String>} nullifiers
 */

ListConfirmedTransactionsByAddressRIBSZVJoinSplit.prototype['nullifiers'] = undefined;
/**
 * Defines the one time public key.
 * @member {String} oneTimePubKey
 */

ListConfirmedTransactionsByAddressRIBSZVJoinSplit.prototype['oneTimePubKey'] = undefined;
/**
 * Defines the proof.
 * @member {String} proof
 */

ListConfirmedTransactionsByAddressRIBSZVJoinSplit.prototype['proof'] = undefined;
/**
...
ListConfirmedTransactionsByAddressRIBSZVJoinSplit.prototype['randomSeed'] = undefined;
/**
...
ListConfirmedTransactionsByAddressRIBSZVJoinSplit.prototype['vPubNew'] = undefined;
/**
...
ListConfirmedTransactionsByAddressRIBSZVJoinSplit.prototype['vPubOld'] = undefined;
var _default = ListConfirmedTransactionsByAddressRIBSZVJoinSplit;
