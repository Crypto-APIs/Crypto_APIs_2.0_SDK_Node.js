...
var BannedIpAddress = /*#__PURE__*/function () {
   ...
   */
  function BannedIpAddress(code, message) {
    _classCallCheck(this, BannedIpAddress);
    BannedIpAddress.initialize(this, code, message);
  }
  ...
  _createClass(BannedIpAddress, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>BannedIpAddress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BannedIpAddress</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(BannedIpAddress.RequiredProperties),
        _step;
      try {
...
BannedIpAddress.RequiredProperties = ["code", "message"];
