...
var GetHDWalletXPubYPubZPubAssetsRIConfirmedBalance = /*#__PURE__*/function () {
  ...
  _createClass(GetHDWalletXPubYPubZPubAssetsRIConfirmedBalance, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetHDWalletXPubYPubZPubAssetsRIConfirmedBalance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetHDWalletXPubYPubZPubAssetsRIConfirmedBalance</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetHDWalletXPubYPubZPubAssetsRIConfirmedBalance.RequiredProperties),
        _step;
      try {
...
GetHDWalletXPubYPubZPubAssetsRIConfirmedBalance.RequiredProperties = ["amount", "unit"];
