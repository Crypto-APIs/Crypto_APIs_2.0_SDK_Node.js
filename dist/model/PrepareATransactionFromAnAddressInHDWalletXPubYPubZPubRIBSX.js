...
var PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSX = /*#__PURE__*/function () {
  ...
  _createClass(PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSX, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSX.RequiredProperties),
        _step;
      try {
      ...
      if (data['fee']) {
        // data not null
        _PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSXFee["default"].validateJSON(data['fee']);
      }
