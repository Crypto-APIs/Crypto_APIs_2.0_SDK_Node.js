...
var ListLatestMinedBlocksRIBSZ2 = /*#__PURE__*/function () {
  ...
  _createClass(ListLatestMinedBlocksRIBSZ2, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListLatestMinedBlocksRIBSZ2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLatestMinedBlocksRIBSZ2</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListLatestMinedBlocksRIBSZ2.RequiredProperties),
        _step;
      try {
...
ListLatestMinedBlocksRIBSZ2.RequiredProperties = ["bits", "chainwork", "difficulty", "merkleRoot", "nonce", "size", "version"];
