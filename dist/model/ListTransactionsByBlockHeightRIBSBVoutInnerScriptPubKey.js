 ...
 * @version 1.11.0
 */
var ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey(addresses, asm, hex, type) {
    _classCallCheck(this, ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey);
   ...
   */
  _createClass(ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey.RequiredProperties),
        _step;
      try {
...
ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey.RequiredProperties = ["addresses", "asm", "hex", "type"];
...
var _default = ListTransactionsByBlockHeightRIBSBVoutInnerScriptPubKey;
