...
var _GetXRPRippleBlockDetailsByBlockHashResponseItemTotalCoins = _interopRequireDefault(require("./GetXRPRippleBlockDetailsByBlockHashResponseItemTotalCoins"));
 ...
 * @version 2.0.0
 */
var GetXRPRippleBlockDetailsByBlockHashResponseItem = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetXRPRippleBlockDetailsByBlockHashResponseItem(blockHash, blockHeight, nextBlockHash, previousBlockHash, timestamp, totalCoins, totalFees, transactionsCount) {
    _classCallCheck(this, GetXRPRippleBlockDetailsByBlockHashResponseItem);
  ...
  _createClass(GetXRPRippleBlockDetailsByBlockHashResponseItem, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('totalCoins')) {
          obj['totalCoins'] = _GetXRPRippleBlockDetailsByBlockHashResponseItemTotalCoins["default"].constructFromObject(data['totalCoins']);
        }
  ...
  return GetXRPRippleBlockDetailsByBlockHashResponseItem;
}();
/**
...
var _default = GetXRPRippleBlockDetailsByBlockHashResponseItem;
