...
var _ConfirmedCoinsTransactionForCertainAmountOrHigherData = _interopRequireDefault(require("./ConfirmedCoinsTransactionForCertainAmountOrHigherData"));
...
var ConfirmedCoinsTransactionForCertainAmountOrHigher = /*#__PURE__*/function () {
   ...
   */
  function ConfirmedCoinsTransactionForCertainAmountOrHigher(apiVersion, referenceId, idempotencyKey, data) {
    _classCallCheck(this, ConfirmedCoinsTransactionForCertainAmountOrHigher);
   ...
   */
  _createClass(ConfirmedCoinsTransactionForCertainAmountOrHigher, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ConfirmedCoinsTransactionForCertainAmountOrHigherData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmedCoinsTransactionForCertainAmountOrHigher</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmedCoinsTransactionForCertainAmountOrHigher</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ConfirmedCoinsTransactionForCertainAmountOrHigher.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _ConfirmedCoinsTransactionForCertainAmountOrHigherData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
ConfirmedCoinsTransactionForCertainAmountOrHigher.RequiredProperties = ["apiVersion", "referenceId", "idempotencyKey", "data"];
...
var _default = ConfirmedCoinsTransactionForCertainAmountOrHigher;
