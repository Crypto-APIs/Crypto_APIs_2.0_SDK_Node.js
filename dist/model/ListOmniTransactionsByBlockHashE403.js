...
/**
 * The ListOmniTransactionsByBlockHashE403 model module.
 * @module model/ListOmniTransactionsByBlockHashE403
 * @version 1.5.0
 */
var ListOmniTransactionsByBlockHashE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListOmniTransactionsByBlockHashE403</code>.
   * @alias module:model/ListOmniTransactionsByBlockHashE403
   ...
   */
  function ListOmniTransactionsByBlockHashE403(code, message) {
    _classCallCheck(this, ListOmniTransactionsByBlockHashE403);
    ...
    ListOmniTransactionsByBlockHashE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListOmniTransactionsByBlockHashE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListOmniTransactionsByBlockHashE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListOmniTransactionsByBlockHashE403} obj Optional instance to populate.
     * @return {module:model/ListOmniTransactionsByBlockHashE403} The populated <code>ListOmniTransactionsByBlockHashE403</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListOmniTransactionsByBlockHashE403();
  ...
  return ListOmniTransactionsByBlockHashE403;
}();
/**
...
ListOmniTransactionsByBlockHashE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListOmniTransactionsByBlockHashE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetails>} details
 */

ListOmniTransactionsByBlockHashE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
...
var _default = ListOmniTransactionsByBlockHashE403;
