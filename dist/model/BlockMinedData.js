...
var _BlockMinedDataItem = _interopRequireDefault(require("./BlockMinedDataItem"));
 ...
 * @version 1.11.0
 */
var BlockMinedData = /*#__PURE__*/function () {
  /**
   ...
   */
  function BlockMinedData(product, event, item) {
    _classCallCheck(this, BlockMinedData);
   ...
   */
  _createClass(BlockMinedData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _BlockMinedDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(BlockMinedData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _BlockMinedDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
