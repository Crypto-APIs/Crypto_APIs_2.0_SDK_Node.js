...
/**
 * The GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin model module.
 * @module model/GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin
 * @version 2.0.0
 */
var GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin</code>.
   * Litecoin
   * @alias module:model/GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin
   ...
   */
  function GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin);

    GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight);
  }
  /**
  ...
  _createClass(GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin} obj Optional instance to populate.
     * @return {module:model/GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin} The populated <code>GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin();
  ...
  return GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin;
}();
/**
...
var _default = GetLatestMinedBlockResponseItemBlockchainSpecificLitecoin;
