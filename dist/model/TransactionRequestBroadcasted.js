...
var _TransactionRequestBroadcastedData = _interopRequireDefault(require("./TransactionRequestBroadcastedData"));
...
var TransactionRequestBroadcasted = /*#__PURE__*/function () {
   ...
   * @param data {module:model/TransactionRequestBroadcastedData} 
   */
  function TransactionRequestBroadcasted(apiVersion, referenceId, idempotencyKey, data) {
    _classCallCheck(this, TransactionRequestBroadcasted);
    TransactionRequestBroadcasted.initialize(this, apiVersion, referenceId, idempotencyKey, data);
  }
   ...
   */
  _createClass(TransactionRequestBroadcasted, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>TransactionRequestBroadcasted</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/TransactionRequestBroadcasted} obj Optional instance to populate.
     * @return {module:model/TransactionRequestBroadcasted} The populated <code>TransactionRequestBroadcasted</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TransactionRequestBroadcasted();
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _TransactionRequestBroadcastedData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TransactionRequestBroadcasted</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransactionRequestBroadcasted</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TransactionRequestBroadcasted.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _TransactionRequestBroadcastedData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
TransactionRequestBroadcasted.RequiredProperties = ["apiVersion", "referenceId", "idempotencyKey", "data"];
 ...
 */
TransactionRequestBroadcasted.prototype['referenceId'] = undefined;

/**
 * Specifies a unique ID generated by the system and attached to each callback. It is used by the server to recognize consecutive requests with the same data with the purpose not to perform the same operation twice.
 * @member {String} idempotencyKey
 */
TransactionRequestBroadcasted.prototype['idempotencyKey'] = undefined;

/**
 * @member {module:model/TransactionRequestBroadcastedData} data
 */
TransactionRequestBroadcasted.prototype['data'] = undefined;
var _default = TransactionRequestBroadcasted;
