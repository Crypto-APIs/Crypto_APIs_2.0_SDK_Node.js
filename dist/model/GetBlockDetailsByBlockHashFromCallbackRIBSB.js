...
/**
 * The GetBlockDetailsByBlockHashFromCallbackRIBSB model module.
 * @module model/GetBlockDetailsByBlockHashFromCallbackRIBSB
 * @version 1.11.0
 */
var GetBlockDetailsByBlockHashFromCallbackRIBSB = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHashFromCallbackRIBSB</code>.
   * Bitcoin
   * @alias module:model/GetBlockDetailsByBlockHashFromCallbackRIBSB
   ...
   */
  function GetBlockDetailsByBlockHashFromCallbackRIBSB(bits, chainwork, difficulty, merkleRoot, nonce, size, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, GetBlockDetailsByBlockHashFromCallbackRIBSB);
    GetBlockDetailsByBlockHashFromCallbackRIBSB.initialize(this, bits, chainwork, difficulty, merkleRoot, nonce, size, strippedSize, version, versionHex, weight);
  }
   ...
   */
  _createClass(GetBlockDetailsByBlockHashFromCallbackRIBSB, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHashFromCallbackRIBSB</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHashFromCallbackRIBSB} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHashFromCallbackRIBSB} The populated <code>GetBlockDetailsByBlockHashFromCallbackRIBSB</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHashFromCallbackRIBSB();
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHashFromCallbackRIBSB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHashFromCallbackRIBSB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashFromCallbackRIBSB.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHashFromCallbackRIBSB.RequiredProperties = ["bits", "chainwork", "difficulty", "merkleRoot", "nonce", "size", "strippedSize", "version", "versionHex", "weight"];
...
var _default = GetBlockDetailsByBlockHashFromCallbackRIBSB;
