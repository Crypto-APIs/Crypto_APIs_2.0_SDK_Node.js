...
/**
 * The GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic model module.
 * @module model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic
 * @version 2.0.0
 */
var GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic</code>.
   * Ethereum Classic
   * @alias module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic
   ...
   */
  function GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles) {
    _classCallCheck(this, GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic);

    GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic.initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles);
  }
  /**
  ...
  _createClass(GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic, null, [{
    key: "initialize",
    value: function initialize(obj, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles) {
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic} The populated <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic();
  ...
  return GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic;
}();
/**
...
var _default = GetBlockDetailsByBlockHashResponseItemBlockchainSpecificEthereumClassic;
