...
var GetHDWalletXPubYPubZPubDetails422Response = /*#__PURE__*/function () {
  ...
  _createClass(GetHDWalletXPubYPubZPubDetails422Response, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetHDWalletXPubYPubZPubDetails422Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetHDWalletXPubYPubZPubDetails422Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetHDWalletXPubYPubZPubDetails422Response.RequiredProperties),
        _step;
      try {
...
GetHDWalletXPubYPubZPubDetails422Response.RequiredProperties = ["apiVersion", "requestId", "error"];
