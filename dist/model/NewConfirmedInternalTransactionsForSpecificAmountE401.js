 ...
 * @version 1.11.0
 */
var NewConfirmedInternalTransactionsForSpecificAmountE401 = /*#__PURE__*/function () {
  /**
   ...
   * @param {(module:model/InvalidApiKey|module:model/MissingApiKey)} instance The actual instance to initialize NewConfirmedInternalTransactionsForSpecificAmountE401.
   */
  function NewConfirmedInternalTransactionsForSpecificAmountE401() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, NewConfirmedInternalTransactionsForSpecificAmountE401);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewConfirmedInternalTransactionsForSpecificAmountE401` with oneOf schemas InvalidApiKey, MissingApiKey. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewConfirmedInternalTransactionsForSpecificAmountE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(NewConfirmedInternalTransactionsForSpecificAmountE401, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewConfirmedInternalTransactionsForSpecificAmountE401.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new NewConfirmedInternalTransactionsForSpecificAmountE401(data);
    }
  }]);
  return NewConfirmedInternalTransactionsForSpecificAmountE401;
}();
/**
 * Specifies an error code, e.g. error 404.
 * @member {String} code
 */
_defineProperty(NewConfirmedInternalTransactionsForSpecificAmountE401, "fromJSON", function (json_string) {
  return NewConfirmedInternalTransactionsForSpecificAmountE401.constructFromObject(JSON.parse(json_string));
});
...
NewConfirmedInternalTransactionsForSpecificAmountE401.OneOf = ["InvalidApiKey", "MissingApiKey"];
var _default = NewConfirmedInternalTransactionsForSpecificAmountE401;
