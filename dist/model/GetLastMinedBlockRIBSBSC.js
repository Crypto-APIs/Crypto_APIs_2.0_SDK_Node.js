...
var GetLastMinedBlockRIBSBSC = /*#__PURE__*/function () {
   ...
   */
  function GetLastMinedBlockRIBSBSC(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles) {
    _classCallCheck(this, GetLastMinedBlockRIBSBSC);

    GetLastMinedBlockRIBSBSC.initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles);
  }
  /**
