...
/**
 * The MinedTransactionResponseItem model module.
 * @module model/MinedTransactionResponseItem
 * @version 2.0.0
 */
var MinedTransactionResponseItem = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>MinedTransactionResponseItem</code>.
   * @alias module:model/MinedTransactionResponseItem
   ...
   */
  function MinedTransactionResponseItem(address, callbackSecretKey, callbackUrl, confirmationsCount, createdTimestamp, eventType, isActive, referenceId, transactionId) {
    _classCallCheck(this, MinedTransactionResponseItem);

    MinedTransactionResponseItem.initialize(this, address, callbackSecretKey, callbackUrl, confirmationsCount, createdTimestamp, eventType, isActive, referenceId, transactionId);
  }
  /**
  ...
  _createClass(MinedTransactionResponseItem, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>MinedTransactionResponseItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/MinedTransactionResponseItem} obj Optional instance to populate.
     * @return {module:model/MinedTransactionResponseItem} The populated <code>MinedTransactionResponseItem</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new MinedTransactionResponseItem();
  ...
  return MinedTransactionResponseItem;
}();
/**
...
MinedTransactionResponseItem.prototype['address'] = undefined;
/**
 * Represents the Secret Key value provided by the customer. This field is used for security purposes during the callback notification, in order to prove the sender of the callback as Crypto APIs.
 * @member {String} callbackSecretKey
 */

MinedTransactionResponseItem.prototype['callbackSecretKey'] = undefined;
/**
 * Represents the URL that is set by the customer where the callback will be received at. The callback notification will be received only if and when the event occurs.
 * @member {String} callbackUrl
 */

MinedTransactionResponseItem.prototype['callbackUrl'] = undefined;
/**
 * Represents the number of confirmations, i.e. the amount of blocks that have been built on top of this block.
 * @member {Number} confirmationsCount
 */

MinedTransactionResponseItem.prototype['confirmationsCount'] = undefined;
/**
 * Defines the specific time/date when the subscription was created in Unix Timestamp.
 * @member {Number} createdTimestamp
 */

MinedTransactionResponseItem.prototype['createdTimestamp'] = undefined;
/**
 * Defines the type of the specific event available for the customer to subscribe to for callback notification.
 * @member {String} eventType
 */

MinedTransactionResponseItem.prototype['eventType'] = undefined;
/**
 * Defines whether the subscription is active or not. Set as boolean.
 * @member {Boolean} isActive
 */

MinedTransactionResponseItem.prototype['isActive'] = undefined;
/**
 * Represents a unique ID used to reference the specific callback subscription.
 * @member {String} referenceId
 */

MinedTransactionResponseItem.prototype['referenceId'] = undefined;
/**
 * Represents the unique identification string that defines the transaction.
 * @member {String} transactionId
 */

MinedTransactionResponseItem.prototype['transactionId'] = undefined;
var _default = MinedTransactionResponseItem;
