...
var ListBlockchainEventsSubscriptionsE401 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidApiKey|module:model/MissingApiKey)} instance The actual instance to initialize ListBlockchainEventsSubscriptionsE401.
   */
  function ListBlockchainEventsSubscriptionsE401() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListBlockchainEventsSubscriptionsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListBlockchainEventsSubscriptionsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(ListBlockchainEventsSubscriptionsE401, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListBlockchainEventsSubscriptionsE401.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListBlockchainEventsSubscriptionsE401(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListBlockchainEventsSubscriptionsE401, "fromJSON", function (json_string) {
  return ListBlockchainEventsSubscriptionsE401.constructFromObject(JSON.parse(json_string));
});
 ...
 */
ListBlockchainEventsSubscriptionsE401.prototype['details'] = undefined;
ListBlockchainEventsSubscriptionsE401.OneOf = ["InvalidApiKey", "MissingApiKey"];
