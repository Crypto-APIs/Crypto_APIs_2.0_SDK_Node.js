 ...
 * @version 1.11.0
 */
var CreateAutomaticTokensForwarding400Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateAutomaticTokensForwarding400Response(apiVersion, requestId, error) {
    _classCallCheck(this, CreateAutomaticTokensForwarding400Response);
   ...
   */
  _createClass(CreateAutomaticTokensForwarding400Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAutomaticTokensForwarding400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAutomaticTokensForwarding400Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateAutomaticTokensForwarding400Response.RequiredProperties),
        _step;
      try {
...
CreateAutomaticTokensForwarding400Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = CreateAutomaticTokensForwarding400Response;
