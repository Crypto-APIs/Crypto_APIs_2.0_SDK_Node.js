...
var GetTransactionDetailsByTransactionIDFromCallbackE400 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize GetTransactionDetailsByTransactionIDFromCallbackE400.
   */
  function GetTransactionDetailsByTransactionIDFromCallbackE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetTransactionDetailsByTransactionIDFromCallbackE400);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetTransactionDetailsByTransactionIDFromCallbackE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetTransactionDetailsByTransactionIDFromCallbackE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>GetTransactionDetailsByTransactionIDFromCallbackE400</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetTransactionDetailsByTransactionIDFromCallbackE400} obj Optional instance to populate.
   * @return {module:model/GetTransactionDetailsByTransactionIDFromCallbackE400} The populated <code>GetTransactionDetailsByTransactionIDFromCallbackE400</code> instance.
   */
  _createClass(GetTransactionDetailsByTransactionIDFromCallbackE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetTransactionDetailsByTransactionIDFromCallbackE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetTransactionDetailsByTransactionIDFromCallbackE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetTransactionDetailsByTransactionIDFromCallbackE400, "fromJSON", function (json_string) {
  return GetTransactionDetailsByTransactionIDFromCallbackE400.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GetTransactionDetailsByTransactionIDFromCallbackE400.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
GetTransactionDetailsByTransactionIDFromCallbackE400.prototype['details'] = undefined;
GetTransactionDetailsByTransactionIDFromCallbackE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
var _default = GetTransactionDetailsByTransactionIDFromCallbackE400;
