...
var GetEIP1559FeeRecommendationsRI = /*#__PURE__*/function () {
  ...
  _createClass(GetEIP1559FeeRecommendationsRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetEIP1559FeeRecommendationsRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['baseFeePerGas']) {
        // data not null
        _GetEIP1559FeeRecommendationsRIBaseFeePerGas["default"].validateJSON(data['baseFeePerGas']);
      }
      // validate the optional field `maxFeePerGas`
      if (data['maxFeePerGas']) {
        // data not null
        _GetEIP1559FeeRecommendationsRIMaxFeePerGas["default"].validateJSON(data['maxFeePerGas']);
      }
      // validate the optional field `maxPriorityFeePerGas`
      if (data['maxPriorityFeePerGas']) {
        // data not null
        _GetEIP1559FeeRecommendationsRIMaxPriorityFeePerGas["default"].validateJSON(data['maxPriorityFeePerGas']);
      }
      return true;
    }
  }]);
