...
var _WalletAsAServiceNoDepositAddressesFoundError = _interopRequireDefault(require("./WalletAsAServiceNoDepositAddressesFoundError"));
...
var WalletAsAServiceNoDepositAddressesFound = /*#__PURE__*/function () {
   ...
   */
  function WalletAsAServiceNoDepositAddressesFound(apiVersion, requestId, error) {
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _WalletAsAServiceNoDepositAddressesFoundError["default"].constructFromObject(data['error']);
        }
      }
