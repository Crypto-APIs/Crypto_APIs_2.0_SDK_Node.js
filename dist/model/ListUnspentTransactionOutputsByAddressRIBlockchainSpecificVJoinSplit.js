 ...
 * @version 1.3.0
 */
var ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit</code>.
   * @alias module:model/ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit
   ...
   */
  function ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit(anchor, cipherTexts, commitments, macs, nullifiers, oneTimePubKey, proof, randomSeed, vPubNew, vPubOld) {
    _classCallCheck(this, ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit);

    ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit.initialize(this, anchor, cipherTexts, commitments, macs, nullifiers, oneTimePubKey, proof, randomSeed, vPubNew, vPubOld);
  }
  /**
  ...
  _createClass(ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit} obj Optional instance to populate.
     * @return {module:model/ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit} The populated <code>ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit();
  ...
  return ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit;
}();
/**
...
ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit.prototype['anchor'] = undefined;
/**
 * @member {Array.<String>} cipherTexts
 */

ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit.prototype['cipherTexts'] = undefined;
/**
 * @member {Array.<String>} commitments
 */

ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit.prototype['commitments'] = undefined;
/**
 * @member {Array.<String>} macs
 */

ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit.prototype['macs'] = undefined;
/**
 * @member {Array.<String>} nullifiers
 */

ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit.prototype['nullifiers'] = undefined;
/**
 * Defines the one time public key.
 * @member {String} oneTimePubKey
 */

ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit.prototype['oneTimePubKey'] = undefined;
/**
 * Defines the proof.
 * @member {String} proof
 */

ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit.prototype['proof'] = undefined;
/**
...
ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit.prototype['randomSeed'] = undefined;
/**
...
ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit.prototype['vPubNew'] = undefined;
/**
...
ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit.prototype['vPubOld'] = undefined;
var _default = ListUnspentTransactionOutputsByAddressRIBlockchainSpecificVJoinSplit;
