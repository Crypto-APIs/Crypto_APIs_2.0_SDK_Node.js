...
var _CreateTokensTransactionRequestFromAddressRBDataItem = _interopRequireDefault(require("./CreateTokensTransactionRequestFromAddressRBDataItem"));
...
var CreateTokensTransactionRequestFromAddressRBData = /*#__PURE__*/function () {
   ...
   */
  function CreateTokensTransactionRequestFromAddressRBData(item) {
    _classCallCheck(this, CreateTokensTransactionRequestFromAddressRBData);
  ...
  _createClass(CreateTokensTransactionRequestFromAddressRBData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _CreateTokensTransactionRequestFromAddressRBDataItem["default"].constructFromObject(data['item']);
        }
      }
  ...
  return CreateTokensTransactionRequestFromAddressRBData;
}();
/**
...
var _default = CreateTokensTransactionRequestFromAddressRBData;
