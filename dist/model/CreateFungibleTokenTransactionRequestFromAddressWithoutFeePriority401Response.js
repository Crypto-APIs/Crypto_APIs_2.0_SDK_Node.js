...
var _CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE = _interopRequireDefault(require("./CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE401"));
...
var CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response = /*#__PURE__*/function () {
   ...
   */
  function CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response(apiVersion, requestId, error) {
    _classCallCheck(this, CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response);
   ...
   */
  _createClass(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response.RequiredProperties),
        _step;
      try {
...
CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority401Response;
