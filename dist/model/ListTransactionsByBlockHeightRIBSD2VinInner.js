...
var ListTransactionsByBlockHeightRIBSD2VinInner = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHeightRIBSD2VinInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRIBSD2VinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRIBSD2VinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSD2VinInner.RequiredProperties),
        _step;
      try {
...
ListTransactionsByBlockHeightRIBSD2VinInner.RequiredProperties = ["addresses", "scriptSig", "sequence", "txinwitness", "value", "vout"];
