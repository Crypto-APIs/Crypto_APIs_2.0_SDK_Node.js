...
var AddressTokensTransactionConfirmedEachConfirmationErc20 = /*#__PURE__*/function () {
  ...
  _createClass(AddressTokensTransactionConfirmedEachConfirmationErc20, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddressTokensTransactionConfirmedEachConfirmationErc20</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressTokensTransactionConfirmedEachConfirmationErc20</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressTokensTransactionConfirmedEachConfirmationErc20.RequiredProperties),
        _step;
      try {
...
AddressTokensTransactionConfirmedEachConfirmationErc20.RequiredProperties = ["name", "symbol", "amount", "contractAddress"];
