...
var ListTransactionsByBlockHeightRIBSBSCGasPrice = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHeightRIBSBSCGasPrice, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRIBSBSCGasPrice</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRIBSBSCGasPrice</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSBSCGasPrice.RequiredProperties),
        _step;
      try {
...
ListTransactionsByBlockHeightRIBSBSCGasPrice.RequiredProperties = ["amount", "unit"];
