...
var ValidateAddressRB = /*#__PURE__*/function () {
  ...
  _createClass(ValidateAddressRB, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ValidateAddressRB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ValidateAddressRB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ValidateAddressRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _ValidateAddressRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
ValidateAddressRB.RequiredProperties = ["data"];
