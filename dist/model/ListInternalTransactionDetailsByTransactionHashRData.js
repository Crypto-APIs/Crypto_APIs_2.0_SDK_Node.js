...
var ListInternalTransactionDetailsByTransactionHashRData = /*#__PURE__*/function () {
  ...
  _createClass(ListInternalTransactionDetailsByTransactionHashRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListInternalTransactionDetailsByTransactionHashRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListInternalTransactionDetailsByTransactionHashRI["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
