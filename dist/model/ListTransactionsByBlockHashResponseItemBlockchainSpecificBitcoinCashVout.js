...
var _ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey = _interopRequireDefault(require("./ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey"));
 ...
 * @version 2.0.0
 */
var ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout(isSpent, scriptPubKey, value) {
    _classCallCheck(this, ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout);
  ...
  _createClass(ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('scriptPubKey')) {
          obj['scriptPubKey'] = _ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashScriptPubKey["default"].constructFromObject(data['scriptPubKey']);
        }
  ...
  return ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout;
}();
/**
...
var _default = ListTransactionsByBlockHashResponseItemBlockchainSpecificBitcoinCashVout;
