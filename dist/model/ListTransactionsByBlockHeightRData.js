...
var _ListTransactionsByBlockHeightRI = _interopRequireDefault(require("./ListTransactionsByBlockHeightRI"));
 ...
 * @version 1.11.0
 */
var ListTransactionsByBlockHeightRData = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListTransactionsByBlockHeightRData(limit, offset, total, items) {
    _classCallCheck(this, ListTransactionsByBlockHeightRData);
   ...
   */
  _createClass(ListTransactionsByBlockHeightRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('items')) {
          obj['items'] = _ApiClient["default"].convertToType(data['items'], [_ListTransactionsByBlockHeightRI["default"]]);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListTransactionsByBlockHeightRI["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
ListTransactionsByBlockHeightRData.RequiredProperties = ["limit", "offset", "total", "items"];
...
var _default = ListTransactionsByBlockHeightRData;
