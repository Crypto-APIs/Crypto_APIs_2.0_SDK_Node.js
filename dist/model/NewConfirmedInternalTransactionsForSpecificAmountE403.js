...
/**
 * The NewConfirmedInternalTransactionsForSpecificAmountE403 model module.
 * @module model/NewConfirmedInternalTransactionsForSpecificAmountE403
 * @version 1.11.0
 */
var NewConfirmedInternalTransactionsForSpecificAmountE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>NewConfirmedInternalTransactionsForSpecificAmountE403</code>.
   * @alias module:model/NewConfirmedInternalTransactionsForSpecificAmountE403
   * @param {(module:model/BannedIpAddress|module:model/BlockchainEventsCallbacksLimitReached|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize NewConfirmedInternalTransactionsForSpecificAmountE403.
   */
  function NewConfirmedInternalTransactionsForSpecificAmountE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, NewConfirmedInternalTransactionsForSpecificAmountE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewConfirmedInternalTransactionsForSpecificAmountE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewConfirmedInternalTransactionsForSpecificAmountE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>NewConfirmedInternalTransactionsForSpecificAmountE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NewConfirmedInternalTransactionsForSpecificAmountE403} obj Optional instance to populate.
   * @return {module:model/NewConfirmedInternalTransactionsForSpecificAmountE403} The populated <code>NewConfirmedInternalTransactionsForSpecificAmountE403</code> instance.
   */
  _createClass(NewConfirmedInternalTransactionsForSpecificAmountE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewConfirmedInternalTransactionsForSpecificAmountE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new NewConfirmedInternalTransactionsForSpecificAmountE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(NewConfirmedInternalTransactionsForSpecificAmountE403, "fromJSON", function (json_string) {
  return NewConfirmedInternalTransactionsForSpecificAmountE403.constructFromObject(JSON.parse(json_string));
});
NewConfirmedInternalTransactionsForSpecificAmountE403.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
NewConfirmedInternalTransactionsForSpecificAmountE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
NewConfirmedInternalTransactionsForSpecificAmountE403.prototype['details'] = undefined;
NewConfirmedInternalTransactionsForSpecificAmountE403.OneOf = ["BannedIpAddress", "BlockchainEventsCallbacksLimitReached", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = NewConfirmedInternalTransactionsForSpecificAmountE403;
