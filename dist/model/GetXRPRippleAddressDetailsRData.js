...
var GetXRPRippleAddressDetailsRData = /*#__PURE__*/function () {
  ...
  _createClass(GetXRPRippleAddressDetailsRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetXRPRippleAddressDetailsRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _GetXRPRippleAddressDetailsRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
