...
/**
 * The ListTransactionsByBlockHashResponseItemBlockchainSpecificDash model module.
 * @module model/ListTransactionsByBlockHashResponseItemBlockchainSpecificDash
 * @version 2.0.0
 */
var ListTransactionsByBlockHashResponseItemBlockchainSpecificDash = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListTransactionsByBlockHashResponseItemBlockchainSpecificDash</code>.
   * Dash
   * @alias module:model/ListTransactionsByBlockHashResponseItemBlockchainSpecificDash
   ...
   */
  function ListTransactionsByBlockHashResponseItemBlockchainSpecificDash(locktime, size, version, vin, vout) {
    _classCallCheck(this, ListTransactionsByBlockHashResponseItemBlockchainSpecificDash);

    ListTransactionsByBlockHashResponseItemBlockchainSpecificDash.initialize(this, locktime, size, version, vin, vout);
  }
  /**
  ...
  _createClass(ListTransactionsByBlockHashResponseItemBlockchainSpecificDash, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListTransactionsByBlockHashResponseItemBlockchainSpecificDash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTransactionsByBlockHashResponseItemBlockchainSpecificDash} obj Optional instance to populate.
     * @return {module:model/ListTransactionsByBlockHashResponseItemBlockchainSpecificDash} The populated <code>ListTransactionsByBlockHashResponseItemBlockchainSpecificDash</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListTransactionsByBlockHashResponseItemBlockchainSpecificDash();
  ...
  return ListTransactionsByBlockHashResponseItemBlockchainSpecificDash;
}();
/**
...
var _default = ListTransactionsByBlockHashResponseItemBlockchainSpecificDash;
