...
/**
 * The GetAddressDetailsE403 model module.
 * @module model/GetAddressDetailsE403
 * @version 1.11.0
 */
var GetAddressDetailsE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetAddressDetailsE403</code>.
   * @alias module:model/GetAddressDetailsE403
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize GetAddressDetailsE403.
   */
  function GetAddressDetailsE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetAddressDetailsE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetAddressDetailsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetAddressDetailsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>GetAddressDetailsE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetAddressDetailsE403} obj Optional instance to populate.
   * @return {module:model/GetAddressDetailsE403} The populated <code>GetAddressDetailsE403</code> instance.
   */
  _createClass(GetAddressDetailsE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetAddressDetailsE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetAddressDetailsE403(data);
    }
  }]);
  return GetAddressDetailsE403;
}();
/**
 * Specifies an error code, e.g. error 404.
 * @member {String} code
 */
_defineProperty(GetAddressDetailsE403, "fromJSON", function (json_string) {
  return GetAddressDetailsE403.constructFromObject(JSON.parse(json_string));
});
GetAddressDetailsE403.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
GetAddressDetailsE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
GetAddressDetailsE403.prototype['details'] = undefined;
GetAddressDetailsE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = GetAddressDetailsE403;
