...
var GetXRPRippleBlockDetailsByBlockHashE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize GetXRPRippleBlockDetailsByBlockHashE403.
   */
  function GetXRPRippleBlockDetailsByBlockHashE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetXRPRippleBlockDetailsByBlockHashE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetXRPRippleBlockDetailsByBlockHashE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetXRPRippleBlockDetailsByBlockHashE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>GetXRPRippleBlockDetailsByBlockHashE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetXRPRippleBlockDetailsByBlockHashE403} obj Optional instance to populate.
   * @return {module:model/GetXRPRippleBlockDetailsByBlockHashE403} The populated <code>GetXRPRippleBlockDetailsByBlockHashE403</code> instance.
   */
  _createClass(GetXRPRippleBlockDetailsByBlockHashE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetXRPRippleBlockDetailsByBlockHashE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetXRPRippleBlockDetailsByBlockHashE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetXRPRippleBlockDetailsByBlockHashE403, "fromJSON", function (json_string) {
  return GetXRPRippleBlockDetailsByBlockHashE403.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GetXRPRippleBlockDetailsByBlockHashE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
GetXRPRippleBlockDetailsByBlockHashE403.prototype['details'] = undefined;
GetXRPRippleBlockDetailsByBlockHashE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = GetXRPRippleBlockDetailsByBlockHashE403;
