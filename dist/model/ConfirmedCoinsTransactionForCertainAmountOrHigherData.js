...
var ConfirmedCoinsTransactionForCertainAmountOrHigherData = /*#__PURE__*/function () {
  ...
  _createClass(ConfirmedCoinsTransactionForCertainAmountOrHigherData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmedCoinsTransactionForCertainAmountOrHigherData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmedCoinsTransactionForCertainAmountOrHigherData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ConfirmedCoinsTransactionForCertainAmountOrHigherData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _ConfirmedCoinsTransactionForCertainAmountOrHigherDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
ConfirmedCoinsTransactionForCertainAmountOrHigherData.RequiredProperties = ["product", "event", "item"];
