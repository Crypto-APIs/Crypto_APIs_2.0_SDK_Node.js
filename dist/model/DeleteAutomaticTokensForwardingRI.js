...
var DeleteAutomaticTokensForwardingRI = /*#__PURE__*/function () {
  ...
  _createClass(DeleteAutomaticTokensForwardingRI, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAutomaticTokensForwardingRI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAutomaticTokensForwardingRI</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(DeleteAutomaticTokensForwardingRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['tokenData']) {
        // data not null
        _DeleteAutomaticTokensForwardingRITS["default"].validateJSON(data['tokenData']);
      }
      return true;
    }
  }]);
...
DeleteAutomaticTokensForwardingRI.RequiredProperties = ["callbackUrl", "confirmationsCount", "createdTimestamp", "feeAddress", "feePriority", "fromAddress", "minimumTransferAmount", "referenceId", "toAddress", "tokenData"];
