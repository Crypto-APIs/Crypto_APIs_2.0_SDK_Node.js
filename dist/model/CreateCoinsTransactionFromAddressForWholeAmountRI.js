...
var CreateCoinsTransactionFromAddressForWholeAmountRI = /*#__PURE__*/function () {
  ...
  _createClass(CreateCoinsTransactionFromAddressForWholeAmountRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateCoinsTransactionFromAddressForWholeAmountRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['recipients']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _CreateCoinsTransactionFromAddressForWholeAmountRIRecipientsInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['senders']) {
        // data not null
        _CreateCoinsTransactionFromAddressForWholeAmountRISenders["default"].validateJSON(data['senders']);
      }
      // ensure the json data is a string
