...
var ListInternalTransactionsByAddressAndTimeRangeRData = /*#__PURE__*/function () {
  ...
  _createClass(ListInternalTransactionsByAddressAndTimeRangeRData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListInternalTransactionsByAddressAndTimeRangeRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListInternalTransactionsByAddressAndTimeRangeRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListInternalTransactionsByAddressAndTimeRangeRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListInternalTransactionsByAddressAndTimeRangeRI["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
ListInternalTransactionsByAddressAndTimeRangeRData.RequiredProperties = ["limit", "offset", "total", "items"];
