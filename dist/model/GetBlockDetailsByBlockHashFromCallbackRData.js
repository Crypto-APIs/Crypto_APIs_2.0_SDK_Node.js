...
var GetBlockDetailsByBlockHashFromCallbackRData = /*#__PURE__*/function () {
  ...
  _createClass(GetBlockDetailsByBlockHashFromCallbackRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashFromCallbackRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _GetBlockDetailsByBlockHashFromCallbackRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
