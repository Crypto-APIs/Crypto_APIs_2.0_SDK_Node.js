...
/**
 * The ListUnconfirmedOmniTransactionsByAddressE403 model module.
 * @module model/ListUnconfirmedOmniTransactionsByAddressE403
 * @version 1.4.0
 */
var ListUnconfirmedOmniTransactionsByAddressE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListUnconfirmedOmniTransactionsByAddressE403</code>.
   * @alias module:model/ListUnconfirmedOmniTransactionsByAddressE403
   ...
   */
  function ListUnconfirmedOmniTransactionsByAddressE403(code, message) {
    _classCallCheck(this, ListUnconfirmedOmniTransactionsByAddressE403);
    ...
    ListUnconfirmedOmniTransactionsByAddressE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListUnconfirmedOmniTransactionsByAddressE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListUnconfirmedOmniTransactionsByAddressE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUnconfirmedOmniTransactionsByAddressE403} obj Optional instance to populate.
     * @return {module:model/ListUnconfirmedOmniTransactionsByAddressE403} The populated <code>ListUnconfirmedOmniTransactionsByAddressE403</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListUnconfirmedOmniTransactionsByAddressE403();
...
ListUnconfirmedOmniTransactionsByAddressE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListUnconfirmedOmniTransactionsByAddressE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetails>} details
 */

ListUnconfirmedOmniTransactionsByAddressE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
...
var _default = ListUnconfirmedOmniTransactionsByAddressE403;
