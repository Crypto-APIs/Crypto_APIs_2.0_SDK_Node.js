...
var ListTransactionsByBlockHashRIBSD2VinInner = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHashRIBSD2VinInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHashRIBSD2VinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHashRIBSD2VinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIBSD2VinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _ListTransactionsByBlockHashRIBSD2VinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
      // ensure the json data is a string
...
ListTransactionsByBlockHashRIBSD2VinInner.RequiredProperties = ["addresses", "scriptSig", "sequence", "txinwitness", "vout"];
