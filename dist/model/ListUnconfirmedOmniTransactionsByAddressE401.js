 ...
 * @version 1.5.0
 */
var ListUnconfirmedOmniTransactionsByAddressE401 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListUnconfirmedOmniTransactionsByAddressE401</code>.
   * @alias module:model/ListUnconfirmedOmniTransactionsByAddressE401
   * @implements module:model/MissingApiKey
   * @implements module:model/InvalidApiKey
   * @param code {String} Specifies an error code, e.g. error 404.
   * @param message {String} Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
   */
  function ListUnconfirmedOmniTransactionsByAddressE401(code, message) {
    _classCallCheck(this, ListUnconfirmedOmniTransactionsByAddressE401);

    _MissingApiKey["default"].initialize(this, code, message);

    _InvalidApiKey["default"].initialize(this, code, message);

    ListUnconfirmedOmniTransactionsByAddressE401.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListUnconfirmedOmniTransactionsByAddressE401, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListUnconfirmedOmniTransactionsByAddressE401</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUnconfirmedOmniTransactionsByAddressE401} obj Optional instance to populate.
     * @return {module:model/ListUnconfirmedOmniTransactionsByAddressE401} The populated <code>ListUnconfirmedOmniTransactionsByAddressE401</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListUnconfirmedOmniTransactionsByAddressE401();
...
ListUnconfirmedOmniTransactionsByAddressE401.prototype['code'] = undefined;
/**
...
ListUnconfirmedOmniTransactionsByAddressE401.prototype['details'] = undefined; // Implement MissingApiKey interface:
...
var _default = ListUnconfirmedOmniTransactionsByAddressE401;
