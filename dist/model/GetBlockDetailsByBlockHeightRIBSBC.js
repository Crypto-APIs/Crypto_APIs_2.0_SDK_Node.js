 ...
 * @version 1.11.0
 */
var GetBlockDetailsByBlockHeightRIBSBC = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHeightRIBSBC</code>.
   * Bitcoin Cash
   * @alias module:model/GetBlockDetailsByBlockHeightRIBSBC
   ...
   */
  function GetBlockDetailsByBlockHeightRIBSBC(difficulty, bits, chainwork, merkleRoot, nonce, size, version, versionHex) {
    _classCallCheck(this, GetBlockDetailsByBlockHeightRIBSBC);
    GetBlockDetailsByBlockHeightRIBSBC.initialize(this, difficulty, bits, chainwork, merkleRoot, nonce, size, version, versionHex);
  }
   ...
   */
  _createClass(GetBlockDetailsByBlockHeightRIBSBC, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHeightRIBSBC</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHeightRIBSBC} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHeightRIBSBC} The populated <code>GetBlockDetailsByBlockHeightRIBSBC</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHeightRIBSBC();
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHeightRIBSBC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHeightRIBSBC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHeightRIBSBC.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHeightRIBSBC.RequiredProperties = ["difficulty", "bits", "chainwork", "merkleRoot", "nonce", "size", "version", "versionHex"];
...
var _default = GetBlockDetailsByBlockHeightRIBSBC;
