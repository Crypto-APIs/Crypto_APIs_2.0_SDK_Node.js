...
var _CreateCoinsTransactionRequestFromAddressRI = _interopRequireDefault(require("./CreateCoinsTransactionRequestFromAddressRI"));
 ...
 * @version 1.11.0
 */
var CreateCoinsTransactionRequestFromAddressRData = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateCoinsTransactionRequestFromAddressRData(item) {
    _classCallCheck(this, CreateCoinsTransactionRequestFromAddressRData);
   ...
   */
  _createClass(CreateCoinsTransactionRequestFromAddressRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _CreateCoinsTransactionRequestFromAddressRI["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCoinsTransactionRequestFromAddressRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCoinsTransactionRequestFromAddressRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateCoinsTransactionRequestFromAddressRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _CreateCoinsTransactionRequestFromAddressRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
CreateCoinsTransactionRequestFromAddressRData.RequiredProperties = ["item"];
...
var _default = CreateCoinsTransactionRequestFromAddressRData;
