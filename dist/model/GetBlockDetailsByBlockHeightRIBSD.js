...
var GetBlockDetailsByBlockHeightRIBSD = /*#__PURE__*/function () {
   ...
   */
  function GetBlockDetailsByBlockHeightRIBSD(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, weight) {
    _classCallCheck(this, GetBlockDetailsByBlockHeightRIBSD);

    GetBlockDetailsByBlockHeightRIBSD.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, weight);
  }
  /**
