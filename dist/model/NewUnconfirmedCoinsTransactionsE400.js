 ...
 * @version 1.11.0
 */
var NewUnconfirmedCoinsTransactionsE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>NewUnconfirmedCoinsTransactionsE400</code>.
   * @alias module:model/NewUnconfirmedCoinsTransactionsE400
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize NewUnconfirmedCoinsTransactionsE400.
   */
  function NewUnconfirmedCoinsTransactionsE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, NewUnconfirmedCoinsTransactionsE400);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewUnconfirmedCoinsTransactionsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewUnconfirmedCoinsTransactionsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>NewUnconfirmedCoinsTransactionsE400</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NewUnconfirmedCoinsTransactionsE400} obj Optional instance to populate.
   * @return {module:model/NewUnconfirmedCoinsTransactionsE400} The populated <code>NewUnconfirmedCoinsTransactionsE400</code> instance.
   */
  _createClass(NewUnconfirmedCoinsTransactionsE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewUnconfirmedCoinsTransactionsE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new NewUnconfirmedCoinsTransactionsE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(NewUnconfirmedCoinsTransactionsE400, "fromJSON", function (json_string) {
  return NewUnconfirmedCoinsTransactionsE400.constructFromObject(JSON.parse(json_string));
});
NewUnconfirmedCoinsTransactionsE400.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
NewUnconfirmedCoinsTransactionsE400.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
NewUnconfirmedCoinsTransactionsE400.prototype['details'] = undefined;
NewUnconfirmedCoinsTransactionsE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
var _default = NewUnconfirmedCoinsTransactionsE400;
