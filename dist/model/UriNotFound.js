...
var _UriNotFoundError = _interopRequireDefault(require("./UriNotFoundError"));
...
var UriNotFound = /*#__PURE__*/function () {
   ...
   * @param error {module:model/UriNotFoundError} 
   */
  function UriNotFound(apiVersion, requestId, error) {
    _classCallCheck(this, UriNotFound);

    UriNotFound.initialize(this, apiVersion, requestId, error);
  }
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _UriNotFoundError["default"].constructFromObject(data['error']);
        }
      }
...
UriNotFound.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

UriNotFound.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

UriNotFound.prototype['context'] = undefined;
/**
 * @member {module:model/UriNotFoundError} error
 */

UriNotFound.prototype['error'] = undefined;
