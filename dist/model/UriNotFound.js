...
var UriNotFound = /*#__PURE__*/function () {
  ...
  _createClass(UriNotFound, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>UriNotFound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>UriNotFound</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(UriNotFound.RequiredProperties),
        _step;
      try {
...
UriNotFound.RequiredProperties = ["code", "message"];
