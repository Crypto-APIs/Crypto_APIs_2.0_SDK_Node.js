...
/**
 * The ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic model module.
 * @module model/ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic
 * @version 2.0.0
 */
var ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic</code>.
   * Ethereum Classic
   * @alias module:model/ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic
   ...
   */
  function ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic(contract, gasLimit, gasPrice, gasUsed, inputData, nonce, transactionStatus) {
    _classCallCheck(this, ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic);

    ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic.initialize(this, contract, gasLimit, gasPrice, gasUsed, inputData, nonce, transactionStatus);
  }
  /**
  ...
  _createClass(ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic} obj Optional instance to populate.
     * @return {module:model/ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic} The populated <code>ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic();
  ...
  return ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic;
}();
/**
...
var _default = ListTransactionsByBlockHashResponseItemBlockchainSpecificEthereumClassic;
