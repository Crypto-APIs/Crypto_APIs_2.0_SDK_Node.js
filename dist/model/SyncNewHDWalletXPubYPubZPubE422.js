...
var SyncNewHDWalletXPubYPubZPubE422 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidRequestBodyStructure|module:model/XpubSyncInProgress)} instance The actual instance to initialize SyncNewHDWalletXPubYPubZPubE422.
   */
  function SyncNewHDWalletXPubYPubZPubE422() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `SyncNewHDWalletXPubYPubZPubE422` with oneOf schemas InvalidRequestBodyStructure, XpubSyncInProgress. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `SyncNewHDWalletXPubYPubZPubE422` with oneOf schemas InvalidRequestBodyStructure, XpubSyncInProgress. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(SyncNewHDWalletXPubYPubZPubE422, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = SyncNewHDWalletXPubYPubZPubE422.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new SyncNewHDWalletXPubYPubZPubE422(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(SyncNewHDWalletXPubYPubZPubE422, "fromJSON", function (json_string) {
  return SyncNewHDWalletXPubYPubZPubE422.constructFromObject(JSON.parse(json_string));
});
 ...
 */
SyncNewHDWalletXPubYPubZPubE422.prototype['details'] = undefined;
SyncNewHDWalletXPubYPubZPubE422.OneOf = ["InvalidRequestBodyStructure", "XpubSyncInProgress"];
