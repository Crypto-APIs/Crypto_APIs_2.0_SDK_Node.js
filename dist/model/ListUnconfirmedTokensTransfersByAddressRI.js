...
var ListUnconfirmedTokensTransfersByAddressRI = /*#__PURE__*/function () {
  ...
  _createClass(ListUnconfirmedTokensTransfersByAddressRI, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListUnconfirmedTokensTransfersByAddressRI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUnconfirmedTokensTransfersByAddressRI</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListUnconfirmedTokensTransfersByAddressRI.RequiredProperties),
        _step;
      try {
...
ListUnconfirmedTokensTransfersByAddressRI.RequiredProperties = ["contractAddress", "recipientAddress", "senderAddress", "tokenDecimals", "tokenName", "tokenSymbol", "tokenType", "transactionHash", "transactionTimestamp"];
