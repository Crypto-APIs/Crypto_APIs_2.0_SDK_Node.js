...
var ListConfirmedTransactionsByAddressRIBSD = /*#__PURE__*/function () {
  ...
  _createClass(ListConfirmedTransactionsByAddressRIBSD, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListConfirmedTransactionsByAddressRIBSD</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListConfirmedTransactionsByAddressRIBSD</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListConfirmedTransactionsByAddressRIBSD.RequiredProperties),
        _step;
      try {
...
ListConfirmedTransactionsByAddressRIBSD.RequiredProperties = ["locktime", "size", "version", "vin", "vout"];
