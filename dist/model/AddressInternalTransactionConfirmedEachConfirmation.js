...
var AddressInternalTransactionConfirmedEachConfirmation = /*#__PURE__*/function () {
  ...
  _createClass(AddressInternalTransactionConfirmedEachConfirmation, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddressInternalTransactionConfirmedEachConfirmation</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressInternalTransactionConfirmedEachConfirmation</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressInternalTransactionConfirmedEachConfirmation.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _AddressInternalTransactionConfirmedEachConfirmationData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
AddressInternalTransactionConfirmedEachConfirmation.RequiredProperties = ["apiVersion", "referenceId", "idempotencyKey", "data"];
