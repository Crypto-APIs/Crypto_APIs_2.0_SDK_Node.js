...
var AddressInternalTransactionConfirmedData = /*#__PURE__*/function () {
  ...
  _createClass(AddressInternalTransactionConfirmedData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddressInternalTransactionConfirmedData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressInternalTransactionConfirmedData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressInternalTransactionConfirmedData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _AddressInternalTransactionConfirmedDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
AddressInternalTransactionConfirmedData.RequiredProperties = ["product", "event", "item"];
