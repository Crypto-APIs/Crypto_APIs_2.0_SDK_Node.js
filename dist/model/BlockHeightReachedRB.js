...
var _BlockHeightReachedRBData = _interopRequireDefault(require("./BlockHeightReachedRBData"));
...
var BlockHeightReachedRB = /*#__PURE__*/function () {
   ...
   */
  function BlockHeightReachedRB(data) {
    _classCallCheck(this, BlockHeightReachedRB);
   ...
   */
  _createClass(BlockHeightReachedRB, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _BlockHeightReachedRBData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BlockHeightReachedRB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlockHeightReachedRB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(BlockHeightReachedRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _BlockHeightReachedRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
BlockHeightReachedRB.RequiredProperties = ["data"];
...
var _default = BlockHeightReachedRB;
