 ...
 * @version 1.7.2
 */
var ListAllUnconfirmedTransactionsE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListAllUnconfirmedTransactionsE403</code>.
   * @alias module:model/ListAllUnconfirmedTransactionsE403
   ...
   */
  function ListAllUnconfirmedTransactionsE403(code, message) {
    _classCallCheck(this, ListAllUnconfirmedTransactionsE403);
    ...
    ListAllUnconfirmedTransactionsE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListAllUnconfirmedTransactionsE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListAllUnconfirmedTransactionsE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAllUnconfirmedTransactionsE403} obj Optional instance to populate.
     * @return {module:model/ListAllUnconfirmedTransactionsE403} The populated <code>ListAllUnconfirmedTransactionsE403</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListAllUnconfirmedTransactionsE403();
  ...
  return ListAllUnconfirmedTransactionsE403;
}();
/**
...
ListAllUnconfirmedTransactionsE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListAllUnconfirmedTransactionsE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

ListAllUnconfirmedTransactionsE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
...
var _default = ListAllUnconfirmedTransactionsE403;
