...
var CreateCoinsTransactionRequestFromWalletRB = /*#__PURE__*/function () {
  ...
  _createClass(CreateCoinsTransactionRequestFromWalletRB, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCoinsTransactionRequestFromWalletRB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCoinsTransactionRequestFromWalletRB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateCoinsTransactionRequestFromWalletRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _CreateCoinsTransactionRequestFromWalletRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
CreateCoinsTransactionRequestFromWalletRB.RequiredProperties = ["data"];
