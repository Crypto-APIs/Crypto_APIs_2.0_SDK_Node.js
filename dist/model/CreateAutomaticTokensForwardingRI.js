...
var CreateAutomaticTokensForwardingRI = /*#__PURE__*/function () {
  ...
  _createClass(CreateAutomaticTokensForwardingRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateAutomaticTokensForwardingRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['tokenData']) {
        // data not null
        _CreateAutomaticTokensForwardingRITS["default"].validateJSON(data['tokenData']);
      }
      return true;
    }
  }]);
