...
var NewConfirmedTokensTransactionsAndEachConfirmationRBData = /*#__PURE__*/function () {
  ...
  _createClass(NewConfirmedTokensTransactionsAndEachConfirmationRBData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>NewConfirmedTokensTransactionsAndEachConfirmationRBData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewConfirmedTokensTransactionsAndEachConfirmationRBData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewConfirmedTokensTransactionsAndEachConfirmationRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _NewConfirmedTokensTransactionsAndEachConfirmationRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
NewConfirmedTokensTransactionsAndEachConfirmationRBData.RequiredProperties = ["item"];
