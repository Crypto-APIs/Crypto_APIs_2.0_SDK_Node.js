...
var ListSyncedAddressesE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListSyncedAddressesE403</code>.
   * @alias module:model/ListSyncedAddressesE403
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize ListSyncedAddressesE403.
   */
  function ListSyncedAddressesE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, ListSyncedAddressesE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListSyncedAddressesE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListSyncedAddressesE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>ListSyncedAddressesE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListSyncedAddressesE403} obj Optional instance to populate.
   * @return {module:model/ListSyncedAddressesE403} The populated <code>ListSyncedAddressesE403</code> instance.
   */
  _createClass(ListSyncedAddressesE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListSyncedAddressesE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListSyncedAddressesE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListSyncedAddressesE403, "fromJSON", function (json_string) {
  return ListSyncedAddressesE403.constructFromObject(JSON.parse(json_string));
});
ListSyncedAddressesE403.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
ListSyncedAddressesE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
ListSyncedAddressesE403.prototype['details'] = undefined;
ListSyncedAddressesE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = ListSyncedAddressesE403;
