...
var DecodeRawTransactionHexE400 = /*#__PURE__*/function () {
   ...
   * @implements module:model/InvalidTransactionHex
   * @param code {String} Specifies an error code, e.g. error 404.
   * @param message {String} Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
   */
  function DecodeRawTransactionHexE400(code, message) {
    ...
    _InvalidTransactionHex["default"].initialize(this, code, message);
    DecodeRawTransactionHexE400.initialize(this, code, message);
  }
   ...
   */
  _createClass(DecodeRawTransactionHexE400, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new DecodeRawTransactionHexE400();
        ...
        _InvalidTransactionHex["default"].constructFromObject(data, obj);
 ...
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
_InvalidBlockchain["default"].prototype['details'] = undefined;
...
// Implement InvalidTransactionHex interface:
/**
 * Specifies an error code, e.g. error 404.
 * @member {String} code
 */
_InvalidTransactionHex["default"].prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
