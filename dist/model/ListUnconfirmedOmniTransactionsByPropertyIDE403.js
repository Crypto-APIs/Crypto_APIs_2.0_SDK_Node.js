...
/**
 * The ListUnconfirmedOmniTransactionsByPropertyIDE403 model module.
 * @module model/ListUnconfirmedOmniTransactionsByPropertyIDE403
 * @version 1.5.0
 */
var ListUnconfirmedOmniTransactionsByPropertyIDE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListUnconfirmedOmniTransactionsByPropertyIDE403</code>.
   * @alias module:model/ListUnconfirmedOmniTransactionsByPropertyIDE403
   ...
   */
  function ListUnconfirmedOmniTransactionsByPropertyIDE403(code, message) {
    _classCallCheck(this, ListUnconfirmedOmniTransactionsByPropertyIDE403);
    ...
    ListUnconfirmedOmniTransactionsByPropertyIDE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListUnconfirmedOmniTransactionsByPropertyIDE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListUnconfirmedOmniTransactionsByPropertyIDE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUnconfirmedOmniTransactionsByPropertyIDE403} obj Optional instance to populate.
     * @return {module:model/ListUnconfirmedOmniTransactionsByPropertyIDE403} The populated <code>ListUnconfirmedOmniTransactionsByPropertyIDE403</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListUnconfirmedOmniTransactionsByPropertyIDE403();
  ...
  return ListUnconfirmedOmniTransactionsByPropertyIDE403;
}();
/**
...
ListUnconfirmedOmniTransactionsByPropertyIDE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListUnconfirmedOmniTransactionsByPropertyIDE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetails>} details
 */

ListUnconfirmedOmniTransactionsByPropertyIDE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
...
var _default = ListUnconfirmedOmniTransactionsByPropertyIDE403;
