 ...
 * @version 1.11.0
 */
var CreateNewMasterWalletE401 = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateNewMasterWalletE401() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, CreateNewMasterWalletE401);
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `CreateNewMasterWalletE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(CreateNewMasterWalletE401, [{
 ...
 * @member {String} code
 */
_defineProperty(CreateNewMasterWalletE401, "fromJSON", function (json_string) {
...
var _default = CreateNewMasterWalletE401;
