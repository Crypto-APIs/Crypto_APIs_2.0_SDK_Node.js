...
var ListZilliqaTransactionsByBlockHeightE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListZilliqaTransactionsByBlockHeightE400</code>.
   * @alias module:model/ListZilliqaTransactionsByBlockHeightE400
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize ListZilliqaTransactionsByBlockHeightE400.
   */
  function ListZilliqaTransactionsByBlockHeightE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, ListZilliqaTransactionsByBlockHeightE400);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListZilliqaTransactionsByBlockHeightE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListZilliqaTransactionsByBlockHeightE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>ListZilliqaTransactionsByBlockHeightE400</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListZilliqaTransactionsByBlockHeightE400} obj Optional instance to populate.
   * @return {module:model/ListZilliqaTransactionsByBlockHeightE400} The populated <code>ListZilliqaTransactionsByBlockHeightE400</code> instance.
   */
  _createClass(ListZilliqaTransactionsByBlockHeightE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListZilliqaTransactionsByBlockHeightE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListZilliqaTransactionsByBlockHeightE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListZilliqaTransactionsByBlockHeightE400, "fromJSON", function (json_string) {
  return ListZilliqaTransactionsByBlockHeightE400.constructFromObject(JSON.parse(json_string));
});
ListZilliqaTransactionsByBlockHeightE400.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
ListZilliqaTransactionsByBlockHeightE400.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
ListZilliqaTransactionsByBlockHeightE400.prototype['details'] = undefined;
ListZilliqaTransactionsByBlockHeightE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
var _default = ListZilliqaTransactionsByBlockHeightE400;
