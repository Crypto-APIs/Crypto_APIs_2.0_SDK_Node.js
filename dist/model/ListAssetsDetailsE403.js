...
/**
 * The ListAssetsDetailsE403 model module.
 * @module model/ListAssetsDetailsE403
 * @version 1.4.0
 */
var ListAssetsDetailsE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListAssetsDetailsE403</code>.
   * @alias module:model/ListAssetsDetailsE403
   ...
   */
  function ListAssetsDetailsE403(code, message) {
    _classCallCheck(this, ListAssetsDetailsE403);
    ...
    ListAssetsDetailsE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListAssetsDetailsE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListAssetsDetailsE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAssetsDetailsE403} obj Optional instance to populate.
     * @return {module:model/ListAssetsDetailsE403} The populated <code>ListAssetsDetailsE403</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListAssetsDetailsE403();
...
ListAssetsDetailsE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListAssetsDetailsE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetails>} details
 */

ListAssetsDetailsE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
...
var _default = ListAssetsDetailsE403;
