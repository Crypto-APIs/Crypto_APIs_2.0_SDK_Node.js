...
/**
 * The PrepareAFungibleTokenTransferFromAddressE403 model module.
 * @module model/PrepareAFungibleTokenTransferFromAddressE403
 * @version 1.13.0
 */
var PrepareAFungibleTokenTransferFromAddressE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PrepareAFungibleTokenTransferFromAddressE403</code>.
   * @alias module:model/PrepareAFungibleTokenTransferFromAddressE403
   ...
   */
  function PrepareAFungibleTokenTransferFromAddressE403(code, message) {
    _classCallCheck(this, PrepareAFungibleTokenTransferFromAddressE403);
    ...
    PrepareAFungibleTokenTransferFromAddressE403.initialize(this, code, message);
  }
   ...
   */
  _createClass(PrepareAFungibleTokenTransferFromAddressE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>PrepareAFungibleTokenTransferFromAddressE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrepareAFungibleTokenTransferFromAddressE403} obj Optional instance to populate.
     * @return {module:model/PrepareAFungibleTokenTransferFromAddressE403} The populated <code>PrepareAFungibleTokenTransferFromAddressE403</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new PrepareAFungibleTokenTransferFromAddressE403();
 ...
 * @member {String} code
 */
PrepareAFungibleTokenTransferFromAddressE403.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
PrepareAFungibleTokenTransferFromAddressE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
PrepareAFungibleTokenTransferFromAddressE403.prototype['details'] = undefined;
...
var _default = PrepareAFungibleTokenTransferFromAddressE403;
