...
var _ListOmniTransactionsByBlockHeightResponseItem = _interopRequireDefault(require("./ListOmniTransactionsByBlockHeightResponseItem"));
 ...
 * @version 2.0.0
 */
var ListOmniTransactionsByBlockHeightResponseData = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListOmniTransactionsByBlockHeightResponseData(offset, limit, total, items) {
    _classCallCheck(this, ListOmniTransactionsByBlockHeightResponseData);
  ...
  _createClass(ListOmniTransactionsByBlockHeightResponseData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('items')) {
          obj['items'] = _ApiClient["default"].convertToType(data['items'], [_ListOmniTransactionsByBlockHeightResponseItem["default"]]);
        }
      }
  ...
  return ListOmniTransactionsByBlockHeightResponseData;
}();
/**
...
var _default = ListOmniTransactionsByBlockHeightResponseData;
