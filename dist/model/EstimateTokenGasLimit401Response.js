 ...
 * @version 1.11.0
 */
var EstimateTokenGasLimit401Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function EstimateTokenGasLimit401Response(apiVersion, requestId, error) {
    _classCallCheck(this, EstimateTokenGasLimit401Response);
   ...
   */
  _createClass(EstimateTokenGasLimit401Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>EstimateTokenGasLimit401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EstimateTokenGasLimit401Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(EstimateTokenGasLimit401Response.RequiredProperties),
        _step;
      try {
...
EstimateTokenGasLimit401Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = EstimateTokenGasLimit401Response;
