...
var BlockchainDataAddressEventSubscriptionNotFound = /*#__PURE__*/function () {
  ...
  _createClass(BlockchainDataAddressEventSubscriptionNotFound, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>BlockchainDataAddressEventSubscriptionNotFound</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlockchainDataAddressEventSubscriptionNotFound</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(BlockchainDataAddressEventSubscriptionNotFound.RequiredProperties),
        _step;
      try {
...
BlockchainDataAddressEventSubscriptionNotFound.RequiredProperties = ["code", "message"];
