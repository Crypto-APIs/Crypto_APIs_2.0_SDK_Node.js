...
var BlockRevertedData = /*#__PURE__*/function () {
  ...
  _createClass(BlockRevertedData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>BlockRevertedData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlockRevertedData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(BlockRevertedData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _BlockRevertedDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
BlockRevertedData.RequiredProperties = ["product", "event", "item"];
