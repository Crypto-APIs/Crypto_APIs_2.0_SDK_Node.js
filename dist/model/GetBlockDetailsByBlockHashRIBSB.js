...
var GetBlockDetailsByBlockHashRIBSB = /*#__PURE__*/function () {
   ...
   */
  function GetBlockDetailsByBlockHashRIBSB(difficulty, bits, chainwork, merkleRoot, nonce, size, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, GetBlockDetailsByBlockHashRIBSB);
    GetBlockDetailsByBlockHashRIBSB.initialize(this, difficulty, bits, chainwork, merkleRoot, nonce, size, strippedSize, version, versionHex, weight);
  }
  ...
  _createClass(GetBlockDetailsByBlockHashRIBSB, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHashRIBSB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHashRIBSB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashRIBSB.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHashRIBSB.RequiredProperties = ["difficulty", "bits", "chainwork", "merkleRoot", "nonce", "size", "strippedSize", "version", "versionHex", "weight"];
