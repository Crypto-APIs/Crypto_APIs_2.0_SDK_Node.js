...
var NewBlockRData = /*#__PURE__*/function () {
  ...
  _createClass(NewBlockRData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>NewBlockRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewBlockRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewBlockRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _NewBlockRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
NewBlockRData.RequiredProperties = ["item"];
