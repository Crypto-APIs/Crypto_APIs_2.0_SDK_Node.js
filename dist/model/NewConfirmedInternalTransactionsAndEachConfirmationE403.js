...
var NewConfirmedInternalTransactionsAndEachConfirmationE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/BlockchainEventsCallbacksLimitReached|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize NewConfirmedInternalTransactionsAndEachConfirmationE403.
   */
  function NewConfirmedInternalTransactionsAndEachConfirmationE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, NewConfirmedInternalTransactionsAndEachConfirmationE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewConfirmedInternalTransactionsAndEachConfirmationE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewConfirmedInternalTransactionsAndEachConfirmationE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>NewConfirmedInternalTransactionsAndEachConfirmationE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NewConfirmedInternalTransactionsAndEachConfirmationE403} obj Optional instance to populate.
   * @return {module:model/NewConfirmedInternalTransactionsAndEachConfirmationE403} The populated <code>NewConfirmedInternalTransactionsAndEachConfirmationE403</code> instance.
   */
  _createClass(NewConfirmedInternalTransactionsAndEachConfirmationE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewConfirmedInternalTransactionsAndEachConfirmationE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new NewConfirmedInternalTransactionsAndEachConfirmationE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(NewConfirmedInternalTransactionsAndEachConfirmationE403, "fromJSON", function (json_string) {
  return NewConfirmedInternalTransactionsAndEachConfirmationE403.constructFromObject(JSON.parse(json_string));
});
 ...
 */
NewConfirmedInternalTransactionsAndEachConfirmationE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
NewConfirmedInternalTransactionsAndEachConfirmationE403.prototype['details'] = undefined;
NewConfirmedInternalTransactionsAndEachConfirmationE403.OneOf = ["BannedIpAddress", "BlockchainEventsCallbacksLimitReached", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = NewConfirmedInternalTransactionsAndEachConfirmationE403;
