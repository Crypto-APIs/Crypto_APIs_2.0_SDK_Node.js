...
var ListTransactionsByBlockHeightRIBSDVinInner = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHeightRIBSDVinInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRIBSDVinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRIBSDVinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSDVinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _ListTransactionsByBlockHeightRIBSDVinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
      // ensure the json data is a string
...
ListTransactionsByBlockHeightRIBSDVinInner.RequiredProperties = ["addresses", "coinbase", "scriptSig", "sequence", "txinwitness", "vout"];
