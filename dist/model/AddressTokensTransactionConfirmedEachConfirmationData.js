...
var AddressTokensTransactionConfirmedEachConfirmationData = /*#__PURE__*/function () {
  ...
  _createClass(AddressTokensTransactionConfirmedEachConfirmationData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddressTokensTransactionConfirmedEachConfirmationData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressTokensTransactionConfirmedEachConfirmationData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressTokensTransactionConfirmedEachConfirmationData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _AddressTokensTransactionConfirmedEachConfirmationDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
AddressTokensTransactionConfirmedEachConfirmationData.RequiredProperties = ["product", "event", "item"];
