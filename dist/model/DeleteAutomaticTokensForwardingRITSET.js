...
var DeleteAutomaticTokensForwardingRITSET = /*#__PURE__*/function () {
   ...
   */
  function DeleteAutomaticTokensForwardingRITSET(contractAddress) {
    _classCallCheck(this, DeleteAutomaticTokensForwardingRITSET);
   ...
   */
  _createClass(DeleteAutomaticTokensForwardingRITSET, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAutomaticTokensForwardingRITSET</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAutomaticTokensForwardingRITSET</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(DeleteAutomaticTokensForwardingRITSET.RequiredProperties),
        _step;
      try {
...
DeleteAutomaticTokensForwardingRITSET.RequiredProperties = ["contractAddress"];
