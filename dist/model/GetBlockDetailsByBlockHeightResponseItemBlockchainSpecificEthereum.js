...
/**
 * The GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum model module.
 * @module model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum
 * @version 2.0.0
 */
var GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum</code>.
   * Ethereum
   * @alias module:model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum
   ...
   */
  function GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty) {
    _classCallCheck(this, GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum);

    GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum.initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty);
  }
  /**
  ...
  _createClass(GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum} The populated <code>GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum();
  ...
  return GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum;
}();
/**
...
var _default = GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereum;
