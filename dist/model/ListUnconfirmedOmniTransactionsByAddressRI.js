...
var _ListUnconfirmedOmniTransactionsByAddressRISenders = _interopRequireDefault(require("./ListUnconfirmedOmniTransactionsByAddressRISenders"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('senders')) {
          obj['senders'] = _ApiClient["default"].convertToType(data['senders'], [_ListUnconfirmedOmniTransactionsByAddressRISenders["default"]]);
        }
