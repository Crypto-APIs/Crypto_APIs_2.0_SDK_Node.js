...
var AddressCoinsTransactionUnconfirmedData = /*#__PURE__*/function () {
  ...
  _createClass(AddressCoinsTransactionUnconfirmedData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddressCoinsTransactionUnconfirmedData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressCoinsTransactionUnconfirmedData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressCoinsTransactionUnconfirmedData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _AddressCoinsTransactionUnconfirmedDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
AddressCoinsTransactionUnconfirmedData.RequiredProperties = ["product", "event", "item"];
