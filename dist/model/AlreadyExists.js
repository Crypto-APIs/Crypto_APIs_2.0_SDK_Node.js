...
var _AlreadyExistsError = _interopRequireDefault(require("./AlreadyExistsError"));
...
var AlreadyExists = /*#__PURE__*/function () {
   ...
   * @param error {module:model/AlreadyExistsError} 
   */
  function AlreadyExists(apiVersion, requestId, error) {
    _classCallCheck(this, AlreadyExists);

    AlreadyExists.initialize(this, apiVersion, requestId, error);
  }
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _AlreadyExistsError["default"].constructFromObject(data['error']);
        }
      }
...
AlreadyExists.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

AlreadyExists.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

AlreadyExists.prototype['context'] = undefined;
/**
 * @member {module:model/AlreadyExistsError} error
 */

AlreadyExists.prototype['error'] = undefined;
