...
var AlreadyExists = /*#__PURE__*/function () {
  ...
  _createClass(AlreadyExists, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AlreadyExists</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AlreadyExists</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AlreadyExists.RequiredProperties),
        _step;
      try {
...
AlreadyExists.RequiredProperties = ["code", "message"];
