...
var _NewRevertedBlockRI = _interopRequireDefault(require("./NewRevertedBlockRI"));
...
var NewRevertedBlockRData = /*#__PURE__*/function () {
   ...
   */
  function NewRevertedBlockRData(item) {
    _classCallCheck(this, NewRevertedBlockRData);
   ...
   */
  _createClass(NewRevertedBlockRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _NewRevertedBlockRI["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(NewRevertedBlockRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _NewRevertedBlockRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
