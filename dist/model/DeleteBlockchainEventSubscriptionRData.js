...
var DeleteBlockchainEventSubscriptionRData = /*#__PURE__*/function () {
  ...
  _createClass(DeleteBlockchainEventSubscriptionRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DeleteBlockchainEventSubscriptionRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _DeleteBlockchainEventSubscriptionRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
