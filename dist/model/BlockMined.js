...
var _BlockMinedData = _interopRequireDefault(require("./BlockMinedData"));
...
var BlockMined = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>BlockMined</code>.
   * @alias module:model/BlockMined
   ...
   * @param data {module:model/BlockMinedData} 
   */
  function BlockMined(apiVersion, referenceId, idempotencyKey, data) {
    _classCallCheck(this, BlockMined);
    BlockMined.initialize(this, apiVersion, referenceId, idempotencyKey, data);
  }
  ...
  _createClass(BlockMined, null, [{
    ...
    /**
     * Constructs a <code>BlockMined</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/BlockMined} obj Optional instance to populate.
     * @return {module:model/BlockMined} The populated <code>BlockMined</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new BlockMined();
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _BlockMinedData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BlockMined</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BlockMined</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(BlockMined.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _BlockMinedData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
BlockMined.RequiredProperties = ["apiVersion", "referenceId", "idempotencyKey", "data"];

/**
 * Specifies the version of the API that incorporates this endpoint.
 * @member {String} apiVersion
 */
BlockMined.prototype['apiVersion'] = undefined;

/**
 * Represents a unique identifier that serves as reference to the specific request which prompts a callback, e.g. Blockchain Events Subscription, Blockchain Automation, etc.
 * @member {String} referenceId
 */
BlockMined.prototype['referenceId'] = undefined;

/**
 * Specifies a unique ID generated by the system and attached to each callback. It is used by the server to recognize consecutive requests with the same data with the purpose not to perform the same operation twice.
 * @member {String} idempotencyKey
 */
BlockMined.prototype['idempotencyKey'] = undefined;

/**
 * @member {module:model/BlockMinedData} data
 */
BlockMined.prototype['data'] = undefined;
var _default = BlockMined;
