...
var GetTokenDetailsByContractAddressRData = /*#__PURE__*/function () {
  ...
  _createClass(GetTokenDetailsByContractAddressRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetTokenDetailsByContractAddressRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _GetTokenDetailsByContractAddressRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
