 ...
 * @version 1.11.0
 */
var GetAssetDetailsByAssetSymbol403Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetAssetDetailsByAssetSymbol403Response(apiVersion, requestId, error) {
    _classCallCheck(this, GetAssetDetailsByAssetSymbol403Response);
   ...
   */
  _createClass(GetAssetDetailsByAssetSymbol403Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetAssetDetailsByAssetSymbol403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAssetDetailsByAssetSymbol403Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetAssetDetailsByAssetSymbol403Response.RequiredProperties),
        _step;
      try {
...
GetAssetDetailsByAssetSymbol403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = GetAssetDetailsByAssetSymbol403Response;
