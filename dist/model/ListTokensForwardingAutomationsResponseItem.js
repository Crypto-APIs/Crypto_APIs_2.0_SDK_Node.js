...
var _ListTokensForwardingAutomationsResponseItemTokenData = _interopRequireDefault(require("./ListTokensForwardingAutomationsResponseItemTokenData"));
 ...
 * @version 2.0.0
 */
var ListTokensForwardingAutomationsResponseItem = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListTokensForwardingAutomationsResponseItem(callbackUrl, createdTimestamp, feeAddress, feePriority, fromAddress, minimumTransferAmount, referenceId, toAddress, tokenData) {
    _classCallCheck(this, ListTokensForwardingAutomationsResponseItem);
  ...
  _createClass(ListTokensForwardingAutomationsResponseItem, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('tokenData')) {
          obj['tokenData'] = _ListTokensForwardingAutomationsResponseItemTokenData["default"].constructFromObject(data['tokenData']);
        }
      }
  ...
  return ListTokensForwardingAutomationsResponseItem;
}();
/**
...
var _default = ListTokensForwardingAutomationsResponseItem;
