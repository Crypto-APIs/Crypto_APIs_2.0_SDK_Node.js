...
var _XpubSyncInProgressError = _interopRequireDefault(require("./XpubSyncInProgressError"));
...
var XpubSyncInProgress = /*#__PURE__*/function () {
   ...
   * @param error {module:model/XpubSyncInProgressError} 
   */
  function XpubSyncInProgress(apiVersion, requestId, error) {
    _classCallCheck(this, XpubSyncInProgress);

    XpubSyncInProgress.initialize(this, apiVersion, requestId, error);
  }
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _XpubSyncInProgressError["default"].constructFromObject(data['error']);
        }
      }
...
XpubSyncInProgress.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

XpubSyncInProgress.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

XpubSyncInProgress.prototype['context'] = undefined;
/**
 * @member {module:model/XpubSyncInProgressError} error
 */

XpubSyncInProgress.prototype['error'] = undefined;
