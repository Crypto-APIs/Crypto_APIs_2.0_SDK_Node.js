...
var XpubSyncInProgress = /*#__PURE__*/function () {
  ...
  _createClass(XpubSyncInProgress, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>XpubSyncInProgress</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>XpubSyncInProgress</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(XpubSyncInProgress.RequiredProperties),
        _step;
      try {
...
XpubSyncInProgress.RequiredProperties = ["code", "message"];
