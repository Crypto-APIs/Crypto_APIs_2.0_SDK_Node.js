...
/**
 * The FreezeTronEnergyOrBandwidthE403 model module.
 * @module model/FreezeTronEnergyOrBandwidthE403
 * @version 1.10.0
 */
var FreezeTronEnergyOrBandwidthE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>FreezeTronEnergyOrBandwidthE403</code>.
   * @alias module:model/FreezeTronEnergyOrBandwidthE403
   ...
   */
  function FreezeTronEnergyOrBandwidthE403(code, message) {
    _classCallCheck(this, FreezeTronEnergyOrBandwidthE403);
    ...
    FreezeTronEnergyOrBandwidthE403.initialize(this, code, message);
  }
   ...
   */
  _createClass(FreezeTronEnergyOrBandwidthE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>FreezeTronEnergyOrBandwidthE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FreezeTronEnergyOrBandwidthE403} obj Optional instance to populate.
     * @return {module:model/FreezeTronEnergyOrBandwidthE403} The populated <code>FreezeTronEnergyOrBandwidthE403</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new FreezeTronEnergyOrBandwidthE403();
  ...
  return FreezeTronEnergyOrBandwidthE403;
}();
/**
 * Specifies an error code, e.g. error 404.
 * @member {String} code
 */
FreezeTronEnergyOrBandwidthE403.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
FreezeTronEnergyOrBandwidthE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
FreezeTronEnergyOrBandwidthE403.prototype['details'] = undefined;
...
var _default = FreezeTronEnergyOrBandwidthE403;
