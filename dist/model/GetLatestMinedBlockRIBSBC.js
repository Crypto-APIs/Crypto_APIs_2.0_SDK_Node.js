...
/**
 * The GetLatestMinedBlockRIBSBC model module.
 * @module model/GetLatestMinedBlockRIBSBC
 * @version 1.2.1
 */
var GetLatestMinedBlockRIBSBC = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetLatestMinedBlockRIBSBC</code>.
   * Bitcoin Cash
   * @alias module:model/GetLatestMinedBlockRIBSBC
   ...
   */
  function GetLatestMinedBlockRIBSBC(difficulty, nonce, size, bits, chainwork, merkleRoot, version, versionHex) {
    _classCallCheck(this, GetLatestMinedBlockRIBSBC);

    GetLatestMinedBlockRIBSBC.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, version, versionHex);
  }
  /**
  ...
  _createClass(GetLatestMinedBlockRIBSBC, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetLatestMinedBlockRIBSBC</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLatestMinedBlockRIBSBC} obj Optional instance to populate.
     * @return {module:model/GetLatestMinedBlockRIBSBC} The populated <code>GetLatestMinedBlockRIBSBC</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLatestMinedBlockRIBSBC();
  ...
  return GetLatestMinedBlockRIBSBC;
}();
/**
...
var _default = GetLatestMinedBlockRIBSBC;
