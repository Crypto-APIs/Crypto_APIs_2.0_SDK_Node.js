...
var GetZilliqaBlockDetailsByBlockHeightE400 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize GetZilliqaBlockDetailsByBlockHeightE400.
   */
  function GetZilliqaBlockDetailsByBlockHeightE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetZilliqaBlockDetailsByBlockHeightE400);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetZilliqaBlockDetailsByBlockHeightE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetZilliqaBlockDetailsByBlockHeightE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(GetZilliqaBlockDetailsByBlockHeightE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetZilliqaBlockDetailsByBlockHeightE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetZilliqaBlockDetailsByBlockHeightE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetZilliqaBlockDetailsByBlockHeightE400, "fromJSON", function (json_string) {
  return GetZilliqaBlockDetailsByBlockHeightE400.constructFromObject(JSON.parse(json_string));
});
...
GetZilliqaBlockDetailsByBlockHeightE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
var _default = GetZilliqaBlockDetailsByBlockHeightE400;
