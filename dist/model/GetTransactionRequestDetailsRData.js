...
var GetTransactionRequestDetailsRData = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionRequestDetailsRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetTransactionRequestDetailsRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _GetTransactionRequestDetailsRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
