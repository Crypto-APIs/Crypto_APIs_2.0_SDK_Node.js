 ...
 * @version 1.7.0
 */
var PrepareAUTXOBasedTransactionFromXPubE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PrepareAUTXOBasedTransactionFromXPubE400</code>.
   * @alias module:model/PrepareAUTXOBasedTransactionFromXPubE400
   ...
   */
  function PrepareAUTXOBasedTransactionFromXPubE400(code, message) {
    _classCallCheck(this, PrepareAUTXOBasedTransactionFromXPubE400);
    ...
    PrepareAUTXOBasedTransactionFromXPubE400.initialize(this, code, message);
  }
  /**
  ...
  _createClass(PrepareAUTXOBasedTransactionFromXPubE400, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>PrepareAUTXOBasedTransactionFromXPubE400</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrepareAUTXOBasedTransactionFromXPubE400} obj Optional instance to populate.
     * @return {module:model/PrepareAUTXOBasedTransactionFromXPubE400} The populated <code>PrepareAUTXOBasedTransactionFromXPubE400</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new PrepareAUTXOBasedTransactionFromXPubE400();
  ...
  return PrepareAUTXOBasedTransactionFromXPubE400;
}();
/**
...
PrepareAUTXOBasedTransactionFromXPubE400.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

PrepareAUTXOBasedTransactionFromXPubE400.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

PrepareAUTXOBasedTransactionFromXPubE400.prototype['details'] = undefined; // Implement UriNotFound interface:
...
var _default = PrepareAUTXOBasedTransactionFromXPubE400;
