...
var DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidBlockchain|module:model/InvalidNetwork|module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400.
   */
  function DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400} obj Optional instance to populate.
   * @return {module:model/DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400} The populated <code>DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400</code> instance.
   */
  _createClass(DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400, "fromJSON", function (json_string) {
  return DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400.constructFromObject(JSON.parse(json_string));
});
 ...
 */
DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400.prototype['details'] = undefined;
DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400.OneOf = ["InvalidBlockchain", "InvalidNetwork", "InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
var _default = DeriveHDWalletXPubYPubZPubChangeOrReceivingAddressesE400;
