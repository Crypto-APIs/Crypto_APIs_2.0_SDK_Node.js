...
var CreateCoinsTransactionFromAddressForWholeAmountRB = /*#__PURE__*/function () {
  ...
  _createClass(CreateCoinsTransactionFromAddressForWholeAmountRB, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCoinsTransactionFromAddressForWholeAmountRB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCoinsTransactionFromAddressForWholeAmountRB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateCoinsTransactionFromAddressForWholeAmountRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _CreateCoinsTransactionFromAddressForWholeAmountRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
CreateCoinsTransactionFromAddressForWholeAmountRB.RequiredProperties = ["data"];
