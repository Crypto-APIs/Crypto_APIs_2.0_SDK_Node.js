...
var ConfirmedTokensTransactionForCertainAmountOrHigherErc20 = /*#__PURE__*/function () {
  ...
  _createClass(ConfirmedTokensTransactionForCertainAmountOrHigherErc20, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmedTokensTransactionForCertainAmountOrHigherErc20</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmedTokensTransactionForCertainAmountOrHigherErc20</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ConfirmedTokensTransactionForCertainAmountOrHigherErc20.RequiredProperties),
        _step;
      try {
...
ConfirmedTokensTransactionForCertainAmountOrHigherErc20.RequiredProperties = ["name", "symbol", "amount", "contractAddress"];
