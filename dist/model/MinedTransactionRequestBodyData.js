...
var _MinedTransactionRequestBodyDataItem = _interopRequireDefault(require("./MinedTransactionRequestBodyDataItem"));
 ...
 * @version 2.0.0
 */
var MinedTransactionRequestBodyData = /*#__PURE__*/function () {
  /**
   ...
   */
  function MinedTransactionRequestBodyData(item) {
    _classCallCheck(this, MinedTransactionRequestBodyData);
  ...
  _createClass(MinedTransactionRequestBodyData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _MinedTransactionRequestBodyDataItem["default"].constructFromObject(data['item']);
        }
      }
  ...
  return MinedTransactionRequestBodyData;
}();
/**
...
var _default = MinedTransactionRequestBodyData;
