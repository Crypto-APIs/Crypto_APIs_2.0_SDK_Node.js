 ...
 * @version 1.11.0
 */
var ListLatestMinedBlocksRIBSBC = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListLatestMinedBlocksRIBSBC</code>.
   * Bitcoin Cash
   ...
   */
  function ListLatestMinedBlocksRIBSBC(bits, chainwork, difficulty, merkleRoot, nonce, size, version, versionHex) {
    _classCallCheck(this, ListLatestMinedBlocksRIBSBC);
   ...
   */
  _createClass(ListLatestMinedBlocksRIBSBC, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListLatestMinedBlocksRIBSBC</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListLatestMinedBlocksRIBSBC} obj Optional instance to populate.
     * @return {module:model/ListLatestMinedBlocksRIBSBC} The populated <code>ListLatestMinedBlocksRIBSBC</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListLatestMinedBlocksRIBSBC();
    ...
    /**
     * Validates the JSON data with respect to <code>ListLatestMinedBlocksRIBSBC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLatestMinedBlocksRIBSBC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListLatestMinedBlocksRIBSBC.RequiredProperties),
        _step;
      try {
...
ListLatestMinedBlocksRIBSBC.RequiredProperties = ["bits", "chainwork", "difficulty", "merkleRoot", "nonce", "size", "version", "versionHex"];
...
var _default = ListLatestMinedBlocksRIBSBC;
