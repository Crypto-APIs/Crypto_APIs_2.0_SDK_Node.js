...
var _CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE = _interopRequireDefault(require("./CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE400"));
 ...
 * @version 1.11.0
 */
var CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response(apiVersion, requestId, error) {
    _classCallCheck(this, CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response);
   ...
   */
  _createClass(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response.RequiredProperties),
        _step;
      try {
  ...
  return CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response;
}();
CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority400Response;
