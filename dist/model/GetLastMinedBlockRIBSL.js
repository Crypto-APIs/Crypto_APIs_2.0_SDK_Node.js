 ...
 * @version 1.11.0
 */
var GetLastMinedBlockRIBSL = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetLastMinedBlockRIBSL(bits, chainwork, merkleRoot, nonce, size, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, GetLastMinedBlockRIBSL);
   ...
   */
  _createClass(GetLastMinedBlockRIBSL, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetLastMinedBlockRIBSL.RequiredProperties),
        _step;
      try {
...
var _default = GetLastMinedBlockRIBSL;
