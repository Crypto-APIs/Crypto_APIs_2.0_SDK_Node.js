...
var GetLastMinedBlockRIBSL = /*#__PURE__*/function () {
   ...
   */
  function GetLastMinedBlockRIBSL(difficulty, bits, chainwork, merkleRoot, nonce, size, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, GetLastMinedBlockRIBSL);

    GetLastMinedBlockRIBSL.initialize(this, difficulty, bits, chainwork, merkleRoot, nonce, size, strippedSize, version, versionHex, weight);
  }
  /**
