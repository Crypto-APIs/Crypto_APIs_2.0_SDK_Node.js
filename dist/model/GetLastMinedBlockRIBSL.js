...
var GetLastMinedBlockRIBSL = /*#__PURE__*/function () {
   ...
   */
  function GetLastMinedBlockRIBSL(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, GetLastMinedBlockRIBSL);

    GetLastMinedBlockRIBSL.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight);
  }
  /**
