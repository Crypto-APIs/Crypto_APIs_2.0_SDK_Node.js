 ...
 * @version 1.7.0
 */
var SyncNewXPubE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SyncNewXPubE403</code>.
   * @alias module:model/SyncNewXPubE403
   ...
   */
  function SyncNewXPubE403(code, message) {
    _classCallCheck(this, SyncNewXPubE403);
    ...
    SyncNewXPubE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(SyncNewXPubE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>SyncNewXPubE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SyncNewXPubE403} obj Optional instance to populate.
     * @return {module:model/SyncNewXPubE403} The populated <code>SyncNewXPubE403</code> instance.
     */
...
SyncNewXPubE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

SyncNewXPubE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

SyncNewXPubE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
