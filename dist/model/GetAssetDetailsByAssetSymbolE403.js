...
var GetAssetDetailsByAssetSymbolE403 = /*#__PURE__*/function () {
  ...
  function GetAssetDetailsByAssetSymbolE403() {
    ...
    _classCallCheck(this, GetAssetDetailsByAssetSymbolE403);
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `GetAssetDetailsByAssetSymbolE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(GetAssetDetailsByAssetSymbolE403, [{
 ...
 * @member {String} code
 */
_defineProperty(GetAssetDetailsByAssetSymbolE403, "fromJSON", function (json_string) {
...
var _default = GetAssetDetailsByAssetSymbolE403;
