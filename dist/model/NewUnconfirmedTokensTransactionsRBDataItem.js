...
var NewUnconfirmedTokensTransactionsRBDataItem = /*#__PURE__*/function () {
  ...
  _createClass(NewUnconfirmedTokensTransactionsRBDataItem, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>NewUnconfirmedTokensTransactionsRBDataItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewUnconfirmedTokensTransactionsRBDataItem</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewUnconfirmedTokensTransactionsRBDataItem.RequiredProperties),
        _step;
      try {
...
NewUnconfirmedTokensTransactionsRBDataItem.RequiredProperties = ["address", "callbackUrl"];
