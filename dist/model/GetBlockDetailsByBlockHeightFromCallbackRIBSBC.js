...
var GetBlockDetailsByBlockHeightFromCallbackRIBSBC = /*#__PURE__*/function () {
  ...
  _createClass(GetBlockDetailsByBlockHeightFromCallbackRIBSBC, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHeightFromCallbackRIBSBC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHeightFromCallbackRIBSBC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHeightFromCallbackRIBSBC.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHeightFromCallbackRIBSBC.RequiredProperties = ["bits", "chainwork", "difficulty", "merkleRoot", "nonce", "size", "version", "versionHex"];
