...
var CreateNewMasterWalletRI = /*#__PURE__*/function () {
   ...
   */
  function CreateNewMasterWalletRI(walletId) {
    _classCallCheck(this, CreateNewMasterWalletRI);
   ...
   */
  _createClass(CreateNewMasterWalletRI, null, [{
    key: "initialize",
    value: function initialize(obj, walletId) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateNewMasterWalletRI.RequiredProperties),
        _step;
      try {
