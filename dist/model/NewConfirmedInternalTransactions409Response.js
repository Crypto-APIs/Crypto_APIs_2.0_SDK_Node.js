 ...
 * @version 1.11.0
 */
var NewConfirmedInternalTransactions409Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function NewConfirmedInternalTransactions409Response(apiVersion, requestId, error) {
    _classCallCheck(this, NewConfirmedInternalTransactions409Response);
   ...
   */
  _createClass(NewConfirmedInternalTransactions409Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>NewConfirmedInternalTransactions409Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewConfirmedInternalTransactions409Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewConfirmedInternalTransactions409Response.RequiredProperties),
        _step;
      try {
...
NewConfirmedInternalTransactions409Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = NewConfirmedInternalTransactions409Response;
