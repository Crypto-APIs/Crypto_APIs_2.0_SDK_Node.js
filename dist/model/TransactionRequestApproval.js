...
var TransactionRequestApproval = /*#__PURE__*/function () {
  ...
  _createClass(TransactionRequestApproval, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>TransactionRequestApproval</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransactionRequestApproval</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TransactionRequestApproval.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _TransactionRequestApprovalData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
TransactionRequestApproval.RequiredProperties = ["apiVersion", "referenceId", "idempotencyKey", "data"];
