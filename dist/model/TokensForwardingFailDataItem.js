...
var TokensForwardingFailDataItem = /*#__PURE__*/function () {
  ...
  _createClass(TokensForwardingFailDataItem, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>TokensForwardingFailDataItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TokensForwardingFailDataItem</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TokensForwardingFailDataItem.RequiredProperties),
        _step;
      try {
...
TokensForwardingFailDataItem.RequiredProperties = ["blockchain", "network", "fromAddress", "toAddress", "triggerTransactionId", "errorCode", "errorMessage"];
