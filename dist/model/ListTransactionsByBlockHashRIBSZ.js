...
var ListTransactionsByBlockHashRIBSZ = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHashRIBSZ, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHashRIBSZ</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHashRIBSZ</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIBSZ.RequiredProperties),
        _step;
      try {
      ...
      if (data['vJoinSplit']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListTransactionsByBlockHashRIBSZVJoinSplitInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['vin']) {
        ...
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            ...
            _ListTransactionsByBlockHashRIBSZVinInner["default"].validateJsonObject(_item3);
          }
        } catch (err) {
          _iterator5.e(err);
        } finally {
...
ListTransactionsByBlockHashRIBSZ.RequiredProperties = ["bindingSig", "expiryHeight", "joinSplitPubKey", "joinSplitSig", "locktime", "overwintered", "size", "vJoinSplit", "vShieldedOutput", "vShieldedSpend", "valueBalance", "version", "versionGroupId", "vin", "vout"];
