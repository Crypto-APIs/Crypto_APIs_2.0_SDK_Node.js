...
/**
 * The ListInternalTransactionsByAddressE403 model module.
 * @module model/ListInternalTransactionsByAddressE403
 * @version 1.11.0
 */
var ListInternalTransactionsByAddressE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListInternalTransactionsByAddressE403</code>.
   * @alias module:model/ListInternalTransactionsByAddressE403
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize ListInternalTransactionsByAddressE403.
   */
  function ListInternalTransactionsByAddressE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, ListInternalTransactionsByAddressE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListInternalTransactionsByAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListInternalTransactionsByAddressE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>ListInternalTransactionsByAddressE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListInternalTransactionsByAddressE403} obj Optional instance to populate.
   * @return {module:model/ListInternalTransactionsByAddressE403} The populated <code>ListInternalTransactionsByAddressE403</code> instance.
   */
  _createClass(ListInternalTransactionsByAddressE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListInternalTransactionsByAddressE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListInternalTransactionsByAddressE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListInternalTransactionsByAddressE403, "fromJSON", function (json_string) {
  return ListInternalTransactionsByAddressE403.constructFromObject(JSON.parse(json_string));
});
ListInternalTransactionsByAddressE403.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
ListInternalTransactionsByAddressE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
ListInternalTransactionsByAddressE403.prototype['details'] = undefined;
ListInternalTransactionsByAddressE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = ListInternalTransactionsByAddressE403;
