...
var InlineResponse40011 = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse40011(apiVersion, requestId, error) {
    _classCallCheck(this, InlineResponse40011);

    InlineResponse40011.initialize(this, apiVersion, requestId, error);
  }
  /**
...
InlineResponse40011.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

InlineResponse40011.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

InlineResponse40011.prototype['context'] = undefined;
/**
 * @member {module:model/ListXRPRippleTransactionsByAddressE400} error
 */

InlineResponse40011.prototype['error'] = undefined;
