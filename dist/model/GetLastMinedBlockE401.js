...
var GetLastMinedBlockE401 = /*#__PURE__*/function () {
   ...
   */
  function GetLastMinedBlockE401(code, message) {
    ...
    GetLastMinedBlockE401.initialize(this, code, message);
  }
  /**
  ...
  _createClass(GetLastMinedBlockE401, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLastMinedBlockE401();
...
GetLastMinedBlockE401.prototype['details'] = undefined; // Implement MissingApiKey interface:
