...
var GetZilliqaTransactionDetailsByTransactionIDRIRecipientsInner = /*#__PURE__*/function () {
  ...
  _createClass(GetZilliqaTransactionDetailsByTransactionIDRIRecipientsInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetZilliqaTransactionDetailsByTransactionIDRIRecipientsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetZilliqaTransactionDetailsByTransactionIDRIRecipientsInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetZilliqaTransactionDetailsByTransactionIDRIRecipientsInner.RequiredProperties),
        _step;
      try {
...
GetZilliqaTransactionDetailsByTransactionIDRIRecipientsInner.RequiredProperties = ["address", "amount"];
