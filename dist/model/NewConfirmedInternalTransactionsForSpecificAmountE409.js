...
var NewConfirmedInternalTransactionsForSpecificAmountE409 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/AlreadyExists|module:model/InvalidData)} instance The actual instance to initialize NewConfirmedInternalTransactionsForSpecificAmountE409.
   */
  function NewConfirmedInternalTransactionsForSpecificAmountE409() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewConfirmedInternalTransactionsForSpecificAmountE409` with oneOf schemas AlreadyExists, InvalidData. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewConfirmedInternalTransactionsForSpecificAmountE409` with oneOf schemas AlreadyExists, InvalidData. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(NewConfirmedInternalTransactionsForSpecificAmountE409, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewConfirmedInternalTransactionsForSpecificAmountE409.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new NewConfirmedInternalTransactionsForSpecificAmountE409(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(NewConfirmedInternalTransactionsForSpecificAmountE409, "fromJSON", function (json_string) {
  return NewConfirmedInternalTransactionsForSpecificAmountE409.constructFromObject(JSON.parse(json_string));
});
...
NewConfirmedInternalTransactionsForSpecificAmountE409.OneOf = ["AlreadyExists", "InvalidData"];
