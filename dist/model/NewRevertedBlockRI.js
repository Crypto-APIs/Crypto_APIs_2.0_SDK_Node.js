...
var NewRevertedBlockRI = /*#__PURE__*/function () {
   ...
   */
  function NewRevertedBlockRI(address, callbackSecretKey, createdTimestamp, eventType, isActive, referenceId) {
    _classCallCheck(this, NewRevertedBlockRI);
   ...
   */
  _createClass(NewRevertedBlockRI, null, [{
    key: "initialize",
    value: function initialize(obj, address, callbackSecretKey, createdTimestamp, eventType, isActive, referenceId) {
      obj['address'] = address;
    ...
    /**
     * Validates the JSON data with respect to <code>NewRevertedBlockRI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewRevertedBlockRI</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewRevertedBlockRI.RequiredProperties),
        _step;
      try {
...
NewRevertedBlockRI.RequiredProperties = ["address", "callbackSecretKey", "createdTimestamp", "eventType", "isActive", "referenceId"];
...
var _default = NewRevertedBlockRI;
