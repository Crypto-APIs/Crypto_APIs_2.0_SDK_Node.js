...
var ListLatestMinedBlocksRIBSBSC = /*#__PURE__*/function () {
  ...
  _createClass(ListLatestMinedBlocksRIBSBSC, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListLatestMinedBlocksRIBSBSC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLatestMinedBlocksRIBSBSC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListLatestMinedBlocksRIBSBSC.RequiredProperties),
        _step;
      try {
...
ListLatestMinedBlocksRIBSBSC.RequiredProperties = ["difficulty", "extraData", "gasLimit", "gasUsed", "minedInSeconds", "nonce", "sha3Uncles", "size", "totalDifficulty", "uncles"];
