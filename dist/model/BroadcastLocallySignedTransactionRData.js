...
var BroadcastLocallySignedTransactionRData = /*#__PURE__*/function () {
  ...
  _createClass(BroadcastLocallySignedTransactionRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(BroadcastLocallySignedTransactionRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _BroadcastLocallySignedTransactionRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
