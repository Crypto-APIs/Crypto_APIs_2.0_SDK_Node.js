...
var ListTransactionsByBlockHashRIBSBCVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHashRIBSBCVoutInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHashRIBSBCVoutInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHashRIBSBCVoutInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIBSBCVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _ListTransactionsByBlockHashRIBSBCVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
...
ListTransactionsByBlockHashRIBSBCVoutInner.RequiredProperties = ["isSpent", "scriptPubKey", "value"];
