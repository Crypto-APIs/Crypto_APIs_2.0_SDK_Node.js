...
var CreateCoinsTransactionFromAddressForWholeAmountRBData = /*#__PURE__*/function () {
  ...
  _createClass(CreateCoinsTransactionFromAddressForWholeAmountRBData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateCoinsTransactionFromAddressForWholeAmountRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _CreateCoinsTransactionFromAddressForWholeAmountRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
