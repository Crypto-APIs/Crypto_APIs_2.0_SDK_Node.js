...
var ListUnconfirmedTransactionsByAddressRIBSL = /*#__PURE__*/function () {
  ...
  _createClass(ListUnconfirmedTransactionsByAddressRIBSL, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListUnconfirmedTransactionsByAddressRIBSL</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUnconfirmedTransactionsByAddressRIBSL</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListUnconfirmedTransactionsByAddressRIBSL.RequiredProperties),
        _step;
      try {
      ...
      if (data['vin']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListUnconfirmedTransactionsByAddressRIBSLVinInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['vout']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _ListUnconfirmedTransactionsByAddressRIBSLVoutInner["default"].validateJsonObject(_item);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
...
ListUnconfirmedTransactionsByAddressRIBSL.RequiredProperties = ["locktime", "size", "vSize", "version", "vin", "vout"];
