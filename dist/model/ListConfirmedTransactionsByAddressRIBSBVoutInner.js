...
var ListConfirmedTransactionsByAddressRIBSBVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(ListConfirmedTransactionsByAddressRIBSBVoutInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListConfirmedTransactionsByAddressRIBSBVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _ListConfirmedTransactionsByAddressRIBSBVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
