...
var DecodeRawTransactionHexRISD2VinInnerScriptSig = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISD2VinInnerScriptSig, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>DecodeRawTransactionHexRISD2VinInnerScriptSig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DecodeRawTransactionHexRISD2VinInnerScriptSig</code>.
     */
  }, {
    key: "validateJSON",
