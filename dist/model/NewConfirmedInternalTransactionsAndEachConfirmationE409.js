...
var NewConfirmedInternalTransactionsAndEachConfirmationE409 = /*#__PURE__*/function () {
  ...
  function NewConfirmedInternalTransactionsAndEachConfirmationE409() {
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `NewConfirmedInternalTransactionsAndEachConfirmationE409` with oneOf schemas AlreadyExists, InvalidData. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(NewConfirmedInternalTransactionsAndEachConfirmationE409, [{
 ...
 * @member {String} code
 */
_defineProperty(NewConfirmedInternalTransactionsAndEachConfirmationE409, "fromJSON", function (json_string) {
