...
var CreateCoinsTransactionRequestFromAddressRB = /*#__PURE__*/function () {
  ...
  _createClass(CreateCoinsTransactionRequestFromAddressRB, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>CreateCoinsTransactionRequestFromAddressRB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateCoinsTransactionRequestFromAddressRB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateCoinsTransactionRequestFromAddressRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _CreateCoinsTransactionRequestFromAddressRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
CreateCoinsTransactionRequestFromAddressRB.RequiredProperties = ["data"];
