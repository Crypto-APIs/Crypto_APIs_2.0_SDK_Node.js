...
var GetWalletTransactionDetailsByTransactionIDRIBSZ = /*#__PURE__*/function () {
  ...
  _createClass(GetWalletTransactionDetailsByTransactionIDRIBSZ, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetWalletTransactionDetailsByTransactionIDRIBSZ.RequiredProperties),
        _step;
      try {
      ...
      if (data['vin']) {
        ...
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            ...
            _GetWalletTransactionDetailsByTransactionIDRIBSZVinInner["default"].validateJsonObject(_item3);
          }
        } catch (err) {
          _iterator5.e(err);
        } finally {
