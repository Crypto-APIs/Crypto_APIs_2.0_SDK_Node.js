...
var DecodeRawTransactionHexE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize DecodeRawTransactionHexE403.
   */
  function DecodeRawTransactionHexE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, DecodeRawTransactionHexE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `DecodeRawTransactionHexE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `DecodeRawTransactionHexE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(DecodeRawTransactionHexE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = DecodeRawTransactionHexE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new DecodeRawTransactionHexE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(DecodeRawTransactionHexE403, "fromJSON", function (json_string) {
  return DecodeRawTransactionHexE403.constructFromObject(JSON.parse(json_string));
});
...
DecodeRawTransactionHexE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = DecodeRawTransactionHexE403;
