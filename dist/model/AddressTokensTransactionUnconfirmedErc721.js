...
var AddressTokensTransactionUnconfirmedErc721 = /*#__PURE__*/function () {
  ...
  _createClass(AddressTokensTransactionUnconfirmedErc721, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddressTokensTransactionUnconfirmedErc721</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressTokensTransactionUnconfirmedErc721</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressTokensTransactionUnconfirmedErc721.RequiredProperties),
        _step;
      try {
...
AddressTokensTransactionUnconfirmedErc721.RequiredProperties = ["name", "symbol", "tokenId", "contractAddress"];
