...
var _ListInternalTransactionDetailsByTransactionHashE = _interopRequireDefault(require("./ListInternalTransactionDetailsByTransactionHashE400"));
 ...
 * @version 1.11.0
 */
var ListInternalTransactionDetailsByTransactionHash400Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListInternalTransactionDetailsByTransactionHash400Response(apiVersion, requestId, error) {
    _classCallCheck(this, ListInternalTransactionDetailsByTransactionHash400Response);
   ...
   */
  _createClass(ListInternalTransactionDetailsByTransactionHash400Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListInternalTransactionDetailsByTransactionHash400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListInternalTransactionDetailsByTransactionHash400Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListInternalTransactionDetailsByTransactionHash400Response.RequiredProperties),
        _step;
      try {
...
ListInternalTransactionDetailsByTransactionHash400Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = ListInternalTransactionDetailsByTransactionHash400Response;
