...
var _RequestLimitReachedError = _interopRequireDefault(require("./RequestLimitReachedError"));
...
var RequestLimitReached = /*#__PURE__*/function () {
   ...
   * @param error {module:model/RequestLimitReachedError} 
   */
  function RequestLimitReached(apiVersion, requestId, error) {
    _classCallCheck(this, RequestLimitReached);

    RequestLimitReached.initialize(this, apiVersion, requestId, error);
  }
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _RequestLimitReachedError["default"].constructFromObject(data['error']);
        }
      }
...
RequestLimitReached.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

RequestLimitReached.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

RequestLimitReached.prototype['context'] = undefined;
/**
 * @member {module:model/RequestLimitReachedError} error
 */

RequestLimitReached.prototype['error'] = undefined;
