...
var _NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem = _interopRequireDefault(require("./NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem"));
...
var NewConfirmedCoinsTransactionsForSpecificAmountRBData = /*#__PURE__*/function () {
   ...
   */
  function NewConfirmedCoinsTransactionsForSpecificAmountRBData(item) {
    _classCallCheck(this, NewConfirmedCoinsTransactionsForSpecificAmountRBData);
   ...
   */
  _createClass(NewConfirmedCoinsTransactionsForSpecificAmountRBData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(NewConfirmedCoinsTransactionsForSpecificAmountRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _NewConfirmedCoinsTransactionsForSpecificAmountRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
