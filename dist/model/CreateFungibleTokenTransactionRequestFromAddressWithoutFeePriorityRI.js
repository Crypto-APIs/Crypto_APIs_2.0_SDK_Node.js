...
var CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRI = /*#__PURE__*/function () {
  ...
  _createClass(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['recipient']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRIRecipientInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['tokenTypeSpecificData']) {
        // data not null
        _CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityRIS["default"].validateJSON(data['tokenTypeSpecificData']);
      }
      // ensure the json data is a string
