...
var ActivateBlockchainEventSubscriptionRB = /*#__PURE__*/function () {
  ...
  _createClass(ActivateBlockchainEventSubscriptionRB, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ActivateBlockchainEventSubscriptionRB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ActivateBlockchainEventSubscriptionRB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ActivateBlockchainEventSubscriptionRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _ActivateBlockchainEventSubscriptionRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
ActivateBlockchainEventSubscriptionRB.RequiredProperties = ["data"];
