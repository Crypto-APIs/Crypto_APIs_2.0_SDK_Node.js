...
var ListTransactionsByBlockHeightRIBSE = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHeightRIBSE, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRIBSE</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRIBSE</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSE.RequiredProperties),
        _step;
      try {
...
ListTransactionsByBlockHeightRIBSE.RequiredProperties = ["contract", "gasLimit", "gasPrice", "gasUsed", "inputData", "nonce", "transactionStatus"];
