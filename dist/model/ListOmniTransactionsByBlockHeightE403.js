 ...
 * @version 1.5.0
 */
var ListOmniTransactionsByBlockHeightE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListOmniTransactionsByBlockHeightE403</code>.
   * @alias module:model/ListOmniTransactionsByBlockHeightE403
   ...
   */
  function ListOmniTransactionsByBlockHeightE403(code, message) {
    _classCallCheck(this, ListOmniTransactionsByBlockHeightE403);
    ...
    ListOmniTransactionsByBlockHeightE403.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListOmniTransactionsByBlockHeightE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListOmniTransactionsByBlockHeightE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListOmniTransactionsByBlockHeightE403} obj Optional instance to populate.
     * @return {module:model/ListOmniTransactionsByBlockHeightE403} The populated <code>ListOmniTransactionsByBlockHeightE403</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListOmniTransactionsByBlockHeightE403();
...
ListOmniTransactionsByBlockHeightE403.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListOmniTransactionsByBlockHeightE403.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetails>} details
 */

ListOmniTransactionsByBlockHeightE403.prototype['details'] = undefined; // Implement BannedIpAddress interface:
...
var _default = ListOmniTransactionsByBlockHeightE403;
