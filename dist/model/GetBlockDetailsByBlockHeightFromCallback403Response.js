...
var GetBlockDetailsByBlockHeightFromCallback403Response = /*#__PURE__*/function () {
   ...
   */
  function GetBlockDetailsByBlockHeightFromCallback403Response(apiVersion, requestId, error) {
    _classCallCheck(this, GetBlockDetailsByBlockHeightFromCallback403Response);
   ...
   */
  _createClass(GetBlockDetailsByBlockHeightFromCallback403Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHeightFromCallback403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHeightFromCallback403Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHeightFromCallback403Response.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHeightFromCallback403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = GetBlockDetailsByBlockHeightFromCallback403Response;
