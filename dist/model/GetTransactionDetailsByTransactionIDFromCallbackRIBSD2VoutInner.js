...
var GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInner = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
