...
/**
 * The GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic model module.
 * @module model/GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic
 * @version 2.0.0
 */
var GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic</code>.
   * Ethereum Classic
   * @alias module:model/GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic
   ...
   */
  function GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty) {
    _classCallCheck(this, GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic);

    GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic.initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty);
  }
  /**
  ...
  _createClass(GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic} obj Optional instance to populate.
     * @return {module:model/GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic} The populated <code>GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic();
  ...
  return GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic;
}();
/**
...
var _default = GetLatestMinedBlockResponseItemBlockchainSpecificEthereumClassic;
