...
/**
 * The NewConfirmedCoinsTransactionsForSpecificAmountE403 model module.
 * @module model/NewConfirmedCoinsTransactionsForSpecificAmountE403
 * @version 1.11.0
 */
var NewConfirmedCoinsTransactionsForSpecificAmountE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>NewConfirmedCoinsTransactionsForSpecificAmountE403</code>.
   * @alias module:model/NewConfirmedCoinsTransactionsForSpecificAmountE403
   * @param {(module:model/BannedIpAddress|module:model/BlockchainEventsCallbacksLimitReached|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize NewConfirmedCoinsTransactionsForSpecificAmountE403.
   */
  function NewConfirmedCoinsTransactionsForSpecificAmountE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, NewConfirmedCoinsTransactionsForSpecificAmountE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewConfirmedCoinsTransactionsForSpecificAmountE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewConfirmedCoinsTransactionsForSpecificAmountE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>NewConfirmedCoinsTransactionsForSpecificAmountE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NewConfirmedCoinsTransactionsForSpecificAmountE403} obj Optional instance to populate.
   * @return {module:model/NewConfirmedCoinsTransactionsForSpecificAmountE403} The populated <code>NewConfirmedCoinsTransactionsForSpecificAmountE403</code> instance.
   */
  _createClass(NewConfirmedCoinsTransactionsForSpecificAmountE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewConfirmedCoinsTransactionsForSpecificAmountE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new NewConfirmedCoinsTransactionsForSpecificAmountE403(data);
    }
  }]);
  return NewConfirmedCoinsTransactionsForSpecificAmountE403;
}();
/**
 * Specifies an error code, e.g. error 404.
 * @member {String} code
 */
_defineProperty(NewConfirmedCoinsTransactionsForSpecificAmountE403, "fromJSON", function (json_string) {
  return NewConfirmedCoinsTransactionsForSpecificAmountE403.constructFromObject(JSON.parse(json_string));
});
NewConfirmedCoinsTransactionsForSpecificAmountE403.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
NewConfirmedCoinsTransactionsForSpecificAmountE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
NewConfirmedCoinsTransactionsForSpecificAmountE403.prototype['details'] = undefined;
NewConfirmedCoinsTransactionsForSpecificAmountE403.OneOf = ["BannedIpAddress", "BlockchainEventsCallbacksLimitReached", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = NewConfirmedCoinsTransactionsForSpecificAmountE403;
