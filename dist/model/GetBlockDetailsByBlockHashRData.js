...
var _GetBlockDetailsByBlockHashRI = _interopRequireDefault(require("./GetBlockDetailsByBlockHashRI"));
...
var GetBlockDetailsByBlockHashRData = /*#__PURE__*/function () {
   ...
   */
  function GetBlockDetailsByBlockHashRData(item) {
    _classCallCheck(this, GetBlockDetailsByBlockHashRData);
   ...
   */
  _createClass(GetBlockDetailsByBlockHashRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _GetBlockDetailsByBlockHashRI["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHashRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHashRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _GetBlockDetailsByBlockHashRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
GetBlockDetailsByBlockHashRData.RequiredProperties = ["item"];
