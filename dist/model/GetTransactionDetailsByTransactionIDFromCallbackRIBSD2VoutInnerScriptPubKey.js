...
var GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInnerScriptPubKey = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInnerScriptPubKey, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInnerScriptPubKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInnerScriptPubKey</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInnerScriptPubKey.RequiredProperties),
        _step;
      try {
...
GetTransactionDetailsByTransactionIDFromCallbackRIBSD2VoutInnerScriptPubKey.RequiredProperties = ["addresses", "asm", "hex", "reqSigs", "type"];
