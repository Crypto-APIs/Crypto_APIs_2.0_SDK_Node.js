...
var DecodeRawTransactionHexRISD2VoutInnerScriptPubKey = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISD2VoutInnerScriptPubKey, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>DecodeRawTransactionHexRISD2VoutInnerScriptPubKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DecodeRawTransactionHexRISD2VoutInnerScriptPubKey</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRISD2VoutInnerScriptPubKey.RequiredProperties),
        _step;
      try {
...
DecodeRawTransactionHexRISD2VoutInnerScriptPubKey.RequiredProperties = ["address"];
