...
var InlineResponse4033 = /*#__PURE__*/function () {
   ...
   */
  function InlineResponse4033(apiVersion, requestId, error) {
    _classCallCheck(this, InlineResponse4033);

    InlineResponse4033.initialize(this, apiVersion, requestId, error);
  }
  /**
...
InlineResponse4033.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

InlineResponse4033.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

InlineResponse4033.prototype['context'] = undefined;
/**
 * @member {module:model/GetZilliqaAddressDetailsE403} error
 */

InlineResponse4033.prototype['error'] = undefined;
