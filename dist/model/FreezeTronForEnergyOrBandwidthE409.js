...
/**
 * The FreezeTronForEnergyOrBandwidthE409 model module.
 * @module model/FreezeTronForEnergyOrBandwidthE409
 * @version 1.11.0
 */
var FreezeTronForEnergyOrBandwidthE409 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>FreezeTronForEnergyOrBandwidthE409</code>.
   * @alias module:model/FreezeTronForEnergyOrBandwidthE409
   * @param {(module:model/InvalidData|module:model/WalletAsAServiceAddressBalanceNotEnough|module:model/WalletAsAServiceTokenNotSupported|module:model/WalletAsAServiceWalletBalanceNotEnough)} instance The actual instance to initialize FreezeTronForEnergyOrBandwidthE409.
   */
  function FreezeTronForEnergyOrBandwidthE409() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, FreezeTronForEnergyOrBandwidthE409);
    ...
    try {
      if (typeof instance === "WalletAsAServiceTokenNotSupported") {
        ...
        // plain JS object
        // validate the object
        _WalletAsAServiceTokenNotSupported["default"].validateJSON(instance); // throw an exception if no match
        // create WalletAsAServiceTokenNotSupported from JS object
        this.actualInstance = _WalletAsAServiceTokenNotSupported["default"].constructFromObject(instance);
      }
      match++;
    } catch (err) {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `FreezeTronForEnergyOrBandwidthE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceTokenNotSupported, WalletAsAServiceWalletBalanceNotEnough. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `FreezeTronForEnergyOrBandwidthE409` with oneOf schemas InvalidData, WalletAsAServiceAddressBalanceNotEnough, WalletAsAServiceTokenNotSupported, WalletAsAServiceWalletBalanceNotEnough. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>FreezeTronForEnergyOrBandwidthE409</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FreezeTronForEnergyOrBandwidthE409} obj Optional instance to populate.
   * @return {module:model/FreezeTronForEnergyOrBandwidthE409} The populated <code>FreezeTronForEnergyOrBandwidthE409</code> instance.
   */
  _createClass(FreezeTronForEnergyOrBandwidthE409, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = FreezeTronForEnergyOrBandwidthE409.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new FreezeTronForEnergyOrBandwidthE409(data);
    }
  }]);
  return FreezeTronForEnergyOrBandwidthE409;
}();
/**
 * Specifies an error code, e.g. error 404.
 * @member {String} code
 */
_defineProperty(FreezeTronForEnergyOrBandwidthE409, "fromJSON", function (json_string) {
  return FreezeTronForEnergyOrBandwidthE409.constructFromObject(JSON.parse(json_string));
});
FreezeTronForEnergyOrBandwidthE409.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
FreezeTronForEnergyOrBandwidthE409.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
FreezeTronForEnergyOrBandwidthE409.prototype['details'] = undefined;
FreezeTronForEnergyOrBandwidthE409.OneOf = ["InvalidData", "WalletAsAServiceAddressBalanceNotEnough", "WalletAsAServiceTokenNotSupported", "WalletAsAServiceWalletBalanceNotEnough"];
var _default = FreezeTronForEnergyOrBandwidthE409;
