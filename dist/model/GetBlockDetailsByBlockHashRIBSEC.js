...
var GetBlockDetailsByBlockHashRIBSEC = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHashRIBSEC</code>.
   * Ethereum Classic
   ...
   */
  function GetBlockDetailsByBlockHashRIBSEC(difficulty, extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty, uncles) {
    _classCallCheck(this, GetBlockDetailsByBlockHashRIBSEC);
    GetBlockDetailsByBlockHashRIBSEC.initialize(this, difficulty, extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty, uncles);
  }
   ...
   */
  _createClass(GetBlockDetailsByBlockHashRIBSEC, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHashRIBSEC</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHashRIBSEC} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHashRIBSEC} The populated <code>GetBlockDetailsByBlockHashRIBSEC</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHashRIBSEC();
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHashRIBSEC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHashRIBSEC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashRIBSEC.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHashRIBSEC.RequiredProperties = ["difficulty", "extraData", "gasLimit", "gasUsed", "minedInSeconds", "nonce", "sha3Uncles", "size", "totalDifficulty", "uncles"];
...
var _default = GetBlockDetailsByBlockHashRIBSEC;
