...
var GetTransactionDetailsByTransactionIDRIBSBCVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDRIBSBCVoutInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDRIBSBCVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _GetTransactionDetailsByTransactionIDRIBSBCVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
