...
/**
 * The ListUnconfirmedOmniTransactionsByPropertyIDResponseItem model module.
 * @module model/ListUnconfirmedOmniTransactionsByPropertyIDResponseItem
 * @version 2.0.0
 */
var ListUnconfirmedOmniTransactionsByPropertyIDResponseItem = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListUnconfirmedOmniTransactionsByPropertyIDResponseItem</code>.
   * @alias module:model/ListUnconfirmedOmniTransactionsByPropertyIDResponseItem
   ...
   */
  function ListUnconfirmedOmniTransactionsByPropertyIDResponseItem(amount, divisible, mined, propertyId, recipients, senders, sent, timestamp, transactionId, type, typeIint, version, fee) {
    _classCallCheck(this, ListUnconfirmedOmniTransactionsByPropertyIDResponseItem);

    ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.initialize(this, amount, divisible, mined, propertyId, recipients, senders, sent, timestamp, transactionId, type, typeIint, version, fee);
  }
  /**
  ...
  _createClass(ListUnconfirmedOmniTransactionsByPropertyIDResponseItem, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListUnconfirmedOmniTransactionsByPropertyIDResponseItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListUnconfirmedOmniTransactionsByPropertyIDResponseItem} obj Optional instance to populate.
     * @return {module:model/ListUnconfirmedOmniTransactionsByPropertyIDResponseItem} The populated <code>ListUnconfirmedOmniTransactionsByPropertyIDResponseItem</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListUnconfirmedOmniTransactionsByPropertyIDResponseItem();
  ...
  return ListUnconfirmedOmniTransactionsByPropertyIDResponseItem;
}();
/**
...
ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.prototype['amount'] = undefined;
/**
...
ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.prototype['divisible'] = undefined;
/**
...
ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.prototype['mined'] = undefined;
/**
 * Represents the identifier of the tokens to send.
 * @member {Number} propertyId
 */

ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.prototype['propertyId'] = undefined;
/**
 * Represents an object of addresses that receive the transactions.
 * @member {Array.<module:model/ListOmniTransactionsByAddressResponseItemRecipients>} recipients
 */

ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.prototype['recipients'] = undefined;
/**
 * Represents an object of addresses that provide the funds.
 * @member {Array.<module:model/GetUnconfirmedOmniTransactionByTransactionIDTxidResponseItemSenders>} senders
 */

ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.prototype['senders'] = undefined;
/**
 * Defines whether the transaction has been sent or not, as boolean. E.g. if set to \"true\", it means the transaction is sent.
 * @member {Boolean} sent
 */

ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.prototype['sent'] = undefined;
/**
 * Defines the exact date/time in Unix Timestamp when this transaction was mined, confirmed or first seen in Mempool, if it is unconfirmed.
 * @member {Number} timestamp
 */

ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.prototype['timestamp'] = undefined;
/**
 * Represents the unique identifier of a transaction, i.e. it could be `transactionId` in UTXO-based protocols like Bitcoin, and transaction `hash` in Ethereum blockchain.
 * @member {String} transactionId
 */

ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.prototype['transactionId'] = undefined;
/**
 * Defines the type of the transaction as a string.
 * @member {String} type
 */

ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.prototype['type'] = undefined;
/**
 * Defines the type of the transaction as a number.
 * @member {Number} typeIint
 */

ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.prototype['typeIint'] = undefined;
/**
 * Defines the specific version.
 * @member {Number} version
 */

ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.prototype['version'] = undefined;
/**
 * @member {module:model/ListUnconfirmedOmniTransactionsByAddressResponseItemFee} fee
 */

ListUnconfirmedOmniTransactionsByPropertyIDResponseItem.prototype['fee'] = undefined;
var _default = ListUnconfirmedOmniTransactionsByPropertyIDResponseItem;
