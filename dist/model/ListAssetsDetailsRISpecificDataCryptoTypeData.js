...
/**
 * The ListAssetsDetailsRISpecificDataCryptoTypeData model module.
 * @module model/ListAssetsDetailsRISpecificDataCryptoTypeData
 * @version 1.1.0
 */
var ListAssetsDetailsRISpecificDataCryptoTypeData = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListAssetsDetailsRISpecificDataCryptoTypeData</code>.
   * Crypto Type Data
   * @alias module:model/ListAssetsDetailsRISpecificDataCryptoTypeData
   ...
   * @param assetType {module:model/ListAssetsDetailsRISpecificDataCryptoTypeData.AssetTypeEnum} Subtype of the crypto assets. Could be COIN or TOKEN
   ...
   */
  function ListAssetsDetailsRISpecificDataCryptoTypeData(_1hourPriceChangeInPercentage, _1weekPriceChangeInPercentage, _24hoursPriceChangeInPercentage, _24hoursTradingVolume, assetType, circulatingSupply, marketCapInUSD, maxSupply) {
    _classCallCheck(this, ListAssetsDetailsRISpecificDataCryptoTypeData);

    ListAssetsDetailsRISpecificDataCryptoTypeData.initialize(this, _1hourPriceChangeInPercentage, _1weekPriceChangeInPercentage, _24hoursPriceChangeInPercentage, _24hoursTradingVolume, assetType, circulatingSupply, marketCapInUSD, maxSupply);
  }
  /**
  ...
  _createClass(ListAssetsDetailsRISpecificDataCryptoTypeData, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListAssetsDetailsRISpecificDataCryptoTypeData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAssetsDetailsRISpecificDataCryptoTypeData} obj Optional instance to populate.
     * @return {module:model/ListAssetsDetailsRISpecificDataCryptoTypeData} The populated <code>ListAssetsDetailsRISpecificDataCryptoTypeData</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListAssetsDetailsRISpecificDataCryptoTypeData();
  ...
  return ListAssetsDetailsRISpecificDataCryptoTypeData;
}();
/**
...
ListAssetsDetailsRISpecificDataCryptoTypeData.prototype['1HourPriceChangeInPercentage'] = undefined;
/**
...
ListAssetsDetailsRISpecificDataCryptoTypeData.prototype['1WeekPriceChangeInPercentage'] = undefined;
/**
...
ListAssetsDetailsRISpecificDataCryptoTypeData.prototype['24HoursPriceChangeInPercentage'] = undefined;
/**
 * Represents the trading volume of the asset for the time frame of 24 hours.
 * @member {String} 24HoursTradingVolume
 */

ListAssetsDetailsRISpecificDataCryptoTypeData.prototype['24HoursTradingVolume'] = undefined;
/**
...
ListAssetsDetailsRISpecificDataCryptoTypeData.prototype['assetType'] = undefined;
/**
 * Represents the amount of the asset that is circulating on the market and in public hands.
 * @member {String} circulatingSupply
 */

ListAssetsDetailsRISpecificDataCryptoTypeData.prototype['circulatingSupply'] = undefined;
/**
 * Defines the total market value of the asset's circulating supply in USD.
 * @member {String} marketCapInUSD
 */

ListAssetsDetailsRISpecificDataCryptoTypeData.prototype['marketCapInUSD'] = undefined;
/**
...
ListAssetsDetailsRISpecificDataCryptoTypeData.prototype['maxSupply'] = undefined;
/**
...
ListAssetsDetailsRISpecificDataCryptoTypeData['AssetTypeEnum'] = {
  /**
   * value: "coin"
   * @const
   */
...
var _default = ListAssetsDetailsRISpecificDataCryptoTypeData;
