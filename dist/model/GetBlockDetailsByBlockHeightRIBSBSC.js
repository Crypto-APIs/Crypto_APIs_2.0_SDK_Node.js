...
var GetBlockDetailsByBlockHeightRIBSBSC = /*#__PURE__*/function () {
   ...
   */
  function GetBlockDetailsByBlockHeightRIBSBSC(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty) {
    _classCallCheck(this, GetBlockDetailsByBlockHeightRIBSBSC);

    GetBlockDetailsByBlockHeightRIBSBSC.initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty);
  }
  /**
