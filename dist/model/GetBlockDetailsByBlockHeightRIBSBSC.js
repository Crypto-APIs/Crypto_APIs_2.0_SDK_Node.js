 ...
 * @version 1.11.0
 */
var GetBlockDetailsByBlockHeightRIBSBSC = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetBlockDetailsByBlockHeightRIBSBSC(difficulty, extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty) {
    _classCallCheck(this, GetBlockDetailsByBlockHeightRIBSBSC);
   ...
   */
  _createClass(GetBlockDetailsByBlockHeightRIBSBSC, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHeightRIBSBSC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHeightRIBSBSC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHeightRIBSBSC.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHeightRIBSBSC.RequiredProperties = ["difficulty", "extraData", "gasLimit", "gasUsed", "minedInSeconds", "nonce", "sha3Uncles", "size", "totalDifficulty"];
...
var _default = GetBlockDetailsByBlockHeightRIBSBSC;
