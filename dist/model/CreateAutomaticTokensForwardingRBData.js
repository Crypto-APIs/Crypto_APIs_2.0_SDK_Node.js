...
var CreateAutomaticTokensForwardingRBData = /*#__PURE__*/function () {
  ...
  _createClass(CreateAutomaticTokensForwardingRBData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAutomaticTokensForwardingRBData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAutomaticTokensForwardingRBData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateAutomaticTokensForwardingRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _CreateAutomaticTokensForwardingRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
CreateAutomaticTokensForwardingRBData.RequiredProperties = ["item"];
