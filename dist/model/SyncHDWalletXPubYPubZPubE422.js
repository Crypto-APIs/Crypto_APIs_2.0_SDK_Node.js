...
var SyncHDWalletXPubYPubZPubE422 = /*#__PURE__*/function () {
   ...
   */
  function SyncHDWalletXPubYPubZPubE422() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, SyncHDWalletXPubYPubZPubE422);
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `SyncHDWalletXPubYPubZPubE422` with oneOf schemas InvalidRequestBodyStructure, XpubSyncInProgress. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(SyncHDWalletXPubYPubZPubE422, [{
 ...
 * @member {String} code
 */
_defineProperty(SyncHDWalletXPubYPubZPubE422, "fromJSON", function (json_string) {
...
var _default = SyncHDWalletXPubYPubZPubE422;
