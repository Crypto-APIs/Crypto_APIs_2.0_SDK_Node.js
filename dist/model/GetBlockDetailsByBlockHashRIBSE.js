...
var GetBlockDetailsByBlockHashRIBSE = /*#__PURE__*/function () {
   ...
   */
  function GetBlockDetailsByBlockHashRIBSE(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles) {
    _classCallCheck(this, GetBlockDetailsByBlockHashRIBSE);

    GetBlockDetailsByBlockHashRIBSE.initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles);
  }
  /**
