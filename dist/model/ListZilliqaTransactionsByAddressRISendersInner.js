...
var ListZilliqaTransactionsByAddressRISendersInner = /*#__PURE__*/function () {
  ...
  _createClass(ListZilliqaTransactionsByAddressRISendersInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListZilliqaTransactionsByAddressRISendersInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListZilliqaTransactionsByAddressRISendersInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListZilliqaTransactionsByAddressRISendersInner.RequiredProperties),
        _step;
      try {
...
ListZilliqaTransactionsByAddressRISendersInner.RequiredProperties = ["address", "amount"];
