...
var _DecodeRawTransactionHexRISLVoutInnerScriptPubKey = _interopRequireDefault(require("./DecodeRawTransactionHexRISLVoutInnerScriptPubKey"));
 ...
 * @version 1.11.0
 */
var DecodeRawTransactionHexRISLVoutInner = /*#__PURE__*/function () {
  /**
   ...
   */
  function DecodeRawTransactionHexRISLVoutInner(scriptPubKey) {
    _classCallCheck(this, DecodeRawTransactionHexRISLVoutInner);
   ...
   */
  _createClass(DecodeRawTransactionHexRISLVoutInner, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('scriptPubKey')) {
          obj['scriptPubKey'] = _DecodeRawTransactionHexRISLVoutInnerScriptPubKey["default"].constructFromObject(data['scriptPubKey']);
        }
    ...
    /**
     * Validates the JSON data with respect to <code>DecodeRawTransactionHexRISLVoutInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DecodeRawTransactionHexRISLVoutInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRISLVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _DecodeRawTransactionHexRISLVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
...
DecodeRawTransactionHexRISLVoutInner.RequiredProperties = ["scriptPubKey"];
...
var _default = DecodeRawTransactionHexRISLVoutInner;
