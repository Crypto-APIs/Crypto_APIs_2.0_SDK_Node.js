 ...
 * @version 1.11.0
 */
var NewBlockE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>NewBlockE400</code>.
   * @alias module:model/NewBlockE400
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize NewBlockE400.
   */
  function NewBlockE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, NewBlockE400);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewBlockE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewBlockE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>NewBlockE400</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NewBlockE400} obj Optional instance to populate.
   * @return {module:model/NewBlockE400} The populated <code>NewBlockE400</code> instance.
   */
  _createClass(NewBlockE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewBlockE400.constructFromObject(obj).getActualInstance();
    }
 ...
 * @member {String} code
 */
_defineProperty(NewBlockE400, "fromJSON", function (json_string) {
  return NewBlockE400.constructFromObject(JSON.parse(json_string));
});
NewBlockE400.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
NewBlockE400.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
NewBlockE400.prototype['details'] = undefined;
NewBlockE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
var _default = NewBlockE400;
