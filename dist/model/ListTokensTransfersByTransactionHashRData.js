...
var _ListTokensTransfersByTransactionHashRI = _interopRequireDefault(require("./ListTokensTransfersByTransactionHashRI"));
 ...
 * @version 1.11.0
 */
var ListTokensTransfersByTransactionHashRData = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListTokensTransfersByTransactionHashRData(limit, offset, total, items) {
    _classCallCheck(this, ListTokensTransfersByTransactionHashRData);
   ...
   */
  _createClass(ListTokensTransfersByTransactionHashRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('items')) {
          obj['items'] = _ApiClient["default"].convertToType(data['items'], [_ListTokensTransfersByTransactionHashRI["default"]]);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListTokensTransfersByTransactionHashRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListTokensTransfersByTransactionHashRI["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
var _default = ListTokensTransfersByTransactionHashRData;
