...
var ListConfirmedTransactionsByAddressRIBSBCVinInner = /*#__PURE__*/function () {
  ...
  _createClass(ListConfirmedTransactionsByAddressRIBSBCVinInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListConfirmedTransactionsByAddressRIBSBCVinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListConfirmedTransactionsByAddressRIBSBCVinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListConfirmedTransactionsByAddressRIBSBCVinInner.RequiredProperties),
        _step;
      try {
...
ListConfirmedTransactionsByAddressRIBSBCVinInner.RequiredProperties = ["addresses", "scriptSig", "sequence", "txid", "txinwitness", "value", "vout"];
