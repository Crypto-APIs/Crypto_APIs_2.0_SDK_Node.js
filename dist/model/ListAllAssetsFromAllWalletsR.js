...
var _ListAllAssetsFromAllWalletsRData = _interopRequireDefault(require("./ListAllAssetsFromAllWalletsRData"));
 ...
 * @version 1.11.0
 */
var ListAllAssetsFromAllWalletsR = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListAllAssetsFromAllWalletsR(apiVersion, requestId, data) {
    _classCallCheck(this, ListAllAssetsFromAllWalletsR);
   ...
   */
  _createClass(ListAllAssetsFromAllWalletsR, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ListAllAssetsFromAllWalletsRData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListAllAssetsFromAllWalletsR.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _ListAllAssetsFromAllWalletsRData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
var _default = ListAllAssetsFromAllWalletsR;
