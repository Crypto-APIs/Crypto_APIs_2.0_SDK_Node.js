...
var _PrepareAFungibleTokenTransferFromAddressRBDataItem = _interopRequireDefault(require("./PrepareAFungibleTokenTransferFromAddressRBDataItem"));
 ...
 * @version 1.13.0
 */
var PrepareAFungibleTokenTransferFromAddressRBData = /*#__PURE__*/function () {
  /**
   ...
   */
  function PrepareAFungibleTokenTransferFromAddressRBData(item) {
    _classCallCheck(this, PrepareAFungibleTokenTransferFromAddressRBData);
   ...
   */
  _createClass(PrepareAFungibleTokenTransferFromAddressRBData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _PrepareAFungibleTokenTransferFromAddressRBDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
...
var _default = PrepareAFungibleTokenTransferFromAddressRBData;
