...
var ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey = /*#__PURE__*/function () {
  ...
  _createClass(ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey.RequiredProperties),
        _step;
      try {
...
ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey.RequiredProperties = ["addresses", "asm", "hex", "type"];
