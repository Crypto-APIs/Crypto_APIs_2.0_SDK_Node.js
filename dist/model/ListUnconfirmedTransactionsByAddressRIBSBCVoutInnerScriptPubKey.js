...
var ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey = /*#__PURE__*/function () {
   ...
   */
  function ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey(addresses, asm, hex, reqSigs, type) {
    _classCallCheck(this, ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey);

    ListUnconfirmedTransactionsByAddressRIBSBCVoutInnerScriptPubKey.initialize(this, addresses, asm, hex, reqSigs, type);
  }
  /**
