...
var GetLastMinedBlockRIBSEC = /*#__PURE__*/function () {
   ...
   */
  function GetLastMinedBlockRIBSEC(difficulty, extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty, uncles) {
    _classCallCheck(this, GetLastMinedBlockRIBSEC);

    GetLastMinedBlockRIBSEC.initialize(this, difficulty, extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty, uncles);
  }
  /**
