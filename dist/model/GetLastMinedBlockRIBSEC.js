...
var GetLastMinedBlockRIBSEC = /*#__PURE__*/function () {
   ...
   */
  function GetLastMinedBlockRIBSEC(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles) {
    _classCallCheck(this, GetLastMinedBlockRIBSEC);

    GetLastMinedBlockRIBSEC.initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles);
  }
  /**
