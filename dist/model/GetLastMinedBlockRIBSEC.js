...
/**
 * The GetLastMinedBlockRIBSEC model module.
 * @module model/GetLastMinedBlockRIBSEC
 * @version 1.11.0
 */
var GetLastMinedBlockRIBSEC = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetLastMinedBlockRIBSEC</code>.
   * Ethereum Classic
   * @alias module:model/GetLastMinedBlockRIBSEC
   ...
   */
  function GetLastMinedBlockRIBSEC(extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty, uncles) {
    _classCallCheck(this, GetLastMinedBlockRIBSEC);
    GetLastMinedBlockRIBSEC.initialize(this, extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty, uncles);
  }
   ...
   */
  _createClass(GetLastMinedBlockRIBSEC, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetLastMinedBlockRIBSEC</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLastMinedBlockRIBSEC} obj Optional instance to populate.
     * @return {module:model/GetLastMinedBlockRIBSEC} The populated <code>GetLastMinedBlockRIBSEC</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLastMinedBlockRIBSEC();
    ...
    /**
     * Validates the JSON data with respect to <code>GetLastMinedBlockRIBSEC</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLastMinedBlockRIBSEC</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetLastMinedBlockRIBSEC.RequiredProperties),
        _step;
      try {
...
GetLastMinedBlockRIBSEC.RequiredProperties = ["extraData", "gasLimit", "gasUsed", "minedInSeconds", "nonce", "sha3Uncles", "size", "totalDifficulty", "uncles"];
...
var _default = GetLastMinedBlockRIBSEC;
