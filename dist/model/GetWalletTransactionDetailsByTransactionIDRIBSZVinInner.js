...
var GetWalletTransactionDetailsByTransactionIDRIBSZVinInner = /*#__PURE__*/function () {
  ...
  _createClass(GetWalletTransactionDetailsByTransactionIDRIBSZVinInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetWalletTransactionDetailsByTransactionIDRIBSZVinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetWalletTransactionDetailsByTransactionIDRIBSZVinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetWalletTransactionDetailsByTransactionIDRIBSZVinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _GetTransactionDetailsByTransactionIDRIBSZVinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
...
GetWalletTransactionDetailsByTransactionIDRIBSZVinInner.RequiredProperties = ["addresses", "scriptSig", "sequence", "txid", "value", "vout"];
