...
/**
 * The FreezeTronEnergyOrBandwidthE409 model module.
 * @module model/FreezeTronEnergyOrBandwidthE409
 * @version 1.10.0
 */
var FreezeTronEnergyOrBandwidthE409 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>FreezeTronEnergyOrBandwidthE409</code>.
   * @alias module:model/FreezeTronEnergyOrBandwidthE409
   ...
   */
  function FreezeTronEnergyOrBandwidthE409(code, message) {
    _classCallCheck(this, FreezeTronEnergyOrBandwidthE409);
    ...
    FreezeTronEnergyOrBandwidthE409.initialize(this, code, message);
  }
   ...
   */
  _createClass(FreezeTronEnergyOrBandwidthE409, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>FreezeTronEnergyOrBandwidthE409</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FreezeTronEnergyOrBandwidthE409} obj Optional instance to populate.
     * @return {module:model/FreezeTronEnergyOrBandwidthE409} The populated <code>FreezeTronEnergyOrBandwidthE409</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new FreezeTronEnergyOrBandwidthE409();
  ...
  return FreezeTronEnergyOrBandwidthE409;
}();
/**
 * Specifies an error code, e.g. error 404.
 * @member {String} code
 */
FreezeTronEnergyOrBandwidthE409.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
FreezeTronEnergyOrBandwidthE409.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
FreezeTronEnergyOrBandwidthE409.prototype['details'] = undefined;
...
var _default = FreezeTronEnergyOrBandwidthE409;
