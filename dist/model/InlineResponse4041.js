 ...
 * @version 1.5.0
 */
var InlineResponse4041 = /*#__PURE__*/function () {
  /**
   ...
   */
  function InlineResponse4041(apiVersion, requestId, error) {
    _classCallCheck(this, InlineResponse4041);

    InlineResponse4041.initialize(this, apiVersion, requestId, error);
  }
  /**
  ...
  _createClass(InlineResponse4041, null, [{
    key: "initialize",
...
InlineResponse4041.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

InlineResponse4041.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

InlineResponse4041.prototype['context'] = undefined;
/**
 * @member {module:model/ResourceNotFound} error
 */

InlineResponse4041.prototype['error'] = undefined;
var _default = InlineResponse4041;
