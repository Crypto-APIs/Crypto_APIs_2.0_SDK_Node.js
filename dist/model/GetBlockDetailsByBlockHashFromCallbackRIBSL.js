...
var GetBlockDetailsByBlockHashFromCallbackRIBSL = /*#__PURE__*/function () {
  ...
  _createClass(GetBlockDetailsByBlockHashFromCallbackRIBSL, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHashFromCallbackRIBSL</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHashFromCallbackRIBSL</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashFromCallbackRIBSL.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHashFromCallbackRIBSL.RequiredProperties = ["bits", "chainwork", "difficulty", "merkleRoot", "nonce", "size", "strippedsize", "version", "versionHex", "weight"];
