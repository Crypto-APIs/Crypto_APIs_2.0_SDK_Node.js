...
var TransactionRequestRejectionData = /*#__PURE__*/function () {
  ...
  _createClass(TransactionRequestRejectionData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TransactionRequestRejectionData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _TransactionRequestRejectionDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
