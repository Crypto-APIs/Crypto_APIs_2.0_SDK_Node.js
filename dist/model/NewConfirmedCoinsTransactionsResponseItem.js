...
/**
 * The NewConfirmedCoinsTransactionsResponseItem model module.
 * @module model/NewConfirmedCoinsTransactionsResponseItem
 * @version 2.0.0
 */
var NewConfirmedCoinsTransactionsResponseItem = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>NewConfirmedCoinsTransactionsResponseItem</code>.
   * @alias module:model/NewConfirmedCoinsTransactionsResponseItem
   ...
   */
  function NewConfirmedCoinsTransactionsResponseItem(address, callbackSecretKey, callbackUrl, confirmationsCount, createdTimestamp, eventType, isActive, referenceId, transactionId) {
    _classCallCheck(this, NewConfirmedCoinsTransactionsResponseItem);

    NewConfirmedCoinsTransactionsResponseItem.initialize(this, address, callbackSecretKey, callbackUrl, confirmationsCount, createdTimestamp, eventType, isActive, referenceId, transactionId);
  }
  /**
  ...
  _createClass(NewConfirmedCoinsTransactionsResponseItem, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>NewConfirmedCoinsTransactionsResponseItem</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/NewConfirmedCoinsTransactionsResponseItem} obj Optional instance to populate.
     * @return {module:model/NewConfirmedCoinsTransactionsResponseItem} The populated <code>NewConfirmedCoinsTransactionsResponseItem</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new NewConfirmedCoinsTransactionsResponseItem();
  ...
  return NewConfirmedCoinsTransactionsResponseItem;
}();
/**
...
NewConfirmedCoinsTransactionsResponseItem.prototype['address'] = undefined;
/**
...
NewConfirmedCoinsTransactionsResponseItem.prototype['callbackSecretKey'] = undefined;
/**
 * Represents the URL that is set by the customer where the callback will be received at. The callback notification will be received only if and when the event occurs.
 * @member {String} callbackUrl
 */

NewConfirmedCoinsTransactionsResponseItem.prototype['callbackUrl'] = undefined;
/**
 * Represents the number of confirmations, i.e. the amount of blocks that have been built on top of this block.
 * @member {Number} confirmationsCount
 */

NewConfirmedCoinsTransactionsResponseItem.prototype['confirmationsCount'] = undefined;
/**
 * Defines the specific time/date when the subscription was created in Unix Timestamp.
 * @member {Number} createdTimestamp
 */

NewConfirmedCoinsTransactionsResponseItem.prototype['createdTimestamp'] = undefined;
/**
 * Defines the type of the specific event available for the customer to subscribe to for callback notification.
 * @member {String} eventType
 */

NewConfirmedCoinsTransactionsResponseItem.prototype['eventType'] = undefined;
/**
 * Defines whether the subscription is active or not. Set as boolean.
 * @member {Boolean} isActive
 */

NewConfirmedCoinsTransactionsResponseItem.prototype['isActive'] = undefined;
/**
 * Represents a unique ID used to reference the specific callback subscription.
 * @member {String} referenceId
 */

NewConfirmedCoinsTransactionsResponseItem.prototype['referenceId'] = undefined;
/**
 * Represents the unique identification string that defines the transaction.
 * @member {String} transactionId
 */

NewConfirmedCoinsTransactionsResponseItem.prototype['transactionId'] = undefined;
var _default = NewConfirmedCoinsTransactionsResponseItem;
