...
var BroadcastLocallySignedTransactionRBDataItem = /*#__PURE__*/function () {
  ...
  _createClass(BroadcastLocallySignedTransactionRBDataItem, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>BroadcastLocallySignedTransactionRBDataItem</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BroadcastLocallySignedTransactionRBDataItem</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(BroadcastLocallySignedTransactionRBDataItem.RequiredProperties),
        _step;
      try {
      ...
      // ensure the json data is a string
      if (data['signedTransactionHex'] && !(typeof data['signedTransactionHex'] === 'string' || data['signedTransactionHex'] instanceof String)) {
        throw new Error("Expected the field `signedTransactionHex` to be a primitive type in the JSON string but got " + data['signedTransactionHex']);
      }
      return true;
    }
  }]);
...
BroadcastLocallySignedTransactionRBDataItem.RequiredProperties = ["signedTransactionHex"];
