...
var GetTransactionRequestDetailsE401 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidApiKey|module:model/MissingApiKey)} instance The actual instance to initialize GetTransactionRequestDetailsE401.
   */
  function GetTransactionRequestDetailsE401() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetTransactionRequestDetailsE401);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetTransactionRequestDetailsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetTransactionRequestDetailsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>GetTransactionRequestDetailsE401</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetTransactionRequestDetailsE401} obj Optional instance to populate.
   * @return {module:model/GetTransactionRequestDetailsE401} The populated <code>GetTransactionRequestDetailsE401</code> instance.
   */
  _createClass(GetTransactionRequestDetailsE401, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetTransactionRequestDetailsE401.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetTransactionRequestDetailsE401(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetTransactionRequestDetailsE401, "fromJSON", function (json_string) {
  return GetTransactionRequestDetailsE401.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GetTransactionRequestDetailsE401.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
GetTransactionRequestDetailsE401.prototype['details'] = undefined;
GetTransactionRequestDetailsE401.OneOf = ["InvalidApiKey", "MissingApiKey"];
var _default = GetTransactionRequestDetailsE401;
