...
var GetTransactionDetailsByTransactionIDRIBSD = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDRIBSD, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransactionDetailsByTransactionIDRIBSD</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransactionDetailsByTransactionIDRIBSD</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDRIBSD.RequiredProperties),
        _step;
      try {
      ...
      if (data['vin']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _GetTransactionDetailsByTransactionIDRIBSDVinInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
...
GetTransactionDetailsByTransactionIDRIBSD.RequiredProperties = ["locktime", "size", "version", "vin", "vout"];
