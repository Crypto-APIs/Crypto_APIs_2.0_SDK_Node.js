...
var _TokensForwardingFailData = _interopRequireDefault(require("./TokensForwardingFailData"));
 ...
 * @version 1.11.0
 */
var TokensForwardingFail = /*#__PURE__*/function () {
  /**
   ...
   */
  function TokensForwardingFail(apiVersion, referenceId, idempotencyKey, data) {
    _classCallCheck(this, TokensForwardingFail);
   ...
   */
  _createClass(TokensForwardingFail, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _TokensForwardingFailData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>TokensForwardingFail</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TokensForwardingFail</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TokensForwardingFail.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _TokensForwardingFailData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
TokensForwardingFail.RequiredProperties = ["apiVersion", "referenceId", "idempotencyKey", "data"];
...
var _default = TokensForwardingFail;
