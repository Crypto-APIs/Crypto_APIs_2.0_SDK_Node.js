...
var DecodeRawTransactionHexRISDVinInner = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISDVinInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>DecodeRawTransactionHexRISDVinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DecodeRawTransactionHexRISDVinInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRISDVinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _DecodeRawTransactionHexRISDVinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
      // ensure the json data is a string
...
DecodeRawTransactionHexRISDVinInner.RequiredProperties = ["scriptSig"];
