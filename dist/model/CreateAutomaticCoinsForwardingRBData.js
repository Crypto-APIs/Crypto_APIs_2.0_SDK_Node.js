...
var CreateAutomaticCoinsForwardingRBData = /*#__PURE__*/function () {
  ...
  _createClass(CreateAutomaticCoinsForwardingRBData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(CreateAutomaticCoinsForwardingRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _CreateAutomaticCoinsForwardingRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
