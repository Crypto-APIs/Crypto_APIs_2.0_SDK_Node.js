...
var TokensForwardingSuccessData = /*#__PURE__*/function () {
  ...
  _createClass(TokensForwardingSuccessData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>TokensForwardingSuccessData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TokensForwardingSuccessData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TokensForwardingSuccessData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _TokensForwardingSuccessDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
TokensForwardingSuccessData.RequiredProperties = ["product", "event", "item"];
