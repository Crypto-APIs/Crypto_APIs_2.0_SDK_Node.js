 ...
 * @version 1.11.0
 */
var GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig(asm, hex, type) {
    _classCallCheck(this, GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig);
   ...
   */
  _createClass(GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig.RequiredProperties),
        _step;
      try {
...
GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig.RequiredProperties = ["asm", "hex", "type"];
...
var _default = GetTransactionDetailsByTransactionIDRIBSD2VinInnerScriptSig;
