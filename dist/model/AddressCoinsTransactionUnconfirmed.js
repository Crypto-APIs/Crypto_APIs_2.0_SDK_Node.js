...
var _AddressCoinsTransactionUnconfirmedData = _interopRequireDefault(require("./AddressCoinsTransactionUnconfirmedData"));
...
var AddressCoinsTransactionUnconfirmed = /*#__PURE__*/function () {
   ...
   */
  function AddressCoinsTransactionUnconfirmed(apiVersion, referenceId, idempotencyKey, data) {
    _classCallCheck(this, AddressCoinsTransactionUnconfirmed);
   ...
   */
  _createClass(AddressCoinsTransactionUnconfirmed, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _AddressCoinsTransactionUnconfirmedData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>AddressCoinsTransactionUnconfirmed</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressCoinsTransactionUnconfirmed</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressCoinsTransactionUnconfirmed.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _AddressCoinsTransactionUnconfirmedData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
AddressCoinsTransactionUnconfirmed.RequiredProperties = ["apiVersion", "referenceId", "idempotencyKey", "data"];
...
var _default = AddressCoinsTransactionUnconfirmed;
