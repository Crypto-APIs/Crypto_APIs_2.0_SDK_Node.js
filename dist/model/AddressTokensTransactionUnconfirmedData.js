...
var AddressTokensTransactionUnconfirmedData = /*#__PURE__*/function () {
  ...
  _createClass(AddressTokensTransactionUnconfirmedData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddressTokensTransactionUnconfirmedData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddressTokensTransactionUnconfirmedData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddressTokensTransactionUnconfirmedData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _AddressTokensTransactionUnconfirmedDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
AddressTokensTransactionUnconfirmedData.RequiredProperties = ["product", "event", "item"];
