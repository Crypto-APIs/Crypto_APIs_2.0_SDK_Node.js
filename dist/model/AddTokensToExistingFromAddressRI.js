...
var AddTokensToExistingFromAddressRI = /*#__PURE__*/function () {
  ...
  _createClass(AddTokensToExistingFromAddressRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AddTokensToExistingFromAddressRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['tokenData']) {
        // data not null
        _AddTokensToExistingFromAddressRITS["default"].validateJSON(data['tokenData']);
      }
      return true;
    }
  }]);
