...
var GetZilliqaAddressDetailsE400 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize GetZilliqaAddressDetailsE400.
   */
  function GetZilliqaAddressDetailsE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetZilliqaAddressDetailsE400);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetZilliqaAddressDetailsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetZilliqaAddressDetailsE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>GetZilliqaAddressDetailsE400</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetZilliqaAddressDetailsE400} obj Optional instance to populate.
   * @return {module:model/GetZilliqaAddressDetailsE400} The populated <code>GetZilliqaAddressDetailsE400</code> instance.
   */
  _createClass(GetZilliqaAddressDetailsE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetZilliqaAddressDetailsE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetZilliqaAddressDetailsE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetZilliqaAddressDetailsE400, "fromJSON", function (json_string) {
  return GetZilliqaAddressDetailsE400.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GetZilliqaAddressDetailsE400.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
GetZilliqaAddressDetailsE400.prototype['details'] = undefined;
GetZilliqaAddressDetailsE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
var _default = GetZilliqaAddressDetailsE400;
