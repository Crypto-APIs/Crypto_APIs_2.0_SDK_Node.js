 ...
 * @version 1.11.0
 */
var EstimateTransactionSmartFeeE401 = /*#__PURE__*/function () {
  /**
   ...
   */
  function EstimateTransactionSmartFeeE401() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, EstimateTransactionSmartFeeE401);
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `EstimateTransactionSmartFeeE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(EstimateTransactionSmartFeeE401, [{
 ...
 * @member {String} code
 */
_defineProperty(EstimateTransactionSmartFeeE401, "fromJSON", function (json_string) {
...
var _default = EstimateTransactionSmartFeeE401;
