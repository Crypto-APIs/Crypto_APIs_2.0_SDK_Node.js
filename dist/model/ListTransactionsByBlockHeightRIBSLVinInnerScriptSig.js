...
var ListTransactionsByBlockHeightRIBSLVinInnerScriptSig = /*#__PURE__*/function () {
   ...
   */
  function ListTransactionsByBlockHeightRIBSLVinInnerScriptSig(asm, hex, type) {
    _classCallCheck(this, ListTransactionsByBlockHeightRIBSLVinInnerScriptSig);
   ...
   */
  _createClass(ListTransactionsByBlockHeightRIBSLVinInnerScriptSig, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHeightRIBSLVinInnerScriptSig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHeightRIBSLVinInnerScriptSig</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSLVinInnerScriptSig.RequiredProperties),
        _step;
      try {
...
ListTransactionsByBlockHeightRIBSLVinInnerScriptSig.RequiredProperties = ["asm", "hex", "type"];
...
var _default = ListTransactionsByBlockHeightRIBSLVinInnerScriptSig;
