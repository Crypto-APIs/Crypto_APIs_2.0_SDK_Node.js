...
var NewConfirmedTokenTransactionsForSpecificAmountRData = /*#__PURE__*/function () {
  ...
  _createClass(NewConfirmedTokenTransactionsForSpecificAmountRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(NewConfirmedTokenTransactionsForSpecificAmountRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _NewConfirmedTokenTransactionsForSpecificAmountRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
