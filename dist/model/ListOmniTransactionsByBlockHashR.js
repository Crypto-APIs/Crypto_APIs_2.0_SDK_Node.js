...
var _ListOmniTransactionsByBlockHashRData = _interopRequireDefault(require("./ListOmniTransactionsByBlockHashRData"));
 ...
 * @version 1.5.0
 */
var ListOmniTransactionsByBlockHashR = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListOmniTransactionsByBlockHashR(apiVersion, requestId, data) {
    _classCallCheck(this, ListOmniTransactionsByBlockHashR);
  ...
  _createClass(ListOmniTransactionsByBlockHashR, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ListOmniTransactionsByBlockHashRData["default"].constructFromObject(data['data']);
        }
      }
...
var _default = ListOmniTransactionsByBlockHashR;
