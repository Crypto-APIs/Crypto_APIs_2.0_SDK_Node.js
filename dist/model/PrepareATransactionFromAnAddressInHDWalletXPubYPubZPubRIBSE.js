...
var PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSE = /*#__PURE__*/function () {
  ...
  _createClass(PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSE, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSE</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSE</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSE.RequiredProperties),
        _step;
      try {
      ...
      if (data['fee']) {
        // data not null
        _PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSEFee["default"].validateJSON(data['fee']);
      }
      // ensure the json data is a string
...
PrepareATransactionFromAnAddressInHDWalletXPubYPubZPubRIBSE.RequiredProperties = ["dataHex", "derivationIndex", "fee", "nonce", "transactionType", "unit"];
