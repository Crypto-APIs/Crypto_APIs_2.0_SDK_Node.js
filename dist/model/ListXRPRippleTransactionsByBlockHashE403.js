 ...
 * @version 1.11.0
 */
var ListXRPRippleTransactionsByBlockHashE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListXRPRippleTransactionsByBlockHashE403</code>.
   * @alias module:model/ListXRPRippleTransactionsByBlockHashE403
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize ListXRPRippleTransactionsByBlockHashE403.
   */
  function ListXRPRippleTransactionsByBlockHashE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, ListXRPRippleTransactionsByBlockHashE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListXRPRippleTransactionsByBlockHashE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListXRPRippleTransactionsByBlockHashE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>ListXRPRippleTransactionsByBlockHashE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListXRPRippleTransactionsByBlockHashE403} obj Optional instance to populate.
   * @return {module:model/ListXRPRippleTransactionsByBlockHashE403} The populated <code>ListXRPRippleTransactionsByBlockHashE403</code> instance.
   */
  _createClass(ListXRPRippleTransactionsByBlockHashE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListXRPRippleTransactionsByBlockHashE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListXRPRippleTransactionsByBlockHashE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListXRPRippleTransactionsByBlockHashE403, "fromJSON", function (json_string) {
  return ListXRPRippleTransactionsByBlockHashE403.constructFromObject(JSON.parse(json_string));
});
ListXRPRippleTransactionsByBlockHashE403.prototype['code'] = undefined;
...
ListXRPRippleTransactionsByBlockHashE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = ListXRPRippleTransactionsByBlockHashE403;
