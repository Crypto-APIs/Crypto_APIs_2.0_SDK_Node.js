...
var ListTransactionsByBlockHashRIBSZVinInner = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHashRIBSZVinInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIBSZVinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _ListTransactionsByBlockHashRIBSZVinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
      // ensure the json data is a string
