...
var GetZilliqaAddressDetailsRI = /*#__PURE__*/function () {
  ...
  _createClass(GetZilliqaAddressDetailsRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetZilliqaAddressDetailsRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['balance']) {
        // data not null
        _GetZilliqaAddressDetailsRIBalance["default"].validateJSON(data['balance']);
      }
      return true;
    }
  }]);
