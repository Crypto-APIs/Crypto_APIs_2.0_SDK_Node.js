...
/**
 * The GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic model module.
 * @module model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic
 * @version 2.0.0
 */
var GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic</code>.
   * Ethereum Classic
   * @alias module:model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic
   ...
   */
  function GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty) {
    _classCallCheck(this, GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic);

    GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic.initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty);
  }
  /**
  ...
  _createClass(GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic} The populated <code>GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic();
  ...
  return GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic;
}();
/**
...
var _default = GetBlockDetailsByBlockHeightResponseItemBlockchainSpecificEthereumClassic;
