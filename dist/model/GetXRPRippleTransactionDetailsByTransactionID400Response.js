...
var _GetXRPRippleTransactionDetailsByTransactionIDE = _interopRequireDefault(require("./GetXRPRippleTransactionDetailsByTransactionIDE400"));
 ...
 * @version 1.11.0
 */
var GetXRPRippleTransactionDetailsByTransactionID400Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetXRPRippleTransactionDetailsByTransactionID400Response(apiVersion, requestId, error) {
    _classCallCheck(this, GetXRPRippleTransactionDetailsByTransactionID400Response);
   ...
   */
  _createClass(GetXRPRippleTransactionDetailsByTransactionID400Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetXRPRippleTransactionDetailsByTransactionID400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetXRPRippleTransactionDetailsByTransactionID400Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetXRPRippleTransactionDetailsByTransactionID400Response.RequiredProperties),
        _step;
      try {
...
GetXRPRippleTransactionDetailsByTransactionID400Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = GetXRPRippleTransactionDetailsByTransactionID400Response;
