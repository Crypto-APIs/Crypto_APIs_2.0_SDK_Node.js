 ...
 * @version 1.11.0
 */
var ListXRPRippleTransactionsByBlockHeight400Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListXRPRippleTransactionsByBlockHeight400Response(apiVersion, requestId, error) {
    _classCallCheck(this, ListXRPRippleTransactionsByBlockHeight400Response);
   ...
   */
  _createClass(ListXRPRippleTransactionsByBlockHeight400Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListXRPRippleTransactionsByBlockHeight400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListXRPRippleTransactionsByBlockHeight400Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListXRPRippleTransactionsByBlockHeight400Response.RequiredProperties),
        _step;
      try {
...
ListXRPRippleTransactionsByBlockHeight400Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = ListXRPRippleTransactionsByBlockHeight400Response;
