 ...
 * @version 1.5.0
 */
var InlineResponse4226 = /*#__PURE__*/function () {
  /**
   ...
   */
  function InlineResponse4226(apiVersion, requestId, error) {
    _classCallCheck(this, InlineResponse4226);

    InlineResponse4226.initialize(this, apiVersion, requestId, error);
  }
  /**
  ...
  _createClass(InlineResponse4226, null, [{
    key: "initialize",
...
InlineResponse4226.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

InlineResponse4226.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

InlineResponse4226.prototype['context'] = undefined;
/**
 * @member {module:model/GetExchangeRateByAssetSymbolsE422} error
 */

InlineResponse4226.prototype['error'] = undefined;
var _default = InlineResponse4226;
