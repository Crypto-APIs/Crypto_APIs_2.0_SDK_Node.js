...
/**
 * The ListAssetsDetailsE400 model module.
 * @module model/ListAssetsDetailsE400
 * @version 1.6.0
 */
var ListAssetsDetailsE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListAssetsDetailsE400</code>.
   * @alias module:model/ListAssetsDetailsE400
   ...
   */
  function ListAssetsDetailsE400(code, message) {
    _classCallCheck(this, ListAssetsDetailsE400);
    ...
    ListAssetsDetailsE400.initialize(this, code, message);
  }
  /**
  ...
  _createClass(ListAssetsDetailsE400, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListAssetsDetailsE400</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListAssetsDetailsE400} obj Optional instance to populate.
     * @return {module:model/ListAssetsDetailsE400} The populated <code>ListAssetsDetailsE400</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListAssetsDetailsE400();
...
ListAssetsDetailsE400.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

ListAssetsDetailsE400.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

ListAssetsDetailsE400.prototype['details'] = undefined; // Implement UriNotFound interface:
...
var _default = ListAssetsDetailsE400;
