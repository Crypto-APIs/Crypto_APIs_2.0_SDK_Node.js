...
var GetBlockDetailsByBlockHashRIBSBSC = /*#__PURE__*/function () {
   ...
   */
  function GetBlockDetailsByBlockHashRIBSBSC(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty) {
    _classCallCheck(this, GetBlockDetailsByBlockHashRIBSBSC);

    GetBlockDetailsByBlockHashRIBSBSC.initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty);
  }
  /**
