...
var _NewConfirmedCoinsTransactionsForSpecificAmountE = _interopRequireDefault(require("./NewConfirmedCoinsTransactionsForSpecificAmountE409"));
 ...
 * @version 1.11.0
 */
var NewConfirmedCoinsTransactionsForSpecificAmount409Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function NewConfirmedCoinsTransactionsForSpecificAmount409Response(apiVersion, requestId, error) {
    _classCallCheck(this, NewConfirmedCoinsTransactionsForSpecificAmount409Response);
   ...
   */
  _createClass(NewConfirmedCoinsTransactionsForSpecificAmount409Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>NewConfirmedCoinsTransactionsForSpecificAmount409Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewConfirmedCoinsTransactionsForSpecificAmount409Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewConfirmedCoinsTransactionsForSpecificAmount409Response.RequiredProperties),
        _step;
      try {
  ...
  return NewConfirmedCoinsTransactionsForSpecificAmount409Response;
}();
NewConfirmedCoinsTransactionsForSpecificAmount409Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = NewConfirmedCoinsTransactionsForSpecificAmount409Response;
