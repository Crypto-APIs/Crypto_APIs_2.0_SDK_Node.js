...
var NewConfirmedInternalTransactionsE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/BlockchainEventsCallbacksLimitReached|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize NewConfirmedInternalTransactionsE403.
   */
  function NewConfirmedInternalTransactionsE403() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `NewConfirmedInternalTransactionsE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `NewConfirmedInternalTransactionsE403` with oneOf schemas BannedIpAddress, BlockchainEventsCallbacksLimitReached, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(NewConfirmedInternalTransactionsE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = NewConfirmedInternalTransactionsE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new NewConfirmedInternalTransactionsE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(NewConfirmedInternalTransactionsE403, "fromJSON", function (json_string) {
  return NewConfirmedInternalTransactionsE403.constructFromObject(JSON.parse(json_string));
});
 ...
 */
NewConfirmedInternalTransactionsE403.prototype['details'] = undefined;
NewConfirmedInternalTransactionsE403.OneOf = ["BannedIpAddress", "BlockchainEventsCallbacksLimitReached", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
