...
var GetBlockDetailsByBlockHeightRIBSD2 = /*#__PURE__*/function () {
   ...
   */
  function GetBlockDetailsByBlockHeightRIBSD2(difficulty, bits, chainwork, merkleRoot, nonce, size, version, versionHex) {
    _classCallCheck(this, GetBlockDetailsByBlockHeightRIBSD2);
   ...
   */
  _createClass(GetBlockDetailsByBlockHeightRIBSD2, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHeightRIBSD2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHeightRIBSD2</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHeightRIBSD2.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHeightRIBSD2.RequiredProperties = ["difficulty", "bits", "chainwork", "merkleRoot", "nonce", "size", "version", "versionHex"];
...
var _default = GetBlockDetailsByBlockHeightRIBSD2;
