...
var NewConfirmedInternalTransactionsForSpecificAmount409Response = /*#__PURE__*/function () {
  ...
  _createClass(NewConfirmedInternalTransactionsForSpecificAmount409Response, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>NewConfirmedInternalTransactionsForSpecificAmount409Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewConfirmedInternalTransactionsForSpecificAmount409Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewConfirmedInternalTransactionsForSpecificAmount409Response.RequiredProperties),
        _step;
      try {
...
NewConfirmedInternalTransactionsForSpecificAmount409Response.RequiredProperties = ["apiVersion", "requestId", "error"];
