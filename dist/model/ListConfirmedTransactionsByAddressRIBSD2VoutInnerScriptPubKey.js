...
var ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey = /*#__PURE__*/function () {
  ...
  _createClass(ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey.RequiredProperties),
        _step;
      try {
...
ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey.RequiredProperties = ["addresses", "asm", "hex", "type"];
