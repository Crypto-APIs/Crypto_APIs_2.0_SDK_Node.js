...
var DecodeRawTransactionHexRISBVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISBVoutInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>DecodeRawTransactionHexRISBVoutInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DecodeRawTransactionHexRISBVoutInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRISBVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _DecodeRawTransactionHexRISBVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
...
DecodeRawTransactionHexRISBVoutInner.RequiredProperties = ["scriptPubKey"];
