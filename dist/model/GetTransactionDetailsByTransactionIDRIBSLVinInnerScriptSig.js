 ...
 * @version 1.11.0
 */
var GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig(asm, hex, type) {
    _classCallCheck(this, GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig);
   ...
   */
  _createClass(GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig.RequiredProperties),
        _step;
      try {
...
GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig.RequiredProperties = ["asm", "hex", "type"];
...
var _default = GetTransactionDetailsByTransactionIDRIBSLVinInnerScriptSig;
