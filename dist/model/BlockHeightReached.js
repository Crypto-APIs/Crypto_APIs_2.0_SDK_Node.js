...
var _BlockHeightReachedData = _interopRequireDefault(require("./BlockHeightReachedData"));
...
var BlockHeightReached = /*#__PURE__*/function () {
   ...
   */
  function BlockHeightReached(apiVersion, referenceId, idempotencyKey, data) {
    _classCallCheck(this, BlockHeightReached);
   ...
   */
  _createClass(BlockHeightReached, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _BlockHeightReachedData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(BlockHeightReached.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _BlockHeightReachedData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
var _default = BlockHeightReached;
