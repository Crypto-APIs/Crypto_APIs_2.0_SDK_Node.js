...
var GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig = /*#__PURE__*/function () {
  ...
  _createClass(GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig.RequiredProperties),
        _step;
      try {
...
GetWalletTransactionDetailsByTransactionIDRIBSBCVinInnerScriptSig.RequiredProperties = ["asm", "hex", "type"];
