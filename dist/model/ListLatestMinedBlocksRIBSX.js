...
var ListLatestMinedBlocksRIBSX = /*#__PURE__*/function () {
  ...
  _createClass(ListLatestMinedBlocksRIBSX, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListLatestMinedBlocksRIBSX.RequiredProperties),
        _step;
      try {
      ...
      if (data['totalCoins']) {
        // data not null
        _ListLatestMinedBlocksRIBSXTotalCoins["default"].validateJSON(data['totalCoins']);
      }
      // validate the optional field `totalFees`
      if (data['totalFees']) {
        // data not null
        _ListLatestMinedBlocksRIBSXTotalFees["default"].validateJSON(data['totalFees']);
      }
      return true;
    }
  }]);
