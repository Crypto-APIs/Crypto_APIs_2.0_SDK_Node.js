...
var ListTransactionsByBlockHeightRIBSZVinInner = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHeightRIBSZVinInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSZVinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _ListTransactionsByBlockHeightRIBSZVinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
      // ensure the json data is a string
