...
var _InvalidRequestBodyStructureError = _interopRequireDefault(require("./InvalidRequestBodyStructureError"));
...
var InvalidRequestBodyStructure = /*#__PURE__*/function () {
   ...
   * @param error {module:model/InvalidRequestBodyStructureError} 
   */
  function InvalidRequestBodyStructure(apiVersion, requestId, error) {
    _classCallCheck(this, InvalidRequestBodyStructure);

    InvalidRequestBodyStructure.initialize(this, apiVersion, requestId, error);
  }
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _InvalidRequestBodyStructureError["default"].constructFromObject(data['error']);
        }
      }
...
InvalidRequestBodyStructure.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

InvalidRequestBodyStructure.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

InvalidRequestBodyStructure.prototype['context'] = undefined;
/**
 * @member {module:model/InvalidRequestBodyStructureError} error
 */

InvalidRequestBodyStructure.prototype['error'] = undefined;
