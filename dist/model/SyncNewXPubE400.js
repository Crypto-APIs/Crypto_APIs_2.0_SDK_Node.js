...
/**
 * The SyncNewXPubE400 model module.
 * @module model/SyncNewXPubE400
 * @version 1.7.0
 */
var SyncNewXPubE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>SyncNewXPubE400</code>.
   * @alias module:model/SyncNewXPubE400
   ...
   */
  function SyncNewXPubE400(code, message) {
    _classCallCheck(this, SyncNewXPubE400);
    ...
    SyncNewXPubE400.initialize(this, code, message);
  }
  /**
  ...
  _createClass(SyncNewXPubE400, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>SyncNewXPubE400</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SyncNewXPubE400} obj Optional instance to populate.
     * @return {module:model/SyncNewXPubE400} The populated <code>SyncNewXPubE400</code> instance.
     */
...
SyncNewXPubE400.prototype['code'] = undefined;
/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */

SyncNewXPubE400.prototype['message'] = undefined;
/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */

SyncNewXPubE400.prototype['details'] = undefined; // Implement UriNotFound interface:
