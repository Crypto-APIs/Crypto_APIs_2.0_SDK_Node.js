...
var ConfirmedTokensTransactionForCertainAmountOrHigherData = /*#__PURE__*/function () {
  ...
  _createClass(ConfirmedTokensTransactionForCertainAmountOrHigherData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmedTokensTransactionForCertainAmountOrHigherData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmedTokensTransactionForCertainAmountOrHigherData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ConfirmedTokensTransactionForCertainAmountOrHigherData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _ConfirmedTokensTransactionForCertainAmountOrHigherDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
ConfirmedTokensTransactionForCertainAmountOrHigherData.RequiredProperties = ["product", "event", "item"];
