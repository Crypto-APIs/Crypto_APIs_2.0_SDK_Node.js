...
var GetFeeAddressDetailsE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize GetFeeAddressDetailsE403.
   */
  function GetFeeAddressDetailsE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetFeeAddressDetailsE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetFeeAddressDetailsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetFeeAddressDetailsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>GetFeeAddressDetailsE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetFeeAddressDetailsE403} obj Optional instance to populate.
   * @return {module:model/GetFeeAddressDetailsE403} The populated <code>GetFeeAddressDetailsE403</code> instance.
   */
  _createClass(GetFeeAddressDetailsE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetFeeAddressDetailsE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetFeeAddressDetailsE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetFeeAddressDetailsE403, "fromJSON", function (json_string) {
  return GetFeeAddressDetailsE403.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GetFeeAddressDetailsE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
GetFeeAddressDetailsE403.prototype['details'] = undefined;
GetFeeAddressDetailsE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = GetFeeAddressDetailsE403;
