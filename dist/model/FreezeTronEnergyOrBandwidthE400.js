...
/**
 * The FreezeTronEnergyOrBandwidthE400 model module.
 * @module model/FreezeTronEnergyOrBandwidthE400
 * @version 1.10.0
 */
var FreezeTronEnergyOrBandwidthE400 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>FreezeTronEnergyOrBandwidthE400</code>.
   * @alias module:model/FreezeTronEnergyOrBandwidthE400
   ...
   */
  function FreezeTronEnergyOrBandwidthE400(code, message) {
    _classCallCheck(this, FreezeTronEnergyOrBandwidthE400);
    ...
    FreezeTronEnergyOrBandwidthE400.initialize(this, code, message);
  }
   ...
   */
  _createClass(FreezeTronEnergyOrBandwidthE400, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>FreezeTronEnergyOrBandwidthE400</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/FreezeTronEnergyOrBandwidthE400} obj Optional instance to populate.
     * @return {module:model/FreezeTronEnergyOrBandwidthE400} The populated <code>FreezeTronEnergyOrBandwidthE400</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new FreezeTronEnergyOrBandwidthE400();
  ...
  return FreezeTronEnergyOrBandwidthE400;
}();
/**
 * Specifies an error code, e.g. error 404.
 * @member {String} code
 */
FreezeTronEnergyOrBandwidthE400.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
FreezeTronEnergyOrBandwidthE400.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
FreezeTronEnergyOrBandwidthE400.prototype['details'] = undefined;
...
var _default = FreezeTronEnergyOrBandwidthE400;
