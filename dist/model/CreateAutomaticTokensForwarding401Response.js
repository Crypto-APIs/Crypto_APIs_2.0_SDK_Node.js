...
var CreateAutomaticTokensForwarding401Response = /*#__PURE__*/function () {
  ...
  _createClass(CreateAutomaticTokensForwarding401Response, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>CreateAutomaticTokensForwarding401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateAutomaticTokensForwarding401Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateAutomaticTokensForwarding401Response.RequiredProperties),
        _step;
      try {
...
CreateAutomaticTokensForwarding401Response.RequiredProperties = ["apiVersion", "requestId", "error"];
