...
var GetBlockDetailsByBlockHeightFromCallbackRIBSZ2 = /*#__PURE__*/function () {
  ...
  _createClass(GetBlockDetailsByBlockHeightFromCallbackRIBSZ2, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHeightFromCallbackRIBSZ2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHeightFromCallbackRIBSZ2</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHeightFromCallbackRIBSZ2.RequiredProperties),
        _step;
      try {
...
GetBlockDetailsByBlockHeightFromCallbackRIBSZ2.RequiredProperties = ["bits", "chainwork", "merkleRoot", "nonce", "size", "version"];
