...
var ListTransactionsByBlockHeightRIBSZ = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHeightRIBSZ, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSZ.RequiredProperties),
        _step;
      try {
      ...
      if (data['vJoinSplit']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListTransactionsByBlockHeightRIBSZVJoinSplitInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['vShieldedOutput']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _ListTransactionsByBlockHeightRIBSZVShieldedOutputInner["default"].validateJsonObject(_item);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
      ...
      if (data['vin']) {
        ...
        try {
          for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
            ...
            _ListTransactionsByBlockHeightRIBSZVinInner["default"].validateJsonObject(_item3);
          }
        } catch (err) {
          _iterator5.e(err);
        } finally {
      ...
      if (data['vout']) {
        ...
        try {
          for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
            ...
            _ListTransactionsByBlockHeightRIBSZVoutInner["default"].validateJsonObject(_item4);
          }
        } catch (err) {
          _iterator6.e(err);
        } finally {
