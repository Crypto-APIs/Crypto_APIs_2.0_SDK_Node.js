...
/**
 * The GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash model module.
 * @module model/GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash
 * @version 2.0.0
 */
var GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash</code>.
   * Bitcoin Cash
   * @alias module:model/GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash
   ...
   */
  function GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash(difficulty, nonce, size, bits, chainwork, merkleRoot, version, versionHex) {
    _classCallCheck(this, GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash);

    GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, version, versionHex);
  }
  /**
  ...
  _createClass(GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash} obj Optional instance to populate.
     * @return {module:model/GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash} The populated <code>GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash();
  ...
  return GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash;
}();
/**
...
var _default = GetLatestMinedBlockResponseItemBlockchainSpecificBitcoinCash;
