...
var ListConfirmedTransactionsByAddressRIBSD2VoutInner = /*#__PURE__*/function () {
  ...
  _createClass(ListConfirmedTransactionsByAddressRIBSD2VoutInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListConfirmedTransactionsByAddressRIBSD2VoutInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListConfirmedTransactionsByAddressRIBSD2VoutInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListConfirmedTransactionsByAddressRIBSD2VoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _ListConfirmedTransactionsByAddressRIBSD2VoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
...
ListConfirmedTransactionsByAddressRIBSD2VoutInner.RequiredProperties = ["isSpent", "scriptPubKey", "value"];
