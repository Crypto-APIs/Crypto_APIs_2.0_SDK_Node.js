...
var DeleteBlockchainEventSubscriptionE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize DeleteBlockchainEventSubscriptionE403.
   */
  function DeleteBlockchainEventSubscriptionE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, DeleteBlockchainEventSubscriptionE403);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `DeleteBlockchainEventSubscriptionE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `DeleteBlockchainEventSubscriptionE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>DeleteBlockchainEventSubscriptionE403</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeleteBlockchainEventSubscriptionE403} obj Optional instance to populate.
   * @return {module:model/DeleteBlockchainEventSubscriptionE403} The populated <code>DeleteBlockchainEventSubscriptionE403</code> instance.
   */
  _createClass(DeleteBlockchainEventSubscriptionE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = DeleteBlockchainEventSubscriptionE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new DeleteBlockchainEventSubscriptionE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(DeleteBlockchainEventSubscriptionE403, "fromJSON", function (json_string) {
  return DeleteBlockchainEventSubscriptionE403.constructFromObject(JSON.parse(json_string));
});
 ...
 */
DeleteBlockchainEventSubscriptionE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
DeleteBlockchainEventSubscriptionE403.prototype['details'] = undefined;
DeleteBlockchainEventSubscriptionE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
var _default = DeleteBlockchainEventSubscriptionE403;
