...
/**
 * The PrepareANonFungibleTokenTransferFromAddressE403 model module.
 * @module model/PrepareANonFungibleTokenTransferFromAddressE403
 * @version 1.13.0
 */
var PrepareANonFungibleTokenTransferFromAddressE403 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PrepareANonFungibleTokenTransferFromAddressE403</code>.
   * @alias module:model/PrepareANonFungibleTokenTransferFromAddressE403
   ...
   */
  function PrepareANonFungibleTokenTransferFromAddressE403(code, message) {
    _classCallCheck(this, PrepareANonFungibleTokenTransferFromAddressE403);
    ...
    PrepareANonFungibleTokenTransferFromAddressE403.initialize(this, code, message);
  }
   ...
   */
  _createClass(PrepareANonFungibleTokenTransferFromAddressE403, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>PrepareANonFungibleTokenTransferFromAddressE403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PrepareANonFungibleTokenTransferFromAddressE403} obj Optional instance to populate.
     * @return {module:model/PrepareANonFungibleTokenTransferFromAddressE403} The populated <code>PrepareANonFungibleTokenTransferFromAddressE403</code> instance.
     */
  }, {
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new PrepareANonFungibleTokenTransferFromAddressE403();
 ...
 * @member {String} code
 */
PrepareANonFungibleTokenTransferFromAddressE403.prototype['code'] = undefined;

/**
 * Specifies the message of the error, i.e. why the error was returned, e.g. error 404 stands for “not found”.
 * @member {String} message
 */
PrepareANonFungibleTokenTransferFromAddressE403.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
PrepareANonFungibleTokenTransferFromAddressE403.prototype['details'] = undefined;
...
var _default = PrepareANonFungibleTokenTransferFromAddressE403;
