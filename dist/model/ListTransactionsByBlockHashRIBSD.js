...
var ListTransactionsByBlockHashRIBSD = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHashRIBSD, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIBSD.RequiredProperties),
        _step;
      try {
      ...
      if (data['vin']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListTransactionsByBlockHashRIBSDVinInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
