...
var _EstimateTokenGasLimitRBDataItem = _interopRequireDefault(require("./EstimateTokenGasLimitRBDataItem"));
...
var EstimateTokenGasLimitRBData = /*#__PURE__*/function () {
   ...
   */
  function EstimateTokenGasLimitRBData(item) {
    _classCallCheck(this, EstimateTokenGasLimitRBData);
   ...
   */
  _createClass(EstimateTokenGasLimitRBData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _EstimateTokenGasLimitRBDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>EstimateTokenGasLimitRBData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>EstimateTokenGasLimitRBData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(EstimateTokenGasLimitRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _EstimateTokenGasLimitRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
EstimateTokenGasLimitRBData.RequiredProperties = ["item"];
