...
var GetLatestMinedXRPRippleBlockE401 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidApiKey|module:model/MissingApiKey)} instance The actual instance to initialize GetLatestMinedXRPRippleBlockE401.
   */
  function GetLatestMinedXRPRippleBlockE401() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetLatestMinedXRPRippleBlockE401);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `GetLatestMinedXRPRippleBlockE401` with oneOf schemas InvalidApiKey, MissingApiKey. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `GetLatestMinedXRPRippleBlockE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>GetLatestMinedXRPRippleBlockE401</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetLatestMinedXRPRippleBlockE401} obj Optional instance to populate.
   * @return {module:model/GetLatestMinedXRPRippleBlockE401} The populated <code>GetLatestMinedXRPRippleBlockE401</code> instance.
   */
  _createClass(GetLatestMinedXRPRippleBlockE401, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = GetLatestMinedXRPRippleBlockE401.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new GetLatestMinedXRPRippleBlockE401(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(GetLatestMinedXRPRippleBlockE401, "fromJSON", function (json_string) {
  return GetLatestMinedXRPRippleBlockE401.constructFromObject(JSON.parse(json_string));
});
 ...
 */
GetLatestMinedXRPRippleBlockE401.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
GetLatestMinedXRPRippleBlockE401.prototype['details'] = undefined;
GetLatestMinedXRPRippleBlockE401.OneOf = ["InvalidApiKey", "MissingApiKey"];
var _default = GetLatestMinedXRPRippleBlockE401;
