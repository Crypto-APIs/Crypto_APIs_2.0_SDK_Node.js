...
var _GetBlockDetailsByBlockHashFromCallbackRData = _interopRequireDefault(require("./GetBlockDetailsByBlockHashFromCallbackRData"));
 ...
 * @version 1.11.0
 */
var GetBlockDetailsByBlockHashFromCallbackR = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetBlockDetailsByBlockHashFromCallbackR(apiVersion, requestId, data) {
    _classCallCheck(this, GetBlockDetailsByBlockHashFromCallbackR);
   ...
   */
  _createClass(GetBlockDetailsByBlockHashFromCallbackR, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _GetBlockDetailsByBlockHashFromCallbackRData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>GetBlockDetailsByBlockHashFromCallbackR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetBlockDetailsByBlockHashFromCallbackR</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetBlockDetailsByBlockHashFromCallbackR.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _GetBlockDetailsByBlockHashFromCallbackRData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
GetBlockDetailsByBlockHashFromCallbackR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
var _default = GetBlockDetailsByBlockHashFromCallbackR;
