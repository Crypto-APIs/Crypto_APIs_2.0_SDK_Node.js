 ...
 * @version 1.11.0
 */
var GetAddressBalanceRIConfirmedBalance = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetAddressBalanceRIConfirmedBalance(amount, unit) {
    _classCallCheck(this, GetAddressBalanceRIConfirmedBalance);
   ...
   */
  _createClass(GetAddressBalanceRIConfirmedBalance, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetAddressBalanceRIConfirmedBalance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetAddressBalanceRIConfirmedBalance</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetAddressBalanceRIConfirmedBalance.RequiredProperties),
        _step;
      try {
...
GetAddressBalanceRIConfirmedBalance.RequiredProperties = ["amount", "unit"];
...
var _default = GetAddressBalanceRIConfirmedBalance;
