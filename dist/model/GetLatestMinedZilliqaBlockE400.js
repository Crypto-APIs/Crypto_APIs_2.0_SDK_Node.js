...
var GetLatestMinedZilliqaBlockE400 = /*#__PURE__*/function () {
   ...
   */
  function GetLatestMinedZilliqaBlockE400(code, message) {
    ...
    GetLatestMinedZilliqaBlockE400.initialize(this, code, message);
  }
  /**
  ...
  _createClass(GetLatestMinedZilliqaBlockE400, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLatestMinedZilliqaBlockE400();
...
GetLatestMinedZilliqaBlockE400.prototype['details'] = undefined; // Implement UriNotFound interface:
