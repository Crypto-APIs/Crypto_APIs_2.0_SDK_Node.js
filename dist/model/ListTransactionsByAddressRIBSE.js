 ...
 * @version 1.2.0
 */
var ListTransactionsByAddressRIBSE = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ListTransactionsByAddressRIBSE</code>.
   * Ethereum
   * @alias module:model/ListTransactionsByAddressRIBSE
   ...
   */
  function ListTransactionsByAddressRIBSE(contract, gasLimit, gasPrice, gasUsed, inputData, nonce, transactionStatus) {
    _classCallCheck(this, ListTransactionsByAddressRIBSE);

    ListTransactionsByAddressRIBSE.initialize(this, contract, gasLimit, gasPrice, gasUsed, inputData, nonce, transactionStatus);
  }
  /**
  ...
  _createClass(ListTransactionsByAddressRIBSE, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>ListTransactionsByAddressRIBSE</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ListTransactionsByAddressRIBSE} obj Optional instance to populate.
     * @return {module:model/ListTransactionsByAddressRIBSE} The populated <code>ListTransactionsByAddressRIBSE</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ListTransactionsByAddressRIBSE();
  ...
  return ListTransactionsByAddressRIBSE;
}();
/**
...
var _default = ListTransactionsByAddressRIBSE;
