...
var ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC = /*#__PURE__*/function () {
   ...
   */
  function ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC(gasLimit, gasPrice, gasUsed, inputData, nonce, transactionStatus) {
    _classCallCheck(this, ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC);
   ...
   */
  _createClass(ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC, null, [{
    key: "initialize",
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC.RequiredProperties),
        _step;
      try {
      ...
      if (data['gasPrice']) {
        // data not null
        _ListConfirmedTransactionsByAddressRIBSBSCGasPrice["default"].validateJSON(data['gasPrice']);
      }
      // ensure the json data is a string
...
var _default = ListConfirmedTransactionsByAddressAndTimeRangeRIBSBSC;
