 ...
 * @version 1.11.0
 */
var GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey(addresses, asm, hex, reqSigs, type) {
    _classCallCheck(this, GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey);
   ...
   */
  _createClass(GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey.RequiredProperties),
        _step;
      try {
...
GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey.RequiredProperties = ["addresses", "asm", "hex", "reqSigs", "type"];
...
var _default = GetTransactionDetailsByTransactionIDFromCallbackRIBSDVoutInnerScriptPubKey;
