...
var ListTransactionsByBlockHeightRIBSZVoutInner = /*#__PURE__*/function () {
  ...
  _createClass(ListTransactionsByBlockHeightRIBSZVoutInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHeightRIBSZVoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _ListTransactionsByBlockHeightRIBSZVoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
