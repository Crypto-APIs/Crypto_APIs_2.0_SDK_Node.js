...
var ListTokensForwardingAutomationsE401 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidApiKey|module:model/MissingApiKey)} instance The actual instance to initialize ListTokensForwardingAutomationsE401.
   */
  function ListTokensForwardingAutomationsE401() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListTokensForwardingAutomationsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListTokensForwardingAutomationsE401` with oneOf schemas InvalidApiKey, MissingApiKey. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(ListTokensForwardingAutomationsE401, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListTokensForwardingAutomationsE401.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListTokensForwardingAutomationsE401(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListTokensForwardingAutomationsE401, "fromJSON", function (json_string) {
  return ListTokensForwardingAutomationsE401.constructFromObject(JSON.parse(json_string));
});
 ...
 */
ListTokensForwardingAutomationsE401.prototype['details'] = undefined;
ListTokensForwardingAutomationsE401.OneOf = ["InvalidApiKey", "MissingApiKey"];
