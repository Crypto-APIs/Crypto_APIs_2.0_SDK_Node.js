...
var GetWalletTransactionDetailsByTransactionIDRIBSE = /*#__PURE__*/function () {
   ...
   */
  function GetWalletTransactionDetailsByTransactionIDRIBSE(contract, gasLimit, gasPrice, gasUsed, inputData, nonce, transactionStatus) {
    _classCallCheck(this, GetWalletTransactionDetailsByTransactionIDRIBSE);
   ...
   */
  _createClass(GetWalletTransactionDetailsByTransactionIDRIBSE, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('gasPrice')) {
          obj['gasPrice'] = _GetWalletTransactionDetailsByTransactionIDRIBSEGasPrice["default"].constructFromObject(data['gasPrice']);
        }
...
var _default = GetWalletTransactionDetailsByTransactionIDRIBSE;
