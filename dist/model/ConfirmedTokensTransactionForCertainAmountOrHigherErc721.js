...
var ConfirmedTokensTransactionForCertainAmountOrHigherErc721 = /*#__PURE__*/function () {
  ...
  _createClass(ConfirmedTokensTransactionForCertainAmountOrHigherErc721, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ConfirmedTokensTransactionForCertainAmountOrHigherErc721</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConfirmedTokensTransactionForCertainAmountOrHigherErc721</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ConfirmedTokensTransactionForCertainAmountOrHigherErc721.RequiredProperties),
        _step;
      try {
...
ConfirmedTokensTransactionForCertainAmountOrHigherErc721.RequiredProperties = ["name", "symbol", "tokenId", "contractAddress"];
