...
var GetXRPRippleBlockDetailsByBlockHeight403Response = /*#__PURE__*/function () {
   ...
   */
  function GetXRPRippleBlockDetailsByBlockHeight403Response(apiVersion, requestId, error) {
    _classCallCheck(this, GetXRPRippleBlockDetailsByBlockHeight403Response);
   ...
   */
  _createClass(GetXRPRippleBlockDetailsByBlockHeight403Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetXRPRippleBlockDetailsByBlockHeight403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetXRPRippleBlockDetailsByBlockHeight403Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetXRPRippleBlockDetailsByBlockHeight403Response.RequiredProperties),
        _step;
      try {
...
GetXRPRippleBlockDetailsByBlockHeight403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = GetXRPRippleBlockDetailsByBlockHeight403Response;
