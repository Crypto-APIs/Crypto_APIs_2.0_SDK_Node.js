...
var _ListTransactionsByBlockHashRIBSD2VinInner = _interopRequireDefault(require("./ListTransactionsByBlockHashRIBSD2VinInner"));
var _ListTransactionsByBlockHashRIBSD2VoutInner = _interopRequireDefault(require("./ListTransactionsByBlockHashRIBSD2VoutInner"));
...
var ListTransactionsByBlockHashRIBSD2 = /*#__PURE__*/function () {
   ...
   * @param vin {Array.<module:model/ListTransactionsByBlockHashRIBSD2VinInner>} Represents the transaction inputs.
   * @param vout {Array.<module:model/ListTransactionsByBlockHashRIBSD2VoutInner>} Represents the transaction outputs.
   */
  ...
  _createClass(ListTransactionsByBlockHashRIBSD2, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('vin')) {
          obj['vin'] = _ApiClient["default"].convertToType(data['vin'], [_ListTransactionsByBlockHashRIBSD2VinInner["default"]]);
        }
        if (data.hasOwnProperty('vout')) {
          obj['vout'] = _ApiClient["default"].convertToType(data['vout'], [_ListTransactionsByBlockHashRIBSD2VoutInner["default"]]);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListTransactionsByBlockHashRIBSD2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListTransactionsByBlockHashRIBSD2</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListTransactionsByBlockHashRIBSD2.RequiredProperties),
        _step;
      try {
      ...
      if (data['vin']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListTransactionsByBlockHashRIBSD2VinInner["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
      ...
      if (data['vout']) {
        ...
        try {
          for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
            ...
            _ListTransactionsByBlockHashRIBSD2VoutInner["default"].validateJsonObject(_item);
          }
        } catch (err) {
          _iterator3.e(err);
        } finally {
...
ListTransactionsByBlockHashRIBSD2.RequiredProperties = ["locktime", "size", "version", "vin", "vout"];
