...
var NewRevertedBlockRB = /*#__PURE__*/function () {
  ...
  _createClass(NewRevertedBlockRB, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>NewRevertedBlockRB</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewRevertedBlockRB</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewRevertedBlockRB.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _NewRevertedBlockRBData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
NewRevertedBlockRB.RequiredProperties = ["data"];
