...
var _CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE = _interopRequireDefault(require("./CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriorityE403"));
 ...
 * @version 1.11.0
 */
var CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response(apiVersion, requestId, error) {
    _classCallCheck(this, CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response);
   ...
   */
  _createClass(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response.RequiredProperties),
        _step;
      try {
  ...
  return CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response;
}();
CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = CreateFungibleTokenTransactionRequestFromAddressWithoutFeePriority403Response;
