...
/**
 * The GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin model module.
 * @module model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin
 * @version 2.0.0
 */
var GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin</code>.
   * Litecoin
   * @alias module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin
   ...
   */
  function GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin);

    GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight);
  }
  /**
  ...
  _createClass(GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin} The populated <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin();
  ...
  return GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin;
}();
/**
...
var _default = GetBlockDetailsByBlockHashResponseItemBlockchainSpecificLitecoin;
