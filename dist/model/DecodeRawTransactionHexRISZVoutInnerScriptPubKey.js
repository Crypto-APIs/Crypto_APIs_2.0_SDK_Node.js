...
var DecodeRawTransactionHexRISZVoutInnerScriptPubKey = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISZVoutInnerScriptPubKey, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>DecodeRawTransactionHexRISZVoutInnerScriptPubKey</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DecodeRawTransactionHexRISZVoutInnerScriptPubKey</code>.
     */
  }, {
    key: "validateJSON",
