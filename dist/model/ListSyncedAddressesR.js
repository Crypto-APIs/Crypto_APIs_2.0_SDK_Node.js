...
var _ListSyncedAddressesRData = _interopRequireDefault(require("./ListSyncedAddressesRData"));
 ...
 * @version 1.11.0
 */
var ListSyncedAddressesR = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListSyncedAddressesR(apiVersion, requestId, data) {
    _classCallCheck(this, ListSyncedAddressesR);
   ...
   */
  _createClass(ListSyncedAddressesR, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _ListSyncedAddressesRData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ListSyncedAddressesR</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListSyncedAddressesR</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListSyncedAddressesR.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _ListSyncedAddressesRData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
ListSyncedAddressesR.RequiredProperties = ["apiVersion", "requestId", "data"];
...
var _default = ListSyncedAddressesR;
