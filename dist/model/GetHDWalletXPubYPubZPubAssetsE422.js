...
var GetHDWalletXPubYPubZPubAssetsE422 = /*#__PURE__*/function () {
   ...
   */
  function GetHDWalletXPubYPubZPubAssetsE422() {
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `GetHDWalletXPubYPubZPubAssetsE422` with oneOf schemas InvalidRequestBodyStructure, XpubSyncInProgress. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(GetHDWalletXPubYPubZPubAssetsE422, [{
 ...
 * @member {String} code
 */
_defineProperty(GetHDWalletXPubYPubZPubAssetsE422, "fromJSON", function (json_string) {
