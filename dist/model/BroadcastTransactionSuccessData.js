...
var _BroadcastTransactionSuccessDataItem = _interopRequireDefault(require("./BroadcastTransactionSuccessDataItem"));
 ...
 * @version 1.11.0
 */
var BroadcastTransactionSuccessData = /*#__PURE__*/function () {
  /**
   ...
   */
  function BroadcastTransactionSuccessData(product, event, item) {
    _classCallCheck(this, BroadcastTransactionSuccessData);
   ...
   */
  _createClass(BroadcastTransactionSuccessData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _BroadcastTransactionSuccessDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BroadcastTransactionSuccessData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BroadcastTransactionSuccessData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(BroadcastTransactionSuccessData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _BroadcastTransactionSuccessDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
BroadcastTransactionSuccessData.RequiredProperties = ["product", "event", "item"];
...
var _default = BroadcastTransactionSuccessData;
