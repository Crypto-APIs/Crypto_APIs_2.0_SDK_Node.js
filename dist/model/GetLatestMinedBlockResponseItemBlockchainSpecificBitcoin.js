...
/**
 * The GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin model module.
 * @module model/GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin
 * @version 2.0.0
 */
var GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin</code>.
   * Bitcoin
   * @alias module:model/GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin
   ...
   */
  function GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin);

    GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight);
  }
  /**
  ...
  _createClass(GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin} obj Optional instance to populate.
     * @return {module:model/GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin} The populated <code>GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin();
  ...
  return GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin;
}();
/**
...
var _default = GetLatestMinedBlockResponseItemBlockchainSpecificBitcoin;
