 ...
 * @version 1.11.0
 */
var GetHDWalletXPubYPubZPubDetails401Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetHDWalletXPubYPubZPubDetails401Response(apiVersion, requestId, error) {
    _classCallCheck(this, GetHDWalletXPubYPubZPubDetails401Response);
   ...
   */
  _createClass(GetHDWalletXPubYPubZPubDetails401Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetHDWalletXPubYPubZPubDetails401Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetHDWalletXPubYPubZPubDetails401Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetHDWalletXPubYPubZPubDetails401Response.RequiredProperties),
        _step;
      try {
...
GetHDWalletXPubYPubZPubDetails401Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = GetHDWalletXPubYPubZPubDetails401Response;
