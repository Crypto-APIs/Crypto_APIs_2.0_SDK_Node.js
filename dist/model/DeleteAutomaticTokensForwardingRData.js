...
var DeleteAutomaticTokensForwardingRData = /*#__PURE__*/function () {
  ...
  _createClass(DeleteAutomaticTokensForwardingRData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>DeleteAutomaticTokensForwardingRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DeleteAutomaticTokensForwardingRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(DeleteAutomaticTokensForwardingRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _DeleteAutomaticTokensForwardingRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
DeleteAutomaticTokensForwardingRData.RequiredProperties = ["item"];
