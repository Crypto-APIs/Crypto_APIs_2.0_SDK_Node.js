...
var InvalidPagination = /*#__PURE__*/function () {
   ...
   */
  function InvalidPagination(code, message) {
    _classCallCheck(this, InvalidPagination);
    InvalidPagination.initialize(this, code, message);
  }
  ...
  _createClass(InvalidPagination, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>InvalidPagination</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>InvalidPagination</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(InvalidPagination.RequiredProperties),
        _step;
      try {
...
InvalidPagination.RequiredProperties = ["code", "message"];
