...
var _ListTransactionsByBlockHeightRIBSBScriptPubKey = _interopRequireDefault(require("./ListTransactionsByBlockHeightRIBSBScriptPubKey"));
...
var ListTransactionsByBlockHeightRIBSBVout = /*#__PURE__*/function () {
   ...
   */
  function ListTransactionsByBlockHeightRIBSBVout(isSpent, scriptPubKey, value) {
    _classCallCheck(this, ListTransactionsByBlockHeightRIBSBVout);
  ...
  _createClass(ListTransactionsByBlockHeightRIBSBVout, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('scriptPubKey')) {
          obj['scriptPubKey'] = _ListTransactionsByBlockHeightRIBSBScriptPubKey["default"].constructFromObject(data['scriptPubKey']);
        }
  ...
  return ListTransactionsByBlockHeightRIBSBVout;
}();
/**
...
var _default = ListTransactionsByBlockHeightRIBSBVout;
