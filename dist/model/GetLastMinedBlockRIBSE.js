...
var GetLastMinedBlockRIBSE = /*#__PURE__*/function () {
   ...
   */
  function GetLastMinedBlockRIBSE(extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty, uncles) {
    _classCallCheck(this, GetLastMinedBlockRIBSE);
    GetLastMinedBlockRIBSE.initialize(this, extraData, gasLimit, gasUsed, minedInSeconds, nonce, sha3Uncles, size, totalDifficulty, uncles);
  }
  ...
  _createClass(GetLastMinedBlockRIBSE, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>GetLastMinedBlockRIBSE</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetLastMinedBlockRIBSE</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetLastMinedBlockRIBSE.RequiredProperties),
        _step;
      try {
...
GetLastMinedBlockRIBSE.RequiredProperties = ["extraData", "gasLimit", "gasUsed", "minedInSeconds", "nonce", "sha3Uncles", "size", "totalDifficulty", "uncles"];
