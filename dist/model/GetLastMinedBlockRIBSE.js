...
var GetLastMinedBlockRIBSE = /*#__PURE__*/function () {
   ...
   */
  function GetLastMinedBlockRIBSE(difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles) {
    _classCallCheck(this, GetLastMinedBlockRIBSE);

    GetLastMinedBlockRIBSE.initialize(this, difficulty, nonce, size, extraData, gasLimit, gasUsed, minedInSeconds, sha3Uncles, totalDifficulty, uncles);
  }
  /**
