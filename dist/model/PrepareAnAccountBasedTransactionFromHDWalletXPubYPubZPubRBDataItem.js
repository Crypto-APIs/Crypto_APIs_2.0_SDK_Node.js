 ...
 */var PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBDataItem = /*#__PURE__*/function () {
   ...
   */
  function PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBDataItem(amount, recipient, sender, xpub, fee) {
  ...
  _createClass(PrepareAnAccountBasedTransactionFromHDWalletXPubYPubZPubRBDataItem, null, [{
    key: "initialize",
    value: function initialize(obj, amount, recipient, sender, xpub, fee) {
      obj['amount'] = amount;
