...
var DecodeRawTransactionHexRISE = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISE, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>DecodeRawTransactionHexRISE</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>DecodeRawTransactionHexRISE</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRISE.RequiredProperties),
        _step;
      try {
      ...
      // ensure the json data is a string
      if (data['maxFeePriorityPerGas'] && !(typeof data['maxFeePriorityPerGas'] === 'string' || data['maxFeePriorityPerGas'] instanceof String)) {
        throw new Error("Expected the field `maxFeePriorityPerGas` to be a primitive type in the JSON string but got " + data['maxFeePriorityPerGas']);
      }
      // ensure the json data is a string
...
DecodeRawTransactionHexRISE.RequiredProperties = ["gasLimit", "nonce", "recipient", "sender", "type"];
