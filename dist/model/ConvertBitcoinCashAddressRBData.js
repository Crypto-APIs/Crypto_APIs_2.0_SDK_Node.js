...
var _ConvertBitcoinCashAddressRBDataItem = _interopRequireDefault(require("./ConvertBitcoinCashAddressRBDataItem"));
...
var ConvertBitcoinCashAddressRBData = /*#__PURE__*/function () {
   ...
   */
  function ConvertBitcoinCashAddressRBData(item) {
    _classCallCheck(this, ConvertBitcoinCashAddressRBData);
   ...
   */
  _createClass(ConvertBitcoinCashAddressRBData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _ConvertBitcoinCashAddressRBDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ConvertBitcoinCashAddressRBData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ConvertBitcoinCashAddressRBData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ConvertBitcoinCashAddressRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _ConvertBitcoinCashAddressRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
ConvertBitcoinCashAddressRBData.RequiredProperties = ["item"];
