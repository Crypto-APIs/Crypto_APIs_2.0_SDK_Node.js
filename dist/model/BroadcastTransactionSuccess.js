...
var _BroadcastTransactionSuccessData = _interopRequireDefault(require("./BroadcastTransactionSuccessData"));
...
var BroadcastTransactionSuccess = /*#__PURE__*/function () {
   ...
   */
  function BroadcastTransactionSuccess(apiVersion, referenceId, idempotencyKey, data) {
    _classCallCheck(this, BroadcastTransactionSuccess);
   ...
   */
  _createClass(BroadcastTransactionSuccess, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _BroadcastTransactionSuccessData["default"].constructFromObject(data['data']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>BroadcastTransactionSuccess</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>BroadcastTransactionSuccess</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(BroadcastTransactionSuccess.RequiredProperties),
        _step;
      try {
      ...
      if (data['data']) {
        // data not null
        _BroadcastTransactionSuccessData["default"].validateJSON(data['data']);
      }
      return true;
    }
  }]);
...
BroadcastTransactionSuccess.RequiredProperties = ["apiVersion", "referenceId", "idempotencyKey", "data"];
...
var _default = BroadcastTransactionSuccess;
