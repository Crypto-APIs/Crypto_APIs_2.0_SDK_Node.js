...
var GetWalletAssetDetails403Response = /*#__PURE__*/function () {
   ...
   */
  function GetWalletAssetDetails403Response(apiVersion, requestId, error) {
    _classCallCheck(this, GetWalletAssetDetails403Response);
   ...
   */
  _createClass(GetWalletAssetDetails403Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetWalletAssetDetails403Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetWalletAssetDetails403Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetWalletAssetDetails403Response.RequiredProperties),
        _step;
      try {
...
GetWalletAssetDetails403Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = GetWalletAssetDetails403Response;
