...
/**
 * The GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin model module.
 * @module model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin
 * @version 2.0.0
 */
var GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin</code>.
   * Bitcoin
   * @alias module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin
   ...
   */
  function GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin(difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight) {
    _classCallCheck(this, GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin);

    GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin.initialize(this, difficulty, nonce, size, bits, chainwork, merkleRoot, strippedSize, version, versionHex, weight);
  }
  /**
  ...
  _createClass(GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin, null, [{
    key: "initialize",
    ...
    /**
     * Constructs a <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin} obj Optional instance to populate.
     * @return {module:model/GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin} The populated <code>GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin</code> instance.
     */
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin();
  ...
  return GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin;
}();
/**
...
var _default = GetBlockDetailsByBlockHashResponseItemBlockchainSpecificBitcoin;
