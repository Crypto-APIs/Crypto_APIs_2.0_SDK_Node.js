 ...
 * @version 1.11.0
 */
var ListInternalTransactionsByAddress400Response = /*#__PURE__*/function () {
  /**
   ...
   */
  function ListInternalTransactionsByAddress400Response(apiVersion, requestId, error) {
    _classCallCheck(this, ListInternalTransactionsByAddress400Response);
   ...
   */
  _createClass(ListInternalTransactionsByAddress400Response, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>ListInternalTransactionsByAddress400Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListInternalTransactionsByAddress400Response</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListInternalTransactionsByAddress400Response.RequiredProperties),
        _step;
      try {
...
ListInternalTransactionsByAddress400Response.RequiredProperties = ["apiVersion", "requestId", "error"];
...
var _default = ListInternalTransactionsByAddress400Response;
