...
var DecodeRawTransactionHexRISD2VinInner = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISD2VinInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRISD2VinInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptSig']) {
        // data not null
        _DecodeRawTransactionHexRISD2VinInnerScriptSig["default"].validateJSON(data['scriptSig']);
      }
      // ensure the json data is a string
