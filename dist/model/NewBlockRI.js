 ...
 * @version 1.11.0
 */
var NewBlockRI = /*#__PURE__*/function () {
  /**
   ...
   */
  function NewBlockRI(callbackSecretKey, callbackUrl, createdTimestamp, isActive, referenceId) {
    _classCallCheck(this, NewBlockRI);
  ...
  _createClass(NewBlockRI, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>NewBlockRI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>NewBlockRI</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(NewBlockRI.RequiredProperties),
        _step;
      try {
...
NewBlockRI.RequiredProperties = ["callbackSecretKey", "callbackUrl", "createdTimestamp", "isActive", "referenceId"];
