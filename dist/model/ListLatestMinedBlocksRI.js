...
var ListLatestMinedBlocksRI = /*#__PURE__*/function () {
  ...
  _createClass(ListLatestMinedBlocksRI, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListLatestMinedBlocksRI</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListLatestMinedBlocksRI</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListLatestMinedBlocksRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['blockchainSpecific']) {
        // data not null
        _ListLatestMinedBlocksRIBS["default"].validateJSON(data['blockchainSpecific']);
      }
      return true;
    }
  }]);
...
ListLatestMinedBlocksRI.RequiredProperties = ["hash", "height", "previousBlockHash", "timestamp", "transactionsCount", "blockchainSpecific"];
