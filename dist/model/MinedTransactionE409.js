...
var MinedTransactionE409 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/AlreadyExists|module:model/InvalidData)} instance The actual instance to initialize MinedTransactionE409.
   */
  function MinedTransactionE409() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, MinedTransactionE409);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `MinedTransactionE409` with oneOf schemas AlreadyExists, InvalidData. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `MinedTransactionE409` with oneOf schemas AlreadyExists, InvalidData. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>MinedTransactionE409</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/MinedTransactionE409} obj Optional instance to populate.
   * @return {module:model/MinedTransactionE409} The populated <code>MinedTransactionE409</code> instance.
   */
  _createClass(MinedTransactionE409, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = MinedTransactionE409.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new MinedTransactionE409(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(MinedTransactionE409, "fromJSON", function (json_string) {
  return MinedTransactionE409.constructFromObject(JSON.parse(json_string));
});
 ...
 */
MinedTransactionE409.prototype['message'] = undefined;

/**
 * @member {Array.<module:model/BannedIpAddressDetailsInner>} details
 */
MinedTransactionE409.prototype['details'] = undefined;
MinedTransactionE409.OneOf = ["AlreadyExists", "InvalidData"];
var _default = MinedTransactionE409;
