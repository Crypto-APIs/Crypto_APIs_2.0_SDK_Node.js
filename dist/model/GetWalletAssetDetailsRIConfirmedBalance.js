...
var GetWalletAssetDetailsRIConfirmedBalance = /*#__PURE__*/function () {
   ...
   */
  function GetWalletAssetDetailsRIConfirmedBalance(amount, unit) {
    _classCallCheck(this, GetWalletAssetDetailsRIConfirmedBalance);
   ...
   */
  _createClass(GetWalletAssetDetailsRIConfirmedBalance, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetWalletAssetDetailsRIConfirmedBalance</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetWalletAssetDetailsRIConfirmedBalance</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetWalletAssetDetailsRIConfirmedBalance.RequiredProperties),
        _step;
      try {
...
GetWalletAssetDetailsRIConfirmedBalance.RequiredProperties = ["amount", "unit"];
...
var _default = GetWalletAssetDetailsRIConfirmedBalance;
