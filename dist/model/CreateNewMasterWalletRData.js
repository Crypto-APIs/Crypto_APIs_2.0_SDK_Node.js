...
var _CreateNewMasterWalletRI = _interopRequireDefault(require("./CreateNewMasterWalletRI"));
...
var CreateNewMasterWalletRData = /*#__PURE__*/function () {
   ...
   */
  function CreateNewMasterWalletRData(item) {
    _classCallCheck(this, CreateNewMasterWalletRData);
   ...
   */
  _createClass(CreateNewMasterWalletRData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _CreateNewMasterWalletRI["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>CreateNewMasterWalletRData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CreateNewMasterWalletRData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CreateNewMasterWalletRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _CreateNewMasterWalletRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
CreateNewMasterWalletRData.RequiredProperties = ["item"];
