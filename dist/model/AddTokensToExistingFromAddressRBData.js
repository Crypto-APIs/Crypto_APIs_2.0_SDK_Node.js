...
var AddTokensToExistingFromAddressRBData = /*#__PURE__*/function () {
  ...
  _createClass(AddTokensToExistingFromAddressRBData, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>AddTokensToExistingFromAddressRBData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>AddTokensToExistingFromAddressRBData</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(AddTokensToExistingFromAddressRBData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _AddTokensToExistingFromAddressRBDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
AddTokensToExistingFromAddressRBData.RequiredProperties = ["item"];
