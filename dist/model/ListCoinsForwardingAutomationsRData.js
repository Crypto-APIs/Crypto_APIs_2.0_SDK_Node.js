...
var ListCoinsForwardingAutomationsRData = /*#__PURE__*/function () {
   ...
   */
  function ListCoinsForwardingAutomationsRData(limit, offset, total, items) {
  ...
  _createClass(ListCoinsForwardingAutomationsRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ListCoinsForwardingAutomationsRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['items']) {
        ...
        try {
          for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
            ...
            _ListCoinsForwardingAutomationsRI["default"].validateJsonObject(item);
          }
        } catch (err) {
          _iterator2.e(err);
        } finally {
