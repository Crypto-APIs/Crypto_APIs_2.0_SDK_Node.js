...
var GetTransactionDetailsByTransactionIDFromCallbackRIBSXValue = /*#__PURE__*/function () {
   ...
   */
  function GetTransactionDetailsByTransactionIDFromCallbackRIBSXValue(amount, unit) {
    _classCallCheck(this, GetTransactionDetailsByTransactionIDFromCallbackRIBSXValue);
   ...
   */
  _createClass(GetTransactionDetailsByTransactionIDFromCallbackRIBSXValue, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSXValue</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetTransactionDetailsByTransactionIDFromCallbackRIBSXValue</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDFromCallbackRIBSXValue.RequiredProperties),
        _step;
      try {
...
GetTransactionDetailsByTransactionIDFromCallbackRIBSXValue.RequiredProperties = ["amount", "unit"];
...
var _default = GetTransactionDetailsByTransactionIDFromCallbackRIBSXValue;
