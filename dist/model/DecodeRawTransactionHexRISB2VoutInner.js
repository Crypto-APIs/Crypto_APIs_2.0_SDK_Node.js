...
var DecodeRawTransactionHexRISB2VoutInner = /*#__PURE__*/function () {
  ...
  _createClass(DecodeRawTransactionHexRISB2VoutInner, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(DecodeRawTransactionHexRISB2VoutInner.RequiredProperties),
        _step;
      try {
      ...
      if (data['scriptPubKey']) {
        // data not null
        _DecodeRawTransactionHexRISB2VoutInnerScriptPubKey["default"].validateJSON(data['scriptPubKey']);
      }
