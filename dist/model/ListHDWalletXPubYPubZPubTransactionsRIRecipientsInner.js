...
var ListHDWalletXPubYPubZPubTransactionsRIRecipientsInner = /*#__PURE__*/function () {
  ...
  _createClass(ListHDWalletXPubYPubZPubTransactionsRIRecipientsInner, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>ListHDWalletXPubYPubZPubTransactionsRIRecipientsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ListHDWalletXPubYPubZPubTransactionsRIRecipientsInner</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(ListHDWalletXPubYPubZPubTransactionsRIRecipientsInner.RequiredProperties),
        _step;
      try {
...
ListHDWalletXPubYPubZPubTransactionsRIRecipientsInner.RequiredProperties = ["address", "amount", "isMember"];
