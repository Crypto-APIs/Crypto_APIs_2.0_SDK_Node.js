...
var CoinsForwardingAutomationsLimitReached = /*#__PURE__*/function () {
  ...
  _createClass(CoinsForwardingAutomationsLimitReached, null, [{
    ...
    /**
     * Validates the JSON data with respect to <code>CoinsForwardingAutomationsLimitReached</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>CoinsForwardingAutomationsLimitReached</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(CoinsForwardingAutomationsLimitReached.RequiredProperties),
        _step;
      try {
...
CoinsForwardingAutomationsLimitReached.RequiredProperties = ["code", "message"];
