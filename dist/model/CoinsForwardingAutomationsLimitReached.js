...
var _CoinsForwardingAutomationsLimitReachedError = _interopRequireDefault(require("./CoinsForwardingAutomationsLimitReachedError"));
...
var CoinsForwardingAutomationsLimitReached = /*#__PURE__*/function () {
   ...
   * @param error {module:model/CoinsForwardingAutomationsLimitReachedError} 
   */
  function CoinsForwardingAutomationsLimitReached(apiVersion, requestId, error) {
    _classCallCheck(this, CoinsForwardingAutomationsLimitReached);

    CoinsForwardingAutomationsLimitReached.initialize(this, apiVersion, requestId, error);
  }
  /**
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('error')) {
          obj['error'] = _CoinsForwardingAutomationsLimitReachedError["default"].constructFromObject(data['error']);
        }
      }
...
CoinsForwardingAutomationsLimitReached.prototype['apiVersion'] = undefined;
/**
 * Defines the ID of the request. The `requestId` is generated by Crypto APIs and it's unique for every request.
 * @member {String} requestId
 */

CoinsForwardingAutomationsLimitReached.prototype['requestId'] = undefined;
/**
 * In batch situations the user can use the context to correlate responses with requests. This property is present regardless of whether the response was successful or returned as an error. `context` is specified by the user.
 * @member {String} context
 */

CoinsForwardingAutomationsLimitReached.prototype['context'] = undefined;
/**
 * @member {module:model/CoinsForwardingAutomationsLimitReachedError} error
 */

CoinsForwardingAutomationsLimitReached.prototype['error'] = undefined;
