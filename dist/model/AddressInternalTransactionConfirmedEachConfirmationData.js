...
var _AddressInternalTransactionConfirmedEachConfirmationDataItem = _interopRequireDefault(require("./AddressInternalTransactionConfirmedEachConfirmationDataItem"));
...
var AddressInternalTransactionConfirmedEachConfirmationData = /*#__PURE__*/function () {
   ...
   */
  function AddressInternalTransactionConfirmedEachConfirmationData(product, event, item) {
    _classCallCheck(this, AddressInternalTransactionConfirmedEachConfirmationData);
   ...
   */
  _createClass(AddressInternalTransactionConfirmedEachConfirmationData, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('item')) {
          obj['item'] = _AddressInternalTransactionConfirmedEachConfirmationDataItem["default"].constructFromObject(data['item']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(AddressInternalTransactionConfirmedEachConfirmationData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _AddressInternalTransactionConfirmedEachConfirmationDataItem["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
...
var _default = AddressInternalTransactionConfirmedEachConfirmationData;
