...
var TransactionMinedDataItemMinedInBlock = /*#__PURE__*/function () {
   ...
   */
  function TransactionMinedDataItemMinedInBlock(height, hash, timestamp) {
    _classCallCheck(this, TransactionMinedDataItemMinedInBlock);
   ...
   */
  _createClass(TransactionMinedDataItemMinedInBlock, null, [{
    key: "initialize",
    ...
    /**
     * Validates the JSON data with respect to <code>TransactionMinedDataItemMinedInBlock</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>TransactionMinedDataItemMinedInBlock</code>.
     */
  }, {
    key: "validateJSON",
    value: function validateJSON(data) {
      // check to make sure all required properties are present in the JSON string
      var _iterator = _createForOfIteratorHelper(TransactionMinedDataItemMinedInBlock.RequiredProperties),
        _step;
      try {
...
TransactionMinedDataItemMinedInBlock.RequiredProperties = ["height", "hash", "timestamp"];
...
var _default = TransactionMinedDataItemMinedInBlock;
