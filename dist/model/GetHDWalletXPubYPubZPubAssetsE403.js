...
var GetHDWalletXPubYPubZPubAssetsE403 = /*#__PURE__*/function () {
   ...
   */
  function GetHDWalletXPubYPubZPubAssetsE403() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, GetHDWalletXPubYPubZPubAssetsE403);
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `GetHDWalletXPubYPubZPubAssetsE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(GetHDWalletXPubYPubZPubAssetsE403, [{
 ...
 * @member {String} code
 */
_defineProperty(GetHDWalletXPubYPubZPubAssetsE403, "fromJSON", function (json_string) {
...
var _default = GetHDWalletXPubYPubZPubAssetsE403;
