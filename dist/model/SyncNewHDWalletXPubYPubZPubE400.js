...
var SyncNewHDWalletXPubYPubZPubE400 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidBlockchain|module:model/InvalidNetwork|module:model/InvalidPagination|module:model/InvalidXpub|module:model/LimitGreaterThanAllowed|module:model/UriNotFound|module:model/XpubNotSynced)} instance The actual instance to initialize SyncNewHDWalletXPubYPubZPubE400.
   */
  function SyncNewHDWalletXPubYPubZPubE400() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `SyncNewHDWalletXPubYPubZPubE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `SyncNewHDWalletXPubYPubZPubE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound, XpubNotSynced. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(SyncNewHDWalletXPubYPubZPubE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = SyncNewHDWalletXPubYPubZPubE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new SyncNewHDWalletXPubYPubZPubE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(SyncNewHDWalletXPubYPubZPubE400, "fromJSON", function (json_string) {
  return SyncNewHDWalletXPubYPubZPubE400.constructFromObject(JSON.parse(json_string));
});
 ...
 */
SyncNewHDWalletXPubYPubZPubE400.prototype['details'] = undefined;
SyncNewHDWalletXPubYPubZPubE400.OneOf = ["InvalidBlockchain", "InvalidNetwork", "InvalidPagination", "InvalidXpub", "LimitGreaterThanAllowed", "UriNotFound", "XpubNotSynced"];
