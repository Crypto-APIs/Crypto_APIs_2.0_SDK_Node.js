...
var GetTransactionDetailsByTransactionIDFromCallbackRData = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDFromCallbackRData, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDFromCallbackRData.RequiredProperties),
        _step;
      try {
      ...
      if (data['item']) {
        // data not null
        _GetTransactionDetailsByTransactionIDFromCallbackRI["default"].validateJSON(data['item']);
      }
      return true;
    }
  }]);
