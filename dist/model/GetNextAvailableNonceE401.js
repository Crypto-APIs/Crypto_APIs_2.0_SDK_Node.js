...
var GetNextAvailableNonceE401 = /*#__PURE__*/function () {
   ...
   */
  function GetNextAvailableNonceE401(code, message) {
    ...
    GetNextAvailableNonceE401.initialize(this, code, message);
  }
  /**
  ...
  _createClass(GetNextAvailableNonceE401, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetNextAvailableNonceE401();
...
GetNextAvailableNonceE401.prototype['details'] = undefined; // Implement MissingApiKey interface:
