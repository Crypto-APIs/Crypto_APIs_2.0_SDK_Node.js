...
var ListZilliqaTransactionsByBlockHeightE403 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/BannedIpAddress|module:model/EndpointNotAllowedForApiKey|module:model/EndpointNotAllowedForPlan|module:model/FeatureMainnetsNotAllowedForPlan)} instance The actual instance to initialize ListZilliqaTransactionsByBlockHeightE403.
   */
  function ListZilliqaTransactionsByBlockHeightE403() {
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListZilliqaTransactionsByBlockHeightE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListZilliqaTransactionsByBlockHeightE403` with oneOf schemas BannedIpAddress, EndpointNotAllowedForApiKey, EndpointNotAllowedForPlan, FeatureMainnetsNotAllowedForPlan. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(ListZilliqaTransactionsByBlockHeightE403, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListZilliqaTransactionsByBlockHeightE403.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListZilliqaTransactionsByBlockHeightE403(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListZilliqaTransactionsByBlockHeightE403, "fromJSON", function (json_string) {
  return ListZilliqaTransactionsByBlockHeightE403.constructFromObject(JSON.parse(json_string));
});
 ...
 */
ListZilliqaTransactionsByBlockHeightE403.prototype['details'] = undefined;
ListZilliqaTransactionsByBlockHeightE403.OneOf = ["BannedIpAddress", "EndpointNotAllowedForApiKey", "EndpointNotAllowedForPlan", "FeatureMainnetsNotAllowedForPlan"];
