...
var DeriveAndSyncNewChangeAddressesE400 = /*#__PURE__*/function () {
   ...
   */
  function DeriveAndSyncNewChangeAddressesE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, DeriveAndSyncNewChangeAddressesE400);
    ...
    if (match > 1) {
      ...
      throw new Error("No match found constructing `DeriveAndSyncNewChangeAddressesE400` with oneOf schemas InvalidBlockchain, InvalidNetwork, InvalidPagination, InvalidXpub, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
  ...
  /**
   * Constructs a <code>DeriveAndSyncNewChangeAddressesE400</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeriveAndSyncNewChangeAddressesE400} obj Optional instance to populate.
   ...
   */
  _createClass(DeriveAndSyncNewChangeAddressesE400, [{
 ...
 * @member {String} code
 */
_defineProperty(DeriveAndSyncNewChangeAddressesE400, "fromJSON", function (json_string) {
 ...
 */
DeriveAndSyncNewChangeAddressesE400.prototype['message'] = undefined;
...
var _default = DeriveAndSyncNewChangeAddressesE400;
