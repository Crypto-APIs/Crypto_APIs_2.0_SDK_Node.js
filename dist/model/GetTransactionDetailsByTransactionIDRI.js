...
var GetTransactionDetailsByTransactionIDRI = /*#__PURE__*/function () {
  ...
  _createClass(GetTransactionDetailsByTransactionIDRI, null, [{
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(GetTransactionDetailsByTransactionIDRI.RequiredProperties),
        _step;
      try {
      ...
      if (data['fee']) {
        // data not null
        _GetTransactionDetailsByTransactionIDRIFee["default"].validateJSON(data['fee']);
      }
      // validate the optional field `blockchainSpecific`
      if (data['blockchainSpecific']) {
        // data not null
        _GetTransactionDetailsByTransactionIDRIBS["default"].validateJSON(data['blockchainSpecific']);
      }
      return true;
    }
  }]);
