...
var ListTransactionsByBlockHeightE400 = /*#__PURE__*/function () {
   ...
   * @param {(module:model/InvalidPagination|module:model/LimitGreaterThanAllowed|module:model/UriNotFound)} instance The actual instance to initialize ListTransactionsByBlockHeightE400.
   */
  function ListTransactionsByBlockHeightE400() {
    var instance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    _classCallCheck(this, ListTransactionsByBlockHeightE400);
    ...
    if (match > 1) {
      throw new Error("Multiple matches found constructing `ListTransactionsByBlockHeightE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Input: " + JSON.stringify(instance));
    } else if (match === 0) {
      this.actualInstance = null; // clear the actual instance in case there are multiple matches
      throw new Error("No match found constructing `ListTransactionsByBlockHeightE400` with oneOf schemas InvalidPagination, LimitGreaterThanAllowed, UriNotFound. Details: " + errorMessages.join(", "));
    } else {// only 1 match
      // the input is valid
    }
  }
   ...
   */
  _createClass(ListTransactionsByBlockHeightE400, [{
    ...
    value: function setActualInstance(obj) {
      this.actualInstance = ListTransactionsByBlockHeightE400.constructFromObject(obj).getActualInstance();
    }
    ...
    value: function constructFromObject(data, obj) {
      return new ListTransactionsByBlockHeightE400(data);
    }
  }]);
 ...
 * @member {String} code
 */
_defineProperty(ListTransactionsByBlockHeightE400, "fromJSON", function (json_string) {
  return ListTransactionsByBlockHeightE400.constructFromObject(JSON.parse(json_string));
});
...
ListTransactionsByBlockHeightE400.OneOf = ["InvalidPagination", "LimitGreaterThanAllowed", "UriNotFound"];
var _default = ListTransactionsByBlockHeightE400;
