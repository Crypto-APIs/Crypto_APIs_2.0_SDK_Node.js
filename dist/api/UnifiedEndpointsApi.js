  ...
  */
  ...
  _createClass(UnifiedEndpointsApi, [{
    ...
    value: function getAddressDetailsWithHttpInfo(blockchain, network, address, opts) {
      ...
      var returnType = _GetAddressDetailsResponse["default"];
    ...
    value: function getBlockDetailsByBlockHashWithHttpInfo(blockchain, network, blockHash, opts) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _GetBlockDetailsByBlockHashResponse["default"];
    ...
    value: function getBlockDetailsByBlockHeightWithHttpInfo(blockchain, network, height, opts) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _GetBlockDetailsByBlockHeightResponse["default"];
    ...
    value: function getFeeRecommendationsWithHttpInfo(blockchain, network, opts) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _GetFeeRecommendationsResponse["default"];
    ...
    value: function getLatestMinedBlockWithHttpInfo(blockchain, network, opts) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _GetLatestMinedBlockResponse["default"];
    ...
    value: function getTransactionDetailsByTransactionIDWithHttpInfo(blockchain, network, transactionId, opts) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _GetTransactionDetailsByTransactionIDResponse["default"];
    ...
    value: function listTransactionsByAddressWithHttpInfo(blockchain, network, address, opts) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _ListTransactionsByAddressResponse["default"];
    ...
    value: function listTransactionsByBlockHashWithHttpInfo(blockchain, network, blockHash, opts) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _ListTransactionsByBlockHashResponse["default"];
    ...
    value: function listTransactionsByBlockHeightWithHttpInfo(blockchain, network, height, opts) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _ListTransactionsByBlockHeightResponse["default"];
